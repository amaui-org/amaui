...
const IconMaterialPendingW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialPendingW100.displayName = 'AmauiIconMaterialPendingW100';

export default IconMaterialPendingW100;
