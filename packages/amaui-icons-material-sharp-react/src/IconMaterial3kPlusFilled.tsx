...
const IconMaterial3kPlusFilled = React.forwardRef((props: IIcon, ref) => {
  ...
  return (
    <Icon
      ...
      {...props}
    >
      <path d="M16.5 14h1v-1.5H19v-1h-1.5V10h-1v1.5H15v1h1.5ZM11 15h1.5v-2.25L14.25 15H16l-2.25-3L16 9h-1.75l-1.75 2.25V9H11Zm-5.5 0H10V9H5.5v1.5h3v1h-2v1h2v1h-3ZM3 21V3h18v18Z"/>
    </Icon>
  );
});
