...
const IconMaterialContactlessW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='ContactlessW100'
...
IconMaterialContactlessW100.displayName = 'AmauiIconMaterialContactlessW100';

export default IconMaterialContactlessW100;
