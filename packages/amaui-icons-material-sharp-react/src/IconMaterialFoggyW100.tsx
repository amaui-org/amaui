...
const IconMaterialFoggyW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialFoggyW100.displayName = 'AmauiIconMaterialFoggyW100';

export default IconMaterialFoggyW100;
