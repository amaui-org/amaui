...
const IconMaterialCompostW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialCompostW100.displayName = 'AmauiIconMaterialCompostW100';

export default IconMaterialCompostW100;
