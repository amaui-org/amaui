...
const IconMaterialLauncherAssistantOn = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='LauncherAssistantOn'
...
IconMaterialLauncherAssistantOn.displayName = 'AmauiIconMaterialLauncherAssistantOn';

export default IconMaterialLauncherAssistantOn;
