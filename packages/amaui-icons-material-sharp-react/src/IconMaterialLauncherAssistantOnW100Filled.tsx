...
const IconMaterialLauncherAssistantOnW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='LauncherAssistantOnW100Filled'
...
IconMaterialLauncherAssistantOnW100Filled.displayName = 'AmauiIconMaterialLauncherAssistantOnW100Filled';

export default IconMaterialLauncherAssistantOnW100Filled;
