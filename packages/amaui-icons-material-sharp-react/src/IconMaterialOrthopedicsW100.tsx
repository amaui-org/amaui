...
const IconMaterialOrthopedicsW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='OrthopedicsW100'
...
IconMaterialOrthopedicsW100.displayName = 'AmauiIconMaterialOrthopedicsW100';

export default IconMaterialOrthopedicsW100;
