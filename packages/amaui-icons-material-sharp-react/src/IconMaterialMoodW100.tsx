...
const IconMaterialMoodW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialMoodW100.displayName = 'AmauiIconMaterialMoodW100';

export default IconMaterialMoodW100;
