...
const IconMaterialMobileScreenShareW100Filled = React.forwardRef((props: IIcon, ref) => {
  ...
  return (
    <Icon
      ...
      {...props}
    >
      <path d="M9.65 14.75V13.5q0-.975.688-1.663.687-.687 1.662-.687h1.25v-1.1l1.45 1.45-1.45 1.45v-1.1H12q-.675 0-1.162.487-.488.488-.488 1.163v1.25ZM6.3 21.7V2.3h11.4v19.4Zm.7-3.05h10V5.35H7Z"/>
    </Icon>
  );
});
