...
const IconMaterialPreliminaryW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='PreliminaryW100'
...
IconMaterialPreliminaryW100.displayName = 'AmauiIconMaterialPreliminaryW100';

export default IconMaterialPreliminaryW100;
