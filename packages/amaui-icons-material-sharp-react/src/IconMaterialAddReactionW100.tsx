...
const IconMaterialAddReactionW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='AddReactionW100'
...
export default IconMaterialAddReactionW100;
