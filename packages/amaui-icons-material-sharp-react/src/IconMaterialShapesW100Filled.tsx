...
const IconMaterialShapesW100Filled = React.forwardRef((props: IIcon, ref) => {
  ...
  return (
    <Icon
      ...
      {...props}
    >
      <path d="M9.3 15q-2.375 0-4.037-1.663Q3.6 11.675 3.6 9.3t1.663-4.038Q6.925 3.6 9.3 3.6t4.038 1.662Q15 6.925 15 9.3t-1.662 4.037Q11.675 15 9.3 15ZM9 20.4V18h.3q3.625 0 6.163-2.538Q18 12.925 18 9.3V9h2.4v11.4Z"/>
    </Icon>
  );
});
