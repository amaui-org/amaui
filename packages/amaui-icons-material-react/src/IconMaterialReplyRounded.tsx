...
const IconMaterialReplyRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialReplyRounded.displayName = 'AmauiIconMaterialReplyRounded';

export default IconMaterialReplyRounded;
