...
const IconMaterialTibiaOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TibiaOutlinedW100Filled'
      short_name='Tibia'
...
export default IconMaterialTibiaOutlinedW100Filled;
