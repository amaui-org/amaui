...
const IconMaterialAstrophotographyOffSharpW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AstrophotographyOffSharpW700'
...
export default IconMaterialAstrophotographyOffSharpW700;
