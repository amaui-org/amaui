...
const IconMaterialSpatialAudioOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SpatialAudioOutlinedFilled'
...
export default IconMaterialSpatialAudioOutlinedFilled;
