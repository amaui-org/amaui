...
const IconMaterialSettingsAccessibilityOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SettingsAccessibilityOutlinedFilled'
...
export default IconMaterialSettingsAccessibilityOutlinedFilled;
