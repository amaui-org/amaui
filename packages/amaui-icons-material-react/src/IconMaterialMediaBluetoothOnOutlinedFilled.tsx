...
const IconMaterialMediaBluetoothOnOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MediaBluetoothOnOutlinedFilled'
...
export default IconMaterialMediaBluetoothOnOutlinedFilled;
