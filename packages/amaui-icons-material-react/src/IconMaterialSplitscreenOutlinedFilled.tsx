...
const IconMaterialSplitscreenOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SplitscreenOutlinedFilled'
...
export default IconMaterialSplitscreenOutlinedFilled;
