...
const IconMaterialBattery50OutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Battery50OutlinedFilled'
...
export default IconMaterialBattery50OutlinedFilled;
