...
const IconMaterialBreakfastDiningOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BreakfastDiningOutlinedFilled'
...
export default IconMaterialBreakfastDiningOutlinedFilled;
