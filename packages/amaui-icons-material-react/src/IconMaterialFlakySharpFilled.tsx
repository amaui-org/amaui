...
const IconMaterialFlakySharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FlakySharpFilled'
      short_name='Flaky'
...
IconMaterialFlakySharpFilled.displayName = 'AmauiIconMaterialFlakySharpFilled';

export default IconMaterialFlakySharpFilled;
