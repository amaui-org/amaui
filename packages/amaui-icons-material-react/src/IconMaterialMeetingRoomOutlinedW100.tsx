...
const IconMaterialMeetingRoomOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MeetingRoomOutlinedW100'
...
export default IconMaterialMeetingRoomOutlinedW100;
