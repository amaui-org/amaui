...
const IconMaterialDetectionAndZoneOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DetectionAndZoneOutlinedW100'
...
export default IconMaterialDetectionAndZoneOutlinedW100;
