...
const IconMaterialViewAgendaOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ViewAgendaOutlinedW100Filled'
...
export default IconMaterialViewAgendaOutlinedW100Filled;
