...
const IconMaterialFrontHandTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialFrontHandTwoTone.displayName = 'AmauiIconMaterialFrontHandTwoTone';

export default IconMaterialFrontHandTwoTone;
