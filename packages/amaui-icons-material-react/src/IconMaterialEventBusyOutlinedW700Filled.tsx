...
const IconMaterialEventBusyOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='EventBusyOutlinedW700Filled'
...
export default IconMaterialEventBusyOutlinedW700Filled;
