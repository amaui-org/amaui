...
const IconMaterialWcTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialWcTwoTone.displayName = 'AmauiIconMaterialWcTwoTone';

export default IconMaterialWcTwoTone;
