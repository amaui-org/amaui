...
const IconMaterialDownloadForOfflineSharpW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DownloadForOfflineSharpW700'
...
export default IconMaterialDownloadForOfflineSharpW700;
