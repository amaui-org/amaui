...
const IconMaterialCoffeeMakerTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialCoffeeMakerTwoTone.displayName = 'AmauiIconMaterialCoffeeMakerTwoTone';

export default IconMaterialCoffeeMakerTwoTone;
