...
const IconMaterialLightGroupSharp = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LightGroupSharp'
...
IconMaterialLightGroupSharp.displayName = 'AmauiIconMaterialLightGroupSharp';

export default IconMaterialLightGroupSharp;
