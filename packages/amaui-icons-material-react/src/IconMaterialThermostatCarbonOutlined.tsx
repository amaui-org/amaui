...
const IconMaterialThermostatCarbonOutlined = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ThermostatCarbonOutlined'
...
export default IconMaterialThermostatCarbonOutlined;
