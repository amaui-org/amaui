...
const IconMaterialMoreVertSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MoreVertSharpW700Filled'
      short_name='MoreVert'
...
export default IconMaterialMoreVertSharpW700Filled;
