...
const IconMaterialToggleOffRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ToggleOffRoundedW700Filled'
...
export default IconMaterialToggleOffRoundedW700Filled;
