...
const IconMaterialTableChartOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TableChartOutlinedW100Filled'
...
export default IconMaterialTableChartOutlinedW100Filled;
