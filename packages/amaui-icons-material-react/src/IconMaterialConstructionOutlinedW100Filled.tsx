...
const IconMaterialConstructionOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ConstructionOutlinedW100Filled'
...
export default IconMaterialConstructionOutlinedW100Filled;
