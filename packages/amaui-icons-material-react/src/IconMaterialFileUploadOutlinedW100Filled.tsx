...
const IconMaterialFileUploadOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FileUploadOutlinedW100Filled'
...
export default IconMaterialFileUploadOutlinedW100Filled;
