...
const IconMaterialBrightness6OutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Brightness6OutlinedW100'
...
export default IconMaterialBrightness6OutlinedW100;
