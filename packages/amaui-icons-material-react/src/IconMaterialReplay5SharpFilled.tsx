...
const IconMaterialReplay5SharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Replay5SharpFilled'
      short_name='Replay5'
...
IconMaterialReplay5SharpFilled.displayName = 'AmauiIconMaterialReplay5SharpFilled';

export default IconMaterialReplay5SharpFilled;
