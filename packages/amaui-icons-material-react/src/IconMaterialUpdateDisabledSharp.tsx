...
const IconMaterialUpdateDisabledSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialUpdateDisabledSharp.displayName = 'AmauiIconMaterialUpdateDisabledSharp';

export default IconMaterialUpdateDisabledSharp;
