...
const IconMaterialChecklistOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ChecklistOutlinedW700Filled'
...
export default IconMaterialChecklistOutlinedW700Filled;
