...
const IconMaterialToolsLevelOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ToolsLevelOutlinedFilled'
...
export default IconMaterialToolsLevelOutlinedFilled;
