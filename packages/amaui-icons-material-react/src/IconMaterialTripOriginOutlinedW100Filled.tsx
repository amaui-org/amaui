...
const IconMaterialTripOriginOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TripOriginOutlinedW100Filled'
...
export default IconMaterialTripOriginOutlinedW100Filled;
