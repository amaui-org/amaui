...
const IconMaterialUlnaRadiusAltSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='UlnaRadiusAltSharpW700Filled'
...
export default IconMaterialUlnaRadiusAltSharpW700Filled;
