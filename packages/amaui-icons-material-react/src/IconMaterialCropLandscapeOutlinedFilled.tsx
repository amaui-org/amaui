...
const IconMaterialCropLandscapeOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CropLandscapeOutlinedFilled'
...
export default IconMaterialCropLandscapeOutlinedFilled;
