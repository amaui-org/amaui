...
const IconMaterialConfirmationNumberOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ConfirmationNumberOutlinedW100Filled'
...
export default IconMaterialConfirmationNumberOutlinedW100Filled;
