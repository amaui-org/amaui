...
const IconMaterialChromecast2OutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Chromecast2OutlinedFilled'
...
export default IconMaterialChromecast2OutlinedFilled;
