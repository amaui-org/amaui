...
const IconMaterialWaterDamageOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WaterDamageOutlinedW100'
...
export default IconMaterialWaterDamageOutlinedW100;
