...
const IconMaterialHighlightSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HighlightSharpW700Filled'
...
export default IconMaterialHighlightSharpW700Filled;
