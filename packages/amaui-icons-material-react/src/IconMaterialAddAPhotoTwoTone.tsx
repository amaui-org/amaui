...
const IconMaterialAddAPhotoTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialAddAPhotoTwoTone.displayName = 'AmauiIconMaterialAddAPhotoTwoTone';

export default IconMaterialAddAPhotoTwoTone;
