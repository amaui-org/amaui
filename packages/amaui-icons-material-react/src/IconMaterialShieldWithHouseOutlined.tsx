...
const IconMaterialShieldWithHouseOutlined = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ShieldWithHouseOutlined'
...
export default IconMaterialShieldWithHouseOutlined;
