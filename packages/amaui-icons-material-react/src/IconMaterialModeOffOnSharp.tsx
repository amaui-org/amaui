...
const IconMaterialModeOffOnSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialModeOffOnSharp.displayName = 'AmauiIconMaterialModeOffOnSharp';

export default IconMaterialModeOffOnSharp;
