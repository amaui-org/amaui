...
const IconMaterialBatteryFullAltOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryFullAltOutlinedW100'
...
export default IconMaterialBatteryFullAltOutlinedW100;
