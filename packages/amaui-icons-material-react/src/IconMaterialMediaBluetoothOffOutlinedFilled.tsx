...
const IconMaterialMediaBluetoothOffOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MediaBluetoothOffOutlinedFilled'
...
export default IconMaterialMediaBluetoothOffOutlinedFilled;
