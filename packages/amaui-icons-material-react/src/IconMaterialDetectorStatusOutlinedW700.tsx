...
const IconMaterialDetectorStatusOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DetectorStatusOutlinedW700'
...
export default IconMaterialDetectorStatusOutlinedW700;
