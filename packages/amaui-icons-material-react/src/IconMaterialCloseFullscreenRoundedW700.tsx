...
const IconMaterialCloseFullscreenRoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CloseFullscreenRoundedW700'
...
export default IconMaterialCloseFullscreenRoundedW700;
