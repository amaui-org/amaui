...
const IconMaterialBrowseGallerySharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BrowseGallerySharpW700Filled'
...
export default IconMaterialBrowseGallerySharpW700Filled;
