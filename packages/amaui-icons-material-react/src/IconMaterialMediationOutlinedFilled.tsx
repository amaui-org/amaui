...
const IconMaterialMediationOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MediationOutlinedFilled'
...
export default IconMaterialMediationOutlinedFilled;
