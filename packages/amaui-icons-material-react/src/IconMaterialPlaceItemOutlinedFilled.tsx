...
const IconMaterialPlaceItemOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PlaceItemOutlinedFilled'
...
export default IconMaterialPlaceItemOutlinedFilled;
