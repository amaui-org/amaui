...
const IconMaterialSentimentVerySatisfiedOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SentimentVerySatisfiedOutlinedW700'
...
export default IconMaterialSentimentVerySatisfiedOutlinedW700;
