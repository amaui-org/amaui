...
const IconMaterialTeamDashboardOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TeamDashboardOutlinedW100Filled'
...
export default IconMaterialTeamDashboardOutlinedW100Filled;
