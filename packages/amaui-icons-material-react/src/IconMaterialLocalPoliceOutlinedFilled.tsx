...
const IconMaterialLocalPoliceOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LocalPoliceOutlinedFilled'
...
export default IconMaterialLocalPoliceOutlinedFilled;
