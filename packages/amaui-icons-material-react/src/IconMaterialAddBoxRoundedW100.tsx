...
const IconMaterialAddBoxRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AddBoxRoundedW100'
      short_name='AddBox'
...
IconMaterialAddBoxRoundedW100.displayName = 'AmauiIconMaterialAddBoxRoundedW100';

export default IconMaterialAddBoxRoundedW100;
