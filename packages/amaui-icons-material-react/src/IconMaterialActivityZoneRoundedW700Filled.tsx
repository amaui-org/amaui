...
const IconMaterialActivityZoneRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ActivityZoneRoundedW700Filled'
...
export default IconMaterialActivityZoneRoundedW700Filled;
