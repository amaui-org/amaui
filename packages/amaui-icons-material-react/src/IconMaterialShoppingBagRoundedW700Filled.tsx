...
const IconMaterialShoppingBagRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ShoppingBagRoundedW700Filled'
...
export default IconMaterialShoppingBagRoundedW700Filled;
