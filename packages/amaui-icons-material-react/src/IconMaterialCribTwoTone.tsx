...
const IconMaterialCribTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialCribTwoTone.displayName = 'AmauiIconMaterialCribTwoTone';

export default IconMaterialCribTwoTone;
