...
const IconMaterialFlipToFrontOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FlipToFrontOutlinedFilled'
...
export default IconMaterialFlipToFrontOutlinedFilled;
