...
const IconMaterialBatteryCharging80Outlined = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryCharging80Outlined'
...
export default IconMaterialBatteryCharging80Outlined;
