...
const IconMaterialWebStoriesSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialWebStoriesSharp.displayName = 'AmauiIconMaterialWebStoriesSharp';

export default IconMaterialWebStoriesSharp;
