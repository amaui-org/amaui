...
const IconMaterialTrainOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TrainOutlinedW100Filled'
      short_name='Train'
...
export default IconMaterialTrainOutlinedW100Filled;
