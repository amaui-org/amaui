...
const IconMaterialFollowTheSignsOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FollowTheSignsOutlinedFilled'
...
export default IconMaterialFollowTheSignsOutlinedFilled;
