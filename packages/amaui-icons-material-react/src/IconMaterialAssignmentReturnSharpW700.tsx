...
const IconMaterialAssignmentReturnSharpW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AssignmentReturnSharpW700'
...
export default IconMaterialAssignmentReturnSharpW700;
