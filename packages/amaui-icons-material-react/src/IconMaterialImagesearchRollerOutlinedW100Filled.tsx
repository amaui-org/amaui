...
const IconMaterialImagesearchRollerOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ImagesearchRollerOutlinedW100Filled'
...
export default IconMaterialImagesearchRollerOutlinedW100Filled;
