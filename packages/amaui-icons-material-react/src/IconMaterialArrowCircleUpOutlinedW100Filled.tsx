...
const IconMaterialArrowCircleUpOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ArrowCircleUpOutlinedW100Filled'
...
export default IconMaterialArrowCircleUpOutlinedW100Filled;
