...
const IconMaterialTextRotationDownOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TextRotationDownOutlinedFilled'
...
export default IconMaterialTextRotationDownOutlinedFilled;
