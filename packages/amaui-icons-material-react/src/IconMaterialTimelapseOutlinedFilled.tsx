...
const IconMaterialTimelapseOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TimelapseOutlinedFilled'
...
export default IconMaterialTimelapseOutlinedFilled;
