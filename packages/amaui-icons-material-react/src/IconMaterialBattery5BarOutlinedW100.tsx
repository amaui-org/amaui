...
const IconMaterialBattery5BarOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Battery5BarOutlinedW100'
...
export default IconMaterialBattery5BarOutlinedW100;
