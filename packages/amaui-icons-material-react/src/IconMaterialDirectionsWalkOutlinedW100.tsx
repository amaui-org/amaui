...
const IconMaterialDirectionsWalkOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DirectionsWalkOutlinedW100'
...
export default IconMaterialDirectionsWalkOutlinedW100;
