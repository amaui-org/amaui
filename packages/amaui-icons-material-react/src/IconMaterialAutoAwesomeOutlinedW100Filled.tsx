...
const IconMaterialAutoAwesomeOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AutoAwesomeOutlinedW100Filled'
...
export default IconMaterialAutoAwesomeOutlinedW100Filled;
