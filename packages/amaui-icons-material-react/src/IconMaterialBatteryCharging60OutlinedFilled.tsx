...
const IconMaterialBatteryCharging60OutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryCharging60OutlinedFilled'
...
export default IconMaterialBatteryCharging60OutlinedFilled;
