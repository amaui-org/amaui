...
const IconMaterialMergeTypeOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MergeTypeOutlinedFilled'
...
export default IconMaterialMergeTypeOutlinedFilled;
