...
const IconMaterialShieldWithHouseOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ShieldWithHouseOutlinedFilled'
...
export default IconMaterialShieldWithHouseOutlinedFilled;
