...
const IconMaterialNestWifiPointOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestWifiPointOutlinedW100Filled'
...
export default IconMaterialNestWifiPointOutlinedW100Filled;
