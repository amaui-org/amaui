...
const IconMaterialMagicButtonSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MagicButtonSharpW700Filled'
...
export default IconMaterialMagicButtonSharpW700Filled;
