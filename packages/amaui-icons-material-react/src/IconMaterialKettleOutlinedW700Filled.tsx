...
const IconMaterialKettleOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='KettleOutlinedW700Filled'
      short_name='Kettle'
...
export default IconMaterialKettleOutlinedW700Filled;
