...
const IconMaterialRoundedCornerOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RoundedCornerOutlinedW100'
...
export default IconMaterialRoundedCornerOutlinedW100;
