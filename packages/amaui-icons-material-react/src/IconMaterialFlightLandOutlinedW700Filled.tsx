...
const IconMaterialFlightLandOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FlightLandOutlinedW700Filled'
...
export default IconMaterialFlightLandOutlinedW700Filled;
