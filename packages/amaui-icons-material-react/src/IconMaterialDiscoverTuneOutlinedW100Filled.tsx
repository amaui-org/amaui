...
const IconMaterialDiscoverTuneOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DiscoverTuneOutlinedW100Filled'
...
export default IconMaterialDiscoverTuneOutlinedW100Filled;
