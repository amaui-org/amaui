...
const IconMaterialGppBadOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='GppBadOutlinedW100Filled'
      short_name='GppBad'
...
export default IconMaterialGppBadOutlinedW100Filled;
