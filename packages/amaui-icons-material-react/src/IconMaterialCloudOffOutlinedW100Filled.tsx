...
const IconMaterialCloudOffOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CloudOffOutlinedW100Filled'
      short_name='CloudOff'
...
export default IconMaterialCloudOffOutlinedW100Filled;
