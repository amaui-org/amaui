...
const IconMaterialBorderStyleOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BorderStyleOutlinedW100'
...
export default IconMaterialBorderStyleOutlinedW100;
