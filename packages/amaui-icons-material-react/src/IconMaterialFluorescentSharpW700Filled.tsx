...
const IconMaterialFluorescentSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FluorescentSharpW700Filled'
...
export default IconMaterialFluorescentSharpW700Filled;
