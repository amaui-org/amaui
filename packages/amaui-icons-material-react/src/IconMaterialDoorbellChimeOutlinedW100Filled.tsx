...
const IconMaterialDoorbellChimeOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DoorbellChimeOutlinedW100Filled'
...
export default IconMaterialDoorbellChimeOutlinedW100Filled;
