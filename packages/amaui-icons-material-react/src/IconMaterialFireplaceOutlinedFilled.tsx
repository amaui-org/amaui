...
const IconMaterialFireplaceOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FireplaceOutlinedFilled'
...
export default IconMaterialFireplaceOutlinedFilled;
