...
const IconMaterialToggleOnSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ToggleOnSharpW700Filled'
      short_name='ToggleOn'
...
export default IconMaterialToggleOnSharpW700Filled;
