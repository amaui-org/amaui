...
const IconMaterialNestConnectOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestConnectOutlinedFilled'
...
export default IconMaterialNestConnectOutlinedFilled;
