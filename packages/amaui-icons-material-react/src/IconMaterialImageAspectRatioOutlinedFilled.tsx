...
const IconMaterialImageAspectRatioOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ImageAspectRatioOutlinedFilled'
...
export default IconMaterialImageAspectRatioOutlinedFilled;
