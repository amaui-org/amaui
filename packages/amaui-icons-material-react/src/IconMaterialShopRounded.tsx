...
const IconMaterialShopRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialShopRounded.displayName = 'AmauiIconMaterialShopRounded';

export default IconMaterialShopRounded;
