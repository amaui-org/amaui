...
const IconMaterialCameraOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CameraOutlinedW100Filled'
      short_name='Camera'
...
export default IconMaterialCameraOutlinedW100Filled;
