...
const IconMaterialBatteryChargingFullRoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryChargingFullRoundedW700'
...
export default IconMaterialBatteryChargingFullRoundedW700;
