...
const IconMaterialKeyboardArrowLeftRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='KeyboardArrowLeftRoundedW700Filled'
...
export default IconMaterialKeyboardArrowLeftRoundedW700Filled;
