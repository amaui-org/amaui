...
const IconMaterialDataSaverOnOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DataSaverOnOutlinedW700'
...
export default IconMaterialDataSaverOnOutlinedW700;
