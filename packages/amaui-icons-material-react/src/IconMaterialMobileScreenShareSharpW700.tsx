...
const IconMaterialMobileScreenShareSharpW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MobileScreenShareSharpW700'
...
export default IconMaterialMobileScreenShareSharpW700;
