...
const IconMaterialPlaylistAddCheckCircleSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PlaylistAddCheckCircleSharpW700Filled'
...
export default IconMaterialPlaylistAddCheckCircleSharpW700Filled;
