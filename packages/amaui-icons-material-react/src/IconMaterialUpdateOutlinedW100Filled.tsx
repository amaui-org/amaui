...
const IconMaterialUpdateOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='UpdateOutlinedW100Filled'
      short_name='Update'
...
export default IconMaterialUpdateOutlinedW100Filled;
