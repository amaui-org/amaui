...
const IconMaterialTapAndPlayOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TapAndPlayOutlinedW100Filled'
...
export default IconMaterialTapAndPlayOutlinedW100Filled;
