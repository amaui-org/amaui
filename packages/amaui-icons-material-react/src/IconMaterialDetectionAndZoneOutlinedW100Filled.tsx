...
const IconMaterialDetectionAndZoneOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DetectionAndZoneOutlinedW100Filled'
...
export default IconMaterialDetectionAndZoneOutlinedW100Filled;
