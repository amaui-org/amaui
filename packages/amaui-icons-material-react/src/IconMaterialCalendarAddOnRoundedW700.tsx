...
const IconMaterialCalendarAddOnRoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CalendarAddOnRoundedW700'
...
export default IconMaterialCalendarAddOnRoundedW700;
