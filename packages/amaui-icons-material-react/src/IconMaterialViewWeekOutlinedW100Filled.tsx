...
const IconMaterialViewWeekOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ViewWeekOutlinedW100Filled'
      short_name='ViewWeek'
...
export default IconMaterialViewWeekOutlinedW100Filled;
