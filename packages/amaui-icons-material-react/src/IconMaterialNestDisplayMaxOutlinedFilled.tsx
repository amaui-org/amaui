...
const IconMaterialNestDisplayMaxOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestDisplayMaxOutlinedFilled'
...
export default IconMaterialNestDisplayMaxOutlinedFilled;
