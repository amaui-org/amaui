...
const IconMaterialLocalDiningOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LocalDiningOutlinedFilled'
...
export default IconMaterialLocalDiningOutlinedFilled;
