...
const IconMaterialLoyaltyTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialLoyaltyTwoTone.displayName = 'AmauiIconMaterialLoyaltyTwoTone';

export default IconMaterialLoyaltyTwoTone;
