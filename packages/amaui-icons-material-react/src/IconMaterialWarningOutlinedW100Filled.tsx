...
const IconMaterialWarningOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WarningOutlinedW100Filled'
      short_name='Warning'
...
export default IconMaterialWarningOutlinedW100Filled;
