...
const IconMaterialShieldWithHouseOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ShieldWithHouseOutlinedW700'
...
export default IconMaterialShieldWithHouseOutlinedW700;
