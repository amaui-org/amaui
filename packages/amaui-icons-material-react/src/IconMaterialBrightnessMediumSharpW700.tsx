...
const IconMaterialBrightnessMediumSharpW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BrightnessMediumSharpW700'
...
export default IconMaterialBrightnessMediumSharpW700;
