...
const IconMaterialHomeAppLogoRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HomeAppLogoRoundedW700Filled'
...
export default IconMaterialHomeAppLogoRoundedW700Filled;
