...
const IconMaterialBlanketOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BlanketOutlinedW700Filled'
      short_name='Blanket'
...
export default IconMaterialBlanketOutlinedW700Filled;
