...
const IconMaterialToggleOnSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ToggleOnSharpFilled'
      short_name='ToggleOn'
...
IconMaterialToggleOnSharpFilled.displayName = 'AmauiIconMaterialToggleOnSharpFilled';

export default IconMaterialToggleOnSharpFilled;
