...
const IconMaterialCenterFocusStrongOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CenterFocusStrongOutlinedW700Filled'
...
export default IconMaterialCenterFocusStrongOutlinedW700Filled;
