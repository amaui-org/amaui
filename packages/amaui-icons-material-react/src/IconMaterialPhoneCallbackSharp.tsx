...
const IconMaterialPhoneCallbackSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialPhoneCallbackSharp.displayName = 'AmauiIconMaterialPhoneCallbackSharp';

export default IconMaterialPhoneCallbackSharp;
