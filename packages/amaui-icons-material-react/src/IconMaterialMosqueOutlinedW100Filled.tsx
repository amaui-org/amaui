...
const IconMaterialMosqueOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MosqueOutlinedW100Filled'
      short_name='Mosque'
...
export default IconMaterialMosqueOutlinedW100Filled;
