...
const IconMaterialContactPhoneTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialContactPhoneTwoTone.displayName = 'AmauiIconMaterialContactPhoneTwoTone';

export default IconMaterialContactPhoneTwoTone;
