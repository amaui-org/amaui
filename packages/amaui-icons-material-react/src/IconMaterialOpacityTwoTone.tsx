...
const IconMaterialOpacityTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialOpacityTwoTone.displayName = 'AmauiIconMaterialOpacityTwoTone';

export default IconMaterialOpacityTwoTone;
