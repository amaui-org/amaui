...
const IconMaterialPhoneBluetoothSpeakerOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PhoneBluetoothSpeakerOutlinedW700Filled'
...
export default IconMaterialPhoneBluetoothSpeakerOutlinedW700Filled;
