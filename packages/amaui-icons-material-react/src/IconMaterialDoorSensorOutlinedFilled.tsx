...
const IconMaterialDoorSensorOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DoorSensorOutlinedFilled'
...
export default IconMaterialDoorSensorOutlinedFilled;
