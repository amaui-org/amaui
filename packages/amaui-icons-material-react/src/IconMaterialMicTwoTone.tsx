...
const IconMaterialMicTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialMicTwoTone.displayName = 'AmauiIconMaterialMicTwoTone';

export default IconMaterialMicTwoTone;
