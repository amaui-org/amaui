...
const IconMaterialPhonelinkOffTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialPhonelinkOffTwoTone.displayName = 'AmauiIconMaterialPhonelinkOffTwoTone';

export default IconMaterialPhonelinkOffTwoTone;
