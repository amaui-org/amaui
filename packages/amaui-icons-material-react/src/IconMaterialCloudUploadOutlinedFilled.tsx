...
const IconMaterialCloudUploadOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CloudUploadOutlinedFilled'
...
export default IconMaterialCloudUploadOutlinedFilled;
