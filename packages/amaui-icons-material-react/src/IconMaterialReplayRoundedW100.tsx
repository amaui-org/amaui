...
const IconMaterialReplayRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ReplayRoundedW100'
      short_name='Replay'
...
IconMaterialReplayRoundedW100.displayName = 'AmauiIconMaterialReplayRoundedW100';

export default IconMaterialReplayRoundedW100;
