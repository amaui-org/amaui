...
const IconMaterialNextWeekRounded = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NextWeekRounded'
      short_name='NextWeek'
...
IconMaterialNextWeekRounded.displayName = 'AmauiIconMaterialNextWeekRounded';

export default IconMaterialNextWeekRounded;
