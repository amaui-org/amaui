...
const IconMaterialTourTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialTourTwoTone.displayName = 'AmauiIconMaterialTourTwoTone';

export default IconMaterialTourTwoTone;
