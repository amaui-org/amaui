...
const IconMaterialAtrSharpFilled = React.forwardRef((props: any, ref) => {
...
IconMaterialAtrSharpFilled.displayName = 'AmauiIconMaterialAtrSharpFilled';

export default IconMaterialAtrSharpFilled;
