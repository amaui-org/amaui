...
const IconMaterialTrailLengthMediumRoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TrailLengthMediumRoundedW700'
...
export default IconMaterialTrailLengthMediumRoundedW700;
