...
const IconMaterialNextPlanSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NextPlanSharpW700Filled'
      short_name='NextPlan'
...
export default IconMaterialNextPlanSharpW700Filled;
