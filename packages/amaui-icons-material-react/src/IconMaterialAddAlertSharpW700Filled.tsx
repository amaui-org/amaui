...
const IconMaterialAddAlertSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AddAlertSharpW700Filled'
      short_name='AddAlert'
...
export default IconMaterialAddAlertSharpW700Filled;
