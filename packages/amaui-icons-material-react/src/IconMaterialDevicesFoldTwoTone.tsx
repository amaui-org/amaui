...
const IconMaterialDevicesFoldTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialDevicesFoldTwoTone.displayName = 'AmauiIconMaterialDevicesFoldTwoTone';

export default IconMaterialDevicesFoldTwoTone;
