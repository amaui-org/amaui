...
const IconMaterialSettingsSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SettingsSharpFilled'
      short_name='Settings'
...
IconMaterialSettingsSharpFilled.displayName = 'AmauiIconMaterialSettingsSharpFilled';

export default IconMaterialSettingsSharpFilled;
