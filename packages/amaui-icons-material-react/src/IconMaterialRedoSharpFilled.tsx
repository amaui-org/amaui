...
const IconMaterialRedoSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RedoSharpFilled'
      short_name='Redo'
...
IconMaterialRedoSharpFilled.displayName = 'AmauiIconMaterialRedoSharpFilled';

export default IconMaterialRedoSharpFilled;
