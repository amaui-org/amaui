...
const IconMaterialPlayForWorkRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialPlayForWorkRounded.displayName = 'AmauiIconMaterialPlayForWorkRounded';

export default IconMaterialPlayForWorkRounded;
