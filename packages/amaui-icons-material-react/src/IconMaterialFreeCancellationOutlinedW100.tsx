...
const IconMaterialFreeCancellationOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FreeCancellationOutlinedW100'
...
export default IconMaterialFreeCancellationOutlinedW100;
