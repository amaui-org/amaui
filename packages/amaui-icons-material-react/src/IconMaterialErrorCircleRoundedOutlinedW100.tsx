...
const IconMaterialErrorCircleRoundedOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ErrorCircleRoundedOutlinedW100'
...
export default IconMaterialErrorCircleRoundedOutlinedW100;
