...
const IconMaterialAttachFileRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialAttachFileRounded.displayName = 'AmauiIconMaterialAttachFileRounded';

export default IconMaterialAttachFileRounded;
