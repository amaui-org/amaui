...
const IconMaterialSupportTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialSupportTwoTone.displayName = 'AmauiIconMaterialSupportTwoTone';

export default IconMaterialSupportTwoTone;
