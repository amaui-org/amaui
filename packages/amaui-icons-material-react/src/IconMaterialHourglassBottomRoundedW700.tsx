...
const IconMaterialHourglassBottomRoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HourglassBottomRoundedW700'
...
export default IconMaterialHourglassBottomRoundedW700;
