...
const IconMaterialExposureZeroOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ExposureZeroOutlinedW100'
...
export default IconMaterialExposureZeroOutlinedW100;
