...
const IconMaterialBorderLeftOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BorderLeftOutlinedW100Filled'
...
export default IconMaterialBorderLeftOutlinedW100Filled;
