...
const IconMaterialEcoSharpFilled = React.forwardRef((props: any, ref) => {
...
IconMaterialEcoSharpFilled.displayName = 'AmauiIconMaterialEcoSharpFilled';

export default IconMaterialEcoSharpFilled;
