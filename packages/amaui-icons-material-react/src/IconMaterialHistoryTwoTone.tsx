...
const IconMaterialHistoryTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialHistoryTwoTone.displayName = 'AmauiIconMaterialHistoryTwoTone';

export default IconMaterialHistoryTwoTone;
