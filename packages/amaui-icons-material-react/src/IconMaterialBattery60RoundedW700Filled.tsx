...
const IconMaterialBattery60RoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Battery60RoundedW700Filled'
...
export default IconMaterialBattery60RoundedW700Filled;
