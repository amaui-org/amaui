...
const IconMaterialBattery30RoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Battery30RoundedW700Filled'
...
export default IconMaterialBattery30RoundedW700Filled;
