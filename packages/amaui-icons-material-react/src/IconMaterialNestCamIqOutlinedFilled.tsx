...
const IconMaterialNestCamIqOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestCamIqOutlinedFilled'
...
export default IconMaterialNestCamIqOutlinedFilled;
