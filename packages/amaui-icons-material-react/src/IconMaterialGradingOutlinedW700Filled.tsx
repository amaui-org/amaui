...
const IconMaterialGradingOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='GradingOutlinedW700Filled'
      short_name='Grading'
...
export default IconMaterialGradingOutlinedW700Filled;
