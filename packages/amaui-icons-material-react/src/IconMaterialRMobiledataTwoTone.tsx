...
const IconMaterialRMobiledataTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialRMobiledataTwoTone.displayName = 'AmauiIconMaterialRMobiledataTwoTone';

export default IconMaterialRMobiledataTwoTone;
