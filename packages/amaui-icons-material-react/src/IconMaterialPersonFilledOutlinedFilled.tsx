...
const IconMaterialPersonFilledOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PersonFilledOutlinedFilled'
...
export default IconMaterialPersonFilledOutlinedFilled;
