...
const IconMaterialSyncProblemTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialSyncProblemTwoTone.displayName = 'AmauiIconMaterialSyncProblemTwoTone';

export default IconMaterialSyncProblemTwoTone;
