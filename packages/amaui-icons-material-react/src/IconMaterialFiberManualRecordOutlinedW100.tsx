...
const IconMaterialFiberManualRecordOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FiberManualRecordOutlinedW100'
...
export default IconMaterialFiberManualRecordOutlinedW100;
