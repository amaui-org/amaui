...
const IconMaterialDomainOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DomainOutlinedW700Filled'
      short_name='Domain'
...
export default IconMaterialDomainOutlinedW700Filled;
