...
const IconMaterialClarifySharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ClarifySharpW100'
      short_name='Clarify'
...
IconMaterialClarifySharpW100.displayName = 'AmauiIconMaterialClarifySharpW100';

export default IconMaterialClarifySharpW100;
