...
const IconMaterialWifiOffSharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WifiOffSharpW100'
      short_name='WifiOff'
...
IconMaterialWifiOffSharpW100.displayName = 'AmauiIconMaterialWifiOffSharpW100';

export default IconMaterialWifiOffSharpW100;
