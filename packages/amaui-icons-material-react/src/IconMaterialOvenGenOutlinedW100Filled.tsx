...
const IconMaterialOvenGenOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='OvenGenOutlinedW100Filled'
      short_name='OvenGen'
...
export default IconMaterialOvenGenOutlinedW100Filled;
