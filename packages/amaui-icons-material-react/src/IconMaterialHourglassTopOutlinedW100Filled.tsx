...
const IconMaterialHourglassTopOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HourglassTopOutlinedW100Filled'
...
export default IconMaterialHourglassTopOutlinedW100Filled;
