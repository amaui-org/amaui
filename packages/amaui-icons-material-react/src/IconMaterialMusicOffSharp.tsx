...
const IconMaterialMusicOffSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialMusicOffSharp.displayName = 'AmauiIconMaterialMusicOffSharp';

export default IconMaterialMusicOffSharp;
