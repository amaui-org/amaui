...
const IconMaterialRawOnOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RawOnOutlinedW100Filled'
      short_name='RawOn'
...
export default IconMaterialRawOnOutlinedW100Filled;
