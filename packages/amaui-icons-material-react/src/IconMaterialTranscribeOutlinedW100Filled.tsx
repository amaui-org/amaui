...
const IconMaterialTranscribeOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TranscribeOutlinedW100Filled'
...
export default IconMaterialTranscribeOutlinedW100Filled;
