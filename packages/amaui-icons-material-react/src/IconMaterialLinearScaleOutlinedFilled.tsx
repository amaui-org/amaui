...
const IconMaterialLinearScaleOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LinearScaleOutlinedFilled'
...
export default IconMaterialLinearScaleOutlinedFilled;
