...
const IconMaterialE911AvatarSharp = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='E911AvatarSharp'
...
IconMaterialE911AvatarSharp.displayName = 'AmauiIconMaterialE911AvatarSharp';

export default IconMaterialE911AvatarSharp;
