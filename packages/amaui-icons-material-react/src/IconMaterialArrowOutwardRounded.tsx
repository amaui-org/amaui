...
const IconMaterialArrowOutwardRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialArrowOutwardRounded.displayName = 'AmauiIconMaterialArrowOutwardRounded';

export default IconMaterialArrowOutwardRounded;
