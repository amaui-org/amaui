...
const IconMaterialBrightnessLowOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BrightnessLowOutlinedFilled'
...
export default IconMaterialBrightnessLowOutlinedFilled;
