...
const IconMaterialPerson4SharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Person4SharpFilled'
      short_name='Person4'
...
IconMaterialPerson4SharpFilled.displayName = 'AmauiIconMaterialPerson4SharpFilled';

export default IconMaterialPerson4SharpFilled;
