...
const IconMaterialBattery90OutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Battery90OutlinedFilled'
...
export default IconMaterialBattery90OutlinedFilled;
