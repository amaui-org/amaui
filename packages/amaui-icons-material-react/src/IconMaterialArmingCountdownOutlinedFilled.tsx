...
const IconMaterialArmingCountdownOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ArmingCountdownOutlinedFilled'
...
export default IconMaterialArmingCountdownOutlinedFilled;
