...
const IconMaterialSmartButtonOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SmartButtonOutlinedFilled'
...
export default IconMaterialSmartButtonOutlinedFilled;
