...
const IconMaterialMultilineChartOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MultilineChartOutlinedFilled'
...
export default IconMaterialMultilineChartOutlinedFilled;
