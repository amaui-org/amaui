...
const IconMaterialBatteryCharging50OutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryCharging50OutlinedW700Filled'
...
export default IconMaterialBatteryCharging50OutlinedW700Filled;
