...
const IconMaterialTrailLengthMediumOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TrailLengthMediumOutlinedW100Filled'
...
export default IconMaterialTrailLengthMediumOutlinedW100Filled;
