...
const IconMaterialKettleRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='KettleRoundedW700Filled'
      short_name='Kettle'
...
export default IconMaterialKettleRoundedW700Filled;
