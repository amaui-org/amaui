...
const IconMaterialCameraEnhanceOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CameraEnhanceOutlinedW700'
...
export default IconMaterialCameraEnhanceOutlinedW700;
