...
const IconMaterialHdRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialHdRounded.displayName = 'AmauiIconMaterialHdRounded';

export default IconMaterialHdRounded;
