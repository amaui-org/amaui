...
const IconMaterialModeHeatSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ModeHeatSharpFilled'
      short_name='ModeHeat'
...
IconMaterialModeHeatSharpFilled.displayName = 'AmauiIconMaterialModeHeatSharpFilled';

export default IconMaterialModeHeatSharpFilled;
