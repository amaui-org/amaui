...
const IconMaterialLightbulbCircleOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LightbulbCircleOutlinedFilled'
...
export default IconMaterialLightbulbCircleOutlinedFilled;
