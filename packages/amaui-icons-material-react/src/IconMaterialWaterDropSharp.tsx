...
const IconMaterialWaterDropSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialWaterDropSharp.displayName = 'AmauiIconMaterialWaterDropSharp';

export default IconMaterialWaterDropSharp;
