...
const IconMaterialFootBonesOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FootBonesOutlinedFilled'
...
export default IconMaterialFootBonesOutlinedFilled;
