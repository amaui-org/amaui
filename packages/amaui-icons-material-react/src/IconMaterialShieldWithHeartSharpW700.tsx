...
const IconMaterialShieldWithHeartSharpW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ShieldWithHeartSharpW700'
...
export default IconMaterialShieldWithHeartSharpW700;
