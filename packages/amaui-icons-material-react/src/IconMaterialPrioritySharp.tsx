...
const IconMaterialPrioritySharp = React.forwardRef((props: any, ref) => {
...
IconMaterialPrioritySharp.displayName = 'AmauiIconMaterialPrioritySharp';

export default IconMaterialPrioritySharp;
