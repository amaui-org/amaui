...
const IconMaterialLaptopMacOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LaptopMacOutlinedW100Filled'
...
export default IconMaterialLaptopMacOutlinedW100Filled;
