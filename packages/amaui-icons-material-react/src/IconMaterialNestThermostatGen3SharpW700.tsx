...
const IconMaterialNestThermostatGen3SharpW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestThermostatGen3SharpW700'
...
export default IconMaterialNestThermostatGen3SharpW700;
