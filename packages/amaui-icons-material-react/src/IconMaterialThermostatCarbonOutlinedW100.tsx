...
const IconMaterialThermostatCarbonOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ThermostatCarbonOutlinedW100'
...
export default IconMaterialThermostatCarbonOutlinedW100;
