...
const IconMaterialTabUnselectedOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TabUnselectedOutlinedW700'
...
export default IconMaterialTabUnselectedOutlinedW700;
