...
const IconMaterialBrunchDiningTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialBrunchDiningTwoTone.displayName = 'AmauiIconMaterialBrunchDiningTwoTone';

export default IconMaterialBrunchDiningTwoTone;
