...
const IconMaterialTvWithAssistantOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TvWithAssistantOutlinedW100'
...
export default IconMaterialTvWithAssistantOutlinedW100;
