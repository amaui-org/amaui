...
const IconMaterialEarlyOnSharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='EarlyOnSharpW100'
      short_name='EarlyOn'
...
IconMaterialEarlyOnSharpW100.displayName = 'AmauiIconMaterialEarlyOnSharpW100';

export default IconMaterialEarlyOnSharpW100;
