...
const IconMaterialZonePersonAlertOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ZonePersonAlertOutlinedW100'
...
export default IconMaterialZonePersonAlertOutlinedW100;
