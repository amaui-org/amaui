...
const IconMaterialVpnLockTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialVpnLockTwoTone.displayName = 'AmauiIconMaterialVpnLockTwoTone';

export default IconMaterialVpnLockTwoTone;
