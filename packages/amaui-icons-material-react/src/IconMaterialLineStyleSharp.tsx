...
const IconMaterialLineStyleSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialLineStyleSharp.displayName = 'AmauiIconMaterialLineStyleSharp';

export default IconMaterialLineStyleSharp;
