...
const IconMaterialChecklistSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ChecklistSharpW700Filled'
...
export default IconMaterialChecklistSharpW700Filled;
