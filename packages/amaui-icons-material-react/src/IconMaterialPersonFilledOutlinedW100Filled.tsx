...
const IconMaterialPersonFilledOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PersonFilledOutlinedW100Filled'
...
export default IconMaterialPersonFilledOutlinedW100Filled;
