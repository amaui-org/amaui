...
const IconMaterialAlignHorizontalCenterRoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AlignHorizontalCenterRoundedW700'
...
export default IconMaterialAlignHorizontalCenterRoundedW700;
