...
const IconMaterialMotionSensorActiveOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MotionSensorActiveOutlinedFilled'
...
export default IconMaterialMotionSensorActiveOutlinedFilled;
