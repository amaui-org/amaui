...
const IconMaterialEmergencyHomeOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='EmergencyHomeOutlinedW100'
...
export default IconMaterialEmergencyHomeOutlinedW100;
