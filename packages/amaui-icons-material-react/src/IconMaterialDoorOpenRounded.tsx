...
const IconMaterialDoorOpenRounded = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DoorOpenRounded'
      short_name='DoorOpen'
...
IconMaterialDoorOpenRounded.displayName = 'AmauiIconMaterialDoorOpenRounded';

export default IconMaterialDoorOpenRounded;
