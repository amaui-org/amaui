...
const IconMaterialSpokeOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SpokeOutlinedW100Filled'
      short_name='Spoke'
...
export default IconMaterialSpokeOutlinedW100Filled;
