...
const IconMaterialDetectorOfflineOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DetectorOfflineOutlinedFilled'
...
export default IconMaterialDetectorOfflineOutlinedFilled;
