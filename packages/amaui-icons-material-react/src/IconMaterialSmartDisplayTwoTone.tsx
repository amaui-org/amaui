...
const IconMaterialSmartDisplayTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialSmartDisplayTwoTone.displayName = 'AmauiIconMaterialSmartDisplayTwoTone';

export default IconMaterialSmartDisplayTwoTone;
