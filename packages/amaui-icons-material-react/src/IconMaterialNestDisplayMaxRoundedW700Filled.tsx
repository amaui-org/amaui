...
const IconMaterialNestDisplayMaxRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestDisplayMaxRoundedW700Filled'
...
export default IconMaterialNestDisplayMaxRoundedW700Filled;
