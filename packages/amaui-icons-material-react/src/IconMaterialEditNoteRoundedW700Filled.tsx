...
const IconMaterialEditNoteRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='EditNoteRoundedW700Filled'
      short_name='EditNote'
...
export default IconMaterialEditNoteRoundedW700Filled;
