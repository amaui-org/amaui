...
const IconMaterialOnDeviceTrainingOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='OnDeviceTrainingOutlinedFilled'
...
export default IconMaterialOnDeviceTrainingOutlinedFilled;
