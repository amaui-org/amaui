...
const IconMaterialRotateLeftOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RotateLeftOutlinedFilled'
...
export default IconMaterialRotateLeftOutlinedFilled;
