...
const IconMaterialFileUploadOffOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FileUploadOffOutlinedW100Filled'
...
export default IconMaterialFileUploadOffOutlinedW100Filled;
