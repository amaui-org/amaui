...
const IconMaterialMotionSensorAlertOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MotionSensorAlertOutlinedW700'
...
export default IconMaterialMotionSensorAlertOutlinedW700;
