...
const IconMaterialPersonPinOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PersonPinOutlinedW100Filled'
...
export default IconMaterialPersonPinOutlinedW100Filled;
