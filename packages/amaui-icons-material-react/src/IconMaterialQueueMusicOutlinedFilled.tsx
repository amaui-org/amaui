...
const IconMaterialQueueMusicOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='QueueMusicOutlinedFilled'
...
export default IconMaterialQueueMusicOutlinedFilled;
