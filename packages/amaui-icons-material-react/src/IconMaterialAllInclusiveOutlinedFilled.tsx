...
const IconMaterialAllInclusiveOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AllInclusiveOutlinedFilled'
...
export default IconMaterialAllInclusiveOutlinedFilled;
