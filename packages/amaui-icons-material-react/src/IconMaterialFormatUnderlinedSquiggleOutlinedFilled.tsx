...
const IconMaterialFormatUnderlinedSquiggleOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FormatUnderlinedSquiggleOutlinedFilled'
...
export default IconMaterialFormatUnderlinedSquiggleOutlinedFilled;
