...
const IconMaterialListAltOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ListAltOutlinedW700Filled'
      short_name='ListAlt'
...
export default IconMaterialListAltOutlinedW700Filled;
