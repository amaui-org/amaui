...
const IconMaterialScienceRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ScienceRoundedW700Filled'
      short_name='Science'
...
export default IconMaterialScienceRoundedW700Filled;
