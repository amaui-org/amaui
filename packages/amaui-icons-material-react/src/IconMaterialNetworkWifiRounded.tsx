...
const IconMaterialNetworkWifiRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialNetworkWifiRounded.displayName = 'AmauiIconMaterialNetworkWifiRounded';

export default IconMaterialNetworkWifiRounded;
