...
const IconMaterialRotateRightOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RotateRightOutlinedFilled'
...
export default IconMaterialRotateRightOutlinedFilled;
