...
const IconMaterialBlockTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialBlockTwoTone.displayName = 'AmauiIconMaterialBlockTwoTone';

export default IconMaterialBlockTwoTone;
