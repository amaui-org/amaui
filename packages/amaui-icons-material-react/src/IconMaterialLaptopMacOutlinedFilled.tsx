...
const IconMaterialLaptopMacOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LaptopMacOutlinedFilled'
...
export default IconMaterialLaptopMacOutlinedFilled;
