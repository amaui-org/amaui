...
const IconMaterialWysiwygRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialWysiwygRounded.displayName = 'AmauiIconMaterialWysiwygRounded';

export default IconMaterialWysiwygRounded;
