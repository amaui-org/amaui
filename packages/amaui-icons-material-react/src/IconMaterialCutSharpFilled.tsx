...
const IconMaterialCutSharpFilled = React.forwardRef((props: any, ref) => {
...
IconMaterialCutSharpFilled.displayName = 'AmauiIconMaterialCutSharpFilled';

export default IconMaterialCutSharpFilled;
