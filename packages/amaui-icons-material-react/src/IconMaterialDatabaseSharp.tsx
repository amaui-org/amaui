...
const IconMaterialDatabaseSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialDatabaseSharp.displayName = 'AmauiIconMaterialDatabaseSharp';

export default IconMaterialDatabaseSharp;
