...
const IconMaterialNotesRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NotesRoundedW100'
      short_name='Notes'
...
IconMaterialNotesRoundedW100.displayName = 'AmauiIconMaterialNotesRoundedW100';

export default IconMaterialNotesRoundedW100;
