...
const IconMaterialRadioButtonCheckedOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RadioButtonCheckedOutlinedW100Filled'
...
export default IconMaterialRadioButtonCheckedOutlinedW100Filled;
