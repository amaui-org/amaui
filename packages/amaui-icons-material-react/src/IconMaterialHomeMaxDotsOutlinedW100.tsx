...
const IconMaterialHomeMaxDotsOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HomeMaxDotsOutlinedW100'
...
export default IconMaterialHomeMaxDotsOutlinedW100;
