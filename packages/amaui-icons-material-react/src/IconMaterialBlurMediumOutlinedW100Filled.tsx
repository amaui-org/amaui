...
const IconMaterialBlurMediumOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BlurMediumOutlinedW100Filled'
...
export default IconMaterialBlurMediumOutlinedW100Filled;
