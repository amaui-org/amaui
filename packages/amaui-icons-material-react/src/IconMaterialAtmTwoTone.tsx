...
const IconMaterialAtmTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialAtmTwoTone.displayName = 'AmauiIconMaterialAtmTwoTone';

export default IconMaterialAtmTwoTone;
