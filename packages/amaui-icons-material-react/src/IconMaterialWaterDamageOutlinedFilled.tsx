...
const IconMaterialWaterDamageOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WaterDamageOutlinedFilled'
...
export default IconMaterialWaterDamageOutlinedFilled;
