...
const IconMaterialWbIridescentOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WbIridescentOutlinedW100'
...
export default IconMaterialWbIridescentOutlinedW100;
