...
const IconMaterialTimer3SelectOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Timer3SelectOutlinedFilled'
...
export default IconMaterialTimer3SelectOutlinedFilled;
