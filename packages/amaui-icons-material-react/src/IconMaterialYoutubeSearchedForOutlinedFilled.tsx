...
const IconMaterialYoutubeSearchedForOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='YoutubeSearchedForOutlinedFilled'
...
export default IconMaterialYoutubeSearchedForOutlinedFilled;
