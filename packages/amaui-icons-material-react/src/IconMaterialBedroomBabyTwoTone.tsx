...
const IconMaterialBedroomBabyTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialBedroomBabyTwoTone.displayName = 'AmauiIconMaterialBedroomBabyTwoTone';

export default IconMaterialBedroomBabyTwoTone;
