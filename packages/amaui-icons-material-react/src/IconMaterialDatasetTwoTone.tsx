...
const IconMaterialDatasetTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialDatasetTwoTone.displayName = 'AmauiIconMaterialDatasetTwoTone';

export default IconMaterialDatasetTwoTone;
