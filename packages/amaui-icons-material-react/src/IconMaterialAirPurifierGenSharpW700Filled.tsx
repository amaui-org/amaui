...
const IconMaterialAirPurifierGenSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AirPurifierGenSharpW700Filled'
...
export default IconMaterialAirPurifierGenSharpW700Filled;
