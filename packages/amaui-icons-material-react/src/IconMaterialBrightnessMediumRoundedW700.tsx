...
const IconMaterialBrightnessMediumRoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BrightnessMediumRoundedW700'
...
export default IconMaterialBrightnessMediumRoundedW700;
