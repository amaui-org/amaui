...
const IconMaterialMagicButtonOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MagicButtonOutlinedW100'
...
export default IconMaterialMagicButtonOutlinedW100;
