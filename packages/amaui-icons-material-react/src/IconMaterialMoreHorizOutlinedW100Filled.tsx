...
const IconMaterialMoreHorizOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MoreHorizOutlinedW100Filled'
...
export default IconMaterialMoreHorizOutlinedW100Filled;
