...
const IconMaterialCropLandscapeOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CropLandscapeOutlinedW100'
...
export default IconMaterialCropLandscapeOutlinedW100;
