...
const IconMaterialSearchSharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SearchSharpW100'
      short_name='Search'
...
IconMaterialSearchSharpW100.displayName = 'AmauiIconMaterialSearchSharpW100';

export default IconMaterialSearchSharpW100;
