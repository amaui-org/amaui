...
const IconMaterialAccessibilitySharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AccessibilitySharpW700Filled'
...
export default IconMaterialAccessibilitySharpW700Filled;
