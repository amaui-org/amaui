...
const IconMaterialRiceBowlSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RiceBowlSharpW700Filled'
      short_name='RiceBowl'
...
export default IconMaterialRiceBowlSharpW700Filled;
