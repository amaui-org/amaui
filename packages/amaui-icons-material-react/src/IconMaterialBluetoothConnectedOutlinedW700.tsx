...
const IconMaterialBluetoothConnectedOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BluetoothConnectedOutlinedW700'
...
export default IconMaterialBluetoothConnectedOutlinedW700;
