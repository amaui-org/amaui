...
const IconMaterialHearingSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HearingSharpFilled'
      short_name='Hearing'
...
IconMaterialHearingSharpFilled.displayName = 'AmauiIconMaterialHearingSharpFilled';

export default IconMaterialHearingSharpFilled;
