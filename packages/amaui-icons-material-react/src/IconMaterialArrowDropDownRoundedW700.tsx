...
const IconMaterialArrowDropDownRoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ArrowDropDownRoundedW700'
...
export default IconMaterialArrowDropDownRoundedW700;
