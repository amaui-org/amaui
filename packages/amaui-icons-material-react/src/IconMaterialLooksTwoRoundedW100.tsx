...
const IconMaterialLooksTwoRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LooksTwoRoundedW100'
      short_name='LooksTwo'
...
IconMaterialLooksTwoRoundedW100.displayName = 'AmauiIconMaterialLooksTwoRoundedW100';

export default IconMaterialLooksTwoRoundedW100;
