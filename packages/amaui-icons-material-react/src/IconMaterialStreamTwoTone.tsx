...
const IconMaterialStreamTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialStreamTwoTone.displayName = 'AmauiIconMaterialStreamTwoTone';

export default IconMaterialStreamTwoTone;
