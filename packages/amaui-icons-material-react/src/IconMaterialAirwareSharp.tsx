...
const IconMaterialAirwareSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialAirwareSharp.displayName = 'AmauiIconMaterialAirwareSharp';

export default IconMaterialAirwareSharp;
