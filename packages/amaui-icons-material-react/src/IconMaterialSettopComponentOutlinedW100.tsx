...
const IconMaterialSettopComponentOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SettopComponentOutlinedW100'
...
export default IconMaterialSettopComponentOutlinedW100;
