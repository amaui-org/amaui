...
const IconMaterialPageviewOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PageviewOutlinedW100Filled'
      short_name='Pageview'
...
export default IconMaterialPageviewOutlinedW100Filled;
