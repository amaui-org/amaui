...
const IconMaterialBatteryLowOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryLowOutlinedW700Filled'
...
export default IconMaterialBatteryLowOutlinedW700Filled;
