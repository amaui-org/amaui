...
const IconMaterialBakeryDiningTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialBakeryDiningTwoTone.displayName = 'AmauiIconMaterialBakeryDiningTwoTone';

export default IconMaterialBakeryDiningTwoTone;
