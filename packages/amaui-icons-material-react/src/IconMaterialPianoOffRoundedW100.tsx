...
const IconMaterialPianoOffRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PianoOffRoundedW100'
      short_name='PianoOff'
...
IconMaterialPianoOffRoundedW100.displayName = 'AmauiIconMaterialPianoOffRoundedW100';

export default IconMaterialPianoOffRoundedW100;
