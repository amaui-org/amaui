...
const IconMaterialFace4OutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Face4OutlinedW100Filled'
      short_name='Face4'
...
export default IconMaterialFace4OutlinedW100Filled;
