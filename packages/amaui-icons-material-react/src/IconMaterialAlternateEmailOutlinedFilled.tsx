...
const IconMaterialAlternateEmailOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AlternateEmailOutlinedFilled'
...
export default IconMaterialAlternateEmailOutlinedFilled;
