...
const IconMaterialBatteryUnknownSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialBatteryUnknownSharp.displayName = 'AmauiIconMaterialBatteryUnknownSharp';

export default IconMaterialBatteryUnknownSharp;
