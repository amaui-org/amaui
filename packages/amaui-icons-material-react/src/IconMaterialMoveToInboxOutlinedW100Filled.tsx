...
const IconMaterialMoveToInboxOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MoveToInboxOutlinedW100Filled'
...
export default IconMaterialMoveToInboxOutlinedW100Filled;
