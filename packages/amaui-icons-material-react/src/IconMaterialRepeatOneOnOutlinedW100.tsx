...
const IconMaterialRepeatOneOnOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RepeatOneOnOutlinedW100'
...
export default IconMaterialRepeatOneOnOutlinedW100;
