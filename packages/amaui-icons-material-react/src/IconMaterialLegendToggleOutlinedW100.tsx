...
const IconMaterialLegendToggleOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LegendToggleOutlinedW100'
...
export default IconMaterialLegendToggleOutlinedW100;
