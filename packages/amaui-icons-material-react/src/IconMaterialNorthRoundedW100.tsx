...
const IconMaterialNorthRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NorthRoundedW100'
      short_name='North'
...
IconMaterialNorthRoundedW100.displayName = 'AmauiIconMaterialNorthRoundedW100';

export default IconMaterialNorthRoundedW100;
