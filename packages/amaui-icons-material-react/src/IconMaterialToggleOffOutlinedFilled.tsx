...
const IconMaterialToggleOffOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ToggleOffOutlinedFilled'
...
export default IconMaterialToggleOffOutlinedFilled;
