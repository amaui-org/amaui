...
const IconMaterialCloudOffTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialCloudOffTwoTone.displayName = 'AmauiIconMaterialCloudOffTwoTone';

export default IconMaterialCloudOffTwoTone;
