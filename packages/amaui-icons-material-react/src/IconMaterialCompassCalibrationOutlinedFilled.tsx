...
const IconMaterialCompassCalibrationOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CompassCalibrationOutlinedFilled'
...
export default IconMaterialCompassCalibrationOutlinedFilled;
