...
const IconMaterialFileUploadOffOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FileUploadOffOutlinedW100'
...
export default IconMaterialFileUploadOffOutlinedW100;
