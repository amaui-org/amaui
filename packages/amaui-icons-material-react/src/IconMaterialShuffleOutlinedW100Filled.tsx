...
const IconMaterialShuffleOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ShuffleOutlinedW100Filled'
      short_name='Shuffle'
...
export default IconMaterialShuffleOutlinedW100Filled;
