...
const IconMaterialEmergencySharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='EmergencySharpW700Filled'
...
export default IconMaterialEmergencySharpW700Filled;
