...
const IconMaterialOutputOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='OutputOutlinedW700Filled'
      short_name='Output'
...
export default IconMaterialOutputOutlinedW700Filled;
