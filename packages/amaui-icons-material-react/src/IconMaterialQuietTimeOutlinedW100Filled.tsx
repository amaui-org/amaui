...
const IconMaterialQuietTimeOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='QuietTimeOutlinedW100Filled'
...
export default IconMaterialQuietTimeOutlinedW100Filled;
