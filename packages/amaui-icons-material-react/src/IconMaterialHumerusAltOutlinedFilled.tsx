...
const IconMaterialHumerusAltOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HumerusAltOutlinedFilled'
...
export default IconMaterialHumerusAltOutlinedFilled;
