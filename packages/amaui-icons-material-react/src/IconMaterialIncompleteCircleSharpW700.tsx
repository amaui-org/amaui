...
const IconMaterialIncompleteCircleSharpW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='IncompleteCircleSharpW700'
...
export default IconMaterialIncompleteCircleSharpW700;
