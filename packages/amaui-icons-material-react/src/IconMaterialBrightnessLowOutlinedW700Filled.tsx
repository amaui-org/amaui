...
const IconMaterialBrightnessLowOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BrightnessLowOutlinedW700Filled'
...
export default IconMaterialBrightnessLowOutlinedW700Filled;
