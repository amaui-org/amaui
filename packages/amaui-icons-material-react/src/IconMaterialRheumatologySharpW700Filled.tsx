...
const IconMaterialRheumatologySharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RheumatologySharpW700Filled'
...
export default IconMaterialRheumatologySharpW700Filled;
