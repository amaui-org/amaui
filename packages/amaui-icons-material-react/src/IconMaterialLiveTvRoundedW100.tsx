...
const IconMaterialLiveTvRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LiveTvRoundedW100'
      short_name='LiveTv'
...
IconMaterialLiveTvRoundedW100.displayName = 'AmauiIconMaterialLiveTvRoundedW100';

export default IconMaterialLiveTvRoundedW100;
