...
const IconMaterialBatteryLowOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryLowOutlinedFilled'
...
export default IconMaterialBatteryLowOutlinedFilled;
