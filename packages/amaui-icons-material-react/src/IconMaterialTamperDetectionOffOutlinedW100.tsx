...
const IconMaterialTamperDetectionOffOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TamperDetectionOffOutlinedW100'
...
export default IconMaterialTamperDetectionOffOutlinedW100;
