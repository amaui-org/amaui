...
const IconMaterialFilterHdrTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialFilterHdrTwoTone.displayName = 'AmauiIconMaterialFilterHdrTwoTone';

export default IconMaterialFilterHdrTwoTone;
