...
const IconMaterialOutgoingMailOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='OutgoingMailOutlinedW700Filled'
...
export default IconMaterialOutgoingMailOutlinedW700Filled;
