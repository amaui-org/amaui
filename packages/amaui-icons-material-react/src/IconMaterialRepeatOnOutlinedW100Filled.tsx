...
const IconMaterialRepeatOnOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RepeatOnOutlinedW100Filled'
      short_name='RepeatOn'
...
export default IconMaterialRepeatOnOutlinedW100Filled;
