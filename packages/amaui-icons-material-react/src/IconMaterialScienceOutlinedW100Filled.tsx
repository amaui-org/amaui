...
const IconMaterialScienceOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ScienceOutlinedW100Filled'
      short_name='Science'
...
export default IconMaterialScienceOutlinedW100Filled;
