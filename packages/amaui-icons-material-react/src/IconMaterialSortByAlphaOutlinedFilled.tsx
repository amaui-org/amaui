...
const IconMaterialSortByAlphaOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SortByAlphaOutlinedFilled'
...
export default IconMaterialSortByAlphaOutlinedFilled;
