...
const IconMaterialTabletTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialTabletTwoTone.displayName = 'AmauiIconMaterialTabletTwoTone';

export default IconMaterialTabletTwoTone;
