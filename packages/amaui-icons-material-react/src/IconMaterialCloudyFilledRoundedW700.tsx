...
const IconMaterialCloudyFilledRoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CloudyFilledRoundedW700'
...
export default IconMaterialCloudyFilledRoundedW700;
