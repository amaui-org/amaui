...
const IconMaterialSettingsApplicationsSharpW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SettingsApplicationsSharpW700'
...
export default IconMaterialSettingsApplicationsSharpW700;
