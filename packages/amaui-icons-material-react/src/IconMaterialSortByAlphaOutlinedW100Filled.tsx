...
const IconMaterialSortByAlphaOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SortByAlphaOutlinedW100Filled'
...
export default IconMaterialSortByAlphaOutlinedW100Filled;
