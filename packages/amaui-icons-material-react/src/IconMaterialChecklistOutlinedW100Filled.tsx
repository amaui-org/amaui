...
const IconMaterialChecklistOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ChecklistOutlinedW100Filled'
...
export default IconMaterialChecklistOutlinedW100Filled;
