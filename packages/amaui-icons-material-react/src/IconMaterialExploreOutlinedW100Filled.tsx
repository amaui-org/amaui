...
const IconMaterialExploreOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ExploreOutlinedW100Filled'
      short_name='Explore'
...
export default IconMaterialExploreOutlinedW100Filled;
