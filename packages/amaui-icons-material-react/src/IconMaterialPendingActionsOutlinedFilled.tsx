...
const IconMaterialPendingActionsOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PendingActionsOutlinedFilled'
...
export default IconMaterialPendingActionsOutlinedFilled;
