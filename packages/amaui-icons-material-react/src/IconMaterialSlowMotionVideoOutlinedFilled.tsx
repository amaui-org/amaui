...
const IconMaterialSlowMotionVideoOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SlowMotionVideoOutlinedFilled'
...
export default IconMaterialSlowMotionVideoOutlinedFilled;
