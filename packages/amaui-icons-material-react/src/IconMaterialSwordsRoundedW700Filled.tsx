...
const IconMaterialSwordsRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SwordsRoundedW700Filled'
      short_name='Swords'
...
export default IconMaterialSwordsRoundedW700Filled;
