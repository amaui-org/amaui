...
const IconMaterialBatteryProfileOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryProfileOutlinedW100'
...
export default IconMaterialBatteryProfileOutlinedW100;
