...
const IconMaterialSmokingRoomsOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SmokingRoomsOutlinedW700'
...
export default IconMaterialSmokingRoomsOutlinedW700;
