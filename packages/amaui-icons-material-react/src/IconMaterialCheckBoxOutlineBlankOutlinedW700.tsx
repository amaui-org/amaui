...
const IconMaterialCheckBoxOutlineBlankOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CheckBoxOutlineBlankOutlinedW700'
...
export default IconMaterialCheckBoxOutlineBlankOutlinedW700;
