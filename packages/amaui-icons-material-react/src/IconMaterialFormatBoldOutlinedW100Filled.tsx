...
const IconMaterialFormatBoldOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FormatBoldOutlinedW100Filled'
...
export default IconMaterialFormatBoldOutlinedW100Filled;
