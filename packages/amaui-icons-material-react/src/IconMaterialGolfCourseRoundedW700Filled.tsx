...
const IconMaterialGolfCourseRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='GolfCourseRoundedW700Filled'
...
export default IconMaterialGolfCourseRoundedW700Filled;
