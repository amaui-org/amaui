...
const IconMaterialWomanOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WomanOutlinedW700Filled'
      short_name='Woman'
...
export default IconMaterialWomanOutlinedW700Filled;
