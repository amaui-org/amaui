...
const IconMaterialRadioButtonCheckedSharpW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RadioButtonCheckedSharpW700'
...
export default IconMaterialRadioButtonCheckedSharpW700;
