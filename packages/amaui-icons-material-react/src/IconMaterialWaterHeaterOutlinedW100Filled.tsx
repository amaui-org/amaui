...
const IconMaterialWaterHeaterOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WaterHeaterOutlinedW100Filled'
...
export default IconMaterialWaterHeaterOutlinedW100Filled;
