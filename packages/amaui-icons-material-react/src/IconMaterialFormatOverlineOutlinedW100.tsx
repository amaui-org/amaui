...
const IconMaterialFormatOverlineOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FormatOverlineOutlinedW100'
...
export default IconMaterialFormatOverlineOutlinedW100;
