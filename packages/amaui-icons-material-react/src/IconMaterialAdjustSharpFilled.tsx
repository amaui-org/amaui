...
const IconMaterialAdjustSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AdjustSharpFilled'
      short_name='Adjust'
...
IconMaterialAdjustSharpFilled.displayName = 'AmauiIconMaterialAdjustSharpFilled';

export default IconMaterialAdjustSharpFilled;
