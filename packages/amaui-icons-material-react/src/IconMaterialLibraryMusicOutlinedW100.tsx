...
const IconMaterialLibraryMusicOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LibraryMusicOutlinedW100'
...
export default IconMaterialLibraryMusicOutlinedW100;
