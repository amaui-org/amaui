...
const IconMaterialTibiaAltOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TibiaAltOutlinedW100Filled'
      short_name='TibiaAlt'
...
export default IconMaterialTibiaAltOutlinedW100Filled;
