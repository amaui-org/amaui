...
const IconMaterialRepeatOneOnTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialRepeatOneOnTwoTone.displayName = 'AmauiIconMaterialRepeatOneOnTwoTone';

export default IconMaterialRepeatOneOnTwoTone;
