...
const IconMaterialTimerRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TimerRoundedW100'
      short_name='Timer'
...
IconMaterialTimerRoundedW100.displayName = 'AmauiIconMaterialTimerRoundedW100';

export default IconMaterialTimerRoundedW100;
