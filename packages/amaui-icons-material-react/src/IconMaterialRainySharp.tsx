...
const IconMaterialRainySharp = React.forwardRef((props: any, ref) => {
...
IconMaterialRainySharp.displayName = 'AmauiIconMaterialRainySharp';

export default IconMaterialRainySharp;
