...
const IconMaterialBatteryVeryLowOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryVeryLowOutlinedW100'
...
export default IconMaterialBatteryVeryLowOutlinedW100;
