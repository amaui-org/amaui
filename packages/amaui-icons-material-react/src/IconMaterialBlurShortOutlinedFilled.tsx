...
const IconMaterialBlurShortOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BlurShortOutlinedFilled'
...
export default IconMaterialBlurShortOutlinedFilled;
