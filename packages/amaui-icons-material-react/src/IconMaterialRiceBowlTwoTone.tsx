...
const IconMaterialRiceBowlTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialRiceBowlTwoTone.displayName = 'AmauiIconMaterialRiceBowlTwoTone';

export default IconMaterialRiceBowlTwoTone;
