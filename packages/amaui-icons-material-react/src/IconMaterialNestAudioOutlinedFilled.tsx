...
const IconMaterialNestAudioOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestAudioOutlinedFilled'
...
export default IconMaterialNestAudioOutlinedFilled;
