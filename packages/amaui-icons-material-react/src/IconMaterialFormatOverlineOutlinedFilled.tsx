...
const IconMaterialFormatOverlineOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FormatOverlineOutlinedFilled'
...
export default IconMaterialFormatOverlineOutlinedFilled;
