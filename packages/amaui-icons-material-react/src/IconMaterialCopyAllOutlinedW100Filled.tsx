...
const IconMaterialCopyAllOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CopyAllOutlinedW100Filled'
      short_name='CopyAll'
...
export default IconMaterialCopyAllOutlinedW100Filled;
