...
const IconMaterialBatteryAlertSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryAlertSharpW700Filled'
...
export default IconMaterialBatteryAlertSharpW700Filled;
