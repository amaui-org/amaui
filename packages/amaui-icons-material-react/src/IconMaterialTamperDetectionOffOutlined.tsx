...
const IconMaterialTamperDetectionOffOutlined = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TamperDetectionOffOutlined'
...
export default IconMaterialTamperDetectionOffOutlined;
