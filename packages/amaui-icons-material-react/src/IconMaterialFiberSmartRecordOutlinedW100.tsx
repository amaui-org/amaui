...
const IconMaterialFiberSmartRecordOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FiberSmartRecordOutlinedW100'
...
export default IconMaterialFiberSmartRecordOutlinedW100;
