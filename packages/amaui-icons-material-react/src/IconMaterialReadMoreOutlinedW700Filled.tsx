...
const IconMaterialReadMoreOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ReadMoreOutlinedW700Filled'
      short_name='ReadMore'
...
export default IconMaterialReadMoreOutlinedW700Filled;
