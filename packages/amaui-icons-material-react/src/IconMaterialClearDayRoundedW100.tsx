...
const IconMaterialClearDayRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ClearDayRoundedW100'
      short_name='ClearDay'
...
IconMaterialClearDayRoundedW100.displayName = 'AmauiIconMaterialClearDayRoundedW100';

export default IconMaterialClearDayRoundedW100;
