...
const IconMaterialPreviewRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialPreviewRounded.displayName = 'AmauiIconMaterialPreviewRounded';

export default IconMaterialPreviewRounded;
