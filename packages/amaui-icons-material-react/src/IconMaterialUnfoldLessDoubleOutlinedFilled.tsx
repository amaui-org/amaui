...
const IconMaterialUnfoldLessDoubleOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='UnfoldLessDoubleOutlinedFilled'
...
export default IconMaterialUnfoldLessDoubleOutlinedFilled;
