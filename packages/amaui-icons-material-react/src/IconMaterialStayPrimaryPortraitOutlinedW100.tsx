...
const IconMaterialStayPrimaryPortraitOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='StayPrimaryPortraitOutlinedW100'
...
export default IconMaterialStayPrimaryPortraitOutlinedW100;
