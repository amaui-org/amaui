...
const IconMaterialSettingsPhoneTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialSettingsPhoneTwoTone.displayName = 'AmauiIconMaterialSettingsPhoneTwoTone';

export default IconMaterialSettingsPhoneTwoTone;
