...
const IconMaterialNestCamWallMountOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestCamWallMountOutlinedFilled'
...
export default IconMaterialNestCamWallMountOutlinedFilled;
