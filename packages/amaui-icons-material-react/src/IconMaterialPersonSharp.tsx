...
const IconMaterialPersonSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialPersonSharp.displayName = 'AmauiIconMaterialPersonSharp';

export default IconMaterialPersonSharp;
