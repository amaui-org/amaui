...
const IconMaterialRoomServiceTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialRoomServiceTwoTone.displayName = 'AmauiIconMaterialRoomServiceTwoTone';

export default IconMaterialRoomServiceTwoTone;
