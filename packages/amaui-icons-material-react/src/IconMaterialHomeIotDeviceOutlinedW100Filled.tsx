...
const IconMaterialHomeIotDeviceOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HomeIotDeviceOutlinedW100Filled'
...
export default IconMaterialHomeIotDeviceOutlinedW100Filled;
