...
const IconMaterialPlayDisabledOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PlayDisabledOutlinedW100'
...
export default IconMaterialPlayDisabledOutlinedW100;
