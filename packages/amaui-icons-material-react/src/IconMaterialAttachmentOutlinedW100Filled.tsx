...
const IconMaterialAttachmentOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AttachmentOutlinedW100Filled'
...
export default IconMaterialAttachmentOutlinedW100Filled;
