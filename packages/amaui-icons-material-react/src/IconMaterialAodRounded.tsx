...
const IconMaterialAodRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialAodRounded.displayName = 'AmauiIconMaterialAodRounded';

export default IconMaterialAodRounded;
