...
const IconMaterialSwitchAccessShortcutSharpW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SwitchAccessShortcutSharpW700'
...
export default IconMaterialSwitchAccessShortcutSharpW700;
