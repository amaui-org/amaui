...
const IconMaterialModeOfTravelOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ModeOfTravelOutlinedFilled'
...
export default IconMaterialModeOfTravelOutlinedFilled;
