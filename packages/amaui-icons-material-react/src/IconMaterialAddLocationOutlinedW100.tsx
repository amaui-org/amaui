...
const IconMaterialAddLocationOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AddLocationOutlinedW100'
...
export default IconMaterialAddLocationOutlinedW100;
