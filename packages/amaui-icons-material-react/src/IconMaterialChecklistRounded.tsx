...
const IconMaterialChecklistRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialChecklistRounded.displayName = 'AmauiIconMaterialChecklistRounded';

export default IconMaterialChecklistRounded;
