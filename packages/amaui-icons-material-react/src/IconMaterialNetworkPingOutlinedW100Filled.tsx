...
const IconMaterialNetworkPingOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NetworkPingOutlinedW100Filled'
...
export default IconMaterialNetworkPingOutlinedW100Filled;
