...
const IconMaterialPerson2SharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Person2SharpFilled'
      short_name='Person2'
...
IconMaterialPerson2SharpFilled.displayName = 'AmauiIconMaterialPerson2SharpFilled';

export default IconMaterialPerson2SharpFilled;
