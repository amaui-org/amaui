...
const IconMaterialArchitectureSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialArchitectureSharp.displayName = 'AmauiIconMaterialArchitectureSharp';

export default IconMaterialArchitectureSharp;
