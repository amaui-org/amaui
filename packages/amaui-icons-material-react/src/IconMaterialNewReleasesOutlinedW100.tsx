...
const IconMaterialNewReleasesOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NewReleasesOutlinedW100'
...
export default IconMaterialNewReleasesOutlinedW100;
