...
const IconMaterialControllerGenOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ControllerGenOutlinedW100Filled'
...
export default IconMaterialControllerGenOutlinedW100Filled;
