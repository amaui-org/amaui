...
const IconMaterialCommunicationRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CommunicationRoundedW700Filled'
...
export default IconMaterialCommunicationRoundedW700Filled;
