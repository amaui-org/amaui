...
const IconMaterialWorkspacesSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WorkspacesSharpW700Filled'
...
export default IconMaterialWorkspacesSharpW700Filled;
