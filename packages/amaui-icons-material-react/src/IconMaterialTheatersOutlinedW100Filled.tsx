...
const IconMaterialTheatersOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TheatersOutlinedW100Filled'
      short_name='Theaters'
...
export default IconMaterialTheatersOutlinedW100Filled;
