...
IconMaterialKeyboardArrowLeftRounded.displayName = 'AmauiIconMaterialKeyboardArrowLeftRounded';

export default IconMaterialKeyboardArrowLeftRounded;
