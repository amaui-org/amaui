...
const IconMaterialStreetviewOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='StreetviewOutlinedFilled'
...
export default IconMaterialStreetviewOutlinedFilled;
