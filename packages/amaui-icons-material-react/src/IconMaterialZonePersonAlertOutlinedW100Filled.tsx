...
const IconMaterialZonePersonAlertOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ZonePersonAlertOutlinedW100Filled'
...
export default IconMaterialZonePersonAlertOutlinedW100Filled;
