...
const IconMaterialFastfoodTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialFastfoodTwoTone.displayName = 'AmauiIconMaterialFastfoodTwoTone';

export default IconMaterialFastfoodTwoTone;
