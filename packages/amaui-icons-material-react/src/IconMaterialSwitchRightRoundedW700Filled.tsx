...
const IconMaterialSwitchRightRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SwitchRightRoundedW700Filled'
...
export default IconMaterialSwitchRightRoundedW700Filled;
