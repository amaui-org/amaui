...
const IconMaterialAirwareRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialAirwareRounded.displayName = 'AmauiIconMaterialAirwareRounded';

export default IconMaterialAirwareRounded;
