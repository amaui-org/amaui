...
const IconMaterialVideoLibraryOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='VideoLibraryOutlinedW100Filled'
...
export default IconMaterialVideoLibraryOutlinedW100Filled;
