...
const IconMaterialIcecreamTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialIcecreamTwoTone.displayName = 'AmauiIconMaterialIcecreamTwoTone';

export default IconMaterialIcecreamTwoTone;
