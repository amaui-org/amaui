...
const IconMaterialMovieTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialMovieTwoTone.displayName = 'AmauiIconMaterialMovieTwoTone';

export default IconMaterialMovieTwoTone;
