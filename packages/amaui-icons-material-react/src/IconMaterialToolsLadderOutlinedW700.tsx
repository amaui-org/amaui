...
const IconMaterialToolsLadderOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ToolsLadderOutlinedW700'
...
export default IconMaterialToolsLadderOutlinedW700;
