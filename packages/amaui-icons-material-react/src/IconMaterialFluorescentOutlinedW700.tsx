...
const IconMaterialFluorescentOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FluorescentOutlinedW700'
...
export default IconMaterialFluorescentOutlinedW700;
