...
const IconMaterialErrorCircleRoundedOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ErrorCircleRoundedOutlinedFilled'
...
export default IconMaterialErrorCircleRoundedOutlinedFilled;
