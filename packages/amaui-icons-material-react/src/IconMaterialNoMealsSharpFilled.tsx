...
const IconMaterialNoMealsSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NoMealsSharpFilled'
      short_name='NoMeals'
...
IconMaterialNoMealsSharpFilled.displayName = 'AmauiIconMaterialNoMealsSharpFilled';

export default IconMaterialNoMealsSharpFilled;
