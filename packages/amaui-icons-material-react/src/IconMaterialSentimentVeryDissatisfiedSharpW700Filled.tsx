...
const IconMaterialSentimentVeryDissatisfiedSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SentimentVeryDissatisfiedSharpW700Filled'
...
export default IconMaterialSentimentVeryDissatisfiedSharpW700Filled;
