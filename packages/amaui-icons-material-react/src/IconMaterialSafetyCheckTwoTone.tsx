...
const IconMaterialSafetyCheckTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialSafetyCheckTwoTone.displayName = 'AmauiIconMaterialSafetyCheckTwoTone';

export default IconMaterialSafetyCheckTwoTone;
