...
const IconMaterialErrorCircleRoundedOutlined = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ErrorCircleRoundedOutlined'
...
export default IconMaterialErrorCircleRoundedOutlined;
