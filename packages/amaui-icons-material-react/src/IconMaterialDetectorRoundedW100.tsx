...
const IconMaterialDetectorRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DetectorRoundedW100'
      short_name='Detector'
...
IconMaterialDetectorRoundedW100.displayName = 'AmauiIconMaterialDetectorRoundedW100';

export default IconMaterialDetectorRoundedW100;
