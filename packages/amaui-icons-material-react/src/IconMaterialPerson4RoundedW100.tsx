...
const IconMaterialPerson4RoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Person4RoundedW100'
      short_name='Person4'
...
IconMaterialPerson4RoundedW100.displayName = 'AmauiIconMaterialPerson4RoundedW100';

export default IconMaterialPerson4RoundedW100;
