...
const IconMaterialRadioButtonCheckedRoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RadioButtonCheckedRoundedW700'
...
export default IconMaterialRadioButtonCheckedRoundedW700;
