...
const IconMaterialAutoGraphOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AutoGraphOutlinedW100Filled'
...
export default IconMaterialAutoGraphOutlinedW100Filled;
