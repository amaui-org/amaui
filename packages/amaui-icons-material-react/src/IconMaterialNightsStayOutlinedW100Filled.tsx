...
const IconMaterialNightsStayOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NightsStayOutlinedW100Filled'
...
export default IconMaterialNightsStayOutlinedW100Filled;
