...
const IconMaterialWbSunnyTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialWbSunnyTwoTone.displayName = 'AmauiIconMaterialWbSunnyTwoTone';

export default IconMaterialWbSunnyTwoTone;
