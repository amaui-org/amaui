...
const IconMaterialVisibilityOffOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='VisibilityOffOutlinedFilled'
...
export default IconMaterialVisibilityOffOutlinedFilled;
