...
const IconMaterialLogoutRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialLogoutRounded.displayName = 'AmauiIconMaterialLogoutRounded';

export default IconMaterialLogoutRounded;
