...
const IconMaterialExpandCircleDownSharpW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ExpandCircleDownSharpW700'
...
export default IconMaterialExpandCircleDownSharpW700;
