...
const IconMaterialWebStoriesTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialWebStoriesTwoTone.displayName = 'AmauiIconMaterialWebStoriesTwoTone';

export default IconMaterialWebStoriesTwoTone;
