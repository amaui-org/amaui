...
const IconMaterialCloudDoneTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialCloudDoneTwoTone.displayName = 'AmauiIconMaterialCloudDoneTwoTone';

export default IconMaterialCloudDoneTwoTone;
