...
const IconMaterialNorthWestRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NorthWestRoundedW700Filled'
...
export default IconMaterialNorthWestRoundedW700Filled;
