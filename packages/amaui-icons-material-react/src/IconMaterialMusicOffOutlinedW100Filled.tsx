...
const IconMaterialMusicOffOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MusicOffOutlinedW100Filled'
      short_name='MusicOff'
...
export default IconMaterialMusicOffOutlinedW100Filled;
