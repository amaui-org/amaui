...
const IconMaterialMusicNoteSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialMusicNoteSharp.displayName = 'AmauiIconMaterialMusicNoteSharp';

export default IconMaterialMusicNoteSharp;
