...
const IconMaterialCommunicationOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CommunicationOutlinedW700Filled'
...
export default IconMaterialCommunicationOutlinedW700Filled;
