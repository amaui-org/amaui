...
const IconMaterialMicrowaveGenSharp = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MicrowaveGenSharp'
...
IconMaterialMicrowaveGenSharp.displayName = 'AmauiIconMaterialMicrowaveGenSharp';

export default IconMaterialMicrowaveGenSharp;
