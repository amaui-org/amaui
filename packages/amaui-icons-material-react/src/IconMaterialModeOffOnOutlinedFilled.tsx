...
const IconMaterialModeOffOnOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ModeOffOnOutlinedFilled'
...
export default IconMaterialModeOffOnOutlinedFilled;
