...
const IconMaterialFlightLandOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FlightLandOutlinedFilled'
...
export default IconMaterialFlightLandOutlinedFilled;
