...
const IconMaterialTrailLengthShortOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TrailLengthShortOutlinedW100Filled'
...
export default IconMaterialTrailLengthShortOutlinedW100Filled;
