...
const IconMaterialQueuePlayNextTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialQueuePlayNextTwoTone.displayName = 'AmauiIconMaterialQueuePlayNextTwoTone';

export default IconMaterialQueuePlayNextTwoTone;
