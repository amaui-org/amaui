...
const IconMaterialSavedSearchOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SavedSearchOutlinedW700'
...
export default IconMaterialSavedSearchOutlinedW700;
