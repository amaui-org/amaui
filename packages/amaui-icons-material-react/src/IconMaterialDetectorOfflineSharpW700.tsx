...
const IconMaterialDetectorOfflineSharpW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DetectorOfflineSharpW700'
...
export default IconMaterialDetectorOfflineSharpW700;
