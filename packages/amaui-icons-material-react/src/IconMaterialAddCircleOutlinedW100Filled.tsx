...
const IconMaterialAddCircleOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AddCircleOutlinedW100Filled'
...
export default IconMaterialAddCircleOutlinedW100Filled;
