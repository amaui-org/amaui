...
const IconMaterialEmojiPeopleSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='EmojiPeopleSharpW700Filled'
...
export default IconMaterialEmojiPeopleSharpW700Filled;
