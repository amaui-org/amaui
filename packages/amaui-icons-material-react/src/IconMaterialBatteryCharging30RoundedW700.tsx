...
const IconMaterialBatteryCharging30RoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryCharging30RoundedW700'
...
export default IconMaterialBatteryCharging30RoundedW700;
