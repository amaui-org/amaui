...
const IconMaterialDangerousTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialDangerousTwoTone.displayName = 'AmauiIconMaterialDangerousTwoTone';

export default IconMaterialDangerousTwoTone;
