...
const IconMaterialStyleTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialStyleTwoTone.displayName = 'AmauiIconMaterialStyleTwoTone';

export default IconMaterialStyleTwoTone;
