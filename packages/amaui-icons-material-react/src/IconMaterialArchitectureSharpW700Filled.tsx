...
const IconMaterialArchitectureSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ArchitectureSharpW700Filled'
...
export default IconMaterialArchitectureSharpW700Filled;
