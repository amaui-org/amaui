...
const IconMaterialSdTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialSdTwoTone.displayName = 'AmauiIconMaterialSdTwoTone';

export default IconMaterialSdTwoTone;
