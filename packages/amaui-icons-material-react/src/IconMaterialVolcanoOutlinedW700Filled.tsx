...
const IconMaterialVolcanoOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='VolcanoOutlinedW700Filled'
      short_name='Volcano'
...
export default IconMaterialVolcanoOutlinedW700Filled;
