...
const IconMaterialQueueMusicSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialQueueMusicSharp.displayName = 'AmauiIconMaterialQueueMusicSharp';

export default IconMaterialQueueMusicSharp;
