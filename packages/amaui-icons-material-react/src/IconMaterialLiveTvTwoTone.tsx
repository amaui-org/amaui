...
const IconMaterialLiveTvTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialLiveTvTwoTone.displayName = 'AmauiIconMaterialLiveTvTwoTone';

export default IconMaterialLiveTvTwoTone;
