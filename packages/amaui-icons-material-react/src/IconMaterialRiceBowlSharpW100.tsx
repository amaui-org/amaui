...
const IconMaterialRiceBowlSharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RiceBowlSharpW100'
      short_name='RiceBowl'
...
IconMaterialRiceBowlSharpW100.displayName = 'AmauiIconMaterialRiceBowlSharpW100';

export default IconMaterialRiceBowlSharpW100;
