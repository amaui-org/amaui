...
const IconMaterialSavedSearchOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SavedSearchOutlinedW100Filled'
...
export default IconMaterialSavedSearchOutlinedW100Filled;
