...
const IconMaterialGavelOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='GavelOutlinedW100Filled'
      short_name='Gavel'
...
export default IconMaterialGavelOutlinedW100Filled;
