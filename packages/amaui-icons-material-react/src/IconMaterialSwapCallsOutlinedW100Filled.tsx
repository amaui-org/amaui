...
const IconMaterialSwapCallsOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SwapCallsOutlinedW100Filled'
...
export default IconMaterialSwapCallsOutlinedW100Filled;
