...
const IconMaterialLooks5RoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Looks5RoundedW100'
      short_name='Looks5'
...
IconMaterialLooks5RoundedW100.displayName = 'AmauiIconMaterialLooks5RoundedW100';

export default IconMaterialLooks5RoundedW100;
