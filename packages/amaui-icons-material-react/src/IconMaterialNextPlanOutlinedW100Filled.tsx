...
const IconMaterialNextPlanOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NextPlanOutlinedW100Filled'
      short_name='NextPlan'
...
export default IconMaterialNextPlanOutlinedW100Filled;
