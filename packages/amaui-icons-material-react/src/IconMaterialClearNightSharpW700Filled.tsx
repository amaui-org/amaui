...
const IconMaterialClearNightSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ClearNightSharpW700Filled'
...
export default IconMaterialClearNightSharpW700Filled;
