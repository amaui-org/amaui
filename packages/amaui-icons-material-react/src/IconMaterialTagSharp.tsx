...
const IconMaterialTagSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialTagSharp.displayName = 'AmauiIconMaterialTagSharp';

export default IconMaterialTagSharp;
