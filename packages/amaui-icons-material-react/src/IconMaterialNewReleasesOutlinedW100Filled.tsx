...
const IconMaterialNewReleasesOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NewReleasesOutlinedW100Filled'
...
export default IconMaterialNewReleasesOutlinedW100Filled;
