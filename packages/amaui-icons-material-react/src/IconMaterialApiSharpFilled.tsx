...
const IconMaterialApiSharpFilled = React.forwardRef((props: any, ref) => {
...
IconMaterialApiSharpFilled.displayName = 'AmauiIconMaterialApiSharpFilled';

export default IconMaterialApiSharpFilled;
