...
const IconMaterialAnalyticsTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialAnalyticsTwoTone.displayName = 'AmauiIconMaterialAnalyticsTwoTone';

export default IconMaterialAnalyticsTwoTone;
