...
const IconMaterialRestaurantMenuOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RestaurantMenuOutlinedFilled'
...
export default IconMaterialRestaurantMenuOutlinedFilled;
