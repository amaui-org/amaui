...
const IconMaterialReceiptOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ReceiptOutlinedW100Filled'
      short_name='Receipt'
...
export default IconMaterialReceiptOutlinedW100Filled;
