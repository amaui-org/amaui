...
const IconMaterialAstrophotographyOffOutlined = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AstrophotographyOffOutlined'
...
export default IconMaterialAstrophotographyOffOutlined;
