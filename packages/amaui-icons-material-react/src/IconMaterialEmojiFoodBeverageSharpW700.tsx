...
const IconMaterialEmojiFoodBeverageSharpW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='EmojiFoodBeverageSharpW700'
...
export default IconMaterialEmojiFoodBeverageSharpW700;
