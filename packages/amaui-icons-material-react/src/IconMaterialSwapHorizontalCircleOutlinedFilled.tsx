...
const IconMaterialSwapHorizontalCircleOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SwapHorizontalCircleOutlinedFilled'
...
export default IconMaterialSwapHorizontalCircleOutlinedFilled;
