...
const IconMaterialBrightnessMediumOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BrightnessMediumOutlinedFilled'
...
export default IconMaterialBrightnessMediumOutlinedFilled;
