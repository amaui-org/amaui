...
const IconMaterialThermostatOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ThermostatOutlinedW100Filled'
...
export default IconMaterialThermostatOutlinedW100Filled;
