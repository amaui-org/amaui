...
const IconMaterialAirFreshenerOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AirFreshenerOutlinedFilled'
...
export default IconMaterialAirFreshenerOutlinedFilled;
