...
const IconMaterialDeviceResetOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DeviceResetOutlinedW100Filled'
...
export default IconMaterialDeviceResetOutlinedW100Filled;
