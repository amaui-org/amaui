...
const IconMaterialConnectingAirportsOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ConnectingAirportsOutlinedFilled'
...
export default IconMaterialConnectingAirportsOutlinedFilled;
