...
const IconMaterialSpellcheckOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SpellcheckOutlinedW700Filled'
...
export default IconMaterialSpellcheckOutlinedW700Filled;
