...
const IconMaterialSlowMotionVideoSharpW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SlowMotionVideoSharpW700'
...
export default IconMaterialSlowMotionVideoSharpW700;
