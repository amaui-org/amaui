...
const IconMaterialBatteryCharging90RoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryCharging90RoundedW700Filled'
...
export default IconMaterialBatteryCharging90RoundedW700Filled;
