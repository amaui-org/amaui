...
const IconMaterialParkSharpW100 = React.forwardRef((props: any, ref) => {
...
IconMaterialParkSharpW100.displayName = 'AmauiIconMaterialParkSharpW100';

export default IconMaterialParkSharpW100;
