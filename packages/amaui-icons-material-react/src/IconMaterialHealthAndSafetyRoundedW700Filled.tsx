...
const IconMaterialHealthAndSafetyRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HealthAndSafetyRoundedW700Filled'
...
export default IconMaterialHealthAndSafetyRoundedW700Filled;
