...
const IconMaterialEmojiPeopleOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='EmojiPeopleOutlinedW100Filled'
...
export default IconMaterialEmojiPeopleOutlinedW100Filled;
