...
const IconMaterialAtrSharpW100 = React.forwardRef((props: any, ref) => {
...
IconMaterialAtrSharpW100.displayName = 'AmauiIconMaterialAtrSharpW100';

export default IconMaterialAtrSharpW100;
