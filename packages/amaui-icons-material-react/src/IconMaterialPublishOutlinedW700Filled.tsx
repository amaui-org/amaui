...
const IconMaterialPublishOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PublishOutlinedW700Filled'
      short_name='Publish'
...
export default IconMaterialPublishOutlinedW700Filled;
