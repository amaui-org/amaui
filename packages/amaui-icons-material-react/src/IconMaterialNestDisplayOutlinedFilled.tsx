...
const IconMaterialNestDisplayOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestDisplayOutlinedFilled'
...
export default IconMaterialNestDisplayOutlinedFilled;
