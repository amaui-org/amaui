...
const IconMaterialWindowSensorOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WindowSensorOutlinedW700'
...
export default IconMaterialWindowSensorOutlinedW700;
