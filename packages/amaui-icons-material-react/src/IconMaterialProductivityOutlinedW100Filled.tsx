...
const IconMaterialProductivityOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ProductivityOutlinedW100Filled'
...
export default IconMaterialProductivityOutlinedW100Filled;
