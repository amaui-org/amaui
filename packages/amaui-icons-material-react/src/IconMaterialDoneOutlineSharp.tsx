...
const IconMaterialDoneOutlineSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialDoneOutlineSharp.displayName = 'AmauiIconMaterialDoneOutlineSharp';

export default IconMaterialDoneOutlineSharp;
