...
const IconMaterialCheckBoxOutlineBlankOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CheckBoxOutlineBlankOutlinedW100'
...
export default IconMaterialCheckBoxOutlineBlankOutlinedW100;
