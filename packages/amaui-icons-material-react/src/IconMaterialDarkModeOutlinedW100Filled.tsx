...
const IconMaterialDarkModeOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DarkModeOutlinedW100Filled'
      short_name='DarkMode'
...
export default IconMaterialDarkModeOutlinedW100Filled;
