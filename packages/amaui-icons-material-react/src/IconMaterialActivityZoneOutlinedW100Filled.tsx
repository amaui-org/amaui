...
const IconMaterialActivityZoneOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ActivityZoneOutlinedW100Filled'
...
export default IconMaterialActivityZoneOutlinedW100Filled;
