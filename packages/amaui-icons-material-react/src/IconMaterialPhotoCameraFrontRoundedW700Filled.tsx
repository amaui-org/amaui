...
const IconMaterialPhotoCameraFrontRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PhotoCameraFrontRoundedW700Filled'
...
export default IconMaterialPhotoCameraFrontRoundedW700Filled;
