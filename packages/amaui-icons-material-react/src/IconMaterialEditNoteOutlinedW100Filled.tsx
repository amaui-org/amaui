...
const IconMaterialEditNoteOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='EditNoteOutlinedW100Filled'
      short_name='EditNote'
...
export default IconMaterialEditNoteOutlinedW100Filled;
