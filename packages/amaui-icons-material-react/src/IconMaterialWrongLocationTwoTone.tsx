...
const IconMaterialWrongLocationTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialWrongLocationTwoTone.displayName = 'AmauiIconMaterialWrongLocationTwoTone';

export default IconMaterialWrongLocationTwoTone;
