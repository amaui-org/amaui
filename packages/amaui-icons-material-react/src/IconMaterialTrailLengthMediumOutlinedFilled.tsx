...
const IconMaterialTrailLengthMediumOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TrailLengthMediumOutlinedFilled'
...
export default IconMaterialTrailLengthMediumOutlinedFilled;
