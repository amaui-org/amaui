...
const IconMaterialBorderVerticalOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BorderVerticalOutlinedFilled'
...
export default IconMaterialBorderVerticalOutlinedFilled;
