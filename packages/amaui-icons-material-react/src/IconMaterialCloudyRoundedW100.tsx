...
const IconMaterialCloudyRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CloudyRoundedW100'
      short_name='Cloudy'
...
IconMaterialCloudyRoundedW100.displayName = 'AmauiIconMaterialCloudyRoundedW100';

export default IconMaterialCloudyRoundedW100;
