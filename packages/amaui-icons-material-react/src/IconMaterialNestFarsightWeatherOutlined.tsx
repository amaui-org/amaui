...
const IconMaterialNestFarsightWeatherOutlined = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestFarsightWeatherOutlined'
...
export default IconMaterialNestFarsightWeatherOutlined;
