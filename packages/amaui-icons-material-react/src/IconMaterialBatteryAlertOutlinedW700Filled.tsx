...
const IconMaterialBatteryAlertOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryAlertOutlinedW700Filled'
...
export default IconMaterialBatteryAlertOutlinedW700Filled;
