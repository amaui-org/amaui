...
const IconMaterialTopicRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TopicRoundedW100'
      short_name='Topic'
...
IconMaterialTopicRoundedW100.displayName = 'AmauiIconMaterialTopicRoundedW100';

export default IconMaterialTopicRoundedW100;
