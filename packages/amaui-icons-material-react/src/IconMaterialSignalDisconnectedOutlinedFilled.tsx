...
const IconMaterialSignalDisconnectedOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SignalDisconnectedOutlinedFilled'
...
export default IconMaterialSignalDisconnectedOutlinedFilled;
