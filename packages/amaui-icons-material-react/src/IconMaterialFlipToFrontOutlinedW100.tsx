...
const IconMaterialFlipToFrontOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FlipToFrontOutlinedW100'
...
export default IconMaterialFlipToFrontOutlinedW100;
