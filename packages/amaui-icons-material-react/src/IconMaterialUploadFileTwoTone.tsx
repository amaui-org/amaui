...
const IconMaterialUploadFileTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialUploadFileTwoTone.displayName = 'AmauiIconMaterialUploadFileTwoTone';

export default IconMaterialUploadFileTwoTone;
