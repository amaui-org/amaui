...
const IconMaterialE911EmergencyOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='E911EmergencyOutlinedFilled'
...
export default IconMaterialE911EmergencyOutlinedFilled;
