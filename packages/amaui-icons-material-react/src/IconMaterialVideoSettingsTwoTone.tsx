...
const IconMaterialVideoSettingsTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialVideoSettingsTwoTone.displayName = 'AmauiIconMaterialVideoSettingsTwoTone';

export default IconMaterialVideoSettingsTwoTone;
