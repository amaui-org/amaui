...
const IconMaterialWeightOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WeightOutlinedW700Filled'
      short_name='Weight'
...
export default IconMaterialWeightOutlinedW700Filled;
