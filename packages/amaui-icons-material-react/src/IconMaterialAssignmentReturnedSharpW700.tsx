...
const IconMaterialAssignmentReturnedSharpW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AssignmentReturnedSharpW700'
...
export default IconMaterialAssignmentReturnedSharpW700;
