...
const IconMaterialPreviewSharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PreviewSharpW100'
      short_name='Preview'
...
IconMaterialPreviewSharpW100.displayName = 'AmauiIconMaterialPreviewSharpW100';

export default IconMaterialPreviewSharpW100;
