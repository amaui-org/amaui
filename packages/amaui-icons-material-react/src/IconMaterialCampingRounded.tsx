...
const IconMaterialCampingRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialCampingRounded.displayName = 'AmauiIconMaterialCampingRounded';

export default IconMaterialCampingRounded;
