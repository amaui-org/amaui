...
const IconMaterialFluorescentOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FluorescentOutlinedW100'
...
export default IconMaterialFluorescentOutlinedW100;
