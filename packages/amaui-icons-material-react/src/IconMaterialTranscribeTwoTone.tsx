...
const IconMaterialTranscribeTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialTranscribeTwoTone.displayName = 'AmauiIconMaterialTranscribeTwoTone';

export default IconMaterialTranscribeTwoTone;
