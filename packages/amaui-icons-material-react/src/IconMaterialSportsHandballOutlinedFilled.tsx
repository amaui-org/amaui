...
const IconMaterialSportsHandballOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SportsHandballOutlinedFilled'
...
export default IconMaterialSportsHandballOutlinedFilled;
