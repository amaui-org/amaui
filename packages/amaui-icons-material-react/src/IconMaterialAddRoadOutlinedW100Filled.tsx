...
const IconMaterialAddRoadOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AddRoadOutlinedW100Filled'
      short_name='AddRoad'
...
export default IconMaterialAddRoadOutlinedW100Filled;
