...
const IconMaterialCopyAllOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CopyAllOutlinedW700Filled'
      short_name='CopyAll'
...
export default IconMaterialCopyAllOutlinedW700Filled;
