...
const IconMaterialCabinRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CabinRoundedW100'
      short_name='Cabin'
...
IconMaterialCabinRoundedW100.displayName = 'AmauiIconMaterialCabinRoundedW100';

export default IconMaterialCabinRoundedW100;
