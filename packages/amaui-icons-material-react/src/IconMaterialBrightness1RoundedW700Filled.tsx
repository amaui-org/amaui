...
const IconMaterialBrightness1RoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Brightness1RoundedW700Filled'
...
export default IconMaterialBrightness1RoundedW700Filled;
