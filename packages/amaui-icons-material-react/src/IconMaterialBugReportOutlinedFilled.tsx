...
const IconMaterialBugReportOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BugReportOutlinedFilled'
...
export default IconMaterialBugReportOutlinedFilled;
