...
const IconMaterialDownloadingSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialDownloadingSharp.displayName = 'AmauiIconMaterialDownloadingSharp';

export default IconMaterialDownloadingSharp;
