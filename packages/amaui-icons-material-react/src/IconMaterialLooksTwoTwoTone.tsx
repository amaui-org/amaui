...
const IconMaterialLooksTwoTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialLooksTwoTwoTone.displayName = 'AmauiIconMaterialLooksTwoTwoTone';

export default IconMaterialLooksTwoTwoTone;
