...
const IconMaterialModeCoolOffOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ModeCoolOffOutlinedW100'
...
export default IconMaterialModeCoolOffOutlinedW100;
