...
const IconMaterialSickTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialSickTwoTone.displayName = 'AmauiIconMaterialSickTwoTone';

export default IconMaterialSickTwoTone;
