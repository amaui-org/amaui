...
const IconMaterialBattery80RoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Battery80RoundedW700Filled'
...
export default IconMaterialBattery80RoundedW700Filled;
