...
const IconMaterialAirlineSeatReclineNormalOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AirlineSeatReclineNormalOutlinedFilled'
...
export default IconMaterialAirlineSeatReclineNormalOutlinedFilled;
