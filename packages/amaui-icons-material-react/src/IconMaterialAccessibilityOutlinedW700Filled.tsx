...
const IconMaterialAccessibilityOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AccessibilityOutlinedW700Filled'
...
export default IconMaterialAccessibilityOutlinedW700Filled;
