...
const IconMaterialCloudySharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CloudySharpW100'
      short_name='Cloudy'
...
IconMaterialCloudySharpW100.displayName = 'AmauiIconMaterialCloudySharpW100';

export default IconMaterialCloudySharpW100;
