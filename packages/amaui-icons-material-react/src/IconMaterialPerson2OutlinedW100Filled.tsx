...
const IconMaterialPerson2OutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Person2OutlinedW100Filled'
      short_name='Person2'
...
export default IconMaterialPerson2OutlinedW100Filled;
