...
const IconMaterialStopCircleSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='StopCircleSharpW700Filled'
...
export default IconMaterialStopCircleSharpW700Filled;
