...
const IconMaterialRoundedCornerOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RoundedCornerOutlinedFilled'
...
export default IconMaterialRoundedCornerOutlinedFilled;
