...
const IconMaterialCameraEnhanceRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CameraEnhanceRoundedW700Filled'
...
export default IconMaterialCameraEnhanceRoundedW700Filled;
