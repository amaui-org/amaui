...
const IconMaterialCountertopsOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CountertopsOutlinedFilled'
...
export default IconMaterialCountertopsOutlinedFilled;
