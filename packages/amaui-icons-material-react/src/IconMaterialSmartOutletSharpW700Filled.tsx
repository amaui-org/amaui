...
const IconMaterialSmartOutletSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SmartOutletSharpW700Filled'
...
export default IconMaterialSmartOutletSharpW700Filled;
