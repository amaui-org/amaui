...
const IconMaterialSendToMobileOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SendToMobileOutlinedW100'
...
export default IconMaterialSendToMobileOutlinedW100;
