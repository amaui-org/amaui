...
const IconMaterialSpokeTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialSpokeTwoTone.displayName = 'AmauiIconMaterialSpokeTwoTone';

export default IconMaterialSpokeTwoTone;
