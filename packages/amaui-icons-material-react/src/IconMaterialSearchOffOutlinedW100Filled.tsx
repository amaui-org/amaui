...
const IconMaterialSearchOffOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SearchOffOutlinedW100Filled'
...
export default IconMaterialSearchOffOutlinedW100Filled;
