...
const IconMaterialCategoryOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CategoryOutlinedW100Filled'
      short_name='Category'
...
export default IconMaterialCategoryOutlinedW100Filled;
