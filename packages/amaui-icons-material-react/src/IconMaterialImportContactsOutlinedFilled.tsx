...
const IconMaterialImportContactsOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ImportContactsOutlinedFilled'
...
export default IconMaterialImportContactsOutlinedFilled;
