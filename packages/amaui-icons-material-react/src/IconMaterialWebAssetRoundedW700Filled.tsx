...
const IconMaterialWebAssetRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WebAssetRoundedW700Filled'
      short_name='WebAsset'
...
export default IconMaterialWebAssetRoundedW700Filled;
