...
const IconMaterialPanoramaHorizontalOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PanoramaHorizontalOutlinedW100Filled'
...
export default IconMaterialPanoramaHorizontalOutlinedW100Filled;
