...
const IconMaterialTrailLengthOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TrailLengthOutlinedW100'
...
export default IconMaterialTrailLengthOutlinedW100;
