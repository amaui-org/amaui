...
const IconMaterialRadiologySharp = React.forwardRef((props: any, ref) => {
...
IconMaterialRadiologySharp.displayName = 'AmauiIconMaterialRadiologySharp';

export default IconMaterialRadiologySharp;
