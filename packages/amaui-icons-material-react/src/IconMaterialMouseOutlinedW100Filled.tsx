...
const IconMaterialMouseOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MouseOutlinedW100Filled'
      short_name='Mouse'
...
export default IconMaterialMouseOutlinedW100Filled;
