...
const IconMaterialDigitalOutOfHomeOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DigitalOutOfHomeOutlinedFilled'
...
export default IconMaterialDigitalOutOfHomeOutlinedFilled;
