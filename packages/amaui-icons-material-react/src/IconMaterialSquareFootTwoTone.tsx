...
const IconMaterialSquareFootTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialSquareFootTwoTone.displayName = 'AmauiIconMaterialSquareFootTwoTone';

export default IconMaterialSquareFootTwoTone;
