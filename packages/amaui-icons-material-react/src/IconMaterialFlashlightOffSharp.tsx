...
const IconMaterialFlashlightOffSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialFlashlightOffSharp.displayName = 'AmauiIconMaterialFlashlightOffSharp';

export default IconMaterialFlashlightOffSharp;
