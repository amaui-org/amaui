...
const IconMaterialDoubleArrowRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialDoubleArrowRounded.displayName = 'AmauiIconMaterialDoubleArrowRounded';

export default IconMaterialDoubleArrowRounded;
