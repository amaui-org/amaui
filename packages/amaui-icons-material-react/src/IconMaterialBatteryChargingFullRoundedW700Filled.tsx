...
const IconMaterialBatteryChargingFullRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryChargingFullRoundedW700Filled'
...
export default IconMaterialBatteryChargingFullRoundedW700Filled;
