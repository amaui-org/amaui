...
const IconMaterialToolsLevelRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ToolsLevelRoundedW700Filled'
...
export default IconMaterialToolsLevelRoundedW700Filled;
