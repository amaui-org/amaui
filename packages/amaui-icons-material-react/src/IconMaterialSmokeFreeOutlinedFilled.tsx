...
const IconMaterialSmokeFreeOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SmokeFreeOutlinedFilled'
...
export default IconMaterialSmokeFreeOutlinedFilled;
