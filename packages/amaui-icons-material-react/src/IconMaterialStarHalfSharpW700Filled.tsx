...
const IconMaterialStarHalfSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='StarHalfSharpW700Filled'
      short_name='StarHalf'
...
export default IconMaterialStarHalfSharpW700Filled;
