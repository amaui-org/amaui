...
const IconMaterialDoneOutlineSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DoneOutlineSharpW700Filled'
...
export default IconMaterialDoneOutlineSharpW700Filled;
