...
const IconMaterialFlashOnRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FlashOnRoundedW700Filled'
      short_name='FlashOn'
...
export default IconMaterialFlashOnRoundedW700Filled;
