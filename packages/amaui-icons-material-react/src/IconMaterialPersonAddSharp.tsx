...
const IconMaterialPersonAddSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialPersonAddSharp.displayName = 'AmauiIconMaterialPersonAddSharp';

export default IconMaterialPersonAddSharp;
