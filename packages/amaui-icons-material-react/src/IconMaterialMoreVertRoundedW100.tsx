...
const IconMaterialMoreVertRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MoreVertRoundedW100'
      short_name='MoreVert'
...
IconMaterialMoreVertRoundedW100.displayName = 'AmauiIconMaterialMoreVertRoundedW100';

export default IconMaterialMoreVertRoundedW100;
