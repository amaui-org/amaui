...
const IconMaterialToolsPowerDrillOutlined = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ToolsPowerDrillOutlined'
...
export default IconMaterialToolsPowerDrillOutlined;
