...
const IconMaterialSceneTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialSceneTwoTone.displayName = 'AmauiIconMaterialSceneTwoTone';

export default IconMaterialSceneTwoTone;
