...
const IconMaterialBugReportOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BugReportOutlinedW100Filled'
...
export default IconMaterialBugReportOutlinedW100Filled;
