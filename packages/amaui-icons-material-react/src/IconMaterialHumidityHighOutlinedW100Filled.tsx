...
const IconMaterialHumidityHighOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HumidityHighOutlinedW100Filled'
...
export default IconMaterialHumidityHighOutlinedW100Filled;
