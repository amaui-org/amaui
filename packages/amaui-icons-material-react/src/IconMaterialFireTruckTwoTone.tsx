...
const IconMaterialFireTruckTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialFireTruckTwoTone.displayName = 'AmauiIconMaterialFireTruckTwoTone';

export default IconMaterialFireTruckTwoTone;
