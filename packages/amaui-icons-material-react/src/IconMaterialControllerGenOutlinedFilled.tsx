...
const IconMaterialControllerGenOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ControllerGenOutlinedFilled'
...
export default IconMaterialControllerGenOutlinedFilled;
