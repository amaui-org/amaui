...
const IconMaterialPhonelinkOffRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialPhonelinkOffRounded.displayName = 'AmauiIconMaterialPhonelinkOffRounded';

export default IconMaterialPhonelinkOffRounded;
