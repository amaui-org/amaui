...
const IconMaterialBatteryChargingFullOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryChargingFullOutlinedFilled'
...
export default IconMaterialBatteryChargingFullOutlinedFilled;
