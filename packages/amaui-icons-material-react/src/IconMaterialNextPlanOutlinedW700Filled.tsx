...
const IconMaterialNextPlanOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NextPlanOutlinedW700Filled'
      short_name='NextPlan'
...
export default IconMaterialNextPlanOutlinedW700Filled;
