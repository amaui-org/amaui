...
const IconMaterialDetectorBatteryRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DetectorBatteryRoundedW700Filled'
...
export default IconMaterialDetectorBatteryRoundedW700Filled;
