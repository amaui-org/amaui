...
const IconMaterialFormatClearOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FormatClearOutlinedW100Filled'
...
export default IconMaterialFormatClearOutlinedW100Filled;
