...
const IconMaterialHumidityMidOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HumidityMidOutlinedW100Filled'
...
export default IconMaterialHumidityMidOutlinedW100Filled;
