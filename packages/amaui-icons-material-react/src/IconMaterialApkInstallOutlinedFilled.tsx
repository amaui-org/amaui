...
const IconMaterialApkInstallOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ApkInstallOutlinedFilled'
...
export default IconMaterialApkInstallOutlinedFilled;
