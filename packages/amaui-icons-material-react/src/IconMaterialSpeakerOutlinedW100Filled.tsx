...
const IconMaterialSpeakerOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SpeakerOutlinedW100Filled'
      short_name='Speaker'
...
export default IconMaterialSpeakerOutlinedW100Filled;
