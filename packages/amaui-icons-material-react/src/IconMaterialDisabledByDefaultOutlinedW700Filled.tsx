...
const IconMaterialDisabledByDefaultOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DisabledByDefaultOutlinedW700Filled'
...
export default IconMaterialDisabledByDefaultOutlinedW700Filled;
