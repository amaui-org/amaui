...
const IconMaterialPieChartSharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PieChartSharpW100'
      short_name='PieChart'
...
IconMaterialPieChartSharpW100.displayName = 'AmauiIconMaterialPieChartSharpW100';

export default IconMaterialPieChartSharpW100;
