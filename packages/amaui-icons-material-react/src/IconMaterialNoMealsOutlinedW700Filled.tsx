...
const IconMaterialNoMealsOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NoMealsOutlinedW700Filled'
      short_name='NoMeals'
...
export default IconMaterialNoMealsOutlinedW700Filled;
