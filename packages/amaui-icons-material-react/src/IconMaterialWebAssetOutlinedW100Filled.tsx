...
const IconMaterialWebAssetOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WebAssetOutlinedW100Filled'
      short_name='WebAsset'
...
export default IconMaterialWebAssetOutlinedW100Filled;
