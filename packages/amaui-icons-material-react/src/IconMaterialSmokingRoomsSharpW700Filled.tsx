...
const IconMaterialSmokingRoomsSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SmokingRoomsSharpW700Filled'
...
export default IconMaterialSmokingRoomsSharpW700Filled;
