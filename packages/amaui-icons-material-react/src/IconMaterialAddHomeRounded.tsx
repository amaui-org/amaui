...
const IconMaterialAddHomeRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialAddHomeRounded.displayName = 'AmauiIconMaterialAddHomeRounded';

export default IconMaterialAddHomeRounded;
