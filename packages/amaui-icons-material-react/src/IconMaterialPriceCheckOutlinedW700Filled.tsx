...
const IconMaterialPriceCheckOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PriceCheckOutlinedW700Filled'
...
export default IconMaterialPriceCheckOutlinedW700Filled;
