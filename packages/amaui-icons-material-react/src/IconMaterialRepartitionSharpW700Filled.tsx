...
const IconMaterialRepartitionSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RepartitionSharpW700Filled'
...
export default IconMaterialRepartitionSharpW700Filled;
