...
const IconMaterialEditNoteSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='EditNoteSharpW700Filled'
      short_name='EditNote'
...
export default IconMaterialEditNoteSharpW700Filled;
