...
const IconMaterialLocalPoliceOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LocalPoliceOutlinedW100Filled'
...
export default IconMaterialLocalPoliceOutlinedW100Filled;
