...
const IconMaterialSendAndArchiveOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SendAndArchiveOutlinedW100Filled'
...
export default IconMaterialSendAndArchiveOutlinedW100Filled;
