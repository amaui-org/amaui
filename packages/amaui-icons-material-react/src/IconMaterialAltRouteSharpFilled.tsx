...
const IconMaterialAltRouteSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AltRouteSharpFilled'
      short_name='AltRoute'
...
IconMaterialAltRouteSharpFilled.displayName = 'AmauiIconMaterialAltRouteSharpFilled';

export default IconMaterialAltRouteSharpFilled;
