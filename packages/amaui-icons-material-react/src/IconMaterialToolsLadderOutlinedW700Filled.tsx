...
const IconMaterialToolsLadderOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ToolsLadderOutlinedW700Filled'
...
export default IconMaterialToolsLadderOutlinedW700Filled;
