...
const IconMaterialWrapTextSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WrapTextSharpW700Filled'
      short_name='WrapText'
...
export default IconMaterialWrapTextSharpW700Filled;
