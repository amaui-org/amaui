...
const IconMaterialMatterRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MatterRoundedW100'
      short_name='Matter'
...
IconMaterialMatterRoundedW100.displayName = 'AmauiIconMaterialMatterRoundedW100';

export default IconMaterialMatterRoundedW100;
