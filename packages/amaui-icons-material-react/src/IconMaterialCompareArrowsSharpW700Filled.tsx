...
const IconMaterialCompareArrowsSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CompareArrowsSharpW700Filled'
...
export default IconMaterialCompareArrowsSharpW700Filled;
