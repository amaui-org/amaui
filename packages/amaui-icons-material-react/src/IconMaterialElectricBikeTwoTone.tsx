...
const IconMaterialElectricBikeTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialElectricBikeTwoTone.displayName = 'AmauiIconMaterialElectricBikeTwoTone';

export default IconMaterialElectricBikeTwoTone;
