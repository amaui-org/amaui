...
const IconMaterialApiTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialApiTwoTone.displayName = 'AmauiIconMaterialApiTwoTone';

export default IconMaterialApiTwoTone;
