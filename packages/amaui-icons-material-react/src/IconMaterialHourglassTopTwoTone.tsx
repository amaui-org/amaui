...
const IconMaterialHourglassTopTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialHourglassTopTwoTone.displayName = 'AmauiIconMaterialHourglassTopTwoTone';

export default IconMaterialHourglassTopTwoTone;
