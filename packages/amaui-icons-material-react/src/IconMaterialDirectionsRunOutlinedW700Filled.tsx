...
const IconMaterialDirectionsRunOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DirectionsRunOutlinedW700Filled'
...
export default IconMaterialDirectionsRunOutlinedW700Filled;
