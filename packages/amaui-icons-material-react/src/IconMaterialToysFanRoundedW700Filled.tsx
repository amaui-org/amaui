...
const IconMaterialToysFanRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ToysFanRoundedW700Filled'
      short_name='ToysFan'
...
export default IconMaterialToysFanRoundedW700Filled;
