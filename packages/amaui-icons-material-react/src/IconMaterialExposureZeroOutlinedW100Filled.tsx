...
const IconMaterialExposureZeroOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ExposureZeroOutlinedW100Filled'
...
export default IconMaterialExposureZeroOutlinedW100Filled;
