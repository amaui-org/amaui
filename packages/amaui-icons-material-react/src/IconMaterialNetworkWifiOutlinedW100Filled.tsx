...
const IconMaterialNetworkWifiOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NetworkWifiOutlinedW100Filled'
...
export default IconMaterialNetworkWifiOutlinedW100Filled;
