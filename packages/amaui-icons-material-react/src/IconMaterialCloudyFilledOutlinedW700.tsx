...
const IconMaterialCloudyFilledOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CloudyFilledOutlinedW700'
...
export default IconMaterialCloudyFilledOutlinedW700;
