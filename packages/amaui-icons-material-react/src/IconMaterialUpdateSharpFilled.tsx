...
const IconMaterialUpdateSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='UpdateSharpFilled'
      short_name='Update'
...
IconMaterialUpdateSharpFilled.displayName = 'AmauiIconMaterialUpdateSharpFilled';

export default IconMaterialUpdateSharpFilled;
