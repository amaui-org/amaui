...
const IconMaterialListAltTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialListAltTwoTone.displayName = 'AmauiIconMaterialListAltTwoTone';

export default IconMaterialListAltTwoTone;
