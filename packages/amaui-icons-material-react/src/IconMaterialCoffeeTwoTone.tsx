...
const IconMaterialCoffeeTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialCoffeeTwoTone.displayName = 'AmauiIconMaterialCoffeeTwoTone';

export default IconMaterialCoffeeTwoTone;
