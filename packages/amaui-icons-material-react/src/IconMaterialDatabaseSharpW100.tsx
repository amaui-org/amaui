...
const IconMaterialDatabaseSharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DatabaseSharpW100'
      short_name='Database'
...
IconMaterialDatabaseSharpW100.displayName = 'AmauiIconMaterialDatabaseSharpW100';

export default IconMaterialDatabaseSharpW100;
