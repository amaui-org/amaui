...
const IconMaterialRepartitionOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RepartitionOutlinedFilled'
...
export default IconMaterialRepartitionOutlinedFilled;
