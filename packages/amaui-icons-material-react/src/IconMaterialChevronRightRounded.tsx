...
const IconMaterialChevronRightRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialChevronRightRounded.displayName = 'AmauiIconMaterialChevronRightRounded';

export default IconMaterialChevronRightRounded;
