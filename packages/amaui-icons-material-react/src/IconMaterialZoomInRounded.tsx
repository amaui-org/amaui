...
const IconMaterialZoomInRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialZoomInRounded.displayName = 'AmauiIconMaterialZoomInRounded';

export default IconMaterialZoomInRounded;
