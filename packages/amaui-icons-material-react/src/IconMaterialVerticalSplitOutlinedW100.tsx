...
const IconMaterialVerticalSplitOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='VerticalSplitOutlinedW100'
...
export default IconMaterialVerticalSplitOutlinedW100;
