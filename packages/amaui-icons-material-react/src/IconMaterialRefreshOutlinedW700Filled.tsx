...
const IconMaterialRefreshOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RefreshOutlinedW700Filled'
      short_name='Refresh'
...
export default IconMaterialRefreshOutlinedW700Filled;
