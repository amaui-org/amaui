...
const IconMaterialTranscribeSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TranscribeSharpW700Filled'
...
export default IconMaterialTranscribeSharpW700Filled;
