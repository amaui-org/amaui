...
const IconMaterialHistoryOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HistoryOutlinedW700Filled'
      short_name='History'
...
export default IconMaterialHistoryOutlinedW700Filled;
