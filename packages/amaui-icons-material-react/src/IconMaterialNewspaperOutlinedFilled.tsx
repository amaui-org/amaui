...
const IconMaterialNewspaperOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NewspaperOutlinedFilled'
...
export default IconMaterialNewspaperOutlinedFilled;
