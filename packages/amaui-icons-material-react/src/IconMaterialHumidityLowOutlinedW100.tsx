...
const IconMaterialHumidityLowOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HumidityLowOutlinedW100'
...
export default IconMaterialHumidityLowOutlinedW100;
