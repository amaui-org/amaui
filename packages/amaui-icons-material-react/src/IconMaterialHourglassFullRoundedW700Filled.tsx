...
const IconMaterialHourglassFullRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HourglassFullRoundedW700Filled'
...
export default IconMaterialHourglassFullRoundedW700Filled;
