...
const IconMaterialDevicesFoldOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DevicesFoldOutlinedFilled'
...
export default IconMaterialDevicesFoldOutlinedFilled;
