...
const IconMaterialPartyModeOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PartyModeOutlinedW100Filled'
...
export default IconMaterialPartyModeOutlinedW100Filled;
