...
const IconMaterialFlightTakeoffOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FlightTakeoffOutlinedW100Filled'
...
export default IconMaterialFlightTakeoffOutlinedW100Filled;
