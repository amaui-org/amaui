...
const IconMaterialLowPriorityOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LowPriorityOutlinedW700'
...
export default IconMaterialLowPriorityOutlinedW700;
