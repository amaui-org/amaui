...
const IconMaterialEditLocationTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialEditLocationTwoTone.displayName = 'AmauiIconMaterialEditLocationTwoTone';

export default IconMaterialEditLocationTwoTone;
