...
const IconMaterialSubscriptOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SubscriptOutlinedW700Filled'
...
export default IconMaterialSubscriptOutlinedW700Filled;
