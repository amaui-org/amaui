...
const IconMaterialWatchOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WatchOutlinedW700Filled'
      short_name='Watch'
...
export default IconMaterialWatchOutlinedW700Filled;
