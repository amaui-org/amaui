...
const IconMaterialMoreVertRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MoreVertRoundedW700Filled'
      short_name='MoreVert'
...
export default IconMaterialMoreVertRoundedW700Filled;
