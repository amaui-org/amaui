...
const IconMaterialSecuritySharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SecuritySharpW100'
      short_name='Security'
...
IconMaterialSecuritySharpW100.displayName = 'AmauiIconMaterialSecuritySharpW100';

export default IconMaterialSecuritySharpW100;
