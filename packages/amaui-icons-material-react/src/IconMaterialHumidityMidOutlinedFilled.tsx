...
const IconMaterialHumidityMidOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HumidityMidOutlinedFilled'
...
export default IconMaterialHumidityMidOutlinedFilled;
