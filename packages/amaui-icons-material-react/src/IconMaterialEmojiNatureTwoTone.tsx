...
const IconMaterialEmojiNatureTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialEmojiNatureTwoTone.displayName = 'AmauiIconMaterialEmojiNatureTwoTone';

export default IconMaterialEmojiNatureTwoTone;
