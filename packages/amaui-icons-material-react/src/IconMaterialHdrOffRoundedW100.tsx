...
const IconMaterialHdrOffRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HdrOffRoundedW100'
      short_name='HdrOff'
...
IconMaterialHdrOffRoundedW100.displayName = 'AmauiIconMaterialHdrOffRoundedW100';

export default IconMaterialHdrOffRoundedW100;
