...
const IconMaterialFlightTakeoffSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialFlightTakeoffSharp.displayName = 'AmauiIconMaterialFlightTakeoffSharp';

export default IconMaterialFlightTakeoffSharp;
