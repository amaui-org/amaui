...
const IconMaterialFindReplaceOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FindReplaceOutlinedW100Filled'
...
export default IconMaterialFindReplaceOutlinedW100Filled;
