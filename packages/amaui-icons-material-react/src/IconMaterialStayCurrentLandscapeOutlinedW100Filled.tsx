...
const IconMaterialStayCurrentLandscapeOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='StayCurrentLandscapeOutlinedW100Filled'
...
export default IconMaterialStayCurrentLandscapeOutlinedW100Filled;
