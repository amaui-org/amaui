...
const IconMaterialAssignmentTurnedInSharpW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AssignmentTurnedInSharpW700'
...
export default IconMaterialAssignmentTurnedInSharpW700;
