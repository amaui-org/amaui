...
const IconMaterialUpdateOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='UpdateOutlinedW700Filled'
      short_name='Update'
...
export default IconMaterialUpdateOutlinedW700Filled;
