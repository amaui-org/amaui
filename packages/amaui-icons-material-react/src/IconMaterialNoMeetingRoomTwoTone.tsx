...
const IconMaterialNoMeetingRoomTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialNoMeetingRoomTwoTone.displayName = 'AmauiIconMaterialNoMeetingRoomTwoTone';

export default IconMaterialNoMeetingRoomTwoTone;
