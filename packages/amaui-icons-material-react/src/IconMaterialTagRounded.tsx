...
const IconMaterialTagRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialTagRounded.displayName = 'AmauiIconMaterialTagRounded';

export default IconMaterialTagRounded;
