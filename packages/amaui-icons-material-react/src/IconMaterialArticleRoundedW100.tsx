...
const IconMaterialArticleRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ArticleRoundedW100'
      short_name='Article'
...
IconMaterialArticleRoundedW100.displayName = 'AmauiIconMaterialArticleRoundedW100';

export default IconMaterialArticleRoundedW100;
