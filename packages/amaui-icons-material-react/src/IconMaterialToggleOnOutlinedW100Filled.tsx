...
const IconMaterialToggleOnOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ToggleOnOutlinedW100Filled'
      short_name='ToggleOn'
...
export default IconMaterialToggleOnOutlinedW100Filled;
