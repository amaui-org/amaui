...
const IconMaterialAstrophotographyAutoOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AstrophotographyAutoOutlinedFilled'
...
export default IconMaterialAstrophotographyAutoOutlinedFilled;
