...
const IconMaterialVideoLabelOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='VideoLabelOutlinedFilled'
...
export default IconMaterialVideoLabelOutlinedFilled;
