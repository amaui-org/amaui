...
const IconMaterialNetworkWifiSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialNetworkWifiSharp.displayName = 'AmauiIconMaterialNetworkWifiSharp';

export default IconMaterialNetworkWifiSharp;
