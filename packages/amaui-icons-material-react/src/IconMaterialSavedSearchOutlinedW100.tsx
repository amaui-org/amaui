...
const IconMaterialSavedSearchOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SavedSearchOutlinedW100'
...
export default IconMaterialSavedSearchOutlinedW100;
