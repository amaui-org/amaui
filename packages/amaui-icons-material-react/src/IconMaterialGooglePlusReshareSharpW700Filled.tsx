...
const IconMaterialGooglePlusReshareSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='GooglePlusReshareSharpW700Filled'
...
export default IconMaterialGooglePlusReshareSharpW700Filled;
