...
const IconMaterialAddModeratorOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AddModeratorOutlinedFilled'
...
export default IconMaterialAddModeratorOutlinedFilled;
