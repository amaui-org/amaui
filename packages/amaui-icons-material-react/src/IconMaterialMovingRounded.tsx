...
const IconMaterialMovingRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialMovingRounded.displayName = 'AmauiIconMaterialMovingRounded';

export default IconMaterialMovingRounded;
