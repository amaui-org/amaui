...
const IconMaterialHdrOnOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HdrOnOutlinedW700Filled'
      short_name='HdrOn'
...
export default IconMaterialHdrOnOutlinedW700Filled;
