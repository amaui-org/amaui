...
const IconMaterialSkullRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SkullRoundedW100'
      short_name='Skull'
...
IconMaterialSkullRoundedW100.displayName = 'AmauiIconMaterialSkullRoundedW100';

export default IconMaterialSkullRoundedW100;
