...
const IconMaterialChildCareTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialChildCareTwoTone.displayName = 'AmauiIconMaterialChildCareTwoTone';

export default IconMaterialChildCareTwoTone;
