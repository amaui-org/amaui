...
const IconMaterialNestEcoLeafOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestEcoLeafOutlinedFilled'
...
export default IconMaterialNestEcoLeafOutlinedFilled;
