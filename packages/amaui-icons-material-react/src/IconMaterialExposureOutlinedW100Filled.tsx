...
const IconMaterialExposureOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ExposureOutlinedW100Filled'
      short_name='Exposure'
...
export default IconMaterialExposureOutlinedW100Filled;
