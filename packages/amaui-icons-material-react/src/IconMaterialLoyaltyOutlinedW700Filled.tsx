...
const IconMaterialLoyaltyOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LoyaltyOutlinedW700Filled'
      short_name='Loyalty'
...
export default IconMaterialLoyaltyOutlinedW700Filled;
