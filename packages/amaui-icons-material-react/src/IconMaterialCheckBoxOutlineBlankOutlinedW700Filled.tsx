...
const IconMaterialCheckBoxOutlineBlankOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CheckBoxOutlineBlankOutlinedW700Filled'
...
export default IconMaterialCheckBoxOutlineBlankOutlinedW700Filled;
