...
const IconMaterialSpeakerTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialSpeakerTwoTone.displayName = 'AmauiIconMaterialSpeakerTwoTone';

export default IconMaterialSpeakerTwoTone;
