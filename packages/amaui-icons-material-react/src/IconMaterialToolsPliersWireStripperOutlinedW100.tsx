...
const IconMaterialToolsPliersWireStripperOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ToolsPliersWireStripperOutlinedW100'
...
export default IconMaterialToolsPliersWireStripperOutlinedW100;
