...
const IconMaterialVideocamTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialVideocamTwoTone.displayName = 'AmauiIconMaterialVideocamTwoTone';

export default IconMaterialVideocamTwoTone;
