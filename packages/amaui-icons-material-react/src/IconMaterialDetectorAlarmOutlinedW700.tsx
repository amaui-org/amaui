...
const IconMaterialDetectorAlarmOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DetectorAlarmOutlinedW700'
...
export default IconMaterialDetectorAlarmOutlinedW700;
