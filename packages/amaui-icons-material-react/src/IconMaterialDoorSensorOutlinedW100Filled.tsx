...
const IconMaterialDoorSensorOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DoorSensorOutlinedW100Filled'
...
export default IconMaterialDoorSensorOutlinedW100Filled;
