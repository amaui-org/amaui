...
const IconMaterialBrowseGalleryOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BrowseGalleryOutlinedW100'
...
export default IconMaterialBrowseGalleryOutlinedW100;
