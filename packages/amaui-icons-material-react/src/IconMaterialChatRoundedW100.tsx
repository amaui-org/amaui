...
const IconMaterialChatRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ChatRoundedW100'
      short_name='Chat'
...
IconMaterialChatRoundedW100.displayName = 'AmauiIconMaterialChatRoundedW100';

export default IconMaterialChatRoundedW100;
