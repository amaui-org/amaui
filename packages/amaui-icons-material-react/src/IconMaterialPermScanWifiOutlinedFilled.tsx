...
const IconMaterialPermScanWifiOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PermScanWifiOutlinedFilled'
...
export default IconMaterialPermScanWifiOutlinedFilled;
