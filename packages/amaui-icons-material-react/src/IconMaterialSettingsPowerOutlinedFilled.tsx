...
const IconMaterialSettingsPowerOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SettingsPowerOutlinedFilled'
...
export default IconMaterialSettingsPowerOutlinedFilled;
