...
const IconMaterialCloudDoneOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CloudDoneOutlinedFilled'
...
export default IconMaterialCloudDoneOutlinedFilled;
