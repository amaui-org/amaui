...
const IconMaterialNatureTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialNatureTwoTone.displayName = 'AmauiIconMaterialNatureTwoTone';

export default IconMaterialNatureTwoTone;
