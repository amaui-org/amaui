...
const IconMaterialGardenCartRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='GardenCartRoundedW700Filled'
...
export default IconMaterialGardenCartRoundedW700Filled;
