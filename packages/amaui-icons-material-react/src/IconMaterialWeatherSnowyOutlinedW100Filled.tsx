...
const IconMaterialWeatherSnowyOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WeatherSnowyOutlinedW100Filled'
...
export default IconMaterialWeatherSnowyOutlinedW100Filled;
