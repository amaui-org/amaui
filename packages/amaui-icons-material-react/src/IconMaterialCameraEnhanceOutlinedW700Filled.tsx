...
const IconMaterialCameraEnhanceOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CameraEnhanceOutlinedW700Filled'
...
export default IconMaterialCameraEnhanceOutlinedW700Filled;
