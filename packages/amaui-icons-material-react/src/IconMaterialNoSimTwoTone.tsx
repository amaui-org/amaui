...
const IconMaterialNoSimTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialNoSimTwoTone.displayName = 'AmauiIconMaterialNoSimTwoTone';

export default IconMaterialNoSimTwoTone;
