...
const IconMaterialFileDownloadDoneRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FileDownloadDoneRoundedW700Filled'
...
export default IconMaterialFileDownloadDoneRoundedW700Filled;
