...
const IconMaterialRailwayAlertOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RailwayAlertOutlinedFilled'
...
export default IconMaterialRailwayAlertOutlinedFilled;
