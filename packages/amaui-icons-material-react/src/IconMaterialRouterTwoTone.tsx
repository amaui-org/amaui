...
const IconMaterialRouterTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialRouterTwoTone.displayName = 'AmauiIconMaterialRouterTwoTone';

export default IconMaterialRouterTwoTone;
