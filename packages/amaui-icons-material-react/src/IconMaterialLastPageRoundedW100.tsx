...
const IconMaterialLastPageRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LastPageRoundedW100'
      short_name='LastPage'
...
IconMaterialLastPageRoundedW100.displayName = 'AmauiIconMaterialLastPageRoundedW100';

export default IconMaterialLastPageRoundedW100;
