...
const IconMaterialBatteryLowOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryLowOutlinedW100Filled'
...
export default IconMaterialBatteryLowOutlinedW100Filled;
