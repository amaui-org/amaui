...
const IconMaterial1kPlusTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterial1kPlusTwoTone.displayName = 'AmauiIconMaterial1kPlusTwoTone';

export default IconMaterial1kPlusTwoTone;
