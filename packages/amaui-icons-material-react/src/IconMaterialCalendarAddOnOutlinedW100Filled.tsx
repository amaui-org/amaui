...
const IconMaterialCalendarAddOnOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CalendarAddOnOutlinedW100Filled'
...
export default IconMaterialCalendarAddOnOutlinedW100Filled;
