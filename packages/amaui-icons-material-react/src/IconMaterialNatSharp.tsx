...
const IconMaterialNatSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialNatSharp.displayName = 'AmauiIconMaterialNatSharp';

export default IconMaterialNatSharp;
