...
const IconMaterialBorderInnerOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BorderInnerOutlinedW100'
...
export default IconMaterialBorderInnerOutlinedW100;
