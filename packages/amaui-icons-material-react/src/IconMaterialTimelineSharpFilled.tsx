...
const IconMaterialTimelineSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TimelineSharpFilled'
      short_name='Timeline'
...
IconMaterialTimelineSharpFilled.displayName = 'AmauiIconMaterialTimelineSharpFilled';

export default IconMaterialTimelineSharpFilled;
