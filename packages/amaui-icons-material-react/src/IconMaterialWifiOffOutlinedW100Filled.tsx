...
const IconMaterialWifiOffOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WifiOffOutlinedW100Filled'
      short_name='WifiOff'
...
export default IconMaterialWifiOffOutlinedW100Filled;
