...
const IconMaterialCommunicationRoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CommunicationRoundedW700'
...
export default IconMaterialCommunicationRoundedW700;
