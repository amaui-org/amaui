...
const IconMaterialFormatColorFillOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FormatColorFillOutlinedW700'
...
export default IconMaterialFormatColorFillOutlinedW700;
