...
const IconMaterialMusicOffTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialMusicOffTwoTone.displayName = 'AmauiIconMaterialMusicOffTwoTone';

export default IconMaterialMusicOffTwoTone;
