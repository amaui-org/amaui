...
const IconMaterialAutoActivityZoneOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AutoActivityZoneOutlinedFilled'
...
export default IconMaterialAutoActivityZoneOutlinedFilled;
