...
const IconMaterialCloudyFilledRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CloudyFilledRoundedW700Filled'
...
export default IconMaterialCloudyFilledRoundedW700Filled;
