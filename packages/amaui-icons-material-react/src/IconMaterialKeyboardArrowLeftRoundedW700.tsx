...
const IconMaterialKeyboardArrowLeftRoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='KeyboardArrowLeftRoundedW700'
...
export default IconMaterialKeyboardArrowLeftRoundedW700;
