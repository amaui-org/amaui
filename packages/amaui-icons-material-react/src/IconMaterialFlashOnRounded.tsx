...
const IconMaterialFlashOnRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialFlashOnRounded.displayName = 'AmauiIconMaterialFlashOnRounded';

export default IconMaterialFlashOnRounded;
