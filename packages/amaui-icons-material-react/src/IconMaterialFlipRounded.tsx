...
const IconMaterialFlipRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialFlipRounded.displayName = 'AmauiIconMaterialFlipRounded';

export default IconMaterialFlipRounded;
