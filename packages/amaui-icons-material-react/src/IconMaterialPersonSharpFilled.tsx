...
const IconMaterialPersonSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PersonSharpFilled'
      short_name='Person'
...
IconMaterialPersonSharpFilled.displayName = 'AmauiIconMaterialPersonSharpFilled';

export default IconMaterialPersonSharpFilled;
