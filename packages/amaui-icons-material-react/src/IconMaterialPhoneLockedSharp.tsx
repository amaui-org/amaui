...
const IconMaterialPhoneLockedSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialPhoneLockedSharp.displayName = 'AmauiIconMaterialPhoneLockedSharp';

export default IconMaterialPhoneLockedSharp;
