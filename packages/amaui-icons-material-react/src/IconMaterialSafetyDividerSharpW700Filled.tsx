...
const IconMaterialSafetyDividerSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SafetyDividerSharpW700Filled'
...
export default IconMaterialSafetyDividerSharpW700Filled;
