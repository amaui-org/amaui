...
const IconMaterialBatteryCharging20OutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryCharging20OutlinedW700Filled'
...
export default IconMaterialBatteryCharging20OutlinedW700Filled;
