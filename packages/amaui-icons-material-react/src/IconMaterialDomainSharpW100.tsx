...
const IconMaterialDomainSharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DomainSharpW100'
      short_name='Domain'
...
IconMaterialDomainSharpW100.displayName = 'AmauiIconMaterialDomainSharpW100';

export default IconMaterialDomainSharpW100;
