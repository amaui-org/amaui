...
const IconMaterialBlurMediumOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BlurMediumOutlinedFilled'
...
export default IconMaterialBlurMediumOutlinedFilled;
