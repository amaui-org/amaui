...
const IconMaterialSentimentVerySatisfiedOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SentimentVerySatisfiedOutlinedW100Filled'
...
export default IconMaterialSentimentVerySatisfiedOutlinedW100Filled;
