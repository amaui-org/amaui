...
const IconMaterialThumbUpTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialThumbUpTwoTone.displayName = 'AmauiIconMaterialThumbUpTwoTone';

export default IconMaterialThumbUpTwoTone;
