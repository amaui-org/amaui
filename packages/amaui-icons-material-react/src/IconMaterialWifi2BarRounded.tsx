...
const IconMaterialWifi2BarRounded = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Wifi2BarRounded'
      short_name='Wifi2Bar'
...
IconMaterialWifi2BarRounded.displayName = 'AmauiIconMaterialWifi2BarRounded';

export default IconMaterialWifi2BarRounded;
