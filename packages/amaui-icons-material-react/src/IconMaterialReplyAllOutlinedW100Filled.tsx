...
const IconMaterialReplyAllOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ReplyAllOutlinedW100Filled'
      short_name='ReplyAll'
...
export default IconMaterialReplyAllOutlinedW100Filled;
