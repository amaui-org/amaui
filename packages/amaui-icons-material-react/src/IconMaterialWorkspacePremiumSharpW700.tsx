...
const IconMaterialWorkspacePremiumSharpW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WorkspacePremiumSharpW700'
...
export default IconMaterialWorkspacePremiumSharpW700;
