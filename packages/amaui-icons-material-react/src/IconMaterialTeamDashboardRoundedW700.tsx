...
const IconMaterialTeamDashboardRoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TeamDashboardRoundedW700'
...
export default IconMaterialTeamDashboardRoundedW700;
