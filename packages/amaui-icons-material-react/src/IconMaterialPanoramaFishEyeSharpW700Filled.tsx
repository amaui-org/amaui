...
const IconMaterialPanoramaFishEyeSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PanoramaFishEyeSharpW700Filled'
...
export default IconMaterialPanoramaFishEyeSharpW700Filled;
