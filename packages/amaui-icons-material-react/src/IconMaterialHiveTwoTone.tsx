...
const IconMaterialHiveTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialHiveTwoTone.displayName = 'AmauiIconMaterialHiveTwoTone';

export default IconMaterialHiveTwoTone;
