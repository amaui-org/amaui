...
const IconMaterialUlnaRadiusOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='UlnaRadiusOutlinedFilled'
...
export default IconMaterialUlnaRadiusOutlinedFilled;
