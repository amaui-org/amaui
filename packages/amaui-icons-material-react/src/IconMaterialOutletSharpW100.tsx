...
const IconMaterialOutletSharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='OutletSharpW100'
      short_name='Outlet'
...
IconMaterialOutletSharpW100.displayName = 'AmauiIconMaterialOutletSharpW100';

export default IconMaterialOutletSharpW100;
