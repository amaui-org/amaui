...
const IconMaterialCookingRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialCookingRounded.displayName = 'AmauiIconMaterialCookingRounded';

export default IconMaterialCookingRounded;
