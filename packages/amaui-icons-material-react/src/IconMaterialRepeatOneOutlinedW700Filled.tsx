...
const IconMaterialRepeatOneOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RepeatOneOutlinedW700Filled'
...
export default IconMaterialRepeatOneOutlinedW700Filled;
