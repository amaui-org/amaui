...
const IconMaterialSevereColdOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SevereColdOutlinedFilled'
...
export default IconMaterialSevereColdOutlinedFilled;
