...
const IconMaterialFilterFramesTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialFilterFramesTwoTone.displayName = 'AmauiIconMaterialFilterFramesTwoTone';

export default IconMaterialFilterFramesTwoTone;
