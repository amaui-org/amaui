...
const IconMaterialPanoramaVerticalOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PanoramaVerticalOutlinedW100Filled'
...
export default IconMaterialPanoramaVerticalOutlinedW100Filled;
