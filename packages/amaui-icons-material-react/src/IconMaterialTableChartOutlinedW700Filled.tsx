...
const IconMaterialTableChartOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TableChartOutlinedW700Filled'
...
export default IconMaterialTableChartOutlinedW700Filled;
