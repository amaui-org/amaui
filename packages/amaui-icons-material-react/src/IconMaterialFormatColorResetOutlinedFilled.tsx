...
const IconMaterialFormatColorResetOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FormatColorResetOutlinedFilled'
...
export default IconMaterialFormatColorResetOutlinedFilled;
