...
const IconMaterialMoreHorizOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MoreHorizOutlinedFilled'
...
export default IconMaterialMoreHorizOutlinedFilled;
