...
const IconMaterialChecklistOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ChecklistOutlinedFilled'
...
export default IconMaterialChecklistOutlinedFilled;
