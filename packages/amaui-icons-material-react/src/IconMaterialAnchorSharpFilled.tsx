...
const IconMaterialAnchorSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AnchorSharpFilled'
      short_name='Anchor'
...
IconMaterialAnchorSharpFilled.displayName = 'AmauiIconMaterialAnchorSharpFilled';

export default IconMaterialAnchorSharpFilled;
