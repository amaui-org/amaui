...
const IconMaterialWebAssetOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WebAssetOutlinedW700Filled'
      short_name='WebAsset'
...
export default IconMaterialWebAssetOutlinedW700Filled;
