...
const IconMaterialBlindSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BlindSharpFilled'
      short_name='Blind'
...
IconMaterialBlindSharpFilled.displayName = 'AmauiIconMaterialBlindSharpFilled';

export default IconMaterialBlindSharpFilled;
