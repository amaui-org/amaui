...
const IconMaterialChevronLeftRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ChevronLeftRoundedW700Filled'
...
export default IconMaterialChevronLeftRoundedW700Filled;
