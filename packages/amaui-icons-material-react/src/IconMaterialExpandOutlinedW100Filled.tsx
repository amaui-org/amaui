...
const IconMaterialExpandOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ExpandOutlinedW100Filled'
      short_name='Expand'
...
export default IconMaterialExpandOutlinedW100Filled;
