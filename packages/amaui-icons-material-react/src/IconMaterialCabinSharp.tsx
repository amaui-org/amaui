...
const IconMaterialCabinSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialCabinSharp.displayName = 'AmauiIconMaterialCabinSharp';

export default IconMaterialCabinSharp;
