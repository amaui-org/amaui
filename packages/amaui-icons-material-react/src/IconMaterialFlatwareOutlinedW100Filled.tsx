...
const IconMaterialFlatwareOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FlatwareOutlinedW100Filled'
      short_name='Flatware'
...
export default IconMaterialFlatwareOutlinedW100Filled;
