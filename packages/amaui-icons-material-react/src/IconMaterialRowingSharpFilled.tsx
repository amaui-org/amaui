...
const IconMaterialRowingSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RowingSharpFilled'
      short_name='Rowing'
...
IconMaterialRowingSharpFilled.displayName = 'AmauiIconMaterialRowingSharpFilled';

export default IconMaterialRowingSharpFilled;
