...
const IconMaterialIncompleteCircleOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='IncompleteCircleOutlinedW700Filled'
...
export default IconMaterialIncompleteCircleOutlinedW700Filled;
