...
const IconMaterialNoFlashTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialNoFlashTwoTone.displayName = 'AmauiIconMaterialNoFlashTwoTone';

export default IconMaterialNoFlashTwoTone;
