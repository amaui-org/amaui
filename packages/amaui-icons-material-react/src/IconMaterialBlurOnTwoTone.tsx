...
const IconMaterialBlurOnTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialBlurOnTwoTone.displayName = 'AmauiIconMaterialBlurOnTwoTone';

export default IconMaterialBlurOnTwoTone;
