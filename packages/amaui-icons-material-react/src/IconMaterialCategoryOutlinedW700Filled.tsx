...
const IconMaterialCategoryOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CategoryOutlinedW700Filled'
      short_name='Category'
...
export default IconMaterialCategoryOutlinedW700Filled;
