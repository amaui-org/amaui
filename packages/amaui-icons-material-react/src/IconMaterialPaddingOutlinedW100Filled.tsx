...
const IconMaterialPaddingOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PaddingOutlinedW100Filled'
      short_name='Padding'
...
export default IconMaterialPaddingOutlinedW100Filled;
