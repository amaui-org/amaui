...
const IconMaterialTonalitySharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TonalitySharpFilled'
      short_name='Tonality'
...
IconMaterialTonalitySharpFilled.displayName = 'AmauiIconMaterialTonalitySharpFilled';

export default IconMaterialTonalitySharpFilled;
