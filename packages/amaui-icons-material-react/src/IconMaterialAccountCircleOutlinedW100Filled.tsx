...
const IconMaterialAccountCircleOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AccountCircleOutlinedW100Filled'
...
export default IconMaterialAccountCircleOutlinedW100Filled;
