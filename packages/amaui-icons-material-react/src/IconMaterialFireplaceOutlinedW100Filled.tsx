...
const IconMaterialFireplaceOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FireplaceOutlinedW100Filled'
...
export default IconMaterialFireplaceOutlinedW100Filled;
