...
const IconMaterialStayCurrentPortraitOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='StayCurrentPortraitOutlinedFilled'
...
export default IconMaterialStayCurrentPortraitOutlinedFilled;
