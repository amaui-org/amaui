...
const IconMaterialBrightnessMediumOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BrightnessMediumOutlinedW700Filled'
...
export default IconMaterialBrightnessMediumOutlinedW700Filled;
