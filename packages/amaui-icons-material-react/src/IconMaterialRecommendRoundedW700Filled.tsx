...
const IconMaterialRecommendRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RecommendRoundedW700Filled'
...
export default IconMaterialRecommendRoundedW700Filled;
