...
const IconMaterialPublicOffOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PublicOffOutlinedFilled'
...
export default IconMaterialPublicOffOutlinedFilled;
