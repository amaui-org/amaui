...
const IconMaterialMotionSensorIdleOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MotionSensorIdleOutlinedW100'
...
export default IconMaterialMotionSensorIdleOutlinedW100;
