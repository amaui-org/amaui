...
const IconMaterialDraftRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DraftRoundedW100'
      short_name='Draft'
...
IconMaterialDraftRoundedW100.displayName = 'AmauiIconMaterialDraftRoundedW100';

export default IconMaterialDraftRoundedW100;
