...
const IconMaterialBorderTopOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BorderTopOutlinedFilled'
...
export default IconMaterialBorderTopOutlinedFilled;
