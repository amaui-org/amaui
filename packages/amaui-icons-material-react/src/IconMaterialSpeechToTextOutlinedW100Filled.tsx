...
const IconMaterialSpeechToTextOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SpeechToTextOutlinedW100Filled'
...
export default IconMaterialSpeechToTextOutlinedW100Filled;
