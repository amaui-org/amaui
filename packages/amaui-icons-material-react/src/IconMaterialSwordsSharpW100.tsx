...
const IconMaterialSwordsSharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SwordsSharpW100'
      short_name='Swords'
...
IconMaterialSwordsSharpW100.displayName = 'AmauiIconMaterialSwordsSharpW100';

export default IconMaterialSwordsSharpW100;
