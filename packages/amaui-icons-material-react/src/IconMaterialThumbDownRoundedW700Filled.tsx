...
const IconMaterialThumbDownRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ThumbDownRoundedW700Filled'
...
export default IconMaterialThumbDownRoundedW700Filled;
