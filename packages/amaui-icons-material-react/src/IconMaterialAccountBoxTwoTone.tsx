...
const IconMaterialAccountBoxTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialAccountBoxTwoTone.displayName = 'AmauiIconMaterialAccountBoxTwoTone';

export default IconMaterialAccountBoxTwoTone;
