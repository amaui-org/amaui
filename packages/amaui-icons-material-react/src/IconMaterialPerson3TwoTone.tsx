...
const IconMaterialPerson3TwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialPerson3TwoTone.displayName = 'AmauiIconMaterialPerson3TwoTone';

export default IconMaterialPerson3TwoTone;
