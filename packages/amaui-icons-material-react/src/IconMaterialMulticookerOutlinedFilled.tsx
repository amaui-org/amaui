...
const IconMaterialMulticookerOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MulticookerOutlinedFilled'
...
export default IconMaterialMulticookerOutlinedFilled;
