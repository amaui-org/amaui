...
const IconMaterialBuildCircleTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialBuildCircleTwoTone.displayName = 'AmauiIconMaterialBuildCircleTwoTone';

export default IconMaterialBuildCircleTwoTone;
