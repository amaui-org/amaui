...
const IconMaterialIceSkatingTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialIceSkatingTwoTone.displayName = 'AmauiIconMaterialIceSkatingTwoTone';

export default IconMaterialIceSkatingTwoTone;
