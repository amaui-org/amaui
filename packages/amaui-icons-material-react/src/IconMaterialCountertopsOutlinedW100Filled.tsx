...
const IconMaterialCountertopsOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CountertopsOutlinedW100Filled'
...
export default IconMaterialCountertopsOutlinedW100Filled;
