...
const IconMaterialExploreOffTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialExploreOffTwoTone.displayName = 'AmauiIconMaterialExploreOffTwoTone';

export default IconMaterialExploreOffTwoTone;
