...
const IconMaterialOpenInNewOffTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialOpenInNewOffTwoTone.displayName = 'AmauiIconMaterialOpenInNewOffTwoTone';

export default IconMaterialOpenInNewOffTwoTone;
