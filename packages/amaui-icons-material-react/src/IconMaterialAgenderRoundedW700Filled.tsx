...
const IconMaterialAgenderRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AgenderRoundedW700Filled'
      short_name='Agender'
...
export default IconMaterialAgenderRoundedW700Filled;
