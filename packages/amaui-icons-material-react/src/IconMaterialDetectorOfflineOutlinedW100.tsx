...
const IconMaterialDetectorOfflineOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DetectorOfflineOutlinedW100'
...
export default IconMaterialDetectorOfflineOutlinedW100;
