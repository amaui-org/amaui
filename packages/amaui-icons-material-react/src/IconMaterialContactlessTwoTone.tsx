...
const IconMaterialContactlessTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialContactlessTwoTone.displayName = 'AmauiIconMaterialContactlessTwoTone';

export default IconMaterialContactlessTwoTone;
