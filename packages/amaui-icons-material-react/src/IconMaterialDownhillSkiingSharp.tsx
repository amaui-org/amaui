...
const IconMaterialDownhillSkiingSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialDownhillSkiingSharp.displayName = 'AmauiIconMaterialDownhillSkiingSharp';

export default IconMaterialDownhillSkiingSharp;
