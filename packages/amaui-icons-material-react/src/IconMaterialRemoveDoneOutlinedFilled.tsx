...
const IconMaterialRemoveDoneOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RemoveDoneOutlinedFilled'
...
export default IconMaterialRemoveDoneOutlinedFilled;
