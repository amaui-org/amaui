...
const IconMaterialNestFarsightWeatherOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestFarsightWeatherOutlinedW100Filled'
...
export default IconMaterialNestFarsightWeatherOutlinedW100Filled;
