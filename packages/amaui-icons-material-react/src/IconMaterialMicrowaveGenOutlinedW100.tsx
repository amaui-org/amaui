...
const IconMaterialMicrowaveGenOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MicrowaveGenOutlinedW100'
...
export default IconMaterialMicrowaveGenOutlinedW100;
