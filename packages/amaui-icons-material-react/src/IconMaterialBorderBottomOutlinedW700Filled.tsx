...
const IconMaterialBorderBottomOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BorderBottomOutlinedW700Filled'
...
export default IconMaterialBorderBottomOutlinedW700Filled;
