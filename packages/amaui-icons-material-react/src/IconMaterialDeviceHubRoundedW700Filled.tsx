...
const IconMaterialDeviceHubRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DeviceHubRoundedW700Filled'
...
export default IconMaterialDeviceHubRoundedW700Filled;
