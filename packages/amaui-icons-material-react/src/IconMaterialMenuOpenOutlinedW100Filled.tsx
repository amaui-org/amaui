...
const IconMaterialMenuOpenOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MenuOpenOutlinedW100Filled'
      short_name='MenuOpen'
...
export default IconMaterialMenuOpenOutlinedW100Filled;
