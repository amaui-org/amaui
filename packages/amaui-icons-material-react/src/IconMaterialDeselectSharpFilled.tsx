...
const IconMaterialDeselectSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DeselectSharpFilled'
      short_name='Deselect'
...
IconMaterialDeselectSharpFilled.displayName = 'AmauiIconMaterialDeselectSharpFilled';

export default IconMaterialDeselectSharpFilled;
