...
const IconMaterialShuffleOnOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ShuffleOnOutlinedW700Filled'
...
export default IconMaterialShuffleOnOutlinedW700Filled;
