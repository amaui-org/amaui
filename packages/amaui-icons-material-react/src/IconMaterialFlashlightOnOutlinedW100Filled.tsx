...
const IconMaterialFlashlightOnOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FlashlightOnOutlinedW100Filled'
...
export default IconMaterialFlashlightOnOutlinedW100Filled;
