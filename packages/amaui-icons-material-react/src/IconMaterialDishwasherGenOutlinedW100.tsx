...
const IconMaterialDishwasherGenOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DishwasherGenOutlinedW100'
...
export default IconMaterialDishwasherGenOutlinedW100;
