...
const IconMaterialHdrAutoSelectTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialHdrAutoSelectTwoTone.displayName = 'AmauiIconMaterialHdrAutoSelectTwoTone';

export default IconMaterialHdrAutoSelectTwoTone;
