...
const IconMaterialWindowSensorOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WindowSensorOutlinedFilled'
...
export default IconMaterialWindowSensorOutlinedFilled;
