...
const IconMaterialWindowOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WindowOutlinedW100Filled'
      short_name='Window'
...
export default IconMaterialWindowOutlinedW100Filled;
