...
const IconMaterialModeHeatSharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ModeHeatSharpW100'
      short_name='ModeHeat'
...
IconMaterialModeHeatSharpW100.displayName = 'AmauiIconMaterialModeHeatSharpW100';

export default IconMaterialModeHeatSharpW100;
