...
const IconMaterialDevicesRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DevicesRoundedW100'
      short_name='Devices'
...
IconMaterialDevicesRoundedW100.displayName = 'AmauiIconMaterialDevicesRoundedW100';

export default IconMaterialDevicesRoundedW100;
