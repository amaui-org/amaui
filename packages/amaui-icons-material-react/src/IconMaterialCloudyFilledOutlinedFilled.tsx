...
const IconMaterialCloudyFilledOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CloudyFilledOutlinedFilled'
...
export default IconMaterialCloudyFilledOutlinedFilled;
