...
const IconMaterialNestDisplayMaxOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestDisplayMaxOutlinedW100'
...
export default IconMaterialNestDisplayMaxOutlinedW100;
