...
const IconMaterialContactSupportOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ContactSupportOutlinedFilled'
...
export default IconMaterialContactSupportOutlinedFilled;
