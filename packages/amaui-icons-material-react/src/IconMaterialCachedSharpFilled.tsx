...
const IconMaterialCachedSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CachedSharpFilled'
      short_name='Cached'
...
IconMaterialCachedSharpFilled.displayName = 'AmauiIconMaterialCachedSharpFilled';

export default IconMaterialCachedSharpFilled;
