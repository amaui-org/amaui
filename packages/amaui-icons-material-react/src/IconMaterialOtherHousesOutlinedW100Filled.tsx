...
const IconMaterialOtherHousesOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='OtherHousesOutlinedW100Filled'
...
export default IconMaterialOtherHousesOutlinedW100Filled;
