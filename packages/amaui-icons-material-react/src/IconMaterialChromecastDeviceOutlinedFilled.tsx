...
const IconMaterialChromecastDeviceOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ChromecastDeviceOutlinedFilled'
...
export default IconMaterialChromecastDeviceOutlinedFilled;
