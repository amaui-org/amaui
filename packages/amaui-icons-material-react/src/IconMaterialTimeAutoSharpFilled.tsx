...
const IconMaterialTimeAutoSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TimeAutoSharpFilled'
      short_name='TimeAuto'
...
IconMaterialTimeAutoSharpFilled.displayName = 'AmauiIconMaterialTimeAutoSharpFilled';

export default IconMaterialTimeAutoSharpFilled;
