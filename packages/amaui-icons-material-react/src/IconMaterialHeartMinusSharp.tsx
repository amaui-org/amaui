...
const IconMaterialHeartMinusSharp = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HeartMinusSharp'
...
IconMaterialHeartMinusSharp.displayName = 'AmauiIconMaterialHeartMinusSharp';

export default IconMaterialHeartMinusSharp;
