...
const IconMaterialSettingsOverscanOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SettingsOverscanOutlinedW100Filled'
...
export default IconMaterialSettingsOverscanOutlinedW100Filled;
