...
const IconMaterialEnableSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='EnableSharpFilled'
      short_name='Enable'
...
IconMaterialEnableSharpFilled.displayName = 'AmauiIconMaterialEnableSharpFilled';

export default IconMaterialEnableSharpFilled;
