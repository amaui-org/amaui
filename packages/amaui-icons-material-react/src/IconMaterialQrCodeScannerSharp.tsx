...
const IconMaterialQrCodeScannerSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialQrCodeScannerSharp.displayName = 'AmauiIconMaterialQrCodeScannerSharp';

export default IconMaterialQrCodeScannerSharp;
