...
const IconMaterialCropSquareOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CropSquareOutlinedW700Filled'
...
export default IconMaterialCropSquareOutlinedW700Filled;
