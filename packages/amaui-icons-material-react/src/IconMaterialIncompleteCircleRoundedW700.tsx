...
const IconMaterialIncompleteCircleRoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='IncompleteCircleRoundedW700'
...
export default IconMaterialIncompleteCircleRoundedW700;
