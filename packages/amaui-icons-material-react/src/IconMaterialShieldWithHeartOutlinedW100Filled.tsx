...
const IconMaterialShieldWithHeartOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ShieldWithHeartOutlinedW100Filled'
...
export default IconMaterialShieldWithHeartOutlinedW100Filled;
