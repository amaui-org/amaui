...
const IconMaterialSmartphoneRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialSmartphoneRounded.displayName = 'AmauiIconMaterialSmartphoneRounded';

export default IconMaterialSmartphoneRounded;
