...
const IconMaterialDirectionsWalkSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DirectionsWalkSharpW700Filled'
...
export default IconMaterialDirectionsWalkSharpW700Filled;
