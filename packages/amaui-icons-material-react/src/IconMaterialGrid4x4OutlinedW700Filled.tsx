...
const IconMaterialGrid4x4OutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Grid4x4OutlinedW700Filled'
      short_name='Grid4x4'
...
export default IconMaterialGrid4x4OutlinedW700Filled;
