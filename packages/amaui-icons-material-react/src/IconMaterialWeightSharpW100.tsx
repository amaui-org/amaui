...
const IconMaterialWeightSharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WeightSharpW100'
      short_name='Weight'
...
IconMaterialWeightSharpW100.displayName = 'AmauiIconMaterialWeightSharpW100';

export default IconMaterialWeightSharpW100;
