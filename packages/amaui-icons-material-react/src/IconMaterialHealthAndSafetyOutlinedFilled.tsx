...
const IconMaterialHealthAndSafetyOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HealthAndSafetyOutlinedFilled'
...
export default IconMaterialHealthAndSafetyOutlinedFilled;
