...
const IconMaterialPictureInPictureRoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PictureInPictureRoundedW700'
...
export default IconMaterialPictureInPictureRoundedW700;
