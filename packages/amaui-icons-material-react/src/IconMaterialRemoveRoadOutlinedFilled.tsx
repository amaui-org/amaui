...
const IconMaterialRemoveRoadOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RemoveRoadOutlinedFilled'
...
export default IconMaterialRemoveRoadOutlinedFilled;
