...
const IconMaterialReplayOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ReplayOutlinedW100Filled'
      short_name='Replay'
...
export default IconMaterialReplayOutlinedW100Filled;
