...
const IconMaterialNestLocatorTagOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestLocatorTagOutlinedW100Filled'
...
export default IconMaterialNestLocatorTagOutlinedW100Filled;
