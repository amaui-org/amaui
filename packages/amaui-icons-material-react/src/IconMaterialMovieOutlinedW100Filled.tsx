...
const IconMaterialMovieOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MovieOutlinedW100Filled'
      short_name='Movie'
...
export default IconMaterialMovieOutlinedW100Filled;
