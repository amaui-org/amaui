...
const IconMaterialDatabaseSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DatabaseSharpFilled'
      short_name='Database'
...
IconMaterialDatabaseSharpFilled.displayName = 'AmauiIconMaterialDatabaseSharpFilled';

export default IconMaterialDatabaseSharpFilled;
