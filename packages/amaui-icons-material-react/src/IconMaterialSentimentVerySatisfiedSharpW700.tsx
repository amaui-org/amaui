...
const IconMaterialSentimentVerySatisfiedSharpW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SentimentVerySatisfiedSharpW700'
...
export default IconMaterialSentimentVerySatisfiedSharpW700;
