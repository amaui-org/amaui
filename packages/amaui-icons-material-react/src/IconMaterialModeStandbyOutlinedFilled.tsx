...
const IconMaterialModeStandbyOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ModeStandbyOutlinedFilled'
...
export default IconMaterialModeStandbyOutlinedFilled;
