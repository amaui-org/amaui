...
const IconMaterialCastleTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialCastleTwoTone.displayName = 'AmauiIconMaterialCastleTwoTone';

export default IconMaterialCastleTwoTone;
