...
const IconMaterialLeakRemoveOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LeakRemoveOutlinedFilled'
...
export default IconMaterialLeakRemoveOutlinedFilled;
