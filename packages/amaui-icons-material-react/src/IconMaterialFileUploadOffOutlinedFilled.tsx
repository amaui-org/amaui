...
const IconMaterialFileUploadOffOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FileUploadOffOutlinedFilled'
...
export default IconMaterialFileUploadOffOutlinedFilled;
