...
const IconMaterialHomeAppLogoOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HomeAppLogoOutlinedW100'
...
export default IconMaterialHomeAppLogoOutlinedW100;
