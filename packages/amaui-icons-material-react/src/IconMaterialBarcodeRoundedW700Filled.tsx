...
const IconMaterialBarcodeRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BarcodeRoundedW700Filled'
      short_name='Barcode'
...
export default IconMaterialBarcodeRoundedW700Filled;
