...
const IconMaterialGarageOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='GarageOutlinedW100Filled'
      short_name='Garage'
...
export default IconMaterialGarageOutlinedW100Filled;
