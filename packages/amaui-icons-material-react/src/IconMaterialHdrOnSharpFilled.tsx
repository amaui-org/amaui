...
const IconMaterialHdrOnSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HdrOnSharpFilled'
      short_name='HdrOn'
...
IconMaterialHdrOnSharpFilled.displayName = 'AmauiIconMaterialHdrOnSharpFilled';

export default IconMaterialHdrOnSharpFilled;
