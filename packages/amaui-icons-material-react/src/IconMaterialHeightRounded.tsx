...
const IconMaterialHeightRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialHeightRounded.displayName = 'AmauiIconMaterialHeightRounded';

export default IconMaterialHeightRounded;
