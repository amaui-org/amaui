...
const IconMaterialStayPrimaryPortraitOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='StayPrimaryPortraitOutlinedW700Filled'
...
export default IconMaterialStayPrimaryPortraitOutlinedW700Filled;
