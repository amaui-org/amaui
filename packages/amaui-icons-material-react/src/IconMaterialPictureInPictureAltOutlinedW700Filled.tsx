...
const IconMaterialPictureInPictureAltOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PictureInPictureAltOutlinedW700Filled'
...
export default IconMaterialPictureInPictureAltOutlinedW700Filled;
