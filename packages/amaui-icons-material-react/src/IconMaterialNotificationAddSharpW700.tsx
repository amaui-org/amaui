...
const IconMaterialNotificationAddSharpW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NotificationAddSharpW700'
...
export default IconMaterialNotificationAddSharpW700;
