...
const IconMaterialQuickPhrasesOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='QuickPhrasesOutlinedFilled'
...
export default IconMaterialQuickPhrasesOutlinedFilled;
