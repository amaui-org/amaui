...
const IconMaterialEnableSharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='EnableSharpW100'
      short_name='Enable'
...
IconMaterialEnableSharpW100.displayName = 'AmauiIconMaterialEnableSharpW100';

export default IconMaterialEnableSharpW100;
