...
const IconMaterialEnergyProgramSavingOutlined = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='EnergyProgramSavingOutlined'
...
export default IconMaterialEnergyProgramSavingOutlined;
