...
const IconMaterialContentPasteOffSharpW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ContentPasteOffSharpW700'
...
export default IconMaterialContentPasteOffSharpW700;
