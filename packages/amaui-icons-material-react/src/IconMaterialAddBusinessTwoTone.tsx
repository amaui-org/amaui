...
const IconMaterialAddBusinessTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialAddBusinessTwoTone.displayName = 'AmauiIconMaterialAddBusinessTwoTone';

export default IconMaterialAddBusinessTwoTone;
