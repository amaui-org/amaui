...
const IconMaterialPreviewRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PreviewRoundedW100'
      short_name='Preview'
...
IconMaterialPreviewRoundedW100.displayName = 'AmauiIconMaterialPreviewRoundedW100';

export default IconMaterialPreviewRoundedW100;
