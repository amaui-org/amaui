...
const IconMaterialHouseOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HouseOutlinedW700Filled'
      short_name='House'
...
export default IconMaterialHouseOutlinedW700Filled;
