...
const IconMaterialNestWifiMistralOutlined = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestWifiMistralOutlined'
...
export default IconMaterialNestWifiMistralOutlined;
