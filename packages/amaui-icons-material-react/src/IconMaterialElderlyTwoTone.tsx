...
const IconMaterialElderlyTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialElderlyTwoTone.displayName = 'AmauiIconMaterialElderlyTwoTone';

export default IconMaterialElderlyTwoTone;
