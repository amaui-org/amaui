...
const IconMaterialScatterPlotRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ScatterPlotRoundedW700Filled'
...
export default IconMaterialScatterPlotRoundedW700Filled;
