...
const IconMaterialToysFanSharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ToysFanSharpW100'
      short_name='ToysFan'
...
IconMaterialToysFanSharpW100.displayName = 'AmauiIconMaterialToysFanSharpW100';

export default IconMaterialToysFanSharpW100;
