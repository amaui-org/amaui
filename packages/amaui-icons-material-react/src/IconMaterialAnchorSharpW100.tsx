...
const IconMaterialAnchorSharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AnchorSharpW100'
      short_name='Anchor'
...
IconMaterialAnchorSharpW100.displayName = 'AmauiIconMaterialAnchorSharpW100';

export default IconMaterialAnchorSharpW100;
