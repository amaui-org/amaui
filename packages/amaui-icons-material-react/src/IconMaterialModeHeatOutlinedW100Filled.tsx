...
const IconMaterialModeHeatOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ModeHeatOutlinedW100Filled'
      short_name='ModeHeat'
...
export default IconMaterialModeHeatOutlinedW100Filled;
