...
const IconMaterialStylerSharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='StylerSharpW100'
      short_name='Styler'
...
IconMaterialStylerSharpW100.displayName = 'AmauiIconMaterialStylerSharpW100';

export default IconMaterialStylerSharpW100;
