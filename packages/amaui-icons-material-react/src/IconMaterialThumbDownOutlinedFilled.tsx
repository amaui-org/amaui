...
const IconMaterialThumbDownOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ThumbDownOutlinedFilled'
...
export default IconMaterialThumbDownOutlinedFilled;
