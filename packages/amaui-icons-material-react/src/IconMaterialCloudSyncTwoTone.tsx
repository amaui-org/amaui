...
const IconMaterialCloudSyncTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialCloudSyncTwoTone.displayName = 'AmauiIconMaterialCloudSyncTwoTone';

export default IconMaterialCloudSyncTwoTone;
