...
const IconMaterialChromecastDeviceOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ChromecastDeviceOutlinedW100Filled'
...
export default IconMaterialChromecastDeviceOutlinedW100Filled;
