...
const IconMaterialFeedTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialFeedTwoTone.displayName = 'AmauiIconMaterialFeedTwoTone';

export default IconMaterialFeedTwoTone;
