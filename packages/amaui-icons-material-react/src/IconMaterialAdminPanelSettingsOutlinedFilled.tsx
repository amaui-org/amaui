...
const IconMaterialAdminPanelSettingsOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AdminPanelSettingsOutlinedFilled'
...
export default IconMaterialAdminPanelSettingsOutlinedFilled;
