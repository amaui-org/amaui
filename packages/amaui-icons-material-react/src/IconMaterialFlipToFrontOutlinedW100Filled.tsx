...
const IconMaterialFlipToFrontOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FlipToFrontOutlinedW100Filled'
...
export default IconMaterialFlipToFrontOutlinedW100Filled;
