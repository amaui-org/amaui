...
const IconMaterialBatteryCharging50RoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryCharging50RoundedW700'
...
export default IconMaterialBatteryCharging50RoundedW700;
