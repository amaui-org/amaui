...
const IconMaterialNestWakeOnApproachOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestWakeOnApproachOutlinedW100Filled'
...
export default IconMaterialNestWakeOnApproachOutlinedW100Filled;
