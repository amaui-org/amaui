...
const IconMaterialDeselectTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialDeselectTwoTone.displayName = 'AmauiIconMaterialDeselectTwoTone';

export default IconMaterialDeselectTwoTone;
