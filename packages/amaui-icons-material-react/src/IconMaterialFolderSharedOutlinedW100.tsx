...
const IconMaterialFolderSharedOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FolderSharedOutlinedW100'
...
export default IconMaterialFolderSharedOutlinedW100;
