...
const IconMaterialBatteryCharging60OutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryCharging60OutlinedW700Filled'
...
export default IconMaterialBatteryCharging60OutlinedW700Filled;
