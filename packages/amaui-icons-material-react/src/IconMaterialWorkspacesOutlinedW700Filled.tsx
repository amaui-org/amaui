...
const IconMaterialWorkspacesOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WorkspacesOutlinedW700Filled'
...
export default IconMaterialWorkspacesOutlinedW700Filled;
