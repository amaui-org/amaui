...
const IconMaterialLocationAwayOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LocationAwayOutlinedFilled'
...
export default IconMaterialLocationAwayOutlinedFilled;
