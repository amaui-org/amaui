...
const IconMaterialDataUsageOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DataUsageOutlinedFilled'
...
export default IconMaterialDataUsageOutlinedFilled;
