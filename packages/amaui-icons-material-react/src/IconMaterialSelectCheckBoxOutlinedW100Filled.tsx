...
const IconMaterialSelectCheckBoxOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SelectCheckBoxOutlinedW100Filled'
...
export default IconMaterialSelectCheckBoxOutlinedW100Filled;
