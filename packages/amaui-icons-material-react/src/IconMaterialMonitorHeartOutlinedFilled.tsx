...
const IconMaterialMonitorHeartOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MonitorHeartOutlinedFilled'
...
export default IconMaterialMonitorHeartOutlinedFilled;
