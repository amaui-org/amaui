...
const IconMaterialAddHomeOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AddHomeOutlinedW700Filled'
      short_name='AddHome'
...
export default IconMaterialAddHomeOutlinedW700Filled;
