...
const IconMaterialInboxTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialInboxTwoTone.displayName = 'AmauiIconMaterialInboxTwoTone';

export default IconMaterialInboxTwoTone;
