...
const IconMaterialGooglePlusReshareOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='GooglePlusReshareOutlinedW100'
...
export default IconMaterialGooglePlusReshareOutlinedW100;
