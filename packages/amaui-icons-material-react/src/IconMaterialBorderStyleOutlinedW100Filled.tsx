...
const IconMaterialBorderStyleOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BorderStyleOutlinedW100Filled'
...
export default IconMaterialBorderStyleOutlinedW100Filled;
