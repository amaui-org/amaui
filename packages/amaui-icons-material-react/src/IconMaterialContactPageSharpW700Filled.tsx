...
const IconMaterialContactPageSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ContactPageSharpW700Filled'
...
export default IconMaterialContactPageSharpW700Filled;
