...
const IconMaterialNotificationImportantOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NotificationImportantOutlinedW700Filled'
...
export default IconMaterialNotificationImportantOutlinedW700Filled;
