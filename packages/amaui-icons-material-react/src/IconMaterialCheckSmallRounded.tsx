...
const IconMaterialCheckSmallRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialCheckSmallRounded.displayName = 'AmauiIconMaterialCheckSmallRounded';

export default IconMaterialCheckSmallRounded;
