...
const IconMaterialDonutLargeOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DonutLargeOutlinedFilled'
...
export default IconMaterialDonutLargeOutlinedFilled;
