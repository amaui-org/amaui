...
const IconMaterialCallReceivedRoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CallReceivedRoundedW700'
...
export default IconMaterialCallReceivedRoundedW700;
