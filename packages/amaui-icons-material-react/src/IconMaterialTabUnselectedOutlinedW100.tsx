...
const IconMaterialTabUnselectedOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TabUnselectedOutlinedW100'
...
export default IconMaterialTabUnselectedOutlinedW100;
