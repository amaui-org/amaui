...
const IconMaterialLegendToggleRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LegendToggleRoundedW700Filled'
...
export default IconMaterialLegendToggleRoundedW700Filled;
