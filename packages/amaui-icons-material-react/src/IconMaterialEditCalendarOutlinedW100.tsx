...
const IconMaterialEditCalendarOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='EditCalendarOutlinedW100'
...
export default IconMaterialEditCalendarOutlinedW100;
