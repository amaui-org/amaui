...
const IconMaterialDownloadingOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DownloadingOutlinedW100Filled'
...
export default IconMaterialDownloadingOutlinedW100Filled;
