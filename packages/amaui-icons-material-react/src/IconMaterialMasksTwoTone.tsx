...
const IconMaterialMasksTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialMasksTwoTone.displayName = 'AmauiIconMaterialMasksTwoTone';

export default IconMaterialMasksTwoTone;
