...
const IconMaterialOutgoingMailOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='OutgoingMailOutlinedW100Filled'
...
export default IconMaterialOutgoingMailOutlinedW100Filled;
