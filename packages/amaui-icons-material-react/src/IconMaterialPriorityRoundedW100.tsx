...
const IconMaterialPriorityRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PriorityRoundedW100'
      short_name='Priority'
...
IconMaterialPriorityRoundedW100.displayName = 'AmauiIconMaterialPriorityRoundedW100';

export default IconMaterialPriorityRoundedW100;
