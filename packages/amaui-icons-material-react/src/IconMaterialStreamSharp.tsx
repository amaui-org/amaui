...
const IconMaterialStreamSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialStreamSharp.displayName = 'AmauiIconMaterialStreamSharp';

export default IconMaterialStreamSharp;
