...
const IconMaterialCheckroomOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CheckroomOutlinedFilled'
...
export default IconMaterialCheckroomOutlinedFilled;
