...
const IconMaterialSecuritySharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SecuritySharpW700Filled'
      short_name='Security'
...
export default IconMaterialSecuritySharpW700Filled;
