...
const IconMaterialAddLocationRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialAddLocationRounded.displayName = 'AmauiIconMaterialAddLocationRounded';

export default IconMaterialAddLocationRounded;
