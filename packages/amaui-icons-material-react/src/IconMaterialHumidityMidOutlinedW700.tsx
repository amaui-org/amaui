...
const IconMaterialHumidityMidOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HumidityMidOutlinedW700'
...
export default IconMaterialHumidityMidOutlinedW700;
