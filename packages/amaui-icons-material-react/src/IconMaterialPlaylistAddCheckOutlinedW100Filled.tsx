...
const IconMaterialPlaylistAddCheckOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PlaylistAddCheckOutlinedW100Filled'
...
export default IconMaterialPlaylistAddCheckOutlinedW100Filled;
