...
const IconMaterialLinkSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LinkSharpFilled'
      short_name='Link'
...
IconMaterialLinkSharpFilled.displayName = 'AmauiIconMaterialLinkSharpFilled';

export default IconMaterialLinkSharpFilled;
