...
const IconMaterialGroups3OutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Groups3OutlinedW100Filled'
      short_name='Groups3'
...
export default IconMaterialGroups3OutlinedW100Filled;
