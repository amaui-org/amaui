...
const IconMaterialStorageRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='StorageRoundedW100'
      short_name='Storage'
...
IconMaterialStorageRoundedW100.displayName = 'AmauiIconMaterialStorageRoundedW100';

export default IconMaterialStorageRoundedW100;
