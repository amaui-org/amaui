...
const IconMaterialModeStandbySharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ModeStandbySharpW700Filled'
...
export default IconMaterialModeStandbySharpW700Filled;
