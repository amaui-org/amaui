...
const IconMaterialFormatListBulletedOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FormatListBulletedOutlinedFilled'
...
export default IconMaterialFormatListBulletedOutlinedFilled;
