...
const IconMaterialTextRotateUpOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TextRotateUpOutlinedFilled'
...
export default IconMaterialTextRotateUpOutlinedFilled;
