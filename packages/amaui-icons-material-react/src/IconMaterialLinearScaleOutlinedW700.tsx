...
const IconMaterialLinearScaleOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LinearScaleOutlinedW700'
...
export default IconMaterialLinearScaleOutlinedW700;
