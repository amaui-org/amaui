...
const IconMaterialPhotoLibrarySharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PhotoLibrarySharpW700Filled'
...
export default IconMaterialPhotoLibrarySharpW700Filled;
