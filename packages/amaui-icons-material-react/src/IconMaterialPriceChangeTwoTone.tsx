...
const IconMaterialPriceChangeTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialPriceChangeTwoTone.displayName = 'AmauiIconMaterialPriceChangeTwoTone';

export default IconMaterialPriceChangeTwoTone;
