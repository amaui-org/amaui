...
const IconMaterialAttachEmailTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialAttachEmailTwoTone.displayName = 'AmauiIconMaterialAttachEmailTwoTone';

export default IconMaterialAttachEmailTwoTone;
