...
const IconMaterialBorderTopSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BorderTopSharpW700Filled'
...
export default IconMaterialBorderTopSharpW700Filled;
