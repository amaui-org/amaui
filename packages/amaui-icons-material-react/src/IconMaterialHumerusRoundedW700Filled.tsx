...
const IconMaterialHumerusRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HumerusRoundedW700Filled'
      short_name='Humerus'
...
export default IconMaterialHumerusRoundedW700Filled;
