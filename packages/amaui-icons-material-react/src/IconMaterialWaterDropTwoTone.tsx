...
const IconMaterialWaterDropTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialWaterDropTwoTone.displayName = 'AmauiIconMaterialWaterDropTwoTone';

export default IconMaterialWaterDropTwoTone;
