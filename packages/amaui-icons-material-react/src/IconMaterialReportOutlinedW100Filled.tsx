...
const IconMaterialReportOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ReportOutlinedW100Filled'
      short_name='Report'
...
export default IconMaterialReportOutlinedW100Filled;
