...
const IconMaterialHistoryEduOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HistoryEduOutlinedFilled'
...
export default IconMaterialHistoryEduOutlinedFilled;
