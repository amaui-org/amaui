...
const IconMaterialArmingCountdownOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ArmingCountdownOutlinedW100Filled'
...
export default IconMaterialArmingCountdownOutlinedW100Filled;
