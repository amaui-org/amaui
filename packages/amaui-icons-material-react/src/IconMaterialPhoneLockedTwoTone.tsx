...
const IconMaterialPhoneLockedTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialPhoneLockedTwoTone.displayName = 'AmauiIconMaterialPhoneLockedTwoTone';

export default IconMaterialPhoneLockedTwoTone;
