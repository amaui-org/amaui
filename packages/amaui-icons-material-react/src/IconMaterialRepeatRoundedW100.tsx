...
const IconMaterialRepeatRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RepeatRoundedW100'
      short_name='Repeat'
...
IconMaterialRepeatRoundedW100.displayName = 'AmauiIconMaterialRepeatRoundedW100';

export default IconMaterialRepeatRoundedW100;
