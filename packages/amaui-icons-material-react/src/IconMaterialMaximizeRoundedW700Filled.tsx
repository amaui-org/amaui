...
const IconMaterialMaximizeRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MaximizeRoundedW700Filled'
      short_name='Maximize'
...
export default IconMaterialMaximizeRoundedW700Filled;
