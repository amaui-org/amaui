...
const IconMaterialToolsFlatHeadOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ToolsFlatHeadOutlinedW100'
...
export default IconMaterialToolsFlatHeadOutlinedW100;
