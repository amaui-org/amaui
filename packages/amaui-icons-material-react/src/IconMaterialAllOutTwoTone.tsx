...
const IconMaterialAllOutTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialAllOutTwoTone.displayName = 'AmauiIconMaterialAllOutTwoTone';

export default IconMaterialAllOutTwoTone;
