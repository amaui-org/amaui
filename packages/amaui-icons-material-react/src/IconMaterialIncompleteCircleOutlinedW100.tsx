...
const IconMaterialIncompleteCircleOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='IncompleteCircleOutlinedW100'
...
export default IconMaterialIncompleteCircleOutlinedW100;
