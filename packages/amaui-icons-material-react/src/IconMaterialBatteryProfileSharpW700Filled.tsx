...
const IconMaterialBatteryProfileSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryProfileSharpW700Filled'
...
export default IconMaterialBatteryProfileSharpW700Filled;
