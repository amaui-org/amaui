...
const IconMaterialBorderHorizontalOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BorderHorizontalOutlinedFilled'
...
export default IconMaterialBorderHorizontalOutlinedFilled;
