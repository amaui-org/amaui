...
const IconMaterialSmartphoneOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SmartphoneOutlinedFilled'
...
export default IconMaterialSmartphoneOutlinedFilled;
