...
const IconMaterialUlnaRadiusAltOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='UlnaRadiusAltOutlinedW100Filled'
...
export default IconMaterialUlnaRadiusAltOutlinedW100Filled;
