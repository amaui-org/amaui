...
const IconMaterialFileUploadSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FileUploadSharpW700Filled'
...
export default IconMaterialFileUploadSharpW700Filled;
