...
const IconMaterialLooksRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LooksRoundedW100'
      short_name='Looks'
...
IconMaterialLooksRoundedW100.displayName = 'AmauiIconMaterialLooksRoundedW100';

export default IconMaterialLooksRoundedW100;
