...
const IconMaterialSettingsEthernetOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SettingsEthernetOutlinedW100Filled'
...
export default IconMaterialSettingsEthernetOutlinedW100Filled;
