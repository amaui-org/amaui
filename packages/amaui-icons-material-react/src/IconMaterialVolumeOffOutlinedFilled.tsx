...
const IconMaterialVolumeOffOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='VolumeOffOutlinedFilled'
...
export default IconMaterialVolumeOffOutlinedFilled;
