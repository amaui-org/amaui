...
const IconMaterialExposureZeroTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialExposureZeroTwoTone.displayName = 'AmauiIconMaterialExposureZeroTwoTone';

export default IconMaterialExposureZeroTwoTone;
