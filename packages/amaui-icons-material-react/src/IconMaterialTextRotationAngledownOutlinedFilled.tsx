...
const IconMaterialTextRotationAngledownOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TextRotationAngledownOutlinedFilled'
...
export default IconMaterialTextRotationAngledownOutlinedFilled;
