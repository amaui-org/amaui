...
const IconMaterialCloudDownloadOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CloudDownloadOutlinedFilled'
...
export default IconMaterialCloudDownloadOutlinedFilled;
