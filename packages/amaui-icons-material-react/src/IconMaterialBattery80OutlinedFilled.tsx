...
const IconMaterialBattery80OutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Battery80OutlinedFilled'
...
export default IconMaterialBattery80OutlinedFilled;
