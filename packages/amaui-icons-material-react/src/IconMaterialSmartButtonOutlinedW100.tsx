...
const IconMaterialSmartButtonOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SmartButtonOutlinedW100'
...
export default IconMaterialSmartButtonOutlinedW100;
