...
const IconMaterialSentimentVeryDissatisfiedSharpW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SentimentVeryDissatisfiedSharpW700'
...
export default IconMaterialSentimentVeryDissatisfiedSharpW700;
