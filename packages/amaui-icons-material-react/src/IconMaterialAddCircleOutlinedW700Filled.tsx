...
const IconMaterialAddCircleOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AddCircleOutlinedW700Filled'
...
export default IconMaterialAddCircleOutlinedW700Filled;
