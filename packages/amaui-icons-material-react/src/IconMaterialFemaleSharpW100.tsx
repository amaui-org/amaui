...
const IconMaterialFemaleSharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FemaleSharpW100'
      short_name='Female'
...
IconMaterialFemaleSharpW100.displayName = 'AmauiIconMaterialFemaleSharpW100';

export default IconMaterialFemaleSharpW100;
