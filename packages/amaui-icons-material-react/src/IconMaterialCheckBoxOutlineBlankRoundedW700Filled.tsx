...
const IconMaterialCheckBoxOutlineBlankRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CheckBoxOutlineBlankRoundedW700Filled'
...
export default IconMaterialCheckBoxOutlineBlankRoundedW700Filled;
