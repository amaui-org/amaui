...
const IconMaterialBatteryProfileRoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryProfileRoundedW700'
...
export default IconMaterialBatteryProfileRoundedW700;
