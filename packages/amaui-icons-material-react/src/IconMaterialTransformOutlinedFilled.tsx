...
const IconMaterialTransformOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TransformOutlinedFilled'
...
export default IconMaterialTransformOutlinedFilled;
