...
const IconMaterialHideSourceOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HideSourceOutlinedFilled'
...
export default IconMaterialHideSourceOutlinedFilled;
