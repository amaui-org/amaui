...
const IconMaterialErrorCircleRoundedSharpW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ErrorCircleRoundedSharpW700'
...
export default IconMaterialErrorCircleRoundedSharpW700;
