...
const IconMaterialExposureOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ExposureOutlinedW700Filled'
      short_name='Exposure'
...
export default IconMaterialExposureOutlinedW700Filled;
