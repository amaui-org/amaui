...
const IconMaterialHouseWithShieldOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HouseWithShieldOutlinedW100Filled'
...
export default IconMaterialHouseWithShieldOutlinedW100Filled;
