...
const IconMaterialLibraryAddTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialLibraryAddTwoTone.displayName = 'AmauiIconMaterialLibraryAddTwoTone';

export default IconMaterialLibraryAddTwoTone;
