...
const IconMaterialNetworkWifi3BarOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NetworkWifi3BarOutlinedFilled'
...
export default IconMaterialNetworkWifi3BarOutlinedFilled;
