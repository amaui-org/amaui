...
const IconMaterialAttractionsTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialAttractionsTwoTone.displayName = 'AmauiIconMaterialAttractionsTwoTone';

export default IconMaterialAttractionsTwoTone;
