...
const IconMaterialCrop75OutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Crop75OutlinedW100Filled'
      short_name='Crop75'
...
export default IconMaterialCrop75OutlinedW100Filled;
