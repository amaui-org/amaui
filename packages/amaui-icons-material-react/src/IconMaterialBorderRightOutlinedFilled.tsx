...
const IconMaterialBorderRightOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BorderRightOutlinedFilled'
...
export default IconMaterialBorderRightOutlinedFilled;
