...
const IconMaterialDoorbell3pRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Doorbell3pRoundedW700Filled'
...
export default IconMaterialDoorbell3pRoundedW700Filled;
