...
const IconMaterialPhotoRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PhotoRoundedW100'
      short_name='Photo'
...
IconMaterialPhotoRoundedW100.displayName = 'AmauiIconMaterialPhotoRoundedW100';

export default IconMaterialPhotoRoundedW100;
