...
const IconMaterialSettingsBluetoothOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SettingsBluetoothOutlinedFilled'
...
export default IconMaterialSettingsBluetoothOutlinedFilled;
