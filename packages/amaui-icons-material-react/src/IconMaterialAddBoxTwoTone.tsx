...
const IconMaterialAddBoxTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialAddBoxTwoTone.displayName = 'AmauiIconMaterialAddBoxTwoTone';

export default IconMaterialAddBoxTwoTone;
