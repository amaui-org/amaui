...
const IconMaterialFlourescentOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FlourescentOutlinedW100'
...
export default IconMaterialFlourescentOutlinedW100;
