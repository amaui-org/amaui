...
const IconMaterialWbIridescentOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WbIridescentOutlinedW700Filled'
...
export default IconMaterialWbIridescentOutlinedW700Filled;
