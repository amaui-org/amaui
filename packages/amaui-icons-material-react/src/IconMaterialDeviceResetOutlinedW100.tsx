...
const IconMaterialDeviceResetOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DeviceResetOutlinedW100'
...
export default IconMaterialDeviceResetOutlinedW100;
