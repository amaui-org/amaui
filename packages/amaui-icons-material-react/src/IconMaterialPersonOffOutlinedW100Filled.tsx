...
const IconMaterialPersonOffOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PersonOffOutlinedW100Filled'
...
export default IconMaterialPersonOffOutlinedW100Filled;
