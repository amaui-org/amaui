...
const IconMaterialMusicVideoTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialMusicVideoTwoTone.displayName = 'AmauiIconMaterialMusicVideoTwoTone';

export default IconMaterialMusicVideoTwoTone;
