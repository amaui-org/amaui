...
const IconMaterialPhotoAlbumTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialPhotoAlbumTwoTone.displayName = 'AmauiIconMaterialPhotoAlbumTwoTone';

export default IconMaterialPhotoAlbumTwoTone;
