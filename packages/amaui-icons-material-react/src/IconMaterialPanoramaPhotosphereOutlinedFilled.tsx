...
const IconMaterialPanoramaPhotosphereOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PanoramaPhotosphereOutlinedFilled'
...
export default IconMaterialPanoramaPhotosphereOutlinedFilled;
