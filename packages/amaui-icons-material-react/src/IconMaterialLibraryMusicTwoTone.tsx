...
const IconMaterialLibraryMusicTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialLibraryMusicTwoTone.displayName = 'AmauiIconMaterialLibraryMusicTwoTone';

export default IconMaterialLibraryMusicTwoTone;
