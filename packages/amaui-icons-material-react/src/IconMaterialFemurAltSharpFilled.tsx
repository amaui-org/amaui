...
const IconMaterialFemurAltSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FemurAltSharpFilled'
      short_name='FemurAlt'
...
IconMaterialFemurAltSharpFilled.displayName = 'AmauiIconMaterialFemurAltSharpFilled';

export default IconMaterialFemurAltSharpFilled;
