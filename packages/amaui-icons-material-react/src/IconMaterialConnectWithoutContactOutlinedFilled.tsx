...
const IconMaterialConnectWithoutContactOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ConnectWithoutContactOutlinedFilled'
...
export default IconMaterialConnectWithoutContactOutlinedFilled;
