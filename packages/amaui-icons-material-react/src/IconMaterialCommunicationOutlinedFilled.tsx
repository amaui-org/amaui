...
const IconMaterialCommunicationOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CommunicationOutlinedFilled'
...
export default IconMaterialCommunicationOutlinedFilled;
