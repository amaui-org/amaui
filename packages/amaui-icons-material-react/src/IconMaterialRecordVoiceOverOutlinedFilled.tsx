...
const IconMaterialRecordVoiceOverOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RecordVoiceOverOutlinedFilled'
...
export default IconMaterialRecordVoiceOverOutlinedFilled;
