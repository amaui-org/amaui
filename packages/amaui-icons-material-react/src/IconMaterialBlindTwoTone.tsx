...
const IconMaterialBlindTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialBlindTwoTone.displayName = 'AmauiIconMaterialBlindTwoTone';

export default IconMaterialBlindTwoTone;
