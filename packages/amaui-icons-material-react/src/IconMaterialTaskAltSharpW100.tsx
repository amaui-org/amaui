...
const IconMaterialTaskAltSharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TaskAltSharpW100'
      short_name='TaskAlt'
...
IconMaterialTaskAltSharpW100.displayName = 'AmauiIconMaterialTaskAltSharpW100';

export default IconMaterialTaskAltSharpW100;
