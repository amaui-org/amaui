...
const IconMaterialRepartitionOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RepartitionOutlinedW700'
...
export default IconMaterialRepartitionOutlinedW700;
