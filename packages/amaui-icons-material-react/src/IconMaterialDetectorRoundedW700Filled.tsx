...
const IconMaterialDetectorRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DetectorRoundedW700Filled'
      short_name='Detector'
...
export default IconMaterialDetectorRoundedW700Filled;
