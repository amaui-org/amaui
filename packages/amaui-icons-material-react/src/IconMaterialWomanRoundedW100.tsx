...
const IconMaterialWomanRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WomanRoundedW100'
      short_name='Woman'
...
IconMaterialWomanRoundedW100.displayName = 'AmauiIconMaterialWomanRoundedW100';

export default IconMaterialWomanRoundedW100;
