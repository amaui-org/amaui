...
const IconMaterialHumidityLowOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HumidityLowOutlinedW100Filled'
...
export default IconMaterialHumidityLowOutlinedW100Filled;
