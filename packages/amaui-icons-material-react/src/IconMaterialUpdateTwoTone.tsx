...
const IconMaterialUpdateTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialUpdateTwoTone.displayName = 'AmauiIconMaterialUpdateTwoTone';

export default IconMaterialUpdateTwoTone;
