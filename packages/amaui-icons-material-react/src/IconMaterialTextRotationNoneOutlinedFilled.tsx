...
const IconMaterialTextRotationNoneOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TextRotationNoneOutlinedFilled'
...
export default IconMaterialTextRotationNoneOutlinedFilled;
