...
const IconMaterialCloudyFilledOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CloudyFilledOutlinedW100Filled'
...
export default IconMaterialCloudyFilledOutlinedW100Filled;
