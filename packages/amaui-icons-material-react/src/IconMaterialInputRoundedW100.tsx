...
const IconMaterialInputRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='InputRoundedW100'
      short_name='Input'
...
IconMaterialInputRoundedW100.displayName = 'AmauiIconMaterialInputRoundedW100';

export default IconMaterialInputRoundedW100;
