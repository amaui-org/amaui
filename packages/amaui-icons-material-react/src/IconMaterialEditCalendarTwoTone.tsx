...
const IconMaterialEditCalendarTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialEditCalendarTwoTone.displayName = 'AmauiIconMaterialEditCalendarTwoTone';

export default IconMaterialEditCalendarTwoTone;
