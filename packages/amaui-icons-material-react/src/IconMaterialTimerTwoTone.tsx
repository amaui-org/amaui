...
const IconMaterialTimerTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialTimerTwoTone.displayName = 'AmauiIconMaterialTimerTwoTone';

export default IconMaterialTimerTwoTone;
