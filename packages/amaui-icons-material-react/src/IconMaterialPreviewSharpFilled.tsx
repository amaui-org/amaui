...
const IconMaterialPreviewSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PreviewSharpFilled'
      short_name='Preview'
...
IconMaterialPreviewSharpFilled.displayName = 'AmauiIconMaterialPreviewSharpFilled';

export default IconMaterialPreviewSharpFilled;
