...
const IconMaterialAutofpsSelectOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AutofpsSelectOutlinedFilled'
...
export default IconMaterialAutofpsSelectOutlinedFilled;
