...
const IconMaterialModeHeatSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialModeHeatSharp.displayName = 'AmauiIconMaterialModeHeatSharp';

export default IconMaterialModeHeatSharp;
