...
const IconMaterialToggleOffOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ToggleOffOutlinedW100Filled'
...
export default IconMaterialToggleOffOutlinedW100Filled;
