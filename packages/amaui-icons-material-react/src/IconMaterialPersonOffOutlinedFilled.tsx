...
const IconMaterialPersonOffOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PersonOffOutlinedFilled'
...
export default IconMaterialPersonOffOutlinedFilled;
