...
const IconMaterialCompareOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CompareOutlinedW100Filled'
      short_name='Compare'
...
export default IconMaterialCompareOutlinedW100Filled;
