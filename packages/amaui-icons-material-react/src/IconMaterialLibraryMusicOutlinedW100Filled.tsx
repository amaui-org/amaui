...
const IconMaterialLibraryMusicOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LibraryMusicOutlinedW100Filled'
...
export default IconMaterialLibraryMusicOutlinedW100Filled;
