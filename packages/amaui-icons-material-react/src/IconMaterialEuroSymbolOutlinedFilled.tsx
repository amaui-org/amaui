...
const IconMaterialEuroSymbolOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='EuroSymbolOutlinedFilled'
...
export default IconMaterialEuroSymbolOutlinedFilled;
