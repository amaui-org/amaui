...
const IconMaterialPersonAddOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PersonAddOutlinedFilled'
...
export default IconMaterialPersonAddOutlinedFilled;
