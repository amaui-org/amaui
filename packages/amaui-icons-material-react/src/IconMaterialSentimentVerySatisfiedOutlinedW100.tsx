...
const IconMaterialSentimentVerySatisfiedOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SentimentVerySatisfiedOutlinedW100'
...
export default IconMaterialSentimentVerySatisfiedOutlinedW100;
