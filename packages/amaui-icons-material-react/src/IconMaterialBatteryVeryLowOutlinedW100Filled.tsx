...
const IconMaterialBatteryVeryLowOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryVeryLowOutlinedW100Filled'
...
export default IconMaterialBatteryVeryLowOutlinedW100Filled;
