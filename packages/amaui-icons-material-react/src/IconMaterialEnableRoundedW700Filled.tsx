...
const IconMaterialEnableRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='EnableRoundedW700Filled'
      short_name='Enable'
...
export default IconMaterialEnableRoundedW700Filled;
