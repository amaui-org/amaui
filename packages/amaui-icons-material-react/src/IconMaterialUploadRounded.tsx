...
const IconMaterialUploadRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialUploadRounded.displayName = 'AmauiIconMaterialUploadRounded';

export default IconMaterialUploadRounded;
