...
const IconMaterialBakeryDiningOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BakeryDiningOutlinedFilled'
...
export default IconMaterialBakeryDiningOutlinedFilled;
