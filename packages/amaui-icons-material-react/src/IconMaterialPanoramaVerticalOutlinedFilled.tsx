...
const IconMaterialPanoramaVerticalOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PanoramaVerticalOutlinedFilled'
...
export default IconMaterialPanoramaVerticalOutlinedFilled;
