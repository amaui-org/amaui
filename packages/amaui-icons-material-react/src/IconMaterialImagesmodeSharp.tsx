...
const IconMaterialImagesmodeSharp = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ImagesmodeSharp'
...
IconMaterialImagesmodeSharp.displayName = 'AmauiIconMaterialImagesmodeSharp';

export default IconMaterialImagesmodeSharp;
