...
const IconMaterialWorkHistoryOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WorkHistoryOutlinedW100Filled'
...
export default IconMaterialWorkHistoryOutlinedW100Filled;
