...
const IconMaterialDetectorBatteryOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DetectorBatteryOutlinedW100'
...
export default IconMaterialDetectorBatteryOutlinedW100;
