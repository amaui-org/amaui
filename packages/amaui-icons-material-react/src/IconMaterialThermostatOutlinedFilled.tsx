...
const IconMaterialThermostatOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ThermostatOutlinedFilled'
...
export default IconMaterialThermostatOutlinedFilled;
