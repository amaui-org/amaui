...
const IconMaterialCottageOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CottageOutlinedW100Filled'
      short_name='Cottage'
...
export default IconMaterialCottageOutlinedW100Filled;
