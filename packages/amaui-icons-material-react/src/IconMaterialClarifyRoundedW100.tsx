...
const IconMaterialClarifyRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ClarifyRoundedW100'
      short_name='Clarify'
...
IconMaterialClarifyRoundedW100.displayName = 'AmauiIconMaterialClarifyRoundedW100';

export default IconMaterialClarifyRoundedW100;
