...
const IconMaterialStarRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='StarRoundedW100'
      short_name='Star'
...
IconMaterialStarRoundedW100.displayName = 'AmauiIconMaterialStarRoundedW100';

export default IconMaterialStarRoundedW100;
