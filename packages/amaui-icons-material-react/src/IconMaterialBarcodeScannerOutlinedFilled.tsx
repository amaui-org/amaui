...
const IconMaterialBarcodeScannerOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BarcodeScannerOutlinedFilled'
...
export default IconMaterialBarcodeScannerOutlinedFilled;
