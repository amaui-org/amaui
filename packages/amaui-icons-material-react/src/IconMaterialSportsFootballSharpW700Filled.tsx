...
const IconMaterialSportsFootballSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SportsFootballSharpW700Filled'
...
export default IconMaterialSportsFootballSharpW700Filled;
