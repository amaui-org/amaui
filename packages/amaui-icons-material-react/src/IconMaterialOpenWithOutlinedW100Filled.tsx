...
const IconMaterialOpenWithOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='OpenWithOutlinedW100Filled'
      short_name='OpenWith'
...
export default IconMaterialOpenWithOutlinedW100Filled;
