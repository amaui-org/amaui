...
const IconMaterialDirectionsAltRoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DirectionsAltRoundedW700'
...
export default IconMaterialDirectionsAltRoundedW700;
