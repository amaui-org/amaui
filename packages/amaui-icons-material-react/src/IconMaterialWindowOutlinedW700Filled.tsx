...
const IconMaterialWindowOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WindowOutlinedW700Filled'
      short_name='Window'
...
export default IconMaterialWindowOutlinedW700Filled;
