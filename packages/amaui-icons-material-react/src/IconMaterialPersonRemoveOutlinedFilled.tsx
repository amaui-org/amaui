...
const IconMaterialPersonRemoveOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PersonRemoveOutlinedFilled'
...
export default IconMaterialPersonRemoveOutlinedFilled;
