...
const IconMaterialNoAdultContentOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NoAdultContentOutlinedFilled'
...
export default IconMaterialNoAdultContentOutlinedFilled;
