...
const IconMaterialClarifyOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ClarifyOutlinedW100Filled'
      short_name='Clarify'
...
export default IconMaterialClarifyOutlinedW100Filled;
