...
const IconMaterialImageOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ImageOutlinedW100Filled'
      short_name='Image'
...
export default IconMaterialImageOutlinedW100Filled;
