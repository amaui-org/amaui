...
const IconMaterialIncompleteCircleOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='IncompleteCircleOutlinedW100Filled'
...
export default IconMaterialIncompleteCircleOutlinedW100Filled;
