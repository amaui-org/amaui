...
const IconMaterialHvacTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialHvacTwoTone.displayName = 'AmauiIconMaterialHvacTwoTone';

export default IconMaterialHvacTwoTone;
