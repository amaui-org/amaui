...
const IconMaterialLyricsOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LyricsOutlinedW100Filled'
      short_name='Lyrics'
...
export default IconMaterialLyricsOutlinedW100Filled;
