...
const IconMaterialDentistryRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DentistryRoundedW700Filled'
...
export default IconMaterialDentistryRoundedW700Filled;
