...
const IconMaterialHourglassDisabledOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HourglassDisabledOutlinedFilled'
...
export default IconMaterialHourglassDisabledOutlinedFilled;
