...
const IconMaterialEngineeringTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialEngineeringTwoTone.displayName = 'AmauiIconMaterialEngineeringTwoTone';

export default IconMaterialEngineeringTwoTone;
