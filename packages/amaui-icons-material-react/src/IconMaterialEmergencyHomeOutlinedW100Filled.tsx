...
const IconMaterialEmergencyHomeOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='EmergencyHomeOutlinedW100Filled'
...
export default IconMaterialEmergencyHomeOutlinedW100Filled;
