...
const IconMaterialAccountBoxOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AccountBoxOutlinedW100Filled'
...
export default IconMaterialAccountBoxOutlinedW100Filled;
