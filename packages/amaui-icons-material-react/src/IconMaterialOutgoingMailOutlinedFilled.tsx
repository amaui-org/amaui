...
const IconMaterialOutgoingMailOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='OutgoingMailOutlinedFilled'
...
export default IconMaterialOutgoingMailOutlinedFilled;
