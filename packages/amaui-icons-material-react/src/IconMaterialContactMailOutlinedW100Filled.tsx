...
const IconMaterialContactMailOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ContactMailOutlinedW100Filled'
...
export default IconMaterialContactMailOutlinedW100Filled;
