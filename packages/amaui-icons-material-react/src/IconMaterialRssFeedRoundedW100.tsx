...
const IconMaterialRssFeedRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RssFeedRoundedW100'
      short_name='RssFeed'
...
IconMaterialRssFeedRoundedW100.displayName = 'AmauiIconMaterialRssFeedRoundedW100';

export default IconMaterialRssFeedRoundedW100;
