...
const IconMaterialHowToVoteOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HowToVoteOutlinedFilled'
...
export default IconMaterialHowToVoteOutlinedFilled;
