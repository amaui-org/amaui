...
const IconMaterialWorkspacesOutlineRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WorkspacesOutlineRoundedW700Filled'
...
export default IconMaterialWorkspacesOutlineRoundedW700Filled;
