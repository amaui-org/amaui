...
const IconMaterialSpellcheckOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SpellcheckOutlinedW100Filled'
...
export default IconMaterialSpellcheckOutlinedW100Filled;
