...
const IconMaterialRepeatOneOnSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RepeatOneOnSharpW700Filled'
...
export default IconMaterialRepeatOneOnSharpW700Filled;
