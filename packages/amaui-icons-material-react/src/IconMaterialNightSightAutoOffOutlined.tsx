...
const IconMaterialNightSightAutoOffOutlined = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NightSightAutoOffOutlined'
...
export default IconMaterialNightSightAutoOffOutlined;
