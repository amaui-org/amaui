...
const IconMaterialPianoOffSharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PianoOffSharpW100'
      short_name='PianoOff'
...
IconMaterialPianoOffSharpW100.displayName = 'AmauiIconMaterialPianoOffSharpW100';

export default IconMaterialPianoOffSharpW100;
