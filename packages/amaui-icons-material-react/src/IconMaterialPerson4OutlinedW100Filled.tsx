...
const IconMaterialPerson4OutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Person4OutlinedW100Filled'
      short_name='Person4'
...
export default IconMaterialPerson4OutlinedW100Filled;
