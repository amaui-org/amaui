...
const IconMaterialBedroomChildTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialBedroomChildTwoTone.displayName = 'AmauiIconMaterialBedroomChildTwoTone';

export default IconMaterialBedroomChildTwoTone;
