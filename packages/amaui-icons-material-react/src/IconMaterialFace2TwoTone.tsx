...
const IconMaterialFace2TwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialFace2TwoTone.displayName = 'AmauiIconMaterialFace2TwoTone';

export default IconMaterialFace2TwoTone;
