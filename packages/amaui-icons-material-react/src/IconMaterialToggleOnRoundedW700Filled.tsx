...
const IconMaterialToggleOnRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ToggleOnRoundedW700Filled'
      short_name='ToggleOn'
...
export default IconMaterialToggleOnRoundedW700Filled;
