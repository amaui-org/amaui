...
const IconMaterialPinInvokeOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PinInvokeOutlinedFilled'
...
export default IconMaterialPinInvokeOutlinedFilled;
