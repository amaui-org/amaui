...
const IconMaterialDoNotDisturbOnTotalSilenceSharpW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DoNotDisturbOnTotalSilenceSharpW700'
...
export default IconMaterialDoNotDisturbOnTotalSilenceSharpW700;
