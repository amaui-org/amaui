...
const IconMaterialToolsPliersWireStripperOutlined = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ToolsPliersWireStripperOutlined'
...
export default IconMaterialToolsPliersWireStripperOutlined;
