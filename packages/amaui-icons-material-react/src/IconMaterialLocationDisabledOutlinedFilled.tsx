...
const IconMaterialLocationDisabledOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LocationDisabledOutlinedFilled'
...
export default IconMaterialLocationDisabledOutlinedFilled;
