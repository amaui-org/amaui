...
const IconMaterialOpenInNewOffOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='OpenInNewOffOutlinedFilled'
...
export default IconMaterialOpenInNewOffOutlinedFilled;
