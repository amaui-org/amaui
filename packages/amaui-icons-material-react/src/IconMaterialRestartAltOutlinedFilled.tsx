...
const IconMaterialRestartAltOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RestartAltOutlinedFilled'
...
export default IconMaterialRestartAltOutlinedFilled;
