...
const IconMaterialAlarmAddSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AlarmAddSharpW700Filled'
      short_name='AlarmAdd'
...
export default IconMaterialAlarmAddSharpW700Filled;
