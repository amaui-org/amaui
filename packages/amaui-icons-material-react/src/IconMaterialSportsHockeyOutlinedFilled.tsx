...
const IconMaterialSportsHockeyOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SportsHockeyOutlinedFilled'
...
export default IconMaterialSportsHockeyOutlinedFilled;
