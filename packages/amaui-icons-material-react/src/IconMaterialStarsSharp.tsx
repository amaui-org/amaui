...
const IconMaterialStarsSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialStarsSharp.displayName = 'AmauiIconMaterialStarsSharp';

export default IconMaterialStarsSharp;
