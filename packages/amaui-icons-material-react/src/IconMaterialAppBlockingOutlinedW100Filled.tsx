...
const IconMaterialAppBlockingOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AppBlockingOutlinedW100Filled'
...
export default IconMaterialAppBlockingOutlinedW100Filled;
