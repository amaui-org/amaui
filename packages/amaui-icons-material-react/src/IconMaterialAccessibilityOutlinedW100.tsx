...
const IconMaterialAccessibilityOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AccessibilityOutlinedW100'
...
export default IconMaterialAccessibilityOutlinedW100;
