...
const IconMaterialDetectorAlarmOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DetectorAlarmOutlinedFilled'
...
export default IconMaterialDetectorAlarmOutlinedFilled;
