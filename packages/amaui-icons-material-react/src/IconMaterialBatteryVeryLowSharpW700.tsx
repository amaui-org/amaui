...
const IconMaterialBatteryVeryLowSharpW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryVeryLowSharpW700'
...
export default IconMaterialBatteryVeryLowSharpW700;
