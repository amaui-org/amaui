...
const IconMaterialPublishRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialPublishRounded.displayName = 'AmauiIconMaterialPublishRounded';

export default IconMaterialPublishRounded;
