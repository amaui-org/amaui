...
const IconMaterialGroups3RoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Groups3RoundedW700Filled'
      short_name='Groups3'
...
export default IconMaterialGroups3RoundedW700Filled;
