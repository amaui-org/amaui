...
const IconMaterialBlindSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialBlindSharp.displayName = 'AmauiIconMaterialBlindSharp';

export default IconMaterialBlindSharp;
