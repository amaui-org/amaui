...
const IconMaterialTempPreferencesEcoOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TempPreferencesEcoOutlinedFilled'
...
export default IconMaterialTempPreferencesEcoOutlinedFilled;
