...
const IconMaterialDetectorAlarmOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DetectorAlarmOutlinedW100'
...
export default IconMaterialDetectorAlarmOutlinedW100;
