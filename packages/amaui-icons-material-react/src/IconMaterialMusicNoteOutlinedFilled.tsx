...
const IconMaterialMusicNoteOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MusicNoteOutlinedFilled'
...
export default IconMaterialMusicNoteOutlinedFilled;
