...
const IconMaterialTimerOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TimerOutlinedW100Filled'
      short_name='Timer'
...
export default IconMaterialTimerOutlinedW100Filled;
