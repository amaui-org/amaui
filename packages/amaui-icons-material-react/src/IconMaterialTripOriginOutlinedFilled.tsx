...
const IconMaterialTripOriginOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TripOriginOutlinedFilled'
...
export default IconMaterialTripOriginOutlinedFilled;
