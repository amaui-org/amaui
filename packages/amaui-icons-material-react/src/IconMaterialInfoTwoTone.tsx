...
const IconMaterialInfoTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialInfoTwoTone.displayName = 'AmauiIconMaterialInfoTwoTone';

export default IconMaterialInfoTwoTone;
