...
const IconMaterialRememberMeOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RememberMeOutlinedW100Filled'
...
export default IconMaterialRememberMeOutlinedW100Filled;
