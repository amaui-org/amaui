...
const IconMaterialToolsLadderRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ToolsLadderRoundedW700Filled'
...
export default IconMaterialToolsLadderRoundedW700Filled;
