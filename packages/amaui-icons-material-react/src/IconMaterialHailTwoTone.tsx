...
const IconMaterialHailTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialHailTwoTone.displayName = 'AmauiIconMaterialHailTwoTone';

export default IconMaterialHailTwoTone;
