...
const IconMaterialDishwasherGenOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DishwasherGenOutlinedW100Filled'
...
export default IconMaterialDishwasherGenOutlinedW100Filled;
