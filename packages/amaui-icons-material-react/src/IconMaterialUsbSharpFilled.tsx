...
const IconMaterialUsbSharpFilled = React.forwardRef((props: any, ref) => {
...
IconMaterialUsbSharpFilled.displayName = 'AmauiIconMaterialUsbSharpFilled';

export default IconMaterialUsbSharpFilled;
