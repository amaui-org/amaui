...
const IconMaterialArrowRightAltRoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ArrowRightAltRoundedW700'
...
export default IconMaterialArrowRightAltRoundedW700;
