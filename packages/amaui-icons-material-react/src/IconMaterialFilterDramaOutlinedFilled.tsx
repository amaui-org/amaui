...
const IconMaterialFilterDramaOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FilterDramaOutlinedFilled'
...
export default IconMaterialFilterDramaOutlinedFilled;
