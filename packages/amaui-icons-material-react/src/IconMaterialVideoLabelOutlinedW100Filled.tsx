...
const IconMaterialVideoLabelOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='VideoLabelOutlinedW100Filled'
...
export default IconMaterialVideoLabelOutlinedW100Filled;
