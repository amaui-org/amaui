...
const IconMaterialCloudUploadOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CloudUploadOutlinedW100Filled'
...
export default IconMaterialCloudUploadOutlinedW100Filled;
