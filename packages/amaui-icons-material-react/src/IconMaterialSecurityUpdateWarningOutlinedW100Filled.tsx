...
const IconMaterialSecurityUpdateWarningOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SecurityUpdateWarningOutlinedW100Filled'
...
export default IconMaterialSecurityUpdateWarningOutlinedW100Filled;
