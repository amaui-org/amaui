...
const IconMaterialAutoScheduleOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AutoScheduleOutlinedW700Filled'
...
export default IconMaterialAutoScheduleOutlinedW700Filled;
