...
const IconMaterialCachedOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CachedOutlinedW100Filled'
      short_name='Cached'
...
export default IconMaterialCachedOutlinedW100Filled;
