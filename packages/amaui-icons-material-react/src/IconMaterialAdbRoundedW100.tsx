...
const IconMaterialAdbRoundedW100 = React.forwardRef((props: any, ref) => {
...
IconMaterialAdbRoundedW100.displayName = 'AmauiIconMaterialAdbRoundedW100';

export default IconMaterialAdbRoundedW100;
