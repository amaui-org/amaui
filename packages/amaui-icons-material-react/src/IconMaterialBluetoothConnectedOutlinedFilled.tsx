...
const IconMaterialBluetoothConnectedOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BluetoothConnectedOutlinedFilled'
...
export default IconMaterialBluetoothConnectedOutlinedFilled;
