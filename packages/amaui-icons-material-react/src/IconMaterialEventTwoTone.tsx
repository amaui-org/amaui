...
const IconMaterialEventTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialEventTwoTone.displayName = 'AmauiIconMaterialEventTwoTone';

export default IconMaterialEventTwoTone;
