...
const IconMaterialFilterOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FilterOutlinedW100Filled'
      short_name='Filter'
...
export default IconMaterialFilterOutlinedW100Filled;
