...
const IconMaterialBatteryCharging50OutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryCharging50OutlinedW700'
...
export default IconMaterialBatteryCharging50OutlinedW700;
