...
const IconMaterialAutorenewSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialAutorenewSharp.displayName = 'AmauiIconMaterialAutorenewSharp';

export default IconMaterialAutorenewSharp;
