...
const IconMaterialFileDownloadDoneRoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FileDownloadDoneRoundedW700'
...
export default IconMaterialFileDownloadDoneRoundedW700;
