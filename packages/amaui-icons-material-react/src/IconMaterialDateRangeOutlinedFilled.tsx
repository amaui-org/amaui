...
const IconMaterialDateRangeOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DateRangeOutlinedFilled'
...
export default IconMaterialDateRangeOutlinedFilled;
