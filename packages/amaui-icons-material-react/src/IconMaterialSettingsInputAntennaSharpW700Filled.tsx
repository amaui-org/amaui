...
const IconMaterialSettingsInputAntennaSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SettingsInputAntennaSharpW700Filled'
...
export default IconMaterialSettingsInputAntennaSharpW700Filled;
