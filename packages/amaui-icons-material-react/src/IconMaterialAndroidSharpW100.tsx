...
const IconMaterialAndroidSharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AndroidSharpW100'
      short_name='Android'
...
IconMaterialAndroidSharpW100.displayName = 'AmauiIconMaterialAndroidSharpW100';

export default IconMaterialAndroidSharpW100;
