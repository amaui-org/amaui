...
const IconMaterialNearMeDisabledOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NearMeDisabledOutlinedFilled'
...
export default IconMaterialNearMeDisabledOutlinedFilled;
