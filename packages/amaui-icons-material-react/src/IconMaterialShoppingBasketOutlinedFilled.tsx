...
const IconMaterialShoppingBasketOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ShoppingBasketOutlinedFilled'
...
export default IconMaterialShoppingBasketOutlinedFilled;
