...
const IconMaterialBrightness2SharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Brightness2SharpW700Filled'
...
export default IconMaterialBrightness2SharpW700Filled;
