...
const IconMaterialCommunicationOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CommunicationOutlinedW100'
...
export default IconMaterialCommunicationOutlinedW100;
