...
const IconMaterialModeHeatRounded = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ModeHeatRounded'
      short_name='ModeHeat'
...
IconMaterialModeHeatRounded.displayName = 'AmauiIconMaterialModeHeatRounded';

export default IconMaterialModeHeatRounded;
