...
const IconMaterialOpenWithSharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='OpenWithSharpW100'
      short_name='OpenWith'
...
IconMaterialOpenWithSharpW100.displayName = 'AmauiIconMaterialOpenWithSharpW100';

export default IconMaterialOpenWithSharpW100;
