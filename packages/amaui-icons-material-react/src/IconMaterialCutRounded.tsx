...
const IconMaterialCutRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialCutRounded.displayName = 'AmauiIconMaterialCutRounded';

export default IconMaterialCutRounded;
