...
const IconMaterialSouthAmericaSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialSouthAmericaSharp.displayName = 'AmauiIconMaterialSouthAmericaSharp';

export default IconMaterialSouthAmericaSharp;
