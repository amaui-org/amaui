...
const IconMaterialTextToSpeechOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TextToSpeechOutlinedFilled'
...
export default IconMaterialTextToSpeechOutlinedFilled;
