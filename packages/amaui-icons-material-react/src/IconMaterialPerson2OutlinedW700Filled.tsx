...
const IconMaterialPerson2OutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Person2OutlinedW700Filled'
      short_name='Person2'
...
export default IconMaterialPerson2OutlinedW700Filled;
