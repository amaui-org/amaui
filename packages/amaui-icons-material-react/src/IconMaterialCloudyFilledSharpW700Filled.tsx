...
const IconMaterialCloudyFilledSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CloudyFilledSharpW700Filled'
...
export default IconMaterialCloudyFilledSharpW700Filled;
