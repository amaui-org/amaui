...
const IconMaterialBentoTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialBentoTwoTone.displayName = 'AmauiIconMaterialBentoTwoTone';

export default IconMaterialBentoTwoTone;
