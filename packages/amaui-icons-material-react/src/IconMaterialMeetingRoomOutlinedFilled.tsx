...
const IconMaterialMeetingRoomOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MeetingRoomOutlinedFilled'
...
export default IconMaterialMeetingRoomOutlinedFilled;
