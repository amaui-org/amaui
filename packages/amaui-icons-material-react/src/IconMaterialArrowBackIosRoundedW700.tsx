...
const IconMaterialArrowBackIosRoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ArrowBackIosRoundedW700'
...
export default IconMaterialArrowBackIosRoundedW700;
