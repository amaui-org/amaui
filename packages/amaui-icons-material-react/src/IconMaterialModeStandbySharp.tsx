...
const IconMaterialModeStandbySharp = React.forwardRef((props: any, ref) => {
...
IconMaterialModeStandbySharp.displayName = 'AmauiIconMaterialModeStandbySharp';

export default IconMaterialModeStandbySharp;
