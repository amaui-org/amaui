...
const IconMaterialAlarmOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AlarmOutlinedW700Filled'
      short_name='Alarm'
...
export default IconMaterialAlarmOutlinedW700Filled;
