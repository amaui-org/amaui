...
const IconMaterialHomeMaxDotsOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HomeMaxDotsOutlinedW100Filled'
...
export default IconMaterialHomeMaxDotsOutlinedW100Filled;
