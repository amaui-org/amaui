...
const IconMaterialAlarmAddSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialAlarmAddSharp.displayName = 'AmauiIconMaterialAlarmAddSharp';

export default IconMaterialAlarmAddSharp;
