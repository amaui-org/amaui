...
const IconMaterialBlockOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BlockOutlinedW100Filled'
      short_name='Block'
...
export default IconMaterialBlockOutlinedW100Filled;
