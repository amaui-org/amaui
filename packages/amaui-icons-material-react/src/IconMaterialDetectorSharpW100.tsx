...
const IconMaterialDetectorSharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DetectorSharpW100'
      short_name='Detector'
...
IconMaterialDetectorSharpW100.displayName = 'AmauiIconMaterialDetectorSharpW100';

export default IconMaterialDetectorSharpW100;
