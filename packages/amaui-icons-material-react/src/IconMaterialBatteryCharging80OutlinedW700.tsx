...
const IconMaterialBatteryCharging80OutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryCharging80OutlinedW700'
...
export default IconMaterialBatteryCharging80OutlinedW700;
