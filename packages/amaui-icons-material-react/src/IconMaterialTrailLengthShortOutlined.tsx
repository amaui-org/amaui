...
const IconMaterialTrailLengthShortOutlined = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TrailLengthShortOutlined'
...
export default IconMaterialTrailLengthShortOutlined;
