...
const IconMaterialHistorySharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HistorySharpFilled'
      short_name='History'
...
IconMaterialHistorySharpFilled.displayName = 'AmauiIconMaterialHistorySharpFilled';

export default IconMaterialHistorySharpFilled;
