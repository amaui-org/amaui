...
const IconMaterialModeHeatOffOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ModeHeatOffOutlinedW100Filled'
...
export default IconMaterialModeHeatOffOutlinedW100Filled;
