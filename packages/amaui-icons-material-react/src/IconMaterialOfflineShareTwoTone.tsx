...
const IconMaterialOfflineShareTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialOfflineShareTwoTone.displayName = 'AmauiIconMaterialOfflineShareTwoTone';

export default IconMaterialOfflineShareTwoTone;
