...
const IconMaterialPanoramaWideAngleOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PanoramaWideAngleOutlinedFilled'
...
export default IconMaterialPanoramaWideAngleOutlinedFilled;
