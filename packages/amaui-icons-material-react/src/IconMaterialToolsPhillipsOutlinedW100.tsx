...
const IconMaterialToolsPhillipsOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ToolsPhillipsOutlinedW100'
...
export default IconMaterialToolsPhillipsOutlinedW100;
