...
const IconMaterialHourglassEmptyOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HourglassEmptyOutlinedW100'
...
export default IconMaterialHourglassEmptyOutlinedW100;
