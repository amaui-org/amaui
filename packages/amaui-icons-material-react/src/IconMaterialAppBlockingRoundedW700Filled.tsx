...
const IconMaterialAppBlockingRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AppBlockingRoundedW700Filled'
...
export default IconMaterialAppBlockingRoundedW700Filled;
