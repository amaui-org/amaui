...
const IconMaterialStrikethroughSOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='StrikethroughSOutlinedFilled'
...
export default IconMaterialStrikethroughSOutlinedFilled;
