...
const IconMaterialNestLocatorTagOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestLocatorTagOutlinedW100'
...
export default IconMaterialNestLocatorTagOutlinedW100;
