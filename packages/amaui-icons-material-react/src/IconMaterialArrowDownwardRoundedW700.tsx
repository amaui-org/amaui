...
const IconMaterialArrowDownwardRoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ArrowDownwardRoundedW700'
...
export default IconMaterialArrowDownwardRoundedW700;
