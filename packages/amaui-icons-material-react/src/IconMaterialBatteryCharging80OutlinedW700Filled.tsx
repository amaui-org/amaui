...
const IconMaterialBatteryCharging80OutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryCharging80OutlinedW700Filled'
...
export default IconMaterialBatteryCharging80OutlinedW700Filled;
