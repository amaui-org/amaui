...
const IconMaterialMultipleStopOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MultipleStopOutlinedFilled'
...
export default IconMaterialMultipleStopOutlinedFilled;
