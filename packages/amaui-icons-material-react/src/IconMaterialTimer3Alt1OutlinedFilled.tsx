...
const IconMaterialTimer3Alt1OutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Timer3Alt1OutlinedFilled'
...
export default IconMaterialTimer3Alt1OutlinedFilled;
