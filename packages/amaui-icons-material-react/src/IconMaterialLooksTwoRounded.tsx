...
const IconMaterialLooksTwoRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialLooksTwoRounded.displayName = 'AmauiIconMaterialLooksTwoRounded';

export default IconMaterialLooksTwoRounded;
