...
const IconMaterialSportsMmaTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialSportsMmaTwoTone.displayName = 'AmauiIconMaterialSportsMmaTwoTone';

export default IconMaterialSportsMmaTwoTone;
