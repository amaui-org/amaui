...
const IconMaterialDirectionsRunSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialDirectionsRunSharp.displayName = 'AmauiIconMaterialDirectionsRunSharp';

export default IconMaterialDirectionsRunSharp;
