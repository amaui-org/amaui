...
const IconMaterialWorkHistoryTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialWorkHistoryTwoTone.displayName = 'AmauiIconMaterialWorkHistoryTwoTone';

export default IconMaterialWorkHistoryTwoTone;
