...
const IconMaterialWindowSensorRoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WindowSensorRoundedW700'
...
export default IconMaterialWindowSensorRoundedW700;
