...
const IconMaterialSavingsOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SavingsOutlinedW100Filled'
      short_name='Savings'
...
export default IconMaterialSavingsOutlinedW100Filled;
