...
const IconMaterialSignalWifiBadOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SignalWifiBadOutlinedFilled'
...
export default IconMaterialSignalWifiBadOutlinedFilled;
