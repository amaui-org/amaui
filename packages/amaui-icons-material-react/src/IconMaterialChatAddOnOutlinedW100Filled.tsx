...
const IconMaterialChatAddOnOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ChatAddOnOutlinedW100Filled'
...
export default IconMaterialChatAddOnOutlinedW100Filled;
