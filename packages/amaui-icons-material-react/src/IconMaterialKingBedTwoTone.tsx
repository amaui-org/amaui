...
const IconMaterialKingBedTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialKingBedTwoTone.displayName = 'AmauiIconMaterialKingBedTwoTone';

export default IconMaterialKingBedTwoTone;
