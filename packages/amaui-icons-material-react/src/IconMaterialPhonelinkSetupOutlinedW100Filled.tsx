...
const IconMaterialPhonelinkSetupOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PhonelinkSetupOutlinedW100Filled'
...
export default IconMaterialPhonelinkSetupOutlinedW100Filled;
