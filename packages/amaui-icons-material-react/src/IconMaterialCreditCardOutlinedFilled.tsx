...
const IconMaterialCreditCardOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CreditCardOutlinedFilled'
...
export default IconMaterialCreditCardOutlinedFilled;
