...
const IconMaterialUnfoldMoreDoubleOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='UnfoldMoreDoubleOutlinedW100Filled'
...
export default IconMaterialUnfoldMoreDoubleOutlinedW100Filled;
