...
const IconMaterialClarifyRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ClarifyRoundedW700Filled'
      short_name='Clarify'
...
export default IconMaterialClarifyRoundedW700Filled;
