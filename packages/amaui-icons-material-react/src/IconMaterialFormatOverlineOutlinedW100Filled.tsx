...
const IconMaterialFormatOverlineOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FormatOverlineOutlinedW100Filled'
...
export default IconMaterialFormatOverlineOutlinedW100Filled;
