...
const IconMaterialNightSightAutoOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NightSightAutoOutlinedFilled'
...
export default IconMaterialNightSightAutoOutlinedFilled;
