...
const IconMaterialReplayCircleFilledOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ReplayCircleFilledOutlinedFilled'
...
export default IconMaterialReplayCircleFilledOutlinedFilled;
