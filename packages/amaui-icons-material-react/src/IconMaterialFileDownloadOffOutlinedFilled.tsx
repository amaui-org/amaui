...
const IconMaterialFileDownloadOffOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FileDownloadOffOutlinedFilled'
...
export default IconMaterialFileDownloadOffOutlinedFilled;
