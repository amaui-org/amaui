...
const IconMaterialSetMealTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialSetMealTwoTone.displayName = 'AmauiIconMaterialSetMealTwoTone';

export default IconMaterialSetMealTwoTone;
