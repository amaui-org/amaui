...
const IconMaterialBattery90RoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Battery90RoundedW700Filled'
...
export default IconMaterialBattery90RoundedW700Filled;
