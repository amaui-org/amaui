...
const IconMaterialAddLinkOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AddLinkOutlinedW100Filled'
      short_name='AddLink'
...
export default IconMaterialAddLinkOutlinedW100Filled;
