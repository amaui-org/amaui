...
const IconMaterialBatteryVeryLowOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryVeryLowOutlinedW700'
...
export default IconMaterialBatteryVeryLowOutlinedW700;
