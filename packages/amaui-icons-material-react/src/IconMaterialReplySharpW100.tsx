...
const IconMaterialReplySharpW100 = React.forwardRef((props: any, ref) => {
...
IconMaterialReplySharpW100.displayName = 'AmauiIconMaterialReplySharpW100';

export default IconMaterialReplySharpW100;
