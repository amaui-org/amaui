...
const IconMaterialDetectorBatteryRoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DetectorBatteryRoundedW700'
...
export default IconMaterialDetectorBatteryRoundedW700;
