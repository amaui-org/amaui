...
const IconMaterialFindReplaceOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FindReplaceOutlinedW100'
...
export default IconMaterialFindReplaceOutlinedW100;
