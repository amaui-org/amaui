...
const IconMaterialColorizeTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialColorizeTwoTone.displayName = 'AmauiIconMaterialColorizeTwoTone';

export default IconMaterialColorizeTwoTone;
