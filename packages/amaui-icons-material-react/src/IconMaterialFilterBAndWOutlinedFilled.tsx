...
const IconMaterialFilterBAndWOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FilterBAndWOutlinedFilled'
...
export default IconMaterialFilterBAndWOutlinedFilled;
