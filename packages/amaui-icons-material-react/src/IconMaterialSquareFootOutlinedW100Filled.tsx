...
const IconMaterialSquareFootOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SquareFootOutlinedW100Filled'
...
export default IconMaterialSquareFootOutlinedW100Filled;
