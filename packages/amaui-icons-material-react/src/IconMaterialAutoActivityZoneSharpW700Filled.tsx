...
const IconMaterialAutoActivityZoneSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AutoActivityZoneSharpW700Filled'
...
export default IconMaterialAutoActivityZoneSharpW700Filled;
