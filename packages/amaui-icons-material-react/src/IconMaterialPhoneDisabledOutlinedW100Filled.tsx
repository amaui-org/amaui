...
const IconMaterialPhoneDisabledOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PhoneDisabledOutlinedW100Filled'
...
export default IconMaterialPhoneDisabledOutlinedW100Filled;
