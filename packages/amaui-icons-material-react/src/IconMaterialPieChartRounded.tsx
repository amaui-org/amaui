...
const IconMaterialPieChartRounded = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PieChartRounded'
      short_name='PieChart'
...
IconMaterialPieChartRounded.displayName = 'AmauiIconMaterialPieChartRounded';

export default IconMaterialPieChartRounded;
