...
const IconMaterialNestFarsightWeatherOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestFarsightWeatherOutlinedW100'
...
export default IconMaterialNestFarsightWeatherOutlinedW100;
