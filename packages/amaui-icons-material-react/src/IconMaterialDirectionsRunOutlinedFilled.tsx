...
const IconMaterialDirectionsRunOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DirectionsRunOutlinedFilled'
...
export default IconMaterialDirectionsRunOutlinedFilled;
