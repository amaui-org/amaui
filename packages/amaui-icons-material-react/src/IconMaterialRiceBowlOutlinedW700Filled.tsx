...
const IconMaterialRiceBowlOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RiceBowlOutlinedW700Filled'
      short_name='RiceBowl'
...
export default IconMaterialRiceBowlOutlinedW700Filled;
