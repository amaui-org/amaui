...
const IconMaterialBattery3BarOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Battery3BarOutlinedW100Filled'
...
export default IconMaterialBattery3BarOutlinedW100Filled;
