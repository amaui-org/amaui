...
const IconMaterialRemoveModeratorOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RemoveModeratorOutlinedFilled'
...
export default IconMaterialRemoveModeratorOutlinedFilled;
