...
const IconMaterialClearDaySharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ClearDaySharpFilled'
      short_name='ClearDay'
...
IconMaterialClearDaySharpFilled.displayName = 'AmauiIconMaterialClearDaySharpFilled';

export default IconMaterialClearDaySharpFilled;
