...
const IconMaterialAddToPhotosTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialAddToPhotosTwoTone.displayName = 'AmauiIconMaterialAddToPhotosTwoTone';

export default IconMaterialAddToPhotosTwoTone;
