...
const IconMaterialBatteryCharging50OutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryCharging50OutlinedFilled'
...
export default IconMaterialBatteryCharging50OutlinedFilled;
