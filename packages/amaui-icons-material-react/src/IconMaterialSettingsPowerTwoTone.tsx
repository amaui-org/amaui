...
const IconMaterialSettingsPowerTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialSettingsPowerTwoTone.displayName = 'AmauiIconMaterialSettingsPowerTwoTone';

export default IconMaterialSettingsPowerTwoTone;
