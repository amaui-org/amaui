...
const IconMaterialLowPriorityOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LowPriorityOutlinedFilled'
...
export default IconMaterialLowPriorityOutlinedFilled;
