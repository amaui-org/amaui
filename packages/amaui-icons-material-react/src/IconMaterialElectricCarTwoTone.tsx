...
const IconMaterialElectricCarTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialElectricCarTwoTone.displayName = 'AmauiIconMaterialElectricCarTwoTone';

export default IconMaterialElectricCarTwoTone;
