...
const IconMaterialCloudQueueOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CloudQueueOutlinedFilled'
...
export default IconMaterialCloudQueueOutlinedFilled;
