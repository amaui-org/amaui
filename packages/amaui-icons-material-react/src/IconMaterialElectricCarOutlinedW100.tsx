...
const IconMaterialElectricCarOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ElectricCarOutlinedW100'
...
export default IconMaterialElectricCarOutlinedW100;
