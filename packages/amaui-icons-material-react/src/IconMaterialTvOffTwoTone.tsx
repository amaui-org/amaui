...
const IconMaterialTvOffTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialTvOffTwoTone.displayName = 'AmauiIconMaterialTvOffTwoTone';

export default IconMaterialTvOffTwoTone;
