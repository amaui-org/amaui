...
const IconMaterialMusicNoteOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MusicNoteOutlinedW100Filled'
...
export default IconMaterialMusicNoteOutlinedW100Filled;
