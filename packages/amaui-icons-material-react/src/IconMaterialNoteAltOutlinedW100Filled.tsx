...
const IconMaterialNoteAltOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NoteAltOutlinedW100Filled'
      short_name='NoteAlt'
...
export default IconMaterialNoteAltOutlinedW100Filled;
