...
const IconMaterialManageSearchOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ManageSearchOutlinedFilled'
...
export default IconMaterialManageSearchOutlinedFilled;
