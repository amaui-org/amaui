...
const IconMaterialCopyAllRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CopyAllRoundedW700Filled'
      short_name='CopyAll'
...
export default IconMaterialCopyAllRoundedW700Filled;
