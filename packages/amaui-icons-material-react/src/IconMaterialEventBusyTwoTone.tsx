...
const IconMaterialEventBusyTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialEventBusyTwoTone.displayName = 'AmauiIconMaterialEventBusyTwoTone';

export default IconMaterialEventBusyTwoTone;
