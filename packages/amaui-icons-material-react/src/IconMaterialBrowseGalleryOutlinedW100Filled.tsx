...
const IconMaterialBrowseGalleryOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BrowseGalleryOutlinedW100Filled'
...
export default IconMaterialBrowseGalleryOutlinedW100Filled;
