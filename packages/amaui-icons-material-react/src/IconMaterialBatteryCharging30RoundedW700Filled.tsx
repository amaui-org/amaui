...
const IconMaterialBatteryCharging30RoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryCharging30RoundedW700Filled'
...
export default IconMaterialBatteryCharging30RoundedW700Filled;
