...
const IconMaterialBrightnessMediumOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BrightnessMediumOutlinedW700'
...
export default IconMaterialBrightnessMediumOutlinedW700;
