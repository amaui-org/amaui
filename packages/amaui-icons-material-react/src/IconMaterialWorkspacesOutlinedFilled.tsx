...
const IconMaterialWorkspacesOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WorkspacesOutlinedFilled'
...
export default IconMaterialWorkspacesOutlinedFilled;
