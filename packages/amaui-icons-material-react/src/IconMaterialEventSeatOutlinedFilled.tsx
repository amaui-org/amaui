...
const IconMaterialEventSeatOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='EventSeatOutlinedFilled'
...
export default IconMaterialEventSeatOutlinedFilled;
