...
const IconMaterialHourglassBottomOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HourglassBottomOutlinedW100Filled'
...
export default IconMaterialHourglassBottomOutlinedW100Filled;
