...
const IconMaterialMusicOffRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MusicOffRoundedW100'
      short_name='MusicOff'
...
IconMaterialMusicOffRoundedW100.displayName = 'AmauiIconMaterialMusicOffRoundedW100';

export default IconMaterialMusicOffRoundedW100;
