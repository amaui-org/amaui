...
const IconMaterialPinEndSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PinEndSharpFilled'
      short_name='PinEnd'
...
IconMaterialPinEndSharpFilled.displayName = 'AmauiIconMaterialPinEndSharpFilled';

export default IconMaterialPinEndSharpFilled;
