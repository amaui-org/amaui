...
const IconMaterialTextureOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TextureOutlinedW100Filled'
      short_name='Texture'
...
export default IconMaterialTextureOutlinedW100Filled;
