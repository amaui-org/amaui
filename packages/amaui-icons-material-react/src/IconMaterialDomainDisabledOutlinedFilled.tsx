...
const IconMaterialDomainDisabledOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DomainDisabledOutlinedFilled'
...
export default IconMaterialDomainDisabledOutlinedFilled;
