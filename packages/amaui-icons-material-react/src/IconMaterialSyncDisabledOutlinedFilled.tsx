...
const IconMaterialSyncDisabledOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SyncDisabledOutlinedFilled'
...
export default IconMaterialSyncDisabledOutlinedFilled;
