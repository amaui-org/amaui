...
const IconMaterialOvenGenRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialOvenGenRounded.displayName = 'AmauiIconMaterialOvenGenRounded';

export default IconMaterialOvenGenRounded;
