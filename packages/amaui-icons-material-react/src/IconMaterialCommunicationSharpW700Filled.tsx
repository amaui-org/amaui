...
const IconMaterialCommunicationSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CommunicationSharpW700Filled'
...
export default IconMaterialCommunicationSharpW700Filled;
