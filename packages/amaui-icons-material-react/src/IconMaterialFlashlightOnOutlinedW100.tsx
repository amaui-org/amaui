...
const IconMaterialFlashlightOnOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FlashlightOnOutlinedW100'
...
export default IconMaterialFlashlightOnOutlinedW100;
