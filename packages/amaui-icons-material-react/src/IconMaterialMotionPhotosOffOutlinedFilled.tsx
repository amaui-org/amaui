...
const IconMaterialMotionPhotosOffOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MotionPhotosOffOutlinedFilled'
...
export default IconMaterialMotionPhotosOffOutlinedFilled;
