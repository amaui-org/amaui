...
const IconMaterialCasesRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CasesRoundedW100'
      short_name='Cases'
...
IconMaterialCasesRoundedW100.displayName = 'AmauiIconMaterialCasesRoundedW100';

export default IconMaterialCasesRoundedW100;
