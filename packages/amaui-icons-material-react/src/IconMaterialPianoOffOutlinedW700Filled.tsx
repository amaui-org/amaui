...
const IconMaterialPianoOffOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PianoOffOutlinedW700Filled'
      short_name='PianoOff'
...
export default IconMaterialPianoOffOutlinedW700Filled;
