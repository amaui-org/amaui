...
const IconMaterialDevicesOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DevicesOutlinedW700Filled'
      short_name='Devices'
...
export default IconMaterialDevicesOutlinedW700Filled;
