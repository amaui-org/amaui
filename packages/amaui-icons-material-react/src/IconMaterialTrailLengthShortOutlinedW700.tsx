...
const IconMaterialTrailLengthShortOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TrailLengthShortOutlinedW700'
...
export default IconMaterialTrailLengthShortOutlinedW700;
