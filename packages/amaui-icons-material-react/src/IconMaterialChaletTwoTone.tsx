...
const IconMaterialChaletTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialChaletTwoTone.displayName = 'AmauiIconMaterialChaletTwoTone';

export default IconMaterialChaletTwoTone;
