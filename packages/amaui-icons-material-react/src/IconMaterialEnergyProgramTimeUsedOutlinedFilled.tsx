...
const IconMaterialEnergyProgramTimeUsedOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='EnergyProgramTimeUsedOutlinedFilled'
...
export default IconMaterialEnergyProgramTimeUsedOutlinedFilled;
