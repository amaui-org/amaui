...
const IconMaterialBatteryAlertTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialBatteryAlertTwoTone.displayName = 'AmauiIconMaterialBatteryAlertTwoTone';

export default IconMaterialBatteryAlertTwoTone;
