...
const IconMaterialStorageOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='StorageOutlinedW700Filled'
      short_name='Storage'
...
export default IconMaterialStorageOutlinedW700Filled;
