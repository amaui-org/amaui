...
const IconMaterialVoiceChatTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialVoiceChatTwoTone.displayName = 'AmauiIconMaterialVoiceChatTwoTone';

export default IconMaterialVoiceChatTwoTone;
