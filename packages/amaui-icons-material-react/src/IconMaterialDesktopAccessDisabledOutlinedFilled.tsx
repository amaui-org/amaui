...
const IconMaterialDesktopAccessDisabledOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DesktopAccessDisabledOutlinedFilled'
...
export default IconMaterialDesktopAccessDisabledOutlinedFilled;
