...
const IconMaterialWallpaperOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WallpaperOutlinedFilled'
...
export default IconMaterialWallpaperOutlinedFilled;
