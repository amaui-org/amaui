...
const IconMaterialPerson3SharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Person3SharpFilled'
      short_name='Person3'
...
IconMaterialPerson3SharpFilled.displayName = 'AmauiIconMaterialPerson3SharpFilled';

export default IconMaterialPerson3SharpFilled;
