...
const IconMaterialGroupAddTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialGroupAddTwoTone.displayName = 'AmauiIconMaterialGroupAddTwoTone';

export default IconMaterialGroupAddTwoTone;
