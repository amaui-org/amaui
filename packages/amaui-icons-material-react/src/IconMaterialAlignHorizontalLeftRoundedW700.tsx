...
const IconMaterialAlignHorizontalLeftRoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AlignHorizontalLeftRoundedW700'
...
export default IconMaterialAlignHorizontalLeftRoundedW700;
