...
const IconMaterialDirectionsRailwayOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DirectionsRailwayOutlinedFilled'
...
export default IconMaterialDirectionsRailwayOutlinedFilled;
