...
const IconMaterialExposureTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialExposureTwoTone.displayName = 'AmauiIconMaterialExposureTwoTone';

export default IconMaterialExposureTwoTone;
