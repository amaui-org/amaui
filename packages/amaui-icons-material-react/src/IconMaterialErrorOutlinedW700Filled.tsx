...
const IconMaterialErrorOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ErrorOutlinedW700Filled'
      short_name='Error'
...
export default IconMaterialErrorOutlinedW700Filled;
