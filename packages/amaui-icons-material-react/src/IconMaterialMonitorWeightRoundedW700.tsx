...
const IconMaterialMonitorWeightRoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MonitorWeightRoundedW700'
...
export default IconMaterialMonitorWeightRoundedW700;
