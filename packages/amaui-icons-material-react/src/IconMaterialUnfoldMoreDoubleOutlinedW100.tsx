...
const IconMaterialUnfoldMoreDoubleOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='UnfoldMoreDoubleOutlinedW100'
...
export default IconMaterialUnfoldMoreDoubleOutlinedW100;
