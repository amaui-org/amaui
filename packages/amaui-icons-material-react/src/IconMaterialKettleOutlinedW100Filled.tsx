...
const IconMaterialKettleOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='KettleOutlinedW100Filled'
      short_name='Kettle'
...
export default IconMaterialKettleOutlinedW100Filled;
