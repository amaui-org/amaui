...
const IconMaterialGeneratingTokensOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='GeneratingTokensOutlinedFilled'
...
export default IconMaterialGeneratingTokensOutlinedFilled;
