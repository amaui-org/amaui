...
const IconMaterialLinkOffSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialLinkOffSharp.displayName = 'AmauiIconMaterialLinkOffSharp';

export default IconMaterialLinkOffSharp;
