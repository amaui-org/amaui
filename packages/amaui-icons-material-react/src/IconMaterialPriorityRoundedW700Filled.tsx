...
const IconMaterialPriorityRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PriorityRoundedW700Filled'
      short_name='Priority'
...
export default IconMaterialPriorityRoundedW700Filled;
