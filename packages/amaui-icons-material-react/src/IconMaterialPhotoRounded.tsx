...
const IconMaterialPhotoRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialPhotoRounded.displayName = 'AmauiIconMaterialPhotoRounded';

export default IconMaterialPhotoRounded;
