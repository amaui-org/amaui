...
const IconMaterialNoteAltSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NoteAltSharpFilled'
      short_name='NoteAlt'
...
IconMaterialNoteAltSharpFilled.displayName = 'AmauiIconMaterialNoteAltSharpFilled';

export default IconMaterialNoteAltSharpFilled;
