...
const IconMaterialUndoRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='UndoRoundedW100'
      short_name='Undo'
...
IconMaterialUndoRoundedW100.displayName = 'AmauiIconMaterialUndoRoundedW100';

export default IconMaterialUndoRoundedW100;
