...
const IconMaterialExploreOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ExploreOutlinedW700Filled'
      short_name='Explore'
...
export default IconMaterialExploreOutlinedW700Filled;
