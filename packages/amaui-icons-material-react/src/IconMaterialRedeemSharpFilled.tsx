...
const IconMaterialRedeemSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RedeemSharpFilled'
      short_name='Redeem'
...
IconMaterialRedeemSharpFilled.displayName = 'AmauiIconMaterialRedeemSharpFilled';

export default IconMaterialRedeemSharpFilled;
