...
const IconMaterialElectricMopedTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialElectricMopedTwoTone.displayName = 'AmauiIconMaterialElectricMopedTwoTone';

export default IconMaterialElectricMopedTwoTone;
