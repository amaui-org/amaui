...
const IconMaterialBoltTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialBoltTwoTone.displayName = 'AmauiIconMaterialBoltTwoTone';

export default IconMaterialBoltTwoTone;
