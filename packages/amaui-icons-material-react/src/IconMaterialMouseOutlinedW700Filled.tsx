...
const IconMaterialMouseOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MouseOutlinedW700Filled'
      short_name='Mouse'
...
export default IconMaterialMouseOutlinedW700Filled;
