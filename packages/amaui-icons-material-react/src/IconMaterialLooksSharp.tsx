...
const IconMaterialLooksSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialLooksSharp.displayName = 'AmauiIconMaterialLooksSharp';

export default IconMaterialLooksSharp;
