...
const IconMaterialDifferenceTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialDifferenceTwoTone.displayName = 'AmauiIconMaterialDifferenceTwoTone';

export default IconMaterialDifferenceTwoTone;
