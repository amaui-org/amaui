...
const IconMaterialAdbSharpFilled = React.forwardRef((props: any, ref) => {
...
IconMaterialAdbSharpFilled.displayName = 'AmauiIconMaterialAdbSharpFilled';

export default IconMaterialAdbSharpFilled;
