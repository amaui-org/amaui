...
const IconMaterialStayCurrentPortraitOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='StayCurrentPortraitOutlinedW100'
...
export default IconMaterialStayCurrentPortraitOutlinedW100;
