...
const IconMaterialSportsMotorsportsOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SportsMotorsportsOutlinedW100Filled'
...
export default IconMaterialSportsMotorsportsOutlinedW100Filled;
