...
const IconMaterialCropSquareOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CropSquareOutlinedW100Filled'
...
export default IconMaterialCropSquareOutlinedW100Filled;
