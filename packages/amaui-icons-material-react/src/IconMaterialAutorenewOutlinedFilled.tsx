...
const IconMaterialAutorenewOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AutorenewOutlinedFilled'
...
export default IconMaterialAutorenewOutlinedFilled;
