...
const IconMaterialAddCircleSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AddCircleSharpW700Filled'
...
export default IconMaterialAddCircleSharpW700Filled;
