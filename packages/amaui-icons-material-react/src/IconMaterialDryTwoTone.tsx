...
const IconMaterialDryTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialDryTwoTone.displayName = 'AmauiIconMaterialDryTwoTone';

export default IconMaterialDryTwoTone;
