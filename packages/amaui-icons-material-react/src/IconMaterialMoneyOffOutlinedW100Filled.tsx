...
const IconMaterialMoneyOffOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MoneyOffOutlinedW100Filled'
      short_name='MoneyOff'
...
export default IconMaterialMoneyOffOutlinedW100Filled;
