...
const IconMaterialBadgeCriticalBatteryOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BadgeCriticalBatteryOutlinedFilled'
...
export default IconMaterialBadgeCriticalBatteryOutlinedFilled;
