...
const IconMaterialHumidityLowRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HumidityLowRoundedW700Filled'
...
export default IconMaterialHumidityLowRoundedW700Filled;
