...
const IconMaterialBatteryCharging90RoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryCharging90RoundedW700'
...
export default IconMaterialBatteryCharging90RoundedW700;
