...
const IconMaterialErrorCircleRoundedOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ErrorCircleRoundedOutlinedW100Filled'
...
export default IconMaterialErrorCircleRoundedOutlinedW100Filled;
