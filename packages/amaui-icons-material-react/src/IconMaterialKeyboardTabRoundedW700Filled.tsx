...
const IconMaterialKeyboardTabRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='KeyboardTabRoundedW700Filled'
...
export default IconMaterialKeyboardTabRoundedW700Filled;
