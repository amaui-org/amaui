...
const IconMaterialKeyboardArrowDownRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='KeyboardArrowDownRoundedW700Filled'
...
export default IconMaterialKeyboardArrowDownRoundedW700Filled;
