...
const IconMaterialFluorescentOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FluorescentOutlinedW100Filled'
...
export default IconMaterialFluorescentOutlinedW100Filled;
