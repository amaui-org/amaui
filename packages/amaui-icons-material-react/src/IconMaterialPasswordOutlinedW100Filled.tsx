...
const IconMaterialPasswordOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PasswordOutlinedW100Filled'
      short_name='Password'
...
export default IconMaterialPasswordOutlinedW100Filled;
