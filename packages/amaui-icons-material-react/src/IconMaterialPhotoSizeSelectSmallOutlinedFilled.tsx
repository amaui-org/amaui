...
const IconMaterialPhotoSizeSelectSmallOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PhotoSizeSelectSmallOutlinedFilled'
...
export default IconMaterialPhotoSizeSelectSmallOutlinedFilled;
