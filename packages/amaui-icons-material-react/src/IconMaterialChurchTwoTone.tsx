...
const IconMaterialChurchTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialChurchTwoTone.displayName = 'AmauiIconMaterialChurchTwoTone';

export default IconMaterialChurchTwoTone;
