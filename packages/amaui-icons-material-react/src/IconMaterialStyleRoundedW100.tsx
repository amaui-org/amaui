...
const IconMaterialStyleRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='StyleRoundedW100'
      short_name='Style'
...
IconMaterialStyleRoundedW100.displayName = 'AmauiIconMaterialStyleRoundedW100';

export default IconMaterialStyleRoundedW100;
