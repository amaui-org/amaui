...
const IconMaterialFloodTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialFloodTwoTone.displayName = 'AmauiIconMaterialFloodTwoTone';

export default IconMaterialFloodTwoTone;
