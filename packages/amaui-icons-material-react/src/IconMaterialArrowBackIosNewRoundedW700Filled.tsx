...
const IconMaterialArrowBackIosNewRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ArrowBackIosNewRoundedW700Filled'
...
export default IconMaterialArrowBackIosNewRoundedW700Filled;
