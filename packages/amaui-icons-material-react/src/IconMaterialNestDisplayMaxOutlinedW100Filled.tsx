...
const IconMaterialNestDisplayMaxOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestDisplayMaxOutlinedW100Filled'
...
export default IconMaterialNestDisplayMaxOutlinedW100Filled;
