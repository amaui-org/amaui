...
const IconMaterialScreenLockLandscapeRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ScreenLockLandscapeRoundedW700Filled'
...
export default IconMaterialScreenLockLandscapeRoundedW700Filled;
