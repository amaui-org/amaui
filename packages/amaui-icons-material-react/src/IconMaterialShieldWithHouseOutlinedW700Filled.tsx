...
const IconMaterialShieldWithHouseOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ShieldWithHouseOutlinedW700Filled'
...
export default IconMaterialShieldWithHouseOutlinedW700Filled;
