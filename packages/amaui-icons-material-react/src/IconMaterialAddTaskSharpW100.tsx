...
const IconMaterialAddTaskSharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AddTaskSharpW100'
      short_name='AddTask'
...
IconMaterialAddTaskSharpW100.displayName = 'AmauiIconMaterialAddTaskSharpW100';

export default IconMaterialAddTaskSharpW100;
