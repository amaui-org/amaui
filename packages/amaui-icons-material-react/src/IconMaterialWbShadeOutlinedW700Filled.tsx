...
const IconMaterialWbShadeOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WbShadeOutlinedW700Filled'
      short_name='WbShade'
...
export default IconMaterialWbShadeOutlinedW700Filled;
