...
const IconMaterialAcUnitSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AcUnitSharpFilled'
      short_name='AcUnit'
...
IconMaterialAcUnitSharpFilled.displayName = 'AmauiIconMaterialAcUnitSharpFilled';

export default IconMaterialAcUnitSharpFilled;
