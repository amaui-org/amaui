...
const IconMaterialBatteryCharging20RoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryCharging20RoundedW700Filled'
...
export default IconMaterialBatteryCharging20RoundedW700Filled;
