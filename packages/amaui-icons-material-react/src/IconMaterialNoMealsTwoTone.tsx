...
const IconMaterialNoMealsTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialNoMealsTwoTone.displayName = 'AmauiIconMaterialNoMealsTwoTone';

export default IconMaterialNoMealsTwoTone;
