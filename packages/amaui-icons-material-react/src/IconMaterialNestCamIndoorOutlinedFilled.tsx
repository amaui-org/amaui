...
const IconMaterialNestCamIndoorOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestCamIndoorOutlinedFilled'
...
export default IconMaterialNestCamIndoorOutlinedFilled;
