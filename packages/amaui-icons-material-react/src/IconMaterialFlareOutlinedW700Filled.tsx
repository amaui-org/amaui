...
const IconMaterialFlareOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FlareOutlinedW700Filled'
      short_name='Flare'
...
export default IconMaterialFlareOutlinedW700Filled;
