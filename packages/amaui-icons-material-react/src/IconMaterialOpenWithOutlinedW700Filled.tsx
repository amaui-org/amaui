...
const IconMaterialOpenWithOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='OpenWithOutlinedW700Filled'
      short_name='OpenWith'
...
export default IconMaterialOpenWithOutlinedW700Filled;
