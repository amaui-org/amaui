...
const IconMaterialNestWifiRouterOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestWifiRouterOutlinedFilled'
...
export default IconMaterialNestWifiRouterOutlinedFilled;
