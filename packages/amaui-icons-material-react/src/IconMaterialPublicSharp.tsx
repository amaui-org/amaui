...
const IconMaterialPublicSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialPublicSharp.displayName = 'AmauiIconMaterialPublicSharp';

export default IconMaterialPublicSharp;
