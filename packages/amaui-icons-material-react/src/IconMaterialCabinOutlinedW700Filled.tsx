...
const IconMaterialCabinOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CabinOutlinedW700Filled'
      short_name='Cabin'
...
export default IconMaterialCabinOutlinedW700Filled;
