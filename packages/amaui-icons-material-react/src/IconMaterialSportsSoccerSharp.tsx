...
const IconMaterialSportsSoccerSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialSportsSoccerSharp.displayName = 'AmauiIconMaterialSportsSoccerSharp';

export default IconMaterialSportsSoccerSharp;
