...
const IconMaterialNestCamIqSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialNestCamIqSharp.displayName = 'AmauiIconMaterialNestCamIqSharp';

export default IconMaterialNestCamIqSharp;
