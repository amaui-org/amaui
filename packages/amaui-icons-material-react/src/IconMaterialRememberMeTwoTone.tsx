...
const IconMaterialRememberMeTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialRememberMeTwoTone.displayName = 'AmauiIconMaterialRememberMeTwoTone';

export default IconMaterialRememberMeTwoTone;
