...
const IconMaterialBatteryAlertSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialBatteryAlertSharp.displayName = 'AmauiIconMaterialBatteryAlertSharp';

export default IconMaterialBatteryAlertSharp;
