...
const IconMaterialPhonePausedTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialPhonePausedTwoTone.displayName = 'AmauiIconMaterialPhonePausedTwoTone';

export default IconMaterialPhonePausedTwoTone;
