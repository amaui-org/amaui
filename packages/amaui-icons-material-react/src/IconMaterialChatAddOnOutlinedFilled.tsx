...
const IconMaterialChatAddOnOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ChatAddOnOutlinedFilled'
...
export default IconMaterialChatAddOnOutlinedFilled;
