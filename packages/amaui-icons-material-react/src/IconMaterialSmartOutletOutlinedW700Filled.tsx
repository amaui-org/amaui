...
const IconMaterialSmartOutletOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SmartOutletOutlinedW700Filled'
...
export default IconMaterialSmartOutletOutlinedW700Filled;
