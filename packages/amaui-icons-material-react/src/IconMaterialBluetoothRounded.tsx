...
const IconMaterialBluetoothRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialBluetoothRounded.displayName = 'AmauiIconMaterialBluetoothRounded';

export default IconMaterialBluetoothRounded;
