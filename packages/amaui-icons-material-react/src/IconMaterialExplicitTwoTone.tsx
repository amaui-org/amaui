...
const IconMaterialExplicitTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialExplicitTwoTone.displayName = 'AmauiIconMaterialExplicitTwoTone';

export default IconMaterialExplicitTwoTone;
