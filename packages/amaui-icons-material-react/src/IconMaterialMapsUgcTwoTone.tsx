...
const IconMaterialMapsUgcTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialMapsUgcTwoTone.displayName = 'AmauiIconMaterialMapsUgcTwoTone';

export default IconMaterialMapsUgcTwoTone;
