...
const IconMaterialFitnessCenterSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialFitnessCenterSharp.displayName = 'AmauiIconMaterialFitnessCenterSharp';

export default IconMaterialFitnessCenterSharp;
