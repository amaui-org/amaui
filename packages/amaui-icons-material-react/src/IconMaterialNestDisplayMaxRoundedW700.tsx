...
const IconMaterialNestDisplayMaxRoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestDisplayMaxRoundedW700'
...
export default IconMaterialNestDisplayMaxRoundedW700;
