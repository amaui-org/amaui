...
const IconMaterialAccountCircleOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AccountCircleOutlinedFilled'
...
export default IconMaterialAccountCircleOutlinedFilled;
