...
const IconMaterialQrCodeScannerOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='QrCodeScannerOutlinedFilled'
...
export default IconMaterialQrCodeScannerOutlinedFilled;
