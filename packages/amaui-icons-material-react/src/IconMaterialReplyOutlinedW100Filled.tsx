...
const IconMaterialReplyOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ReplyOutlinedW100Filled'
      short_name='Reply'
...
export default IconMaterialReplyOutlinedW100Filled;
