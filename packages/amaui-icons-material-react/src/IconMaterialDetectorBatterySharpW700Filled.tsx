...
const IconMaterialDetectorBatterySharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DetectorBatterySharpW700Filled'
...
export default IconMaterialDetectorBatterySharpW700Filled;
