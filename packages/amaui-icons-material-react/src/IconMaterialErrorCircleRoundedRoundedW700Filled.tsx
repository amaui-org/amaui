...
const IconMaterialErrorCircleRoundedRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ErrorCircleRoundedRoundedW700Filled'
...
export default IconMaterialErrorCircleRoundedRoundedW700Filled;
