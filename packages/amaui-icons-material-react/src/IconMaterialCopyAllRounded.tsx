...
const IconMaterialCopyAllRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialCopyAllRounded.displayName = 'AmauiIconMaterialCopyAllRounded';

export default IconMaterialCopyAllRounded;
