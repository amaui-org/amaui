...
const IconMaterialAirlineSeatReclineExtraOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AirlineSeatReclineExtraOutlinedW100'
...
export default IconMaterialAirlineSeatReclineExtraOutlinedW100;
