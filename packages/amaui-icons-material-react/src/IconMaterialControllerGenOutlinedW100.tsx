...
const IconMaterialControllerGenOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ControllerGenOutlinedW100'
...
export default IconMaterialControllerGenOutlinedW100;
