...
const IconMaterialKebabDiningTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialKebabDiningTwoTone.displayName = 'AmauiIconMaterialKebabDiningTwoTone';

export default IconMaterialKebabDiningTwoTone;
