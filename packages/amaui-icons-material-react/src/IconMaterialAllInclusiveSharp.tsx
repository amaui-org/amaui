...
const IconMaterialAllInclusiveSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialAllInclusiveSharp.displayName = 'AmauiIconMaterialAllInclusiveSharp';

export default IconMaterialAllInclusiveSharp;
