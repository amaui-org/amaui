...
const IconMaterialScreenshotTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialScreenshotTwoTone.displayName = 'AmauiIconMaterialScreenshotTwoTone';

export default IconMaterialScreenshotTwoTone;
