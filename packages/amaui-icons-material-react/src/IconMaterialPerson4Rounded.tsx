...
const IconMaterialPerson4Rounded = React.forwardRef((props: any, ref) => {
...
IconMaterialPerson4Rounded.displayName = 'AmauiIconMaterialPerson4Rounded';

export default IconMaterialPerson4Rounded;
