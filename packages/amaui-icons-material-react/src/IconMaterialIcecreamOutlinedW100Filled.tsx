...
const IconMaterialIcecreamOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='IcecreamOutlinedW100Filled'
      short_name='Icecream'
...
export default IconMaterialIcecreamOutlinedW100Filled;
