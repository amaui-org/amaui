...
const IconMaterialZoomInRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ZoomInRoundedW100'
      short_name='ZoomIn'
...
IconMaterialZoomInRoundedW100.displayName = 'AmauiIconMaterialZoomInRoundedW100';

export default IconMaterialZoomInRoundedW100;
