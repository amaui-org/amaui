...
const IconMaterialThermometerOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ThermometerOutlinedW100Filled'
...
export default IconMaterialThermometerOutlinedW100Filled;
