...
const IconMaterialProductivityOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ProductivityOutlinedFilled'
...
export default IconMaterialProductivityOutlinedFilled;
