...
const IconMaterialTableRowsTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialTableRowsTwoTone.displayName = 'AmauiIconMaterialTableRowsTwoTone';

export default IconMaterialTableRowsTwoTone;
