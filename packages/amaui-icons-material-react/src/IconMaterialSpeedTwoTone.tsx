...
const IconMaterialSpeedTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialSpeedTwoTone.displayName = 'AmauiIconMaterialSpeedTwoTone';

export default IconMaterialSpeedTwoTone;
