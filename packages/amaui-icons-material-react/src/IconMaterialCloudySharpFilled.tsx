...
const IconMaterialCloudySharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CloudySharpFilled'
      short_name='Cloudy'
...
IconMaterialCloudySharpFilled.displayName = 'AmauiIconMaterialCloudySharpFilled';

export default IconMaterialCloudySharpFilled;
