...
const IconMaterialBoltRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialBoltRounded.displayName = 'AmauiIconMaterialBoltRounded';

export default IconMaterialBoltRounded;
