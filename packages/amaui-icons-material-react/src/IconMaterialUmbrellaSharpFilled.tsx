...
const IconMaterialUmbrellaSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='UmbrellaSharpFilled'
      short_name='Umbrella'
...
IconMaterialUmbrellaSharpFilled.displayName = 'AmauiIconMaterialUmbrellaSharpFilled';

export default IconMaterialUmbrellaSharpFilled;
