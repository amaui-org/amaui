...
const IconMaterialCameraEnhanceSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CameraEnhanceSharpW700Filled'
...
export default IconMaterialCameraEnhanceSharpW700Filled;
