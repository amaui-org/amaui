...
const IconMaterialTapasOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TapasOutlinedW100Filled'
      short_name='Tapas'
...
export default IconMaterialTapasOutlinedW100Filled;
