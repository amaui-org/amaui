...
const IconMaterialSanitizerOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SanitizerOutlinedFilled'
...
export default IconMaterialSanitizerOutlinedFilled;
