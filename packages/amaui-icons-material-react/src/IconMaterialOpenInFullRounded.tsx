...
const IconMaterialOpenInFullRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialOpenInFullRounded.displayName = 'AmauiIconMaterialOpenInFullRounded';

export default IconMaterialOpenInFullRounded;
