...
const IconMaterialTranscribeOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TranscribeOutlinedFilled'
...
export default IconMaterialTranscribeOutlinedFilled;
