...
const IconMaterialCircleTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialCircleTwoTone.displayName = 'AmauiIconMaterialCircleTwoTone';

export default IconMaterialCircleTwoTone;
