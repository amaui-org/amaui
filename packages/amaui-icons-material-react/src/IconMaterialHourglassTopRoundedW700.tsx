...
const IconMaterialHourglassTopRoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HourglassTopRoundedW700'
...
export default IconMaterialHourglassTopRoundedW700;
