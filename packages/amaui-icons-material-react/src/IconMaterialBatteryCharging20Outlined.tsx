...
const IconMaterialBatteryCharging20Outlined = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryCharging20Outlined'
...
export default IconMaterialBatteryCharging20Outlined;
