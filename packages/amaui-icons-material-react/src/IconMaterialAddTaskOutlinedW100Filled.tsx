...
const IconMaterialAddTaskOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AddTaskOutlinedW100Filled'
      short_name='AddTask'
...
export default IconMaterialAddTaskOutlinedW100Filled;
