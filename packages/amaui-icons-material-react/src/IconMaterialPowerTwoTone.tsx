...
const IconMaterialPowerTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialPowerTwoTone.displayName = 'AmauiIconMaterialPowerTwoTone';

export default IconMaterialPowerTwoTone;
