...
const IconMaterialRamenDiningOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RamenDiningOutlinedW700'
...
export default IconMaterialRamenDiningOutlinedW700;
