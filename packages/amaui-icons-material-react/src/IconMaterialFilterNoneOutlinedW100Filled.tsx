...
const IconMaterialFilterNoneOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FilterNoneOutlinedW100Filled'
...
export default IconMaterialFilterNoneOutlinedW100Filled;
