...
const IconMaterialStorefrontTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialStorefrontTwoTone.displayName = 'AmauiIconMaterialStorefrontTwoTone';

export default IconMaterialStorefrontTwoTone;
