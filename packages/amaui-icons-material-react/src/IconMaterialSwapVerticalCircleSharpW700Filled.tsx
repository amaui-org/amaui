...
const IconMaterialSwapVerticalCircleSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SwapVerticalCircleSharpW700Filled'
...
export default IconMaterialSwapVerticalCircleSharpW700Filled;
