...
const IconMaterialArrowUpwardRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ArrowUpwardRoundedW700Filled'
...
export default IconMaterialArrowUpwardRoundedW700Filled;
