...
const IconMaterialFireExtinguisherOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FireExtinguisherOutlinedW100'
...
export default IconMaterialFireExtinguisherOutlinedW100;
