...
const IconMaterialTvGenOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TvGenOutlinedW100Filled'
      short_name='TvGen'
...
export default IconMaterialTvGenOutlinedW100Filled;
