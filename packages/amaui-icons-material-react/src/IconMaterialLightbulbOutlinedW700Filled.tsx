...
const IconMaterialLightbulbOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LightbulbOutlinedW700Filled'
...
export default IconMaterialLightbulbOutlinedW700Filled;
