...
const IconMaterialRangeHoodOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RangeHoodOutlinedW100Filled'
...
export default IconMaterialRangeHoodOutlinedW100Filled;
