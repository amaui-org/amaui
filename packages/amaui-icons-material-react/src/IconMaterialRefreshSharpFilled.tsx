...
const IconMaterialRefreshSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RefreshSharpFilled'
      short_name='Refresh'
...
IconMaterialRefreshSharpFilled.displayName = 'AmauiIconMaterialRefreshSharpFilled';

export default IconMaterialRefreshSharpFilled;
