...
const IconMaterialDetectorStatusSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DetectorStatusSharpW700Filled'
...
export default IconMaterialDetectorStatusSharpW700Filled;
