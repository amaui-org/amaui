...
const IconMaterialDirectionsWalkOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DirectionsWalkOutlinedW100Filled'
...
export default IconMaterialDirectionsWalkOutlinedW100Filled;
