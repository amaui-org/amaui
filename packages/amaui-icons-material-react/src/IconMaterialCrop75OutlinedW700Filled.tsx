...
const IconMaterialCrop75OutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Crop75OutlinedW700Filled'
      short_name='Crop75'
...
export default IconMaterialCrop75OutlinedW700Filled;
