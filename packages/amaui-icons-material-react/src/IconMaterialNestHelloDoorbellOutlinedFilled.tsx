...
const IconMaterialNestHelloDoorbellOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestHelloDoorbellOutlinedFilled'
...
export default IconMaterialNestHelloDoorbellOutlinedFilled;
