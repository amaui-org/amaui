...
const IconMaterialAttachmentSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AttachmentSharpW700Filled'
...
export default IconMaterialAttachmentSharpW700Filled;
