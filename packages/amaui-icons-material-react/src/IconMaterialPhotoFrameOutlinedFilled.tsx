...
const IconMaterialPhotoFrameOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PhotoFrameOutlinedFilled'
...
export default IconMaterialPhotoFrameOutlinedFilled;
