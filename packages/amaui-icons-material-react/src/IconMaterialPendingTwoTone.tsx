...
const IconMaterialPendingTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialPendingTwoTone.displayName = 'AmauiIconMaterialPendingTwoTone';

export default IconMaterialPendingTwoTone;
