...
const IconMaterialErrorCircleRoundedRoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ErrorCircleRoundedRoundedW700'
...
export default IconMaterialErrorCircleRoundedRoundedW700;
