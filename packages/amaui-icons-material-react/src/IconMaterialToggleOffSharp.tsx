...
const IconMaterialToggleOffSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialToggleOffSharp.displayName = 'AmauiIconMaterialToggleOffSharp';

export default IconMaterialToggleOffSharp;
