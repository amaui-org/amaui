...
const IconMaterialZonePersonAlertRoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ZonePersonAlertRoundedW700'
...
export default IconMaterialZonePersonAlertRoundedW700;
