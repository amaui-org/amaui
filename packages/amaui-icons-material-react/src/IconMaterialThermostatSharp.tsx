...
const IconMaterialThermostatSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialThermostatSharp.displayName = 'AmauiIconMaterialThermostatSharp';

export default IconMaterialThermostatSharp;
