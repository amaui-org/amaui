...
const IconMaterialAutoActivityZoneRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AutoActivityZoneRoundedW700Filled'
...
export default IconMaterialAutoActivityZoneRoundedW700Filled;
