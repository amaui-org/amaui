...
const IconMaterialGradientOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='GradientOutlinedW100Filled'
      short_name='Gradient'
...
export default IconMaterialGradientOutlinedW100Filled;
