...
const IconMaterialGooglePlusReshareOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='GooglePlusReshareOutlinedW100Filled'
...
export default IconMaterialGooglePlusReshareOutlinedW100Filled;
