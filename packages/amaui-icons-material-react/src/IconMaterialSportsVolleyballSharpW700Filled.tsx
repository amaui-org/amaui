...
const IconMaterialSportsVolleyballSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SportsVolleyballSharpW700Filled'
...
export default IconMaterialSportsVolleyballSharpW700Filled;
