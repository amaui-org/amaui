...
const IconMaterialNestDisplayMaxOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestDisplayMaxOutlinedW700'
...
export default IconMaterialNestDisplayMaxOutlinedW700;
