...
const IconMaterialTripOriginOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TripOriginOutlinedW700Filled'
...
export default IconMaterialTripOriginOutlinedW700Filled;
