...
const IconMaterialDetectorSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DetectorSharpW700Filled'
      short_name='Detector'
...
export default IconMaterialDetectorSharpW700Filled;
