...
const IconMaterialReplaySharp = React.forwardRef((props: any, ref) => {
...
IconMaterialReplaySharp.displayName = 'AmauiIconMaterialReplaySharp';

export default IconMaterialReplaySharp;
