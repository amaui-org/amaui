...
const IconMaterialRemoveRoadSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialRemoveRoadSharp.displayName = 'AmauiIconMaterialRemoveRoadSharp';

export default IconMaterialRemoveRoadSharp;
