...
const IconMaterialExtensionTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialExtensionTwoTone.displayName = 'AmauiIconMaterialExtensionTwoTone';

export default IconMaterialExtensionTwoTone;
