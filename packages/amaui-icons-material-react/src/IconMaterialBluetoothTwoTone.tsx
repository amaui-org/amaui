...
const IconMaterialBluetoothTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialBluetoothTwoTone.displayName = 'AmauiIconMaterialBluetoothTwoTone';

export default IconMaterialBluetoothTwoTone;
