...
const IconMaterialAddHomeOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AddHomeOutlinedW100Filled'
      short_name='AddHome'
...
export default IconMaterialAddHomeOutlinedW100Filled;
