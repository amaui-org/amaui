...
const IconMaterialEnergyProgramSavingOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='EnergyProgramSavingOutlinedFilled'
...
export default IconMaterialEnergyProgramSavingOutlinedFilled;
