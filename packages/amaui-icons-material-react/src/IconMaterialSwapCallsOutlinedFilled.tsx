...
const IconMaterialSwapCallsOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SwapCallsOutlinedFilled'
...
export default IconMaterialSwapCallsOutlinedFilled;
