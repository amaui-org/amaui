...
const IconMaterialCloudyFilledOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CloudyFilledOutlinedW700Filled'
...
export default IconMaterialCloudyFilledOutlinedW700Filled;
