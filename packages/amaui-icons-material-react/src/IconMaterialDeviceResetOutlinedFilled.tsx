...
const IconMaterialDeviceResetOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DeviceResetOutlinedFilled'
...
export default IconMaterialDeviceResetOutlinedFilled;
