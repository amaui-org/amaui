...
const IconMaterialWhatshotOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WhatshotOutlinedW100Filled'
      short_name='Whatshot'
...
export default IconMaterialWhatshotOutlinedW100Filled;
