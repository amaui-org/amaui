...
const IconMaterialNestCamIqOutdoorSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestCamIqOutdoorSharpW700Filled'
...
export default IconMaterialNestCamIqOutdoorSharpW700Filled;
