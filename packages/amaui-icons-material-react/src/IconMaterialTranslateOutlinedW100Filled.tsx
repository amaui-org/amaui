...
const IconMaterialTranslateOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TranslateOutlinedW100Filled'
...
export default IconMaterialTranslateOutlinedW100Filled;
