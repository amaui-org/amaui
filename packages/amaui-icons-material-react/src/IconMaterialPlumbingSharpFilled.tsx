...
const IconMaterialPlumbingSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PlumbingSharpFilled'
      short_name='Plumbing'
...
IconMaterialPlumbingSharpFilled.displayName = 'AmauiIconMaterialPlumbingSharpFilled';

export default IconMaterialPlumbingSharpFilled;
