...
const IconMaterialAssignmentLateSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AssignmentLateSharpW700Filled'
...
export default IconMaterialAssignmentLateSharpW700Filled;
