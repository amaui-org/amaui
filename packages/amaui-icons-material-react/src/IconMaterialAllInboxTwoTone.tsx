...
const IconMaterialAllInboxTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialAllInboxTwoTone.displayName = 'AmauiIconMaterialAllInboxTwoTone';

export default IconMaterialAllInboxTwoTone;
