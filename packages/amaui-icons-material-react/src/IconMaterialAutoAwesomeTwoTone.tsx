...
const IconMaterialAutoAwesomeTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialAutoAwesomeTwoTone.displayName = 'AmauiIconMaterialAutoAwesomeTwoTone';

export default IconMaterialAutoAwesomeTwoTone;
