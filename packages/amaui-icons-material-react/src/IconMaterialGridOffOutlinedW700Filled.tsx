...
const IconMaterialGridOffOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='GridOffOutlinedW700Filled'
      short_name='GridOff'
...
export default IconMaterialGridOffOutlinedW700Filled;
