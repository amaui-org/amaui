...
const IconMaterialFlashlightOnTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialFlashlightOnTwoTone.displayName = 'AmauiIconMaterialFlashlightOnTwoTone';

export default IconMaterialFlashlightOnTwoTone;
