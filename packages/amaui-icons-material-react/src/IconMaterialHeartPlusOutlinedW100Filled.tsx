...
const IconMaterialHeartPlusOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HeartPlusOutlinedW100Filled'
...
export default IconMaterialHeartPlusOutlinedW100Filled;
