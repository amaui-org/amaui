...
const IconMaterialDisabledByDefaultRoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DisabledByDefaultRoundedW700'
...
export default IconMaterialDisabledByDefaultRoundedW700;
