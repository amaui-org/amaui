...
const IconMaterialFenceOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FenceOutlinedW100Filled'
      short_name='Fence'
...
export default IconMaterialFenceOutlinedW100Filled;
