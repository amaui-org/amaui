...
const IconMaterialVerifiedSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='VerifiedSharpFilled'
      short_name='Verified'
...
IconMaterialVerifiedSharpFilled.displayName = 'AmauiIconMaterialVerifiedSharpFilled';

export default IconMaterialVerifiedSharpFilled;
