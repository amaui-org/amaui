...
const IconMaterialVolumeDownOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='VolumeDownOutlinedW100Filled'
...
export default IconMaterialVolumeDownOutlinedW100Filled;
