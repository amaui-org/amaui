...
const IconMaterialCircleNotificationsOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CircleNotificationsOutlinedW700Filled'
...
export default IconMaterialCircleNotificationsOutlinedW700Filled;
