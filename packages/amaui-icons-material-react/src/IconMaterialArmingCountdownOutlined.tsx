...
const IconMaterialArmingCountdownOutlined = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ArmingCountdownOutlined'
...
export default IconMaterialArmingCountdownOutlined;
