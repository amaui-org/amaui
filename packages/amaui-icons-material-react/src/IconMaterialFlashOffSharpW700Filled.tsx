...
const IconMaterialFlashOffSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FlashOffSharpW700Filled'
      short_name='FlashOff'
...
export default IconMaterialFlashOffSharpW700Filled;
