...
const IconMaterialPhoneIphoneRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PhoneIphoneRoundedW700Filled'
...
export default IconMaterialPhoneIphoneRoundedW700Filled;
