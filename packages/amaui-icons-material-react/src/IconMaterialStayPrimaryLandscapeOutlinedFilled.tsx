...
const IconMaterialStayPrimaryLandscapeOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='StayPrimaryLandscapeOutlinedFilled'
...
export default IconMaterialStayPrimaryLandscapeOutlinedFilled;
