...
const IconMaterialQrCodeSharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='QrCodeSharpW100'
      short_name='QrCode'
...
IconMaterialQrCodeSharpW100.displayName = 'AmauiIconMaterialQrCodeSharpW100';

export default IconMaterialQrCodeSharpW100;
