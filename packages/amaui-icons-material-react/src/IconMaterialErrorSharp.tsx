...
const IconMaterialErrorSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialErrorSharp.displayName = 'AmauiIconMaterialErrorSharp';

export default IconMaterialErrorSharp;
