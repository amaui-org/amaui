...
const IconMaterialEmergencyHeatOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='EmergencyHeatOutlinedFilled'
...
export default IconMaterialEmergencyHeatOutlinedFilled;
