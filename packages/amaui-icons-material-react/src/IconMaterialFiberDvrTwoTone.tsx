...
const IconMaterialFiberDvrTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialFiberDvrTwoTone.displayName = 'AmauiIconMaterialFiberDvrTwoTone';

export default IconMaterialFiberDvrTwoTone;
