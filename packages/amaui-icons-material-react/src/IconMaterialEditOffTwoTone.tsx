...
const IconMaterialEditOffTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialEditOffTwoTone.displayName = 'AmauiIconMaterialEditOffTwoTone';

export default IconMaterialEditOffTwoTone;
