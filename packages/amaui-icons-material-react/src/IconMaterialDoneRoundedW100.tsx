...
const IconMaterialDoneRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DoneRoundedW100'
      short_name='Done'
...
IconMaterialDoneRoundedW100.displayName = 'AmauiIconMaterialDoneRoundedW100';

export default IconMaterialDoneRoundedW100;
