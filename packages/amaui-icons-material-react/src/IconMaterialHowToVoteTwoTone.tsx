...
const IconMaterialHowToVoteTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialHowToVoteTwoTone.displayName = 'AmauiIconMaterialHowToVoteTwoTone';

export default IconMaterialHowToVoteTwoTone;
