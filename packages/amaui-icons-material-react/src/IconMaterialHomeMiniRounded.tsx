...
const IconMaterialHomeMiniRounded = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HomeMiniRounded'
      short_name='HomeMini'
...
IconMaterialHomeMiniRounded.displayName = 'AmauiIconMaterialHomeMiniRounded';

export default IconMaterialHomeMiniRounded;
