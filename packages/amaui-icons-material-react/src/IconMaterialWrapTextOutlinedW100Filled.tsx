...
const IconMaterialWrapTextOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WrapTextOutlinedW100Filled'
      short_name='WrapText'
...
export default IconMaterialWrapTextOutlinedW100Filled;
