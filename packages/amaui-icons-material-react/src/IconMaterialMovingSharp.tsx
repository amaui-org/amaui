...
const IconMaterialMovingSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialMovingSharp.displayName = 'AmauiIconMaterialMovingSharp';

export default IconMaterialMovingSharp;
