...
const IconMaterialRadioButtonCheckedOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RadioButtonCheckedOutlinedFilled'
...
export default IconMaterialRadioButtonCheckedOutlinedFilled;
