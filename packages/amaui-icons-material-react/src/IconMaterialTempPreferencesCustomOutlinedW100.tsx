...
const IconMaterialTempPreferencesCustomOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TempPreferencesCustomOutlinedW100'
...
export default IconMaterialTempPreferencesCustomOutlinedW100;
