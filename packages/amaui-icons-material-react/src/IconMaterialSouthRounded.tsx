...
const IconMaterialSouthRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialSouthRounded.displayName = 'AmauiIconMaterialSouthRounded';

export default IconMaterialSouthRounded;
