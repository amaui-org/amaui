...
const IconMaterialPlaylistAddCheckOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PlaylistAddCheckOutlinedW100'
...
export default IconMaterialPlaylistAddCheckOutlinedW100;
