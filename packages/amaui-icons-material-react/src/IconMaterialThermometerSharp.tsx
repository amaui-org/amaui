...
const IconMaterialThermometerSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialThermometerSharp.displayName = 'AmauiIconMaterialThermometerSharp';

export default IconMaterialThermometerSharp;
