...
const IconMaterialDiscoverTuneOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DiscoverTuneOutlinedW100'
...
export default IconMaterialDiscoverTuneOutlinedW100;
