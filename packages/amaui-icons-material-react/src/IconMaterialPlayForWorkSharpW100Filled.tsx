...
const IconMaterialPlayForWorkSharpW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PlayForWorkSharpW100Filled'
...
export default IconMaterialPlayForWorkSharpW100Filled;
