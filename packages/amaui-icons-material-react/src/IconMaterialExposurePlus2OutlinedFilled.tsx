...
const IconMaterialExposurePlus2OutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ExposurePlus2OutlinedFilled'
...
export default IconMaterialExposurePlus2OutlinedFilled;
