...
const IconMaterialThermometerOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ThermometerOutlinedW100'
...
export default IconMaterialThermometerOutlinedW100;
