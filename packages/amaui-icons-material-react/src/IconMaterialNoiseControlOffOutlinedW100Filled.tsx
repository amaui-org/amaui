...
const IconMaterialNoiseControlOffOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NoiseControlOffOutlinedW100Filled'
...
export default IconMaterialNoiseControlOffOutlinedW100Filled;
