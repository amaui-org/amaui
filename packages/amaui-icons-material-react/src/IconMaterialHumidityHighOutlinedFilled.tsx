...
const IconMaterialHumidityHighOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HumidityHighOutlinedFilled'
...
export default IconMaterialHumidityHighOutlinedFilled;
