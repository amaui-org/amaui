...
const IconMaterialInvertColorsOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='InvertColorsOutlinedW700'
...
export default IconMaterialInvertColorsOutlinedW700;
