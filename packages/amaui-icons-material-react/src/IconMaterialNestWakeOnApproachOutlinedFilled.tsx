...
const IconMaterialNestWakeOnApproachOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestWakeOnApproachOutlinedFilled'
...
export default IconMaterialNestWakeOnApproachOutlinedFilled;
