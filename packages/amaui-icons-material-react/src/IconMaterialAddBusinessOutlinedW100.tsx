...
const IconMaterialAddBusinessOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AddBusinessOutlinedW100'
...
export default IconMaterialAddBusinessOutlinedW100;
