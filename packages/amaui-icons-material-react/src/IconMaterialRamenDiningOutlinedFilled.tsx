...
const IconMaterialRamenDiningOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RamenDiningOutlinedFilled'
...
export default IconMaterialRamenDiningOutlinedFilled;
