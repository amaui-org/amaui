...
const IconMaterialSwordsRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SwordsRoundedW100'
      short_name='Swords'
...
IconMaterialSwordsRoundedW100.displayName = 'AmauiIconMaterialSwordsRoundedW100';

export default IconMaterialSwordsRoundedW100;
