...
const IconMaterialLocalActivityOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LocalActivityOutlinedW100Filled'
...
export default IconMaterialLocalActivityOutlinedW100Filled;
