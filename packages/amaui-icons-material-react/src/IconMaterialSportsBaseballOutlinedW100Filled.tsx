...
const IconMaterialSportsBaseballOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SportsBaseballOutlinedW100Filled'
...
export default IconMaterialSportsBaseballOutlinedW100Filled;
