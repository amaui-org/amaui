...
const IconMaterialMobileOffTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialMobileOffTwoTone.displayName = 'AmauiIconMaterialMobileOffTwoTone';

export default IconMaterialMobileOffTwoTone;
