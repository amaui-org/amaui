...
const IconMaterialLoginRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialLoginRounded.displayName = 'AmauiIconMaterialLoginRounded';

export default IconMaterialLoginRounded;
