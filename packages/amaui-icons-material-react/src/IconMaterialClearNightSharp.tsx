...
const IconMaterialClearNightSharp = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ClearNightSharp'
...
IconMaterialClearNightSharp.displayName = 'AmauiIconMaterialClearNightSharp';

export default IconMaterialClearNightSharp;
