...
const IconMaterialFlatwareSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FlatwareSharpW700Filled'
      short_name='Flatware'
...
export default IconMaterialFlatwareSharpW700Filled;
