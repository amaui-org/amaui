...
const IconMaterialVideoLibraryTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialVideoLibraryTwoTone.displayName = 'AmauiIconMaterialVideoLibraryTwoTone';

export default IconMaterialVideoLibraryTwoTone;
