...
const IconMaterialSpeechToTextOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SpeechToTextOutlinedW100'
...
export default IconMaterialSpeechToTextOutlinedW100;
