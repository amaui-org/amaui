...
const IconMaterialVolumeUpTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialVolumeUpTwoTone.displayName = 'AmauiIconMaterialVolumeUpTwoTone';

export default IconMaterialVolumeUpTwoTone;
