...
const IconMaterialBatterySaverOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatterySaverOutlinedFilled'
...
export default IconMaterialBatterySaverOutlinedFilled;
