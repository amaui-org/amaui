...
const IconMaterialReceiptOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ReceiptOutlinedW700Filled'
      short_name='Receipt'
...
export default IconMaterialReceiptOutlinedW700Filled;
