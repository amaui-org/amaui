...
const IconMaterialScannerOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ScannerOutlinedW700Filled'
      short_name='Scanner'
...
export default IconMaterialScannerOutlinedW700Filled;
