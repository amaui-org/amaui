...
const IconMaterialBatteryFullOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryFullOutlinedFilled'
...
export default IconMaterialBatteryFullOutlinedFilled;
