...
const IconMaterialIncompleteCircleRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='IncompleteCircleRoundedW700Filled'
...
export default IconMaterialIncompleteCircleRoundedW700Filled;
