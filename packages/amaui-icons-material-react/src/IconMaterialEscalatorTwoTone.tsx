...
const IconMaterialEscalatorTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialEscalatorTwoTone.displayName = 'AmauiIconMaterialEscalatorTwoTone';

export default IconMaterialEscalatorTwoTone;
