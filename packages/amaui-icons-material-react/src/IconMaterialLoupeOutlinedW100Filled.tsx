...
const IconMaterialLoupeOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LoupeOutlinedW100Filled'
      short_name='Loupe'
...
export default IconMaterialLoupeOutlinedW100Filled;
