...
const IconMaterialRuleTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialRuleTwoTone.displayName = 'AmauiIconMaterialRuleTwoTone';

export default IconMaterialRuleTwoTone;
