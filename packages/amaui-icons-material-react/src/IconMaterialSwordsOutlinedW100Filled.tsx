...
const IconMaterialSwordsOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SwordsOutlinedW100Filled'
      short_name='Swords'
...
export default IconMaterialSwordsOutlinedW100Filled;
