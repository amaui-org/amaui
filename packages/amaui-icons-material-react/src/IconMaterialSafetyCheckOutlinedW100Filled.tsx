...
const IconMaterialSafetyCheckOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SafetyCheckOutlinedW100Filled'
...
export default IconMaterialSafetyCheckOutlinedW100Filled;
