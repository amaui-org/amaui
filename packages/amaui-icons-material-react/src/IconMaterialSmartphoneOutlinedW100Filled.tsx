...
const IconMaterialSmartphoneOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SmartphoneOutlinedW100Filled'
...
export default IconMaterialSmartphoneOutlinedW100Filled;
