...
const IconMaterialPergolaRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PergolaRoundedW700Filled'
      short_name='Pergola'
...
export default IconMaterialPergolaRoundedW700Filled;
