...
const IconMaterialSavedSearchSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SavedSearchSharpW700Filled'
...
export default IconMaterialSavedSearchSharpW700Filled;
