...
const IconMaterialGroups2SharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Groups2SharpFilled'
      short_name='Groups2'
...
IconMaterialGroups2SharpFilled.displayName = 'AmauiIconMaterialGroups2SharpFilled';

export default IconMaterialGroups2SharpFilled;
