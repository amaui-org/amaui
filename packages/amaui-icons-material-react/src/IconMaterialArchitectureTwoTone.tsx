...
const IconMaterialArchitectureTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialArchitectureTwoTone.displayName = 'AmauiIconMaterialArchitectureTwoTone';

export default IconMaterialArchitectureTwoTone;
