...
const IconMaterialNestCamStandOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestCamStandOutlinedW100Filled'
...
export default IconMaterialNestCamStandOutlinedW100Filled;
