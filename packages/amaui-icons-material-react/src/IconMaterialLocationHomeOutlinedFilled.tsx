...
const IconMaterialLocationHomeOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LocationHomeOutlinedFilled'
...
export default IconMaterialLocationHomeOutlinedFilled;
