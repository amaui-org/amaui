...
const IconMaterialLocalBarRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LocalBarRoundedW700Filled'
      short_name='LocalBar'
...
export default IconMaterialLocalBarRoundedW700Filled;
