...
const IconMaterialTvWithAssistantOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TvWithAssistantOutlinedW100Filled'
...
export default IconMaterialTvWithAssistantOutlinedW100Filled;
