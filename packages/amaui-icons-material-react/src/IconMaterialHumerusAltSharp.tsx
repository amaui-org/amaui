...
const IconMaterialHumerusAltSharp = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HumerusAltSharp'
...
IconMaterialHumerusAltSharp.displayName = 'AmauiIconMaterialHumerusAltSharp';

export default IconMaterialHumerusAltSharp;
