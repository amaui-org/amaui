...
const IconMaterialUnfoldMoreDoubleRoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='UnfoldMoreDoubleRoundedW700'
...
export default IconMaterialUnfoldMoreDoubleRoundedW700;
