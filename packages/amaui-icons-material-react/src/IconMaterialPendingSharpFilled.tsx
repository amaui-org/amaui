...
const IconMaterialPendingSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PendingSharpFilled'
      short_name='Pending'
...
IconMaterialPendingSharpFilled.displayName = 'AmauiIconMaterialPendingSharpFilled';

export default IconMaterialPendingSharpFilled;
