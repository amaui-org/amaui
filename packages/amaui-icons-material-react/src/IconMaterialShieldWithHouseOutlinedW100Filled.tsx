...
const IconMaterialShieldWithHouseOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ShieldWithHouseOutlinedW100Filled'
...
export default IconMaterialShieldWithHouseOutlinedW100Filled;
