...
const IconMaterialArrowCircleDownSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialArrowCircleDownSharp.displayName = 'AmauiIconMaterialArrowCircleDownSharp';

export default IconMaterialArrowCircleDownSharp;
