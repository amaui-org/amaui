...
const IconMaterialUnfoldLessTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialUnfoldLessTwoTone.displayName = 'AmauiIconMaterialUnfoldLessTwoTone';

export default IconMaterialUnfoldLessTwoTone;
