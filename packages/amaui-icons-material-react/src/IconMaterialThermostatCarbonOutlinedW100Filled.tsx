...
const IconMaterialThermostatCarbonOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ThermostatCarbonOutlinedW100Filled'
...
export default IconMaterialThermostatCarbonOutlinedW100Filled;
