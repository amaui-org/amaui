...
const IconMaterialRadioTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialRadioTwoTone.displayName = 'AmauiIconMaterialRadioTwoTone';

export default IconMaterialRadioTwoTone;
