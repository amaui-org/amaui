...
const IconMaterialPackageRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialPackageRounded.displayName = 'AmauiIconMaterialPackageRounded';

export default IconMaterialPackageRounded;
