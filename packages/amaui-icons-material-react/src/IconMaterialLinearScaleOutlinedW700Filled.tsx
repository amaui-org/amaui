...
const IconMaterialLinearScaleOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LinearScaleOutlinedW700Filled'
...
export default IconMaterialLinearScaleOutlinedW700Filled;
