...
const IconMaterialShoppingBasketOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ShoppingBasketOutlinedW100'
...
export default IconMaterialShoppingBasketOutlinedW100;
