...
const IconMaterialEnergyProgramSavingOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='EnergyProgramSavingOutlinedW100'
...
export default IconMaterialEnergyProgramSavingOutlinedW100;
