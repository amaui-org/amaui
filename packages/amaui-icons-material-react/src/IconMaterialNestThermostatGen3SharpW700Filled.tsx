...
const IconMaterialNestThermostatGen3SharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestThermostatGen3SharpW700Filled'
...
export default IconMaterialNestThermostatGen3SharpW700Filled;
