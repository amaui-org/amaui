...
const IconMaterialToolsInstallationKitOutlined = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ToolsInstallationKitOutlined'
...
export default IconMaterialToolsInstallationKitOutlined;
