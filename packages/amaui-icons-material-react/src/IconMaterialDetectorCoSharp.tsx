...
const IconMaterialDetectorCoSharp = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DetectorCoSharp'
...
IconMaterialDetectorCoSharp.displayName = 'AmauiIconMaterialDetectorCoSharp';

export default IconMaterialDetectorCoSharp;
