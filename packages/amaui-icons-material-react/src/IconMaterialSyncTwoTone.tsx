...
const IconMaterialSyncTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialSyncTwoTone.displayName = 'AmauiIconMaterialSyncTwoTone';

export default IconMaterialSyncTwoTone;
