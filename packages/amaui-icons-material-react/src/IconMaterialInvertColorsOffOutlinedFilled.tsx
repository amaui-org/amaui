...
const IconMaterialInvertColorsOffOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='InvertColorsOffOutlinedFilled'
...
export default IconMaterialInvertColorsOffOutlinedFilled;
