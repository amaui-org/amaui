...
const IconMaterialBlurShortOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BlurShortOutlinedW100Filled'
...
export default IconMaterialBlurShortOutlinedW100Filled;
