...
const IconMaterialAirlineStopsOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AirlineStopsOutlinedFilled'
...
export default IconMaterialAirlineStopsOutlinedFilled;
