...
const IconMaterialTeamDashboardRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TeamDashboardRoundedW700Filled'
...
export default IconMaterialTeamDashboardRoundedW700Filled;
