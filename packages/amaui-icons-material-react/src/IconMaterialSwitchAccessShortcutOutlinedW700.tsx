...
const IconMaterialSwitchAccessShortcutOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SwitchAccessShortcutOutlinedW700'
...
export default IconMaterialSwitchAccessShortcutOutlinedW700;
