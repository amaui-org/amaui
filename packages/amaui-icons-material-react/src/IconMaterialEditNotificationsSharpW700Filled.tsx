...
const IconMaterialEditNotificationsSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='EditNotificationsSharpW700Filled'
...
export default IconMaterialEditNotificationsSharpW700Filled;
