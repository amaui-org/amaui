...
const IconMaterialPanoramaFishEyeOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PanoramaFishEyeOutlinedW700Filled'
...
export default IconMaterialPanoramaFishEyeOutlinedW700Filled;
