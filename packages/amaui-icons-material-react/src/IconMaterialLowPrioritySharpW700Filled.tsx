...
const IconMaterialLowPrioritySharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LowPrioritySharpW700Filled'
...
export default IconMaterialLowPrioritySharpW700Filled;
