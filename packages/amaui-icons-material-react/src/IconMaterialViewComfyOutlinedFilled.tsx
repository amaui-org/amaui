...
const IconMaterialViewComfyOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ViewComfyOutlinedFilled'
...
export default IconMaterialViewComfyOutlinedFilled;
