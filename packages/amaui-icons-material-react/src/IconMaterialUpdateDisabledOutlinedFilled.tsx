...
const IconMaterialUpdateDisabledOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='UpdateDisabledOutlinedFilled'
...
export default IconMaterialUpdateDisabledOutlinedFilled;
