...
const IconMaterialUsbRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialUsbRounded.displayName = 'AmauiIconMaterialUsbRounded';

export default IconMaterialUsbRounded;
