...
const IconMaterialSoundDetectionLoudSoundOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SoundDetectionLoudSoundOutlinedW100Filled'
...
export default IconMaterialSoundDetectionLoudSoundOutlinedW100Filled;
