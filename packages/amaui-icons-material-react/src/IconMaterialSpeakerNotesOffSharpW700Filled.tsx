...
const IconMaterialSpeakerNotesOffSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SpeakerNotesOffSharpW700Filled'
...
export default IconMaterialSpeakerNotesOffSharpW700Filled;
