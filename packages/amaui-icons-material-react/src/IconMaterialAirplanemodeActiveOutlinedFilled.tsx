...
const IconMaterialAirplanemodeActiveOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AirplanemodeActiveOutlinedFilled'
...
export default IconMaterialAirplanemodeActiveOutlinedFilled;
