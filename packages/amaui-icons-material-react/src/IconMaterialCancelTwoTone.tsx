...
const IconMaterialCancelTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialCancelTwoTone.displayName = 'AmauiIconMaterialCancelTwoTone';

export default IconMaterialCancelTwoTone;
