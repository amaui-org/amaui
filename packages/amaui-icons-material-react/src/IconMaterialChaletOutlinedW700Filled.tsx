...
const IconMaterialChaletOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ChaletOutlinedW700Filled'
      short_name='Chalet'
...
export default IconMaterialChaletOutlinedW700Filled;
