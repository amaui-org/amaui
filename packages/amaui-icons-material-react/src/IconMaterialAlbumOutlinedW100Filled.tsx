...
const IconMaterialAlbumOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AlbumOutlinedW100Filled'
      short_name='Album'
...
export default IconMaterialAlbumOutlinedW100Filled;
