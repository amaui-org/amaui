...
const IconMaterialPasswordOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PasswordOutlinedW700Filled'
      short_name='Password'
...
export default IconMaterialPasswordOutlinedW700Filled;
