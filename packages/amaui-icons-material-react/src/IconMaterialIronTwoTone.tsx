...
const IconMaterialIronTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialIronTwoTone.displayName = 'AmauiIconMaterialIronTwoTone';

export default IconMaterialIronTwoTone;
