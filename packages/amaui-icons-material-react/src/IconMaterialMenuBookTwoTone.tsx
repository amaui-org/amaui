...
const IconMaterialMenuBookTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialMenuBookTwoTone.displayName = 'AmauiIconMaterialMenuBookTwoTone';

export default IconMaterialMenuBookTwoTone;
