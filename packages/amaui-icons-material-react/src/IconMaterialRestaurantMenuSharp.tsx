...
const IconMaterialRestaurantMenuSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialRestaurantMenuSharp.displayName = 'AmauiIconMaterialRestaurantMenuSharp';

export default IconMaterialRestaurantMenuSharp;
