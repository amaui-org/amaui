...
const IconMaterialCameraEnhanceOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CameraEnhanceOutlinedW100Filled'
...
export default IconMaterialCameraEnhanceOutlinedW100Filled;
