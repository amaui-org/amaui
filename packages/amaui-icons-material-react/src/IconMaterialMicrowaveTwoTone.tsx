...
const IconMaterialMicrowaveTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialMicrowaveTwoTone.displayName = 'AmauiIconMaterialMicrowaveTwoTone';

export default IconMaterialMicrowaveTwoTone;
