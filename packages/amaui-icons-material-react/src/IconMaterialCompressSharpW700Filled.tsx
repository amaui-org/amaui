...
const IconMaterialCompressSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CompressSharpW700Filled'
      short_name='Compress'
...
export default IconMaterialCompressSharpW700Filled;
