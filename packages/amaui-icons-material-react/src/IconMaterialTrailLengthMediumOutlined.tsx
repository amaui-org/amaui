...
const IconMaterialTrailLengthMediumOutlined = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TrailLengthMediumOutlined'
...
export default IconMaterialTrailLengthMediumOutlined;
