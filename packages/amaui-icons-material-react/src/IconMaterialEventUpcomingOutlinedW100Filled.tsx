...
const IconMaterialEventUpcomingOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='EventUpcomingOutlinedW100Filled'
...
export default IconMaterialEventUpcomingOutlinedW100Filled;
