...
const IconMaterialSearchSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SearchSharpFilled'
      short_name='Search'
...
IconMaterialSearchSharpFilled.displayName = 'AmauiIconMaterialSearchSharpFilled';

export default IconMaterialSearchSharpFilled;
