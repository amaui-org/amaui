...
const IconMaterialMoreVertSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MoreVertSharpFilled'
      short_name='MoreVert'
...
IconMaterialMoreVertSharpFilled.displayName = 'AmauiIconMaterialMoreVertSharpFilled';

export default IconMaterialMoreVertSharpFilled;
