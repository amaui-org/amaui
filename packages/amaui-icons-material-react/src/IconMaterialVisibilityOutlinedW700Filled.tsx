...
const IconMaterialVisibilityOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='VisibilityOutlinedW700Filled'
...
export default IconMaterialVisibilityOutlinedW700Filled;
