...
const IconMaterialSpellcheckSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SpellcheckSharpW700Filled'
...
export default IconMaterialSpellcheckSharpW700Filled;
