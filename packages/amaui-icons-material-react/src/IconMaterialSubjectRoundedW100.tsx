...
const IconMaterialSubjectRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SubjectRoundedW100'
      short_name='Subject'
...
IconMaterialSubjectRoundedW100.displayName = 'AmauiIconMaterialSubjectRoundedW100';

export default IconMaterialSubjectRoundedW100;
