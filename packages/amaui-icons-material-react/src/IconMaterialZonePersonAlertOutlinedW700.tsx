...
const IconMaterialZonePersonAlertOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ZonePersonAlertOutlinedW700'
...
export default IconMaterialZonePersonAlertOutlinedW700;
