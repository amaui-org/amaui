...
const IconMaterialHorizontalDistributeRoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HorizontalDistributeRoundedW700'
...
export default IconMaterialHorizontalDistributeRoundedW700;
