...
const IconMaterialPersonSearchTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialPersonSearchTwoTone.displayName = 'AmauiIconMaterialPersonSearchTwoTone';

export default IconMaterialPersonSearchTwoTone;
