...
const IconMaterialZonePersonUrgentOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ZonePersonUrgentOutlinedW100Filled'
...
export default IconMaterialZonePersonUrgentOutlinedW100Filled;
