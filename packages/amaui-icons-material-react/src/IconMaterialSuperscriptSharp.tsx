...
const IconMaterialSuperscriptSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialSuperscriptSharp.displayName = 'AmauiIconMaterialSuperscriptSharp';

export default IconMaterialSuperscriptSharp;
