...
const IconMaterialDirectionsWalkOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DirectionsWalkOutlinedFilled'
...
export default IconMaterialDirectionsWalkOutlinedFilled;
