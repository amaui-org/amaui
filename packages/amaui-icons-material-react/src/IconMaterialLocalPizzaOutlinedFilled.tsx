...
const IconMaterialLocalPizzaOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LocalPizzaOutlinedFilled'
...
export default IconMaterialLocalPizzaOutlinedFilled;
