...
const IconMaterialRamenDiningOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RamenDiningOutlinedW100Filled'
...
export default IconMaterialRamenDiningOutlinedW100Filled;
