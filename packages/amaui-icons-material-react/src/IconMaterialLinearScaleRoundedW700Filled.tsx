...
const IconMaterialLinearScaleRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LinearScaleRoundedW700Filled'
...
export default IconMaterialLinearScaleRoundedW700Filled;
