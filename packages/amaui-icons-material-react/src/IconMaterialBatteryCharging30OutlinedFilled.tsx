...
const IconMaterialBatteryCharging30OutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryCharging30OutlinedFilled'
...
export default IconMaterialBatteryCharging30OutlinedFilled;
