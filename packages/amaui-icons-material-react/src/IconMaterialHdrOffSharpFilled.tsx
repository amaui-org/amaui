...
const IconMaterialHdrOffSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HdrOffSharpFilled'
      short_name='HdrOff'
...
IconMaterialHdrOffSharpFilled.displayName = 'AmauiIconMaterialHdrOffSharpFilled';

export default IconMaterialHdrOffSharpFilled;
