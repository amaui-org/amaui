...
const IconMaterialFluorescentOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FluorescentOutlinedFilled'
...
export default IconMaterialFluorescentOutlinedFilled;
