...
const IconMaterialPersonOffTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialPersonOffTwoTone.displayName = 'AmauiIconMaterialPersonOffTwoTone';

export default IconMaterialPersonOffTwoTone;
