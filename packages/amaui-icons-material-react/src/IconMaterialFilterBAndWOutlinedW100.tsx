...
const IconMaterialFilterBAndWOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FilterBAndWOutlinedW100'
...
export default IconMaterialFilterBAndWOutlinedW100;
