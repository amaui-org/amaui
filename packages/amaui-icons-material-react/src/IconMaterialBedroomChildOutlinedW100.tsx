...
const IconMaterialBedroomChildOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BedroomChildOutlinedW100'
...
export default IconMaterialBedroomChildOutlinedW100;
