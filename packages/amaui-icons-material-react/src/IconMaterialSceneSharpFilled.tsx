...
const IconMaterialSceneSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SceneSharpFilled'
      short_name='Scene'
...
IconMaterialSceneSharpFilled.displayName = 'AmauiIconMaterialSceneSharpFilled';

export default IconMaterialSceneSharpFilled;
