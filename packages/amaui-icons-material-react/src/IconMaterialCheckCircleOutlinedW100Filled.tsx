...
const IconMaterialCheckCircleOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CheckCircleOutlinedW100Filled'
...
export default IconMaterialCheckCircleOutlinedW100Filled;
