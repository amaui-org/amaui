...
const IconMaterialStylerOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='StylerOutlinedW100Filled'
      short_name='Styler'
...
export default IconMaterialStylerOutlinedW100Filled;
