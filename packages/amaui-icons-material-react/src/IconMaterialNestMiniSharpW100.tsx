...
const IconMaterialNestMiniSharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestMiniSharpW100'
      short_name='NestMini'
...
IconMaterialNestMiniSharpW100.displayName = 'AmauiIconMaterialNestMiniSharpW100';

export default IconMaterialNestMiniSharpW100;
