...
const IconMaterialSpeakerOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SpeakerOutlinedW700Filled'
      short_name='Speaker'
...
export default IconMaterialSpeakerOutlinedW700Filled;
