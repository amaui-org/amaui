...
const IconMaterialSouthRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SouthRoundedW100'
      short_name='South'
...
IconMaterialSouthRoundedW100.displayName = 'AmauiIconMaterialSouthRoundedW100';

export default IconMaterialSouthRoundedW100;
