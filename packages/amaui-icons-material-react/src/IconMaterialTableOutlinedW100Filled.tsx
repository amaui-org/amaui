...
const IconMaterialTableOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TableOutlinedW100Filled'
      short_name='Table'
...
export default IconMaterialTableOutlinedW100Filled;
