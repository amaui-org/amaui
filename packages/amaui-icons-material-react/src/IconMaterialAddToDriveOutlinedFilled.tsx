...
const IconMaterialAddToDriveOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AddToDriveOutlinedFilled'
...
export default IconMaterialAddToDriveOutlinedFilled;
