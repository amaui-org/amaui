...
const IconMaterialRestaurantSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RestaurantSharpW700Filled'
...
export default IconMaterialRestaurantSharpW700Filled;
