...
const IconMaterialHomeMiniOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HomeMiniOutlinedW100Filled'
      short_name='HomeMini'
...
export default IconMaterialHomeMiniOutlinedW100Filled;
