...
const IconMaterialGolfCourseOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='GolfCourseOutlinedFilled'
...
export default IconMaterialGolfCourseOutlinedFilled;
