...
const IconMaterialVolumeDownOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='VolumeDownOutlinedFilled'
...
export default IconMaterialVolumeDownOutlinedFilled;
