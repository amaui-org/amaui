...
const IconMaterialCreditCardOffTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialCreditCardOffTwoTone.displayName = 'AmauiIconMaterialCreditCardOffTwoTone';

export default IconMaterialCreditCardOffTwoTone;
