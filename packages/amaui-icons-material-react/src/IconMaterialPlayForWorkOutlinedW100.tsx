...
const IconMaterialPlayForWorkOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PlayForWorkOutlinedW100'
...
export default IconMaterialPlayForWorkOutlinedW100;
