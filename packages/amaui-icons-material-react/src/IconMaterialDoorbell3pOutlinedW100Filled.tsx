...
const IconMaterialDoorbell3pOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Doorbell3pOutlinedW100Filled'
...
export default IconMaterialDoorbell3pOutlinedW100Filled;
