...
const IconMaterialTempPreferencesCustomOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TempPreferencesCustomOutlinedFilled'
...
export default IconMaterialTempPreferencesCustomOutlinedFilled;
