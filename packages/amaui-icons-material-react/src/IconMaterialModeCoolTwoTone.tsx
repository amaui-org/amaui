...
const IconMaterialModeCoolTwoTone = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ModeCoolTwoTone'
      short_name='ModeCool'
...
IconMaterialModeCoolTwoTone.displayName = 'AmauiIconMaterialModeCoolTwoTone';

export default IconMaterialModeCoolTwoTone;
