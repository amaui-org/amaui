...
const IconMaterialDresserSharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DresserSharpW100'
      short_name='Dresser'
...
IconMaterialDresserSharpW100.displayName = 'AmauiIconMaterialDresserSharpW100';

export default IconMaterialDresserSharpW100;
