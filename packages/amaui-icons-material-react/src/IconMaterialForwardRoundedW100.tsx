...
const IconMaterialForwardRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ForwardRoundedW100'
      short_name='Forward'
...
IconMaterialForwardRoundedW100.displayName = 'AmauiIconMaterialForwardRoundedW100';

export default IconMaterialForwardRoundedW100;
