...
const IconMaterialBatteryFullOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryFullOutlinedW100Filled'
...
export default IconMaterialBatteryFullOutlinedW100Filled;
