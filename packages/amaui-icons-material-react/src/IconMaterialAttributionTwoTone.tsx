...
const IconMaterialAttributionTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialAttributionTwoTone.displayName = 'AmauiIconMaterialAttributionTwoTone';

export default IconMaterialAttributionTwoTone;
