...
const IconMaterialLightTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialLightTwoTone.displayName = 'AmauiIconMaterialLightTwoTone';

export default IconMaterialLightTwoTone;
