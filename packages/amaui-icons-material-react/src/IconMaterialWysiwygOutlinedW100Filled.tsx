...
const IconMaterialWysiwygOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WysiwygOutlinedW100Filled'
      short_name='Wysiwyg'
...
export default IconMaterialWysiwygOutlinedW100Filled;
