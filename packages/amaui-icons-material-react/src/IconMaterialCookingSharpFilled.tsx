...
const IconMaterialCookingSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CookingSharpFilled'
      short_name='Cooking'
...
IconMaterialCookingSharpFilled.displayName = 'AmauiIconMaterialCookingSharpFilled';

export default IconMaterialCookingSharpFilled;
