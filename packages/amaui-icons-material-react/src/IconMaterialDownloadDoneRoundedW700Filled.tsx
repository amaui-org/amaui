...
const IconMaterialDownloadDoneRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DownloadDoneRoundedW700Filled'
...
export default IconMaterialDownloadDoneRoundedW700Filled;
