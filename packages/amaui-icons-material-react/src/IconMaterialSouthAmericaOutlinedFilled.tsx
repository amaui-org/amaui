...
const IconMaterialSouthAmericaOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SouthAmericaOutlinedFilled'
...
export default IconMaterialSouthAmericaOutlinedFilled;
