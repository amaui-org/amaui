...
const IconMaterialBreakingNewsAlt1OutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BreakingNewsAlt1OutlinedW700'
...
export default IconMaterialBreakingNewsAlt1OutlinedW700;
