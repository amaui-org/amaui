...
const IconMaterialBatteryLowSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryLowSharpW700Filled'
...
export default IconMaterialBatteryLowSharpW700Filled;
