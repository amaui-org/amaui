...
const IconMaterialBlanketRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BlanketRoundedW700Filled'
      short_name='Blanket'
...
export default IconMaterialBlanketRoundedW700Filled;
