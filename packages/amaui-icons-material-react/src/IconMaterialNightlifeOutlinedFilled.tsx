...
const IconMaterialNightlifeOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NightlifeOutlinedFilled'
...
export default IconMaterialNightlifeOutlinedFilled;
