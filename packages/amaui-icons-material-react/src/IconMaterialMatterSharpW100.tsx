...
const IconMaterialMatterSharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MatterSharpW100'
      short_name='Matter'
...
IconMaterialMatterSharpW100.displayName = 'AmauiIconMaterialMatterSharpW100';

export default IconMaterialMatterSharpW100;
