...
const IconMaterialHdrStrongTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialHdrStrongTwoTone.displayName = 'AmauiIconMaterialHdrStrongTwoTone';

export default IconMaterialHdrStrongTwoTone;
