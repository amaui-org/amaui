...
const IconMaterialLowPriorityOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LowPriorityOutlinedW100Filled'
...
export default IconMaterialLowPriorityOutlinedW100Filled;
