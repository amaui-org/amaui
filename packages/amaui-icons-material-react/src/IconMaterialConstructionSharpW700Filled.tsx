...
const IconMaterialConstructionSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ConstructionSharpW700Filled'
...
export default IconMaterialConstructionSharpW700Filled;
