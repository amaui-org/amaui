...
const IconMaterialSyncAltOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SyncAltOutlinedW700Filled'
      short_name='SyncAlt'
...
export default IconMaterialSyncAltOutlinedW700Filled;
