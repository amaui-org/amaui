...
const IconMaterialKeyboardHideTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialKeyboardHideTwoTone.displayName = 'AmauiIconMaterialKeyboardHideTwoTone';

export default IconMaterialKeyboardHideTwoTone;
