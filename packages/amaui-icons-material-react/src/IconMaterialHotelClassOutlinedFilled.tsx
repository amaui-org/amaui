...
const IconMaterialHotelClassOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HotelClassOutlinedFilled'
...
export default IconMaterialHotelClassOutlinedFilled;
