...
const IconMaterialZoomOutSharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ZoomOutSharpW100'
      short_name='ZoomOut'
...
IconMaterialZoomOutSharpW100.displayName = 'AmauiIconMaterialZoomOutSharpW100';

export default IconMaterialZoomOutSharpW100;
