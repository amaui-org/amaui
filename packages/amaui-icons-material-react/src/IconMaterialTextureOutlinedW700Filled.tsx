...
const IconMaterialTextureOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TextureOutlinedW700Filled'
      short_name='Texture'
...
export default IconMaterialTextureOutlinedW700Filled;
