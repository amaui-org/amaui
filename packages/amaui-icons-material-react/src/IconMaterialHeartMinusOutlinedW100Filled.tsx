...
const IconMaterialHeartMinusOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HeartMinusOutlinedW100Filled'
...
export default IconMaterialHeartMinusOutlinedW100Filled;
