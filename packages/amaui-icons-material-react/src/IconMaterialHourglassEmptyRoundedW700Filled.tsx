...
const IconMaterialHourglassEmptyRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HourglassEmptyRoundedW700Filled'
...
export default IconMaterialHourglassEmptyRoundedW700Filled;
