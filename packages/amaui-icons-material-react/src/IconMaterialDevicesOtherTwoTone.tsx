...
const IconMaterialDevicesOtherTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialDevicesOtherTwoTone.displayName = 'AmauiIconMaterialDevicesOtherTwoTone';

export default IconMaterialDevicesOtherTwoTone;
