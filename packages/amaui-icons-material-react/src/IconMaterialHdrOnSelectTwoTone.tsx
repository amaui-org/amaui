...
const IconMaterialHdrOnSelectTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialHdrOnSelectTwoTone.displayName = 'AmauiIconMaterialHdrOnSelectTwoTone';

export default IconMaterialHdrOnSelectTwoTone;
