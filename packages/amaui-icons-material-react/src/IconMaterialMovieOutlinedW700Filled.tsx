...
const IconMaterialMovieOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MovieOutlinedW700Filled'
      short_name='Movie'
...
export default IconMaterialMovieOutlinedW700Filled;
