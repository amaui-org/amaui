...
const IconMaterialGarageTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialGarageTwoTone.displayName = 'AmauiIconMaterialGarageTwoTone';

export default IconMaterialGarageTwoTone;
