...
const IconMaterialTsunamiTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialTsunamiTwoTone.displayName = 'AmauiIconMaterialTsunamiTwoTone';

export default IconMaterialTsunamiTwoTone;
