...
const IconMaterialEditRoadSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialEditRoadSharp.displayName = 'AmauiIconMaterialEditRoadSharp';

export default IconMaterialEditRoadSharp;
