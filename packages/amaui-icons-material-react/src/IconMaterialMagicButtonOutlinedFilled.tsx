...
const IconMaterialMagicButtonOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MagicButtonOutlinedFilled'
...
export default IconMaterialMagicButtonOutlinedFilled;
