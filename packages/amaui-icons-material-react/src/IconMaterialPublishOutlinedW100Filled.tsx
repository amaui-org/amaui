...
const IconMaterialPublishOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PublishOutlinedW100Filled'
      short_name='Publish'
...
export default IconMaterialPublishOutlinedW100Filled;
