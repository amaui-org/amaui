...
const IconMaterialRheumatologyRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RheumatologyRoundedW700Filled'
...
export default IconMaterialRheumatologyRoundedW700Filled;
