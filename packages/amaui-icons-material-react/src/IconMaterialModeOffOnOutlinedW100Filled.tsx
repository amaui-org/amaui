...
const IconMaterialModeOffOnOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ModeOffOnOutlinedW100Filled'
...
export default IconMaterialModeOffOnOutlinedW100Filled;
