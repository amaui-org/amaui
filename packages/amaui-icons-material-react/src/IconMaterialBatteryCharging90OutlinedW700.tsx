...
const IconMaterialBatteryCharging90OutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryCharging90OutlinedW700'
...
export default IconMaterialBatteryCharging90OutlinedW700;
