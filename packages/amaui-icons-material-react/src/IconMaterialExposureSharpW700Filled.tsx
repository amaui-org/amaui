...
const IconMaterialExposureSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ExposureSharpW700Filled'
      short_name='Exposure'
...
export default IconMaterialExposureSharpW700Filled;
