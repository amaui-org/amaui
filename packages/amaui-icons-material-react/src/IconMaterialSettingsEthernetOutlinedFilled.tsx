...
const IconMaterialSettingsEthernetOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SettingsEthernetOutlinedFilled'
...
export default IconMaterialSettingsEthernetOutlinedFilled;
