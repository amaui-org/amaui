...
const IconMaterialCachedTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialCachedTwoTone.displayName = 'AmauiIconMaterialCachedTwoTone';

export default IconMaterialCachedTwoTone;
