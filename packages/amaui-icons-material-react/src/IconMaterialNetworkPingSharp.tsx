...
const IconMaterialNetworkPingSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialNetworkPingSharp.displayName = 'AmauiIconMaterialNetworkPingSharp';

export default IconMaterialNetworkPingSharp;
