...
const IconMaterialNoteRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialNoteRounded.displayName = 'AmauiIconMaterialNoteRounded';

export default IconMaterialNoteRounded;
