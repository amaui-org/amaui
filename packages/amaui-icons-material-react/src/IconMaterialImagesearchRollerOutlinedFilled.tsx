...
const IconMaterialImagesearchRollerOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ImagesearchRollerOutlinedFilled'
...
export default IconMaterialImagesearchRollerOutlinedFilled;
