...
const IconMaterialDatasetLinkedOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DatasetLinkedOutlinedFilled'
...
export default IconMaterialDatasetLinkedOutlinedFilled;
