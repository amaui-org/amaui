...
const IconMaterialMobiledataOffTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialMobiledataOffTwoTone.displayName = 'AmauiIconMaterialMobiledataOffTwoTone';

export default IconMaterialMobiledataOffTwoTone;
