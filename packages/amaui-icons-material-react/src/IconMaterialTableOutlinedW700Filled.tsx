...
const IconMaterialTableOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TableOutlinedW700Filled'
      short_name='Table'
...
export default IconMaterialTableOutlinedW700Filled;
