...
const IconMaterialExposureNeg2OutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ExposureNeg2OutlinedW100Filled'
...
export default IconMaterialExposureNeg2OutlinedW100Filled;
