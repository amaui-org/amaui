...
const IconMaterialLinearScaleOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LinearScaleOutlinedW100Filled'
...
export default IconMaterialLinearScaleOutlinedW100Filled;
