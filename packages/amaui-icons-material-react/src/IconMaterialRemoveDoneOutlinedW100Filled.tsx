...
const IconMaterialRemoveDoneOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RemoveDoneOutlinedW100Filled'
...
export default IconMaterialRemoveDoneOutlinedW100Filled;
