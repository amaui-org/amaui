...
const IconMaterialBorderBottomOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BorderBottomOutlinedFilled'
...
export default IconMaterialBorderBottomOutlinedFilled;
