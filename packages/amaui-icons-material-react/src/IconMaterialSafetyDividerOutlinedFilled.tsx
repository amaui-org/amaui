...
const IconMaterialSafetyDividerOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SafetyDividerOutlinedFilled'
...
export default IconMaterialSafetyDividerOutlinedFilled;
