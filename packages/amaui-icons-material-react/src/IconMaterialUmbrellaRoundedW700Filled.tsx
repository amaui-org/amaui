...
const IconMaterialUmbrellaRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='UmbrellaRoundedW700Filled'
      short_name='Umbrella'
...
export default IconMaterialUmbrellaRoundedW700Filled;
