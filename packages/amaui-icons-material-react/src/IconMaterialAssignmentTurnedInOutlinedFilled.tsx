...
const IconMaterialAssignmentTurnedInOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AssignmentTurnedInOutlinedFilled'
...
export default IconMaterialAssignmentTurnedInOutlinedFilled;
