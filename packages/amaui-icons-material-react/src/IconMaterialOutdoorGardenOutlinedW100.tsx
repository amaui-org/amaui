...
const IconMaterialOutdoorGardenOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='OutdoorGardenOutlinedW100'
...
export default IconMaterialOutdoorGardenOutlinedW100;
