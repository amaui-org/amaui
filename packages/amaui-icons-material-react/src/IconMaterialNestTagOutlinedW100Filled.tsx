...
const IconMaterialNestTagOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestTagOutlinedW100Filled'
      short_name='NestTag'
...
export default IconMaterialNestTagOutlinedW100Filled;
