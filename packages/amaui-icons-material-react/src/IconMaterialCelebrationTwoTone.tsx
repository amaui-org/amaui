...
const IconMaterialCelebrationTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialCelebrationTwoTone.displayName = 'AmauiIconMaterialCelebrationTwoTone';

export default IconMaterialCelebrationTwoTone;
