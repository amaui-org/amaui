...
const IconMaterialWaterHeaterOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WaterHeaterOutlinedFilled'
...
export default IconMaterialWaterHeaterOutlinedFilled;
