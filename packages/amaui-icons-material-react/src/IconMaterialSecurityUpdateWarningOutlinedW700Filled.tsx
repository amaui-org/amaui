...
const IconMaterialSecurityUpdateWarningOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SecurityUpdateWarningOutlinedW700Filled'
...
export default IconMaterialSecurityUpdateWarningOutlinedW700Filled;
