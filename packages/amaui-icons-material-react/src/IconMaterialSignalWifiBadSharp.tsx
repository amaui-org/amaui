...
const IconMaterialSignalWifiBadSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialSignalWifiBadSharp.displayName = 'AmauiIconMaterialSignalWifiBadSharp';

export default IconMaterialSignalWifiBadSharp;
