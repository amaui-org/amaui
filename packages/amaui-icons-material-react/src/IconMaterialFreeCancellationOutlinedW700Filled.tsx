...
const IconMaterialFreeCancellationOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FreeCancellationOutlinedW700Filled'
...
export default IconMaterialFreeCancellationOutlinedW700Filled;
