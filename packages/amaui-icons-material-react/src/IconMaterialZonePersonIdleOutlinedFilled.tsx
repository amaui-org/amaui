...
const IconMaterialZonePersonIdleOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ZonePersonIdleOutlinedFilled'
...
export default IconMaterialZonePersonIdleOutlinedFilled;
