...
const IconMaterialCloudOffSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CloudOffSharpW700Filled'
      short_name='CloudOff'
...
export default IconMaterialCloudOffSharpW700Filled;
