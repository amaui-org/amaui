...
const IconMaterialNotificationAddOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NotificationAddOutlinedW100'
...
export default IconMaterialNotificationAddOutlinedW100;
