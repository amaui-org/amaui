...
const IconMaterialLinkOffTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialLinkOffTwoTone.displayName = 'AmauiIconMaterialLinkOffTwoTone';

export default IconMaterialLinkOffTwoTone;
