...
const IconMaterialPlaylistAddCheckCircleOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PlaylistAddCheckCircleOutlinedFilled'
...
export default IconMaterialPlaylistAddCheckCircleOutlinedFilled;
