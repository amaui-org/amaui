...
const IconMaterialMagicButtonOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MagicButtonOutlinedW100Filled'
...
export default IconMaterialMagicButtonOutlinedW100Filled;
