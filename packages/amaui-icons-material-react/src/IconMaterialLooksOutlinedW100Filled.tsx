...
const IconMaterialLooksOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LooksOutlinedW100Filled'
      short_name='Looks'
...
export default IconMaterialLooksOutlinedW100Filled;
