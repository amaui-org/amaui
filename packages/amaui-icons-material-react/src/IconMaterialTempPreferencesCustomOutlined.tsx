...
const IconMaterialTempPreferencesCustomOutlined = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TempPreferencesCustomOutlined'
...
export default IconMaterialTempPreferencesCustomOutlined;
