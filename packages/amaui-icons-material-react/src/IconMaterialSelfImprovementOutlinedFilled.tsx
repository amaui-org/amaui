...
const IconMaterialSelfImprovementOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SelfImprovementOutlinedFilled'
...
export default IconMaterialSelfImprovementOutlinedFilled;
