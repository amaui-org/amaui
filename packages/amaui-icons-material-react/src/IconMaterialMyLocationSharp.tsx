...
const IconMaterialMyLocationSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialMyLocationSharp.displayName = 'AmauiIconMaterialMyLocationSharp';

export default IconMaterialMyLocationSharp;
