...
const IconMaterialDetectorAlarmOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DetectorAlarmOutlinedW100Filled'
...
export default IconMaterialDetectorAlarmOutlinedW100Filled;
