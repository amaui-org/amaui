...
const IconMaterialPersonAddOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PersonAddOutlinedW100Filled'
...
export default IconMaterialPersonAddOutlinedW100Filled;
