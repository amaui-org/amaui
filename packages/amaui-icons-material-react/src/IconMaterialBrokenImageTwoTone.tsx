...
const IconMaterialBrokenImageTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialBrokenImageTwoTone.displayName = 'AmauiIconMaterialBrokenImageTwoTone';

export default IconMaterialBrokenImageTwoTone;
