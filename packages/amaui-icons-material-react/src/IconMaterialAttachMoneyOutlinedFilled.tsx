...
const IconMaterialAttachMoneyOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AttachMoneyOutlinedFilled'
...
export default IconMaterialAttachMoneyOutlinedFilled;
