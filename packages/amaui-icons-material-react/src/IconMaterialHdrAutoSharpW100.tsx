...
const IconMaterialHdrAutoSharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HdrAutoSharpW100'
      short_name='HdrAuto'
...
IconMaterialHdrAutoSharpW100.displayName = 'AmauiIconMaterialHdrAutoSharpW100';

export default IconMaterialHdrAutoSharpW100;
