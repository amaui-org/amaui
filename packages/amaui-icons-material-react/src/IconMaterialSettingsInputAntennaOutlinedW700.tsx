...
const IconMaterialSettingsInputAntennaOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SettingsInputAntennaOutlinedW700'
...
export default IconMaterialSettingsInputAntennaOutlinedW700;
