...
const IconMaterialAirlineStopsOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AirlineStopsOutlinedW100'
...
export default IconMaterialAirlineStopsOutlinedW100;
