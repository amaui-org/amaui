...
const IconMaterialTakeoutDiningTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialTakeoutDiningTwoTone.displayName = 'AmauiIconMaterialTakeoutDiningTwoTone';

export default IconMaterialTakeoutDiningTwoTone;
