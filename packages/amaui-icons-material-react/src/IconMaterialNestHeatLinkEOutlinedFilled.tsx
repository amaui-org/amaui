...
const IconMaterialNestHeatLinkEOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestHeatLinkEOutlinedFilled'
...
export default IconMaterialNestHeatLinkEOutlinedFilled;
