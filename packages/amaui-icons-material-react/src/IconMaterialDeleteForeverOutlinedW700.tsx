...
const IconMaterialDeleteForeverOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DeleteForeverOutlinedW700'
...
export default IconMaterialDeleteForeverOutlinedW700;
