...
const IconMaterialVignetteOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='VignetteOutlinedW100Filled'
      short_name='Vignette'
...
export default IconMaterialVignetteOutlinedW100Filled;
