...
const IconMaterialDetectionAndZoneOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DetectionAndZoneOutlinedFilled'
...
export default IconMaterialDetectionAndZoneOutlinedFilled;
