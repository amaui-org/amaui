...
const IconMaterialBorderLeftOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BorderLeftOutlinedFilled'
...
export default IconMaterialBorderLeftOutlinedFilled;
