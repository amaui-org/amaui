...
const IconMaterialPlaylistAddCheckCircleSharpW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PlaylistAddCheckCircleSharpW700'
...
export default IconMaterialPlaylistAddCheckCircleSharpW700;
