...
const IconMaterialPerson3OutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Person3OutlinedW100Filled'
      short_name='Person3'
...
export default IconMaterialPerson3OutlinedW100Filled;
