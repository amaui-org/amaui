...
const IconMaterialUsbOffSharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='UsbOffSharpW100'
      short_name='UsbOff'
...
IconMaterialUsbOffSharpW100.displayName = 'AmauiIconMaterialUsbOffSharpW100';

export default IconMaterialUsbOffSharpW100;
