...
const IconMaterialThermometerOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ThermometerOutlinedFilled'
...
export default IconMaterialThermometerOutlinedFilled;
