...
const IconMaterialPhoneIphoneOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PhoneIphoneOutlinedFilled'
...
export default IconMaterialPhoneIphoneOutlinedFilled;
