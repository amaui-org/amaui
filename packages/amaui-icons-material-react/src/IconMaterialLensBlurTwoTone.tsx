...
const IconMaterialLensBlurTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialLensBlurTwoTone.displayName = 'AmauiIconMaterialLensBlurTwoTone';

export default IconMaterialLensBlurTwoTone;
