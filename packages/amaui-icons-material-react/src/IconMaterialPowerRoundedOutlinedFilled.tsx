...
const IconMaterialPowerRoundedOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PowerRoundedOutlinedFilled'
...
export default IconMaterialPowerRoundedOutlinedFilled;
