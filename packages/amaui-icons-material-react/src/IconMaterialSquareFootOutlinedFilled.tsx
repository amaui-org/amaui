...
const IconMaterialSquareFootOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SquareFootOutlinedFilled'
...
export default IconMaterialSquareFootOutlinedFilled;
