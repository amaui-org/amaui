...
const IconMaterialPrivacyTipOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PrivacyTipOutlinedFilled'
...
export default IconMaterialPrivacyTipOutlinedFilled;
