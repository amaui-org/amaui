...
const IconMaterialUmbrellaOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='UmbrellaOutlinedW700Filled'
      short_name='Umbrella'
...
export default IconMaterialUmbrellaOutlinedW700Filled;
