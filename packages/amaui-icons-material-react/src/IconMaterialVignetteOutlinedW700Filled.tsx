...
const IconMaterialVignetteOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='VignetteOutlinedW700Filled'
      short_name='Vignette'
...
export default IconMaterialVignetteOutlinedW700Filled;
