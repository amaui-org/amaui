...
const IconMaterialSignLanguageTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialSignLanguageTwoTone.displayName = 'AmauiIconMaterialSignLanguageTwoTone';

export default IconMaterialSignLanguageTwoTone;
