...
const IconMaterialDetectorOfflineOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DetectorOfflineOutlinedW700'
...
export default IconMaterialDetectorOfflineOutlinedW700;
