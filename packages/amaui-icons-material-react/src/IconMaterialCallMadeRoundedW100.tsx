...
const IconMaterialCallMadeRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CallMadeRoundedW100'
      short_name='CallMade'
...
IconMaterialCallMadeRoundedW100.displayName = 'AmauiIconMaterialCallMadeRoundedW100';

export default IconMaterialCallMadeRoundedW100;
