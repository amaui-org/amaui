...
const IconMaterialNearbyErrorOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NearbyErrorOutlinedW700'
...
export default IconMaterialNearbyErrorOutlinedW700;
