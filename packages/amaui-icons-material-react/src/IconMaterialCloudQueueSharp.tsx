...
const IconMaterialCloudQueueSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialCloudQueueSharp.displayName = 'AmauiIconMaterialCloudQueueSharp';

export default IconMaterialCloudQueueSharp;
