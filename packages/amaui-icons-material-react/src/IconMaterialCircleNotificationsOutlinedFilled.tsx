...
const IconMaterialCircleNotificationsOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CircleNotificationsOutlinedFilled'
...
export default IconMaterialCircleNotificationsOutlinedFilled;
