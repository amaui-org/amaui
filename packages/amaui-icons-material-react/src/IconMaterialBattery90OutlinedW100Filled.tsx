...
const IconMaterialBattery90OutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Battery90OutlinedW100Filled'
...
export default IconMaterialBattery90OutlinedW100Filled;
