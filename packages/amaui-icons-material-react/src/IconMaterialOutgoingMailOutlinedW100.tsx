...
const IconMaterialOutgoingMailOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='OutgoingMailOutlinedW100'
...
export default IconMaterialOutgoingMailOutlinedW100;
