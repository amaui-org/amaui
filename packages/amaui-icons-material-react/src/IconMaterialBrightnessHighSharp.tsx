...
const IconMaterialBrightnessHighSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialBrightnessHighSharp.displayName = 'AmauiIconMaterialBrightnessHighSharp';

export default IconMaterialBrightnessHighSharp;
