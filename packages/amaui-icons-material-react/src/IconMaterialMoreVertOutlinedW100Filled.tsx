...
const IconMaterialMoreVertOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MoreVertOutlinedW100Filled'
      short_name='MoreVert'
...
export default IconMaterialMoreVertOutlinedW100Filled;
