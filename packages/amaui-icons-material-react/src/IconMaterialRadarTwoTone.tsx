...
const IconMaterialRadarTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialRadarTwoTone.displayName = 'AmauiIconMaterialRadarTwoTone';

export default IconMaterialRadarTwoTone;
