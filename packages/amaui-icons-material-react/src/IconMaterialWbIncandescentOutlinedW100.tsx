...
const IconMaterialWbIncandescentOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WbIncandescentOutlinedW100'
...
export default IconMaterialWbIncandescentOutlinedW100;
