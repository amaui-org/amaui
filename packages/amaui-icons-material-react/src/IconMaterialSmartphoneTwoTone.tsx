...
const IconMaterialSmartphoneTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialSmartphoneTwoTone.displayName = 'AmauiIconMaterialSmartphoneTwoTone';

export default IconMaterialSmartphoneTwoTone;
