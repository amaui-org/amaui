...
const IconMaterialFolderTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialFolderTwoTone.displayName = 'AmauiIconMaterialFolderTwoTone';

export default IconMaterialFolderTwoTone;
