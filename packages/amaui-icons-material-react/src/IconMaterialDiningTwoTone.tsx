...
const IconMaterialDiningTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialDiningTwoTone.displayName = 'AmauiIconMaterialDiningTwoTone';

export default IconMaterialDiningTwoTone;
