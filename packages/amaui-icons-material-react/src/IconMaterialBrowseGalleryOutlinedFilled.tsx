...
const IconMaterialBrowseGalleryOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BrowseGalleryOutlinedFilled'
...
export default IconMaterialBrowseGalleryOutlinedFilled;
