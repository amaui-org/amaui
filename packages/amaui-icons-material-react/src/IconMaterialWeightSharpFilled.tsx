...
const IconMaterialWeightSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WeightSharpFilled'
      short_name='Weight'
...
IconMaterialWeightSharpFilled.displayName = 'AmauiIconMaterialWeightSharpFilled';

export default IconMaterialWeightSharpFilled;
