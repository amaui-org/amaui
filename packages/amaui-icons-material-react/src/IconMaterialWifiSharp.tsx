...
const IconMaterialWifiSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialWifiSharp.displayName = 'AmauiIconMaterialWifiSharp';

export default IconMaterialWifiSharp;
