...
const IconMaterialBrightness3OutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Brightness3OutlinedW100Filled'
...
export default IconMaterialBrightness3OutlinedW100Filled;
