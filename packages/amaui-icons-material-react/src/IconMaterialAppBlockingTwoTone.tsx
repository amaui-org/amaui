...
const IconMaterialAppBlockingTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialAppBlockingTwoTone.displayName = 'AmauiIconMaterialAppBlockingTwoTone';

export default IconMaterialAppBlockingTwoTone;
