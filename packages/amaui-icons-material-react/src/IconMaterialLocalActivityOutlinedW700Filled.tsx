...
const IconMaterialLocalActivityOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LocalActivityOutlinedW700Filled'
...
export default IconMaterialLocalActivityOutlinedW700Filled;
