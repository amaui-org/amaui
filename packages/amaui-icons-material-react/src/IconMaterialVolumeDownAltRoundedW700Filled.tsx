...
const IconMaterialVolumeDownAltRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='VolumeDownAltRoundedW700Filled'
...
export default IconMaterialVolumeDownAltRoundedW700Filled;
