...
const IconMaterialEventAvailableOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='EventAvailableOutlinedW100'
...
export default IconMaterialEventAvailableOutlinedW100;
