...
const IconMaterialDetectorStatusOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DetectorStatusOutlinedFilled'
...
export default IconMaterialDetectorStatusOutlinedFilled;
