...
const IconMaterialDoneAllOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DoneAllOutlinedW700Filled'
      short_name='DoneAll'
...
export default IconMaterialDoneAllOutlinedW700Filled;
