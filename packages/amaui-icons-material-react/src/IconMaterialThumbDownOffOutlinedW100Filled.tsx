...
const IconMaterialThumbDownOffOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ThumbDownOffOutlinedW100Filled'
...
export default IconMaterialThumbDownOffOutlinedW100Filled;
