...
const IconMaterialModeHeatRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ModeHeatRoundedW100'
      short_name='ModeHeat'
...
IconMaterialModeHeatRoundedW100.displayName = 'AmauiIconMaterialModeHeatRoundedW100';

export default IconMaterialModeHeatRoundedW100;
