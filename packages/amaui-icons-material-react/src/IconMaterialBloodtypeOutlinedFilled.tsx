...
const IconMaterialBloodtypeOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BloodtypeOutlinedFilled'
...
export default IconMaterialBloodtypeOutlinedFilled;
