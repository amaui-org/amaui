...
const IconMaterialThumbUpOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ThumbUpOutlinedW100Filled'
      short_name='ThumbUp'
...
export default IconMaterialThumbUpOutlinedW100Filled;
