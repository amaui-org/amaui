...
const IconMaterialBookRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BookRoundedW100'
      short_name='Book'
...
IconMaterialBookRoundedW100.displayName = 'AmauiIconMaterialBookRoundedW100';

export default IconMaterialBookRoundedW100;
