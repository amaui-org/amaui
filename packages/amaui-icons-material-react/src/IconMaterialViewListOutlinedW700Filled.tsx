...
const IconMaterialViewListOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ViewListOutlinedW700Filled'
      short_name='ViewList'
...
export default IconMaterialViewListOutlinedW700Filled;
