...
const IconMaterialLegendToggleSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LegendToggleSharpW700Filled'
...
export default IconMaterialLegendToggleSharpW700Filled;
