...
const IconMaterialVisibilityOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='VisibilityOutlinedW100Filled'
...
export default IconMaterialVisibilityOutlinedW100Filled;
