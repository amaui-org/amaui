...
const IconMaterialBackHandTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialBackHandTwoTone.displayName = 'AmauiIconMaterialBackHandTwoTone';

export default IconMaterialBackHandTwoTone;
