...
const IconMaterialNoCrashOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NoCrashOutlinedW100Filled'
      short_name='NoCrash'
...
export default IconMaterialNoCrashOutlinedW100Filled;
