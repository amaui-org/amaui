...
const IconMaterialInterestsOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='InterestsOutlinedW100Filled'
...
export default IconMaterialInterestsOutlinedW100Filled;
