...
const IconMaterialGridOffTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialGridOffTwoTone.displayName = 'AmauiIconMaterialGridOffTwoTone';

export default IconMaterialGridOffTwoTone;
