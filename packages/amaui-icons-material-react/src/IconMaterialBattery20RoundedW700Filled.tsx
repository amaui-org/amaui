...
const IconMaterialBattery20RoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Battery20RoundedW700Filled'
...
export default IconMaterialBattery20RoundedW700Filled;
