...
const IconMaterialNotAccessibleOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NotAccessibleOutlinedFilled'
...
export default IconMaterialNotAccessibleOutlinedFilled;
