...
const IconMaterialSipTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialSipTwoTone.displayName = 'AmauiIconMaterialSipTwoTone';

export default IconMaterialSipTwoTone;
