...
const IconMaterialNestEcoLeafOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestEcoLeafOutlinedW100'
...
export default IconMaterialNestEcoLeafOutlinedW100;
