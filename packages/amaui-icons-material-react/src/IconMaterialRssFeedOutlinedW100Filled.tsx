...
const IconMaterialRssFeedOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RssFeedOutlinedW100Filled'
      short_name='RssFeed'
...
export default IconMaterialRssFeedOutlinedW100Filled;
