...
const IconMaterialHailRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialHailRounded.displayName = 'AmauiIconMaterialHailRounded';

export default IconMaterialHailRounded;
