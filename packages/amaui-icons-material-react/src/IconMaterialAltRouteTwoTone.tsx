...
const IconMaterialAltRouteTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialAltRouteTwoTone.displayName = 'AmauiIconMaterialAltRouteTwoTone';

export default IconMaterialAltRouteTwoTone;
