...
const IconMaterialDetectorStatusRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DetectorStatusRoundedW700Filled'
...
export default IconMaterialDetectorStatusRoundedW700Filled;
