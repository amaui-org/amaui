...
const IconMaterialArrowOutwardRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ArrowOutwardRoundedW700Filled'
...
export default IconMaterialArrowOutwardRoundedW700Filled;
