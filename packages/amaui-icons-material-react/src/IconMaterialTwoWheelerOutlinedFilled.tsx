...
const IconMaterialTwoWheelerOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TwoWheelerOutlinedFilled'
...
export default IconMaterialTwoWheelerOutlinedFilled;
