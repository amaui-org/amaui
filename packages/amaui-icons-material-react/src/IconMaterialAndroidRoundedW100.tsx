...
const IconMaterialAndroidRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AndroidRoundedW100'
      short_name='Android'
...
IconMaterialAndroidRoundedW100.displayName = 'AmauiIconMaterialAndroidRoundedW100';

export default IconMaterialAndroidRoundedW100;
