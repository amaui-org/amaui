...
const IconMaterialMyLocationSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MyLocationSharpW700Filled'
...
export default IconMaterialMyLocationSharpW700Filled;
