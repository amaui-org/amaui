...
const IconMaterialCloudyOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CloudyOutlinedW100Filled'
      short_name='Cloudy'
...
export default IconMaterialCloudyOutlinedW100Filled;
