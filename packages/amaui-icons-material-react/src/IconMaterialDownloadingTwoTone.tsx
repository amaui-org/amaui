...
const IconMaterialDownloadingTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialDownloadingTwoTone.displayName = 'AmauiIconMaterialDownloadingTwoTone';

export default IconMaterialDownloadingTwoTone;
