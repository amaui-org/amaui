...
const IconMaterialWeightOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WeightOutlinedW100Filled'
      short_name='Weight'
...
export default IconMaterialWeightOutlinedW100Filled;
