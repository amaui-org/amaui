...
const IconMaterialHouseTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialHouseTwoTone.displayName = 'AmauiIconMaterialHouseTwoTone';

export default IconMaterialHouseTwoTone;
