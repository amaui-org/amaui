...
const IconMaterialHomePinSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HomePinSharpFilled'
      short_name='HomePin'
...
IconMaterialHomePinSharpFilled.displayName = 'AmauiIconMaterialHomePinSharpFilled';

export default IconMaterialHomePinSharpFilled;
