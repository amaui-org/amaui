...
const IconMaterialMatterSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MatterSharpFilled'
      short_name='Matter'
...
IconMaterialMatterSharpFilled.displayName = 'AmauiIconMaterialMatterSharpFilled';

export default IconMaterialMatterSharpFilled;
