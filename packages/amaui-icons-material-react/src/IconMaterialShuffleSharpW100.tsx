...
const IconMaterialShuffleSharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ShuffleSharpW100'
      short_name='Shuffle'
...
IconMaterialShuffleSharpW100.displayName = 'AmauiIconMaterialShuffleSharpW100';

export default IconMaterialShuffleSharpW100;
