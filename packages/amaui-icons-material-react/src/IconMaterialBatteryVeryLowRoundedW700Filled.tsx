...
const IconMaterialBatteryVeryLowRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryVeryLowRoundedW700Filled'
...
export default IconMaterialBatteryVeryLowRoundedW700Filled;
