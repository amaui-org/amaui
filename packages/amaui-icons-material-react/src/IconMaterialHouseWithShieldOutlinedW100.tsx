...
const IconMaterialHouseWithShieldOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HouseWithShieldOutlinedW100'
...
export default IconMaterialHouseWithShieldOutlinedW100;
