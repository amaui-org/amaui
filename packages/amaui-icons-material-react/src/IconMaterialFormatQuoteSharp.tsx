...
const IconMaterialFormatQuoteSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialFormatQuoteSharp.displayName = 'AmauiIconMaterialFormatQuoteSharp';

export default IconMaterialFormatQuoteSharp;
