...
const IconMaterialFilter4TwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialFilter4TwoTone.displayName = 'AmauiIconMaterialFilter4TwoTone';

export default IconMaterialFilter4TwoTone;
