...
const IconMaterialDirectionsSubwayOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DirectionsSubwayOutlinedFilled'
...
export default IconMaterialDirectionsSubwayOutlinedFilled;
