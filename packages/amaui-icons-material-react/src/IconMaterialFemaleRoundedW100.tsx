...
const IconMaterialFemaleRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FemaleRoundedW100'
      short_name='Female'
...
IconMaterialFemaleRoundedW100.displayName = 'AmauiIconMaterialFemaleRoundedW100';

export default IconMaterialFemaleRoundedW100;
