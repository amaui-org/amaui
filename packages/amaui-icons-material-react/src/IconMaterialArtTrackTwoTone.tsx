...
const IconMaterialArtTrackTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialArtTrackTwoTone.displayName = 'AmauiIconMaterialArtTrackTwoTone';

export default IconMaterialArtTrackTwoTone;
