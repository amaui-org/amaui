...
const IconMaterialCenterFocusStrongOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CenterFocusStrongOutlinedW100'
...
export default IconMaterialCenterFocusStrongOutlinedW100;
