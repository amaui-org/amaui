...
const IconMaterialEditNotificationsSharpW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='EditNotificationsSharpW700'
...
export default IconMaterialEditNotificationsSharpW700;
