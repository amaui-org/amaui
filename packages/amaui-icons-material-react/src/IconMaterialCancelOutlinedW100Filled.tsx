...
const IconMaterialCancelOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CancelOutlinedW100Filled'
      short_name='Cancel'
...
export default IconMaterialCancelOutlinedW100Filled;
