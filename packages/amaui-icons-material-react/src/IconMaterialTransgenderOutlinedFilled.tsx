...
const IconMaterialTransgenderOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TransgenderOutlinedFilled'
...
export default IconMaterialTransgenderOutlinedFilled;
