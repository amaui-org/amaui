...
const IconMaterialModeCoolRounded = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ModeCoolRounded'
      short_name='ModeCool'
...
IconMaterialModeCoolRounded.displayName = 'AmauiIconMaterialModeCoolRounded';

export default IconMaterialModeCoolRounded;
