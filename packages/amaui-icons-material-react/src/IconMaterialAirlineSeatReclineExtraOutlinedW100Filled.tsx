...
const IconMaterialAirlineSeatReclineExtraOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AirlineSeatReclineExtraOutlinedW100Filled'
...
export default IconMaterialAirlineSeatReclineExtraOutlinedW100Filled;
