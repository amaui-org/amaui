...
const IconMaterialArrowDropUpRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ArrowDropUpRoundedW700Filled'
...
export default IconMaterialArrowDropUpRoundedW700Filled;
