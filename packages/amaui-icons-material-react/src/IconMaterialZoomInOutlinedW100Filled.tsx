...
const IconMaterialZoomInOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ZoomInOutlinedW100Filled'
      short_name='ZoomIn'
...
export default IconMaterialZoomInOutlinedW100Filled;
