...
const IconMaterialHdrAutoOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HdrAutoOutlinedW100Filled'
      short_name='HdrAuto'
...
export default IconMaterialHdrAutoOutlinedW100Filled;
