...
const IconMaterialStarsTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialStarsTwoTone.displayName = 'AmauiIconMaterialStarsTwoTone';

export default IconMaterialStarsTwoTone;
