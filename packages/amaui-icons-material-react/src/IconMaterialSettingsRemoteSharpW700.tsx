...
const IconMaterialSettingsRemoteSharpW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SettingsRemoteSharpW700'
...
export default IconMaterialSettingsRemoteSharpW700;
