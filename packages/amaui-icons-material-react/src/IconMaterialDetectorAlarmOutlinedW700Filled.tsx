...
const IconMaterialDetectorAlarmOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DetectorAlarmOutlinedW700Filled'
...
export default IconMaterialDetectorAlarmOutlinedW700Filled;
