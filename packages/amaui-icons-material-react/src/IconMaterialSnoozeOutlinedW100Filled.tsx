...
const IconMaterialSnoozeOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SnoozeOutlinedW100Filled'
      short_name='Snooze'
...
export default IconMaterialSnoozeOutlinedW100Filled;
