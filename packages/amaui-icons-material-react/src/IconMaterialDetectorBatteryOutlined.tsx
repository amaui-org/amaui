...
const IconMaterialDetectorBatteryOutlined = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DetectorBatteryOutlined'
...
export default IconMaterialDetectorBatteryOutlined;
