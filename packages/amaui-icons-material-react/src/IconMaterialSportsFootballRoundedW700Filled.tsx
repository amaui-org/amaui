...
const IconMaterialSportsFootballRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SportsFootballRoundedW700Filled'
...
export default IconMaterialSportsFootballRoundedW700Filled;
