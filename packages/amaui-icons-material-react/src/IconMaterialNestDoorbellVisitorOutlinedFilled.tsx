...
const IconMaterialNestDoorbellVisitorOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestDoorbellVisitorOutlinedFilled'
...
export default IconMaterialNestDoorbellVisitorOutlinedFilled;
