...
const IconMaterialNoteAltTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialNoteAltTwoTone.displayName = 'AmauiIconMaterialNoteAltTwoTone';

export default IconMaterialNoteAltTwoTone;
