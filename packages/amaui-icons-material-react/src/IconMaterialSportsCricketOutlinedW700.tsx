...
const IconMaterialSportsCricketOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SportsCricketOutlinedW700'
...
export default IconMaterialSportsCricketOutlinedW700;
