...
const IconMaterialCloudUploadTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialCloudUploadTwoTone.displayName = 'AmauiIconMaterialCloudUploadTwoTone';

export default IconMaterialCloudUploadTwoTone;
