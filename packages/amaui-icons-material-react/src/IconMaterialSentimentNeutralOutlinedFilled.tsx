...
const IconMaterialSentimentNeutralOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SentimentNeutralOutlinedFilled'
...
export default IconMaterialSentimentNeutralOutlinedFilled;
