...
const IconMaterialHotTubSharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HotTubSharpW100'
      short_name='HotTub'
...
IconMaterialHotTubSharpW100.displayName = 'AmauiIconMaterialHotTubSharpW100';

export default IconMaterialHotTubSharpW100;
