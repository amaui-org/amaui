...
const IconMaterialBrightness5OutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Brightness5OutlinedW700'
...
export default IconMaterialBrightness5OutlinedW700;
