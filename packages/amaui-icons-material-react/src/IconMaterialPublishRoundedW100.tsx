...
const IconMaterialPublishRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PublishRoundedW100'
      short_name='Publish'
...
IconMaterialPublishRoundedW100.displayName = 'AmauiIconMaterialPublishRoundedW100';

export default IconMaterialPublishRoundedW100;
