...
const IconMaterialAgenderOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AgenderOutlinedW700Filled'
      short_name='Agender'
...
export default IconMaterialAgenderOutlinedW700Filled;
