...
const IconMaterialForwardRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialForwardRounded.displayName = 'AmauiIconMaterialForwardRounded';

export default IconMaterialForwardRounded;
