...
const IconMaterialLyricsSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LyricsSharpFilled'
      short_name='Lyrics'
...
IconMaterialLyricsSharpFilled.displayName = 'AmauiIconMaterialLyricsSharpFilled';

export default IconMaterialLyricsSharpFilled;
