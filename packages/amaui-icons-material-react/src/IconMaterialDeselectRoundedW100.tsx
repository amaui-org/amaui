...
const IconMaterialDeselectRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DeselectRoundedW100'
      short_name='Deselect'
...
IconMaterialDeselectRoundedW100.displayName = 'AmauiIconMaterialDeselectRoundedW100';

export default IconMaterialDeselectRoundedW100;
