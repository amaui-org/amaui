...
const IconMaterialDetailsRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DetailsRoundedW100'
      short_name='Details'
...
IconMaterialDetailsRoundedW100.displayName = 'AmauiIconMaterialDetailsRoundedW100';

export default IconMaterialDetailsRoundedW100;
