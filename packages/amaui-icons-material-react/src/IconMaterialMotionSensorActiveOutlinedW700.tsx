...
const IconMaterialMotionSensorActiveOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MotionSensorActiveOutlinedW700'
...
export default IconMaterialMotionSensorActiveOutlinedW700;
