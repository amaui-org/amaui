...
const IconMaterialRadioButtonUncheckedRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RadioButtonUncheckedRoundedW700Filled'
...
export default IconMaterialRadioButtonUncheckedRoundedW700Filled;
