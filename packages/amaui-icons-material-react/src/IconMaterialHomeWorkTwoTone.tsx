...
const IconMaterialHomeWorkTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialHomeWorkTwoTone.displayName = 'AmauiIconMaterialHomeWorkTwoTone';

export default IconMaterialHomeWorkTwoTone;
