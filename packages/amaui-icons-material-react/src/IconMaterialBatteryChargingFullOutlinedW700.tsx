...
const IconMaterialBatteryChargingFullOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryChargingFullOutlinedW700'
...
export default IconMaterialBatteryChargingFullOutlinedW700;
