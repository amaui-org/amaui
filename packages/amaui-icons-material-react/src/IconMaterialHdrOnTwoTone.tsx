...
const IconMaterialHdrOnTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialHdrOnTwoTone.displayName = 'AmauiIconMaterialHdrOnTwoTone';

export default IconMaterialHdrOnTwoTone;
