...
const IconMaterialPersonalInjuryOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PersonalInjuryOutlinedFilled'
...
export default IconMaterialPersonalInjuryOutlinedFilled;
