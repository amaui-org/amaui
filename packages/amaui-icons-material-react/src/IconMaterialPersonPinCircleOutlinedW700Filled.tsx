...
const IconMaterialPersonPinCircleOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PersonPinCircleOutlinedW700Filled'
...
export default IconMaterialPersonPinCircleOutlinedW700Filled;
