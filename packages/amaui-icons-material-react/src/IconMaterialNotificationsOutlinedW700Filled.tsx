...
const IconMaterialNotificationsOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NotificationsOutlinedW700Filled'
...
export default IconMaterialNotificationsOutlinedW700Filled;
