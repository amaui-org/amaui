...
const IconMaterialPanoramaHorizontalOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PanoramaHorizontalOutlinedFilled'
...
export default IconMaterialPanoramaHorizontalOutlinedFilled;
