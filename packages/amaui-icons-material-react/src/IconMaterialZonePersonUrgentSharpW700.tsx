...
const IconMaterialZonePersonUrgentSharpW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ZonePersonUrgentSharpW700'
...
export default IconMaterialZonePersonUrgentSharpW700;
