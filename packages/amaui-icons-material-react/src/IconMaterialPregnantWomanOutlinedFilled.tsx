...
const IconMaterialPregnantWomanOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PregnantWomanOutlinedFilled'
...
export default IconMaterialPregnantWomanOutlinedFilled;
