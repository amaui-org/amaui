...
const IconMaterialNestDoorbellVisitorOutlined = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestDoorbellVisitorOutlined'
...
export default IconMaterialNestDoorbellVisitorOutlined;
