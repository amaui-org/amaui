...
const IconMaterialNestThermostatGen3RoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestThermostatGen3RoundedW700Filled'
...
export default IconMaterialNestThermostatGen3RoundedW700Filled;
