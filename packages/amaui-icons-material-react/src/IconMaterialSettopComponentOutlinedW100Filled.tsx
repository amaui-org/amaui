...
const IconMaterialSettopComponentOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SettopComponentOutlinedW100Filled'
...
export default IconMaterialSettopComponentOutlinedW100Filled;
