...
const IconMaterialOutgoingMailRoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='OutgoingMailRoundedW700'
...
export default IconMaterialOutgoingMailRoundedW700;
