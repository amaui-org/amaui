...
const IconMaterialFlourescentOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FlourescentOutlinedW100Filled'
...
export default IconMaterialFlourescentOutlinedW100Filled;
