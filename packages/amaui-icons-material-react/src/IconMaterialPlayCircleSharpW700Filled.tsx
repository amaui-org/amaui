...
const IconMaterialPlayCircleSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PlayCircleSharpW700Filled'
...
export default IconMaterialPlayCircleSharpW700Filled;
