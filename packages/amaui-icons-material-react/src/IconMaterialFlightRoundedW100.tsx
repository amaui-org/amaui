...
const IconMaterialFlightRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FlightRoundedW100'
      short_name='Flight'
...
IconMaterialFlightRoundedW100.displayName = 'AmauiIconMaterialFlightRoundedW100';

export default IconMaterialFlightRoundedW100;
