...
const IconMaterialSportsVolleyballOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SportsVolleyballOutlinedW100Filled'
...
export default IconMaterialSportsVolleyballOutlinedW100Filled;
