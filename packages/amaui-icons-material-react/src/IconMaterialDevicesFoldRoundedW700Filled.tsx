...
const IconMaterialDevicesFoldRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DevicesFoldRoundedW700Filled'
...
export default IconMaterialDevicesFoldRoundedW700Filled;
