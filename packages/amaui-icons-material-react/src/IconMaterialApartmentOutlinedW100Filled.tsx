...
const IconMaterialApartmentOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ApartmentOutlinedW100Filled'
...
export default IconMaterialApartmentOutlinedW100Filled;
