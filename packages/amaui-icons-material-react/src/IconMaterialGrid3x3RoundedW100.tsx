...
const IconMaterialGrid3x3RoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Grid3x3RoundedW100'
      short_name='Grid3x3'
...
IconMaterialGrid3x3RoundedW100.displayName = 'AmauiIconMaterialGrid3x3RoundedW100';

export default IconMaterialGrid3x3RoundedW100;
