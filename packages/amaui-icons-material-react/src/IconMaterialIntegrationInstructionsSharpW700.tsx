...
const IconMaterialIntegrationInstructionsSharpW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='IntegrationInstructionsSharpW700'
...
export default IconMaterialIntegrationInstructionsSharpW700;
