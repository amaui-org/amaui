...
const IconMaterialSelectCheckBoxOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SelectCheckBoxOutlinedW100'
...
export default IconMaterialSelectCheckBoxOutlinedW100;
