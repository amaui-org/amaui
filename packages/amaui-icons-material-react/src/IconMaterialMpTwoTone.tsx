...
const IconMaterialMpTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialMpTwoTone.displayName = 'AmauiIconMaterialMpTwoTone';

export default IconMaterialMpTwoTone;
