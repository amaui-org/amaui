...
const IconMaterialWashSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WashSharpFilled'
      short_name='Wash'
...
IconMaterialWashSharpFilled.displayName = 'AmauiIconMaterialWashSharpFilled';

export default IconMaterialWashSharpFilled;
