...
const IconMaterialCompareRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CompareRoundedW100'
      short_name='Compare'
...
IconMaterialCompareRoundedW100.displayName = 'AmauiIconMaterialCompareRoundedW100';

export default IconMaterialCompareRoundedW100;
