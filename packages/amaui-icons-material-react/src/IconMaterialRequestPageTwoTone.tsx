...
const IconMaterialRequestPageTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialRequestPageTwoTone.displayName = 'AmauiIconMaterialRequestPageTwoTone';

export default IconMaterialRequestPageTwoTone;
