...
const IconMaterialPriceCheckSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PriceCheckSharpW700Filled'
...
export default IconMaterialPriceCheckSharpW700Filled;
