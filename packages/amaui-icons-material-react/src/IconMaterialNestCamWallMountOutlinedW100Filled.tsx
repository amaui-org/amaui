...
const IconMaterialNestCamWallMountOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestCamWallMountOutlinedW100Filled'
...
export default IconMaterialNestCamWallMountOutlinedW100Filled;
