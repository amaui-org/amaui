...
const IconMaterialQuietTimeActiveOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='QuietTimeActiveOutlinedW100'
...
export default IconMaterialQuietTimeActiveOutlinedW100;
