...
const IconMaterialWaterDropOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WaterDropOutlinedW100Filled'
...
export default IconMaterialWaterDropOutlinedW100Filled;
