...
const IconMaterialVoicemailSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='VoicemailSharpW700Filled'
...
export default IconMaterialVoicemailSharpW700Filled;
