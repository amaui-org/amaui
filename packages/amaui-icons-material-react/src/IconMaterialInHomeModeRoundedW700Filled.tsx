...
const IconMaterialInHomeModeRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='InHomeModeRoundedW700Filled'
...
export default IconMaterialInHomeModeRoundedW700Filled;
