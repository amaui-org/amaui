...
const IconMaterialLayersTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialLayersTwoTone.displayName = 'AmauiIconMaterialLayersTwoTone';

export default IconMaterialLayersTwoTone;
