...
const IconMaterialChromecastDeviceOutlined = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ChromecastDeviceOutlined'
...
export default IconMaterialChromecastDeviceOutlined;
