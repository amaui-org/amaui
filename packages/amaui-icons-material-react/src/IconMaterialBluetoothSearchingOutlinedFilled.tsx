...
const IconMaterialBluetoothSearchingOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BluetoothSearchingOutlinedFilled'
...
export default IconMaterialBluetoothSearchingOutlinedFilled;
