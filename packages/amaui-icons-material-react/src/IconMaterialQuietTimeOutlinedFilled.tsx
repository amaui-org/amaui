...
const IconMaterialQuietTimeOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='QuietTimeOutlinedFilled'
...
export default IconMaterialQuietTimeOutlinedFilled;
