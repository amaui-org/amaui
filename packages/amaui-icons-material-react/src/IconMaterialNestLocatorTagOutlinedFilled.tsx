...
const IconMaterialNestLocatorTagOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestLocatorTagOutlinedFilled'
...
export default IconMaterialNestLocatorTagOutlinedFilled;
