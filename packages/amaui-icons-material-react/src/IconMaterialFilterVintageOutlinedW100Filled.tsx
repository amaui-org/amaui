...
const IconMaterialFilterVintageOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FilterVintageOutlinedW100Filled'
...
export default IconMaterialFilterVintageOutlinedW100Filled;
