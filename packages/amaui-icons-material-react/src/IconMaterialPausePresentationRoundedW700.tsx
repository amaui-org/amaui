...
const IconMaterialPausePresentationRoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PausePresentationRoundedW700'
...
export default IconMaterialPausePresentationRoundedW700;
