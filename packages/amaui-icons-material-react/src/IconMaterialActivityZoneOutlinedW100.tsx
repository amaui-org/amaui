...
const IconMaterialActivityZoneOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ActivityZoneOutlinedW100'
...
export default IconMaterialActivityZoneOutlinedW100;
