...
const IconMaterialRiceBowlOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RiceBowlOutlinedW100Filled'
      short_name='RiceBowl'
...
export default IconMaterialRiceBowlOutlinedW100Filled;
