...
const IconMaterialOfflinePinOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='OfflinePinOutlinedFilled'
...
export default IconMaterialOfflinePinOutlinedFilled;
