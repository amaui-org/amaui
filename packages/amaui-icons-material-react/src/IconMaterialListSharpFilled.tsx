...
const IconMaterialListSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ListSharpFilled'
      short_name='List'
...
IconMaterialListSharpFilled.displayName = 'AmauiIconMaterialListSharpFilled';

export default IconMaterialListSharpFilled;
