...
const IconMaterialUsbOffSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='UsbOffSharpFilled'
      short_name='UsbOff'
...
IconMaterialUsbOffSharpFilled.displayName = 'AmauiIconMaterialUsbOffSharpFilled';

export default IconMaterialUsbOffSharpFilled;
