...
const IconMaterialSettingsInputAntennaSharpW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SettingsInputAntennaSharpW700'
...
export default IconMaterialSettingsInputAntennaSharpW700;
