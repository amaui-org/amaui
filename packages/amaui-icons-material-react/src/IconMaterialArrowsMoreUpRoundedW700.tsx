...
const IconMaterialArrowsMoreUpRoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ArrowsMoreUpRoundedW700'
...
export default IconMaterialArrowsMoreUpRoundedW700;
