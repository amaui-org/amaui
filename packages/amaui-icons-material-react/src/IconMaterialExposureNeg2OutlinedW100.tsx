...
const IconMaterialExposureNeg2OutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ExposureNeg2OutlinedW100'
...
export default IconMaterialExposureNeg2OutlinedW100;
