...
const IconMaterialRecyclingOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RecyclingOutlinedFilled'
...
export default IconMaterialRecyclingOutlinedFilled;
