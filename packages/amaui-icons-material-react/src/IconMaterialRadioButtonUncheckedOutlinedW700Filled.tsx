...
const IconMaterialRadioButtonUncheckedOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RadioButtonUncheckedOutlinedW700Filled'
...
export default IconMaterialRadioButtonUncheckedOutlinedW700Filled;
