...
const IconMaterial9kTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterial9kTwoTone.displayName = 'AmauiIconMaterial9kTwoTone';

export default IconMaterial9kTwoTone;
