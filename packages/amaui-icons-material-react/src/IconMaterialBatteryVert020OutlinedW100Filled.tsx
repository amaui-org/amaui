...
const IconMaterialBatteryVert020OutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryVert020OutlinedW100Filled'
...
export default IconMaterialBatteryVert020OutlinedW100Filled;
