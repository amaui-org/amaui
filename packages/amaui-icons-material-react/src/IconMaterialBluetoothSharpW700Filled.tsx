...
const IconMaterialBluetoothSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BluetoothSharpW700Filled'
...
export default IconMaterialBluetoothSharpW700Filled;
