...
const IconMaterialStoreOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='StoreOutlinedW100Filled'
      short_name='Store'
...
export default IconMaterialStoreOutlinedW100Filled;
