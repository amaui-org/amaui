...
const IconMaterialHomePinOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HomePinOutlinedW700Filled'
      short_name='HomePin'
...
export default IconMaterialHomePinOutlinedW700Filled;
