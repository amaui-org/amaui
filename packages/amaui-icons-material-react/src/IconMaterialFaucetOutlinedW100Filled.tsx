...
const IconMaterialFaucetOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FaucetOutlinedW100Filled'
      short_name='Faucet'
...
export default IconMaterialFaucetOutlinedW100Filled;
