...
const IconMaterialNestFarsightWeatherOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestFarsightWeatherOutlinedFilled'
...
export default IconMaterialNestFarsightWeatherOutlinedFilled;
