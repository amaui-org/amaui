...
const IconMaterialBluetoothOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BluetoothOutlinedW100Filled'
...
export default IconMaterialBluetoothOutlinedW100Filled;
