...
const IconMaterialBrightness1SharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Brightness1SharpW700Filled'
...
export default IconMaterialBrightness1SharpW700Filled;
