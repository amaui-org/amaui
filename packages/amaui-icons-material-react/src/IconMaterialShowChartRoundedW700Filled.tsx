...
const IconMaterialShowChartRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ShowChartRoundedW700Filled'
...
export default IconMaterialShowChartRoundedW700Filled;
