...
const IconMaterialNestMiniOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestMiniOutlinedW100Filled'
      short_name='NestMini'
...
export default IconMaterialNestMiniOutlinedW100Filled;
