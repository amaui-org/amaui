...
const IconMaterialBatteryCharging30OutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryCharging30OutlinedW700'
...
export default IconMaterialBatteryCharging30OutlinedW700;
