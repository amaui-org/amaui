...
const IconMaterialFormatPaintOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FormatPaintOutlinedW100'
...
export default IconMaterialFormatPaintOutlinedW100;
