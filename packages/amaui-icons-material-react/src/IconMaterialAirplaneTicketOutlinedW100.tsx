...
const IconMaterialAirplaneTicketOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AirplaneTicketOutlinedW100'
...
export default IconMaterialAirplaneTicketOutlinedW100;
