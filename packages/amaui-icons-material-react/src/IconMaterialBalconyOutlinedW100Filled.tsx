...
const IconMaterialBalconyOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BalconyOutlinedW100Filled'
      short_name='Balcony'
...
export default IconMaterialBalconyOutlinedW100Filled;
