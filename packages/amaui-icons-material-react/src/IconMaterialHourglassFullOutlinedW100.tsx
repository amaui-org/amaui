...
const IconMaterialHourglassFullOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HourglassFullOutlinedW100'
...
export default IconMaterialHourglassFullOutlinedW100;
