...
const IconMaterialBattery60OutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Battery60OutlinedW100Filled'
...
export default IconMaterialBattery60OutlinedW100Filled;
