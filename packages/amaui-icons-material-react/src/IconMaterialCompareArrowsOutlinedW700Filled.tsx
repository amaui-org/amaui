...
const IconMaterialCompareArrowsOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CompareArrowsOutlinedW700Filled'
...
export default IconMaterialCompareArrowsOutlinedW700Filled;
