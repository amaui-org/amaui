...
const IconMaterialBrightness2OutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Brightness2OutlinedW100Filled'
...
export default IconMaterialBrightness2OutlinedW100Filled;
