...
const IconMaterialTimelapseSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialTimelapseSharp.displayName = 'AmauiIconMaterialTimelapseSharp';

export default IconMaterialTimelapseSharp;
