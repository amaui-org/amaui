...
const IconMaterialBatterySaverOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatterySaverOutlinedW700Filled'
...
export default IconMaterialBatterySaverOutlinedW700Filled;
