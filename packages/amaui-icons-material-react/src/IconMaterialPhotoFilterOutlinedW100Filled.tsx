...
const IconMaterialPhotoFilterOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PhotoFilterOutlinedW100Filled'
...
export default IconMaterialPhotoFilterOutlinedW100Filled;
