...
const IconMaterialSecurityOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SecurityOutlinedW700Filled'
      short_name='Security'
...
export default IconMaterialSecurityOutlinedW700Filled;
