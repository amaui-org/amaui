...
const IconMaterialExpandRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialExpandRounded.displayName = 'AmauiIconMaterialExpandRounded';

export default IconMaterialExpandRounded;
