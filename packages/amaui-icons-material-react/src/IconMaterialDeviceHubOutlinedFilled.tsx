...
const IconMaterialDeviceHubOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DeviceHubOutlinedFilled'
...
export default IconMaterialDeviceHubOutlinedFilled;
