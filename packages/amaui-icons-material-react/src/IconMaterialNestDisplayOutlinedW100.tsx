...
const IconMaterialNestDisplayOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestDisplayOutlinedW100'
...
export default IconMaterialNestDisplayOutlinedW100;
