...
const IconMaterialInfoSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='InfoSharpFilled'
      short_name='Info'
...
IconMaterialInfoSharpFilled.displayName = 'AmauiIconMaterialInfoSharpFilled';

export default IconMaterialInfoSharpFilled;
