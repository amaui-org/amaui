...
const IconMaterialFlipTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialFlipTwoTone.displayName = 'AmauiIconMaterialFlipTwoTone';

export default IconMaterialFlipTwoTone;
