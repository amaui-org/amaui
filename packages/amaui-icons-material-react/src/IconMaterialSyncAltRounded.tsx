...
const IconMaterialSyncAltRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialSyncAltRounded.displayName = 'AmauiIconMaterialSyncAltRounded';

export default IconMaterialSyncAltRounded;
