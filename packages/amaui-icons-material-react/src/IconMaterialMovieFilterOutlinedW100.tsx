...
const IconMaterialMovieFilterOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MovieFilterOutlinedW100'
...
export default IconMaterialMovieFilterOutlinedW100;
