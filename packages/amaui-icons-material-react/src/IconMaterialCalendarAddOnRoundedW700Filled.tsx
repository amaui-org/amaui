...
const IconMaterialCalendarAddOnRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CalendarAddOnRoundedW700Filled'
...
export default IconMaterialCalendarAddOnRoundedW700Filled;
