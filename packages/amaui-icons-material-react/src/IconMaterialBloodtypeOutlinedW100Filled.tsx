...
const IconMaterialBloodtypeOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BloodtypeOutlinedW100Filled'
...
export default IconMaterialBloodtypeOutlinedW100Filled;
