...
const IconMaterialNightsStayOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NightsStayOutlinedFilled'
...
export default IconMaterialNightsStayOutlinedFilled;
