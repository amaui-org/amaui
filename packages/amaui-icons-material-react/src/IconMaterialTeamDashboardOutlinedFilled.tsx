...
const IconMaterialTeamDashboardOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TeamDashboardOutlinedFilled'
...
export default IconMaterialTeamDashboardOutlinedFilled;
