...
const IconMaterialUnfoldLessDoubleOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='UnfoldLessDoubleOutlinedW100Filled'
...
export default IconMaterialUnfoldLessDoubleOutlinedW100Filled;
