...
const IconMaterialSearchOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SearchOutlinedW100Filled'
      short_name='Search'
...
export default IconMaterialSearchOutlinedW100Filled;
