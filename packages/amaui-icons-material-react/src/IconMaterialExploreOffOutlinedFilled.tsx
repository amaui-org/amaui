...
const IconMaterialExploreOffOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ExploreOffOutlinedFilled'
...
export default IconMaterialExploreOffOutlinedFilled;
