...
const IconMaterialBadgeCriticalBatteryRoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BadgeCriticalBatteryRoundedW700'
...
export default IconMaterialBadgeCriticalBatteryRoundedW700;
