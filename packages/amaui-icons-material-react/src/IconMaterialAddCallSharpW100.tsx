...
const IconMaterialAddCallSharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AddCallSharpW100'
      short_name='AddCall'
...
IconMaterialAddCallSharpW100.displayName = 'AmauiIconMaterialAddCallSharpW100';

export default IconMaterialAddCallSharpW100;
