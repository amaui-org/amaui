...
const IconMaterialBatteryCharging90OutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryCharging90OutlinedFilled'
...
export default IconMaterialBatteryCharging90OutlinedFilled;
