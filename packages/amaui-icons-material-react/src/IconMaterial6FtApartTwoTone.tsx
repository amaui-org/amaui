...
const IconMaterial6FtApartTwoTone = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='6FtApartTwoTone'
      short_name='6FtApart'
...
IconMaterial6FtApartTwoTone.displayName = 'AmauiIconMaterial6FtApartTwoTone';

export default IconMaterial6FtApartTwoTone;
