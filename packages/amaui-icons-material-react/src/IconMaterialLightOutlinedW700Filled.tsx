...
const IconMaterialLightOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LightOutlinedW700Filled'
      short_name='Light'
...
export default IconMaterialLightOutlinedW700Filled;
