...
const IconMaterialNatureOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NatureOutlinedW700Filled'
      short_name='Nature'
...
export default IconMaterialNatureOutlinedW700Filled;
