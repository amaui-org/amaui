...
const IconMaterialLocalTaxiTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialLocalTaxiTwoTone.displayName = 'AmauiIconMaterialLocalTaxiTwoTone';

export default IconMaterialLocalTaxiTwoTone;
