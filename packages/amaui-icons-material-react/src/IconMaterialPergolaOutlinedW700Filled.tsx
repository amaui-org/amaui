...
const IconMaterialPergolaOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PergolaOutlinedW700Filled'
      short_name='Pergola'
...
export default IconMaterialPergolaOutlinedW700Filled;
