...
const IconMaterialHomeAppLogoOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HomeAppLogoOutlinedW100Filled'
...
export default IconMaterialHomeAppLogoOutlinedW100Filled;
