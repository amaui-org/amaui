...
const IconMaterialSortByAlphaOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SortByAlphaOutlinedW100'
...
export default IconMaterialSortByAlphaOutlinedW100;
