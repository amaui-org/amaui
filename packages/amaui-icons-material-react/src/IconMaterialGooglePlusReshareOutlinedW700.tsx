...
const IconMaterialGooglePlusReshareOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='GooglePlusReshareOutlinedW700'
...
export default IconMaterialGooglePlusReshareOutlinedW700;
