...
const IconMaterialDetectorBatteryOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DetectorBatteryOutlinedFilled'
...
export default IconMaterialDetectorBatteryOutlinedFilled;
