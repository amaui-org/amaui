...
const IconMaterialBlindOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BlindOutlinedW100Filled'
      short_name='Blind'
...
export default IconMaterialBlindOutlinedW100Filled;
