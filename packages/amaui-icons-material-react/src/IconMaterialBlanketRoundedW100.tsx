...
const IconMaterialBlanketRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BlanketRoundedW100'
      short_name='Blanket'
...
IconMaterialBlanketRoundedW100.displayName = 'AmauiIconMaterialBlanketRoundedW100';

export default IconMaterialBlanketRoundedW100;
