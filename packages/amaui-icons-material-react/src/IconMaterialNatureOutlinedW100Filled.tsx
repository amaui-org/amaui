...
const IconMaterialNatureOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NatureOutlinedW100Filled'
      short_name='Nature'
...
export default IconMaterialNatureOutlinedW100Filled;
