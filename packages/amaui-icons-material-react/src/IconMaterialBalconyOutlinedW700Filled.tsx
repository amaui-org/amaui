...
const IconMaterialBalconyOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BalconyOutlinedW700Filled'
      short_name='Balcony'
...
export default IconMaterialBalconyOutlinedW700Filled;
