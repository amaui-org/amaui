...
const IconMaterialScreenLockPortraitRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ScreenLockPortraitRoundedW700Filled'
...
export default IconMaterialScreenLockPortraitRoundedW700Filled;
