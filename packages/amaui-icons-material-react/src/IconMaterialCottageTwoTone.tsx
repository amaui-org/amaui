...
const IconMaterialCottageTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialCottageTwoTone.displayName = 'AmauiIconMaterialCottageTwoTone';

export default IconMaterialCottageTwoTone;
