...
const IconMaterialRedoSharpW100 = React.forwardRef((props: any, ref) => {
...
IconMaterialRedoSharpW100.displayName = 'AmauiIconMaterialRedoSharpW100';

export default IconMaterialRedoSharpW100;
