...
const IconMaterialBeachAccessOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BeachAccessOutlinedFilled'
...
export default IconMaterialBeachAccessOutlinedFilled;
