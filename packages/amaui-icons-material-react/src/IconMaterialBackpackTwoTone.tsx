...
const IconMaterialBackpackTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialBackpackTwoTone.displayName = 'AmauiIconMaterialBackpackTwoTone';

export default IconMaterialBackpackTwoTone;
