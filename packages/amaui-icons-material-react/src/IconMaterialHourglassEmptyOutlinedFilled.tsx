...
const IconMaterialHourglassEmptyOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HourglassEmptyOutlinedFilled'
...
export default IconMaterialHourglassEmptyOutlinedFilled;
