...
const IconMaterialViewComfyOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ViewComfyOutlinedW100Filled'
...
export default IconMaterialViewComfyOutlinedW100Filled;
