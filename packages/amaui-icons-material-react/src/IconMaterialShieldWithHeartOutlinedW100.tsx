...
const IconMaterialShieldWithHeartOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ShieldWithHeartOutlinedW100'
...
export default IconMaterialShieldWithHeartOutlinedW100;
