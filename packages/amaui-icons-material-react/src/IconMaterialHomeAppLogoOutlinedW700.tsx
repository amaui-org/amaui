...
const IconMaterialHomeAppLogoOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HomeAppLogoOutlinedW700'
...
export default IconMaterialHomeAppLogoOutlinedW700;
