...
const IconMaterialShareReviewsOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ShareReviewsOutlinedFilled'
...
export default IconMaterialShareReviewsOutlinedFilled;
