...
const IconMaterialChairTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialChairTwoTone.displayName = 'AmauiIconMaterialChairTwoTone';

export default IconMaterialChairTwoTone;
