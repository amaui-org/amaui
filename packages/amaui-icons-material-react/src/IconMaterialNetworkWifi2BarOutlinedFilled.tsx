...
const IconMaterialNetworkWifi2BarOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NetworkWifi2BarOutlinedFilled'
...
export default IconMaterialNetworkWifi2BarOutlinedFilled;
