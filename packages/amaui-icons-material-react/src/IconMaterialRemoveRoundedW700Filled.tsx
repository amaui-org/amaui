...
const IconMaterialRemoveRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RemoveRoundedW700Filled'
      short_name='Remove'
...
export default IconMaterialRemoveRoundedW700Filled;
