...
const IconMaterialDonutSmallSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DonutSmallSharpW700Filled'
...
export default IconMaterialDonutSmallSharpW700Filled;
