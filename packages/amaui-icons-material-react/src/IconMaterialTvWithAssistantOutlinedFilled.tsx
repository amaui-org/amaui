...
const IconMaterialTvWithAssistantOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TvWithAssistantOutlinedFilled'
...
export default IconMaterialTvWithAssistantOutlinedFilled;
