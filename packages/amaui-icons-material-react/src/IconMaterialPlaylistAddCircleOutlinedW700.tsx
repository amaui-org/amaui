...
const IconMaterialPlaylistAddCircleOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PlaylistAddCircleOutlinedW700'
...
export default IconMaterialPlaylistAddCircleOutlinedW700;
