...
const IconMaterialMopTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialMopTwoTone.displayName = 'AmauiIconMaterialMopTwoTone';

export default IconMaterialMopTwoTone;
