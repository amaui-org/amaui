...
const IconMaterialRestaurantOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RestaurantOutlinedW100Filled'
...
export default IconMaterialRestaurantOutlinedW100Filled;
