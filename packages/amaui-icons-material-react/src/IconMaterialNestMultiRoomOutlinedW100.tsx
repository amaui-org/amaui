...
const IconMaterialNestMultiRoomOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestMultiRoomOutlinedW100'
...
export default IconMaterialNestMultiRoomOutlinedW100;
