...
const IconMaterialDataSaverOnSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DataSaverOnSharpW700Filled'
...
export default IconMaterialDataSaverOnSharpW700Filled;
