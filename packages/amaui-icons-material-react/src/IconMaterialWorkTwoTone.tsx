...
const IconMaterialWorkTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialWorkTwoTone.displayName = 'AmauiIconMaterialWorkTwoTone';

export default IconMaterialWorkTwoTone;
