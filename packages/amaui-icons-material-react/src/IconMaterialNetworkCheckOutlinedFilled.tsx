...
const IconMaterialNetworkCheckOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NetworkCheckOutlinedFilled'
...
export default IconMaterialNetworkCheckOutlinedFilled;
