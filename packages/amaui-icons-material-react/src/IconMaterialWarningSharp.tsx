...
const IconMaterialWarningSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialWarningSharp.displayName = 'AmauiIconMaterialWarningSharp';

export default IconMaterialWarningSharp;
