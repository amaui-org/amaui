...
const IconMaterialArrowCircleDownOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ArrowCircleDownOutlinedW100Filled'
...
export default IconMaterialArrowCircleDownOutlinedW100Filled;
