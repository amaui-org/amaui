...
const IconMaterialPivotTableChartOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PivotTableChartOutlinedFilled'
...
export default IconMaterialPivotTableChartOutlinedFilled;
