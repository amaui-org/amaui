...
const IconMaterialSearchOffTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialSearchOffTwoTone.displayName = 'AmauiIconMaterialSearchOffTwoTone';

export default IconMaterialSearchOffTwoTone;
