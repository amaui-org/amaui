...
const IconMaterialDoNotStepTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialDoNotStepTwoTone.displayName = 'AmauiIconMaterialDoNotStepTwoTone';

export default IconMaterialDoNotStepTwoTone;
