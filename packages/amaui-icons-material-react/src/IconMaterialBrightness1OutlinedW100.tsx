...
const IconMaterialBrightness1OutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Brightness1OutlinedW100'
...
export default IconMaterialBrightness1OutlinedW100;
