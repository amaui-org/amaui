...
const IconMaterialFavoriteOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FavoriteOutlinedW700Filled'
      short_name='Favorite'
...
export default IconMaterialFavoriteOutlinedW700Filled;
