...
const IconMaterialFace4SharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Face4SharpFilled'
      short_name='Face4'
...
IconMaterialFace4SharpFilled.displayName = 'AmauiIconMaterialFace4SharpFilled';

export default IconMaterialFace4SharpFilled;
