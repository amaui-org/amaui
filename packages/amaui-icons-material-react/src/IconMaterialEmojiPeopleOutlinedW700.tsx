...
const IconMaterialEmojiPeopleOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='EmojiPeopleOutlinedW700'
...
export default IconMaterialEmojiPeopleOutlinedW700;
