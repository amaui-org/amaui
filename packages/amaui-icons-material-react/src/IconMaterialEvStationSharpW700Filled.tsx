...
const IconMaterialEvStationSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='EvStationSharpW700Filled'
...
export default IconMaterialEvStationSharpW700Filled;
