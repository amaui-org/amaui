...
const IconMaterialModeCoolOffOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ModeCoolOffOutlinedW100Filled'
...
export default IconMaterialModeCoolOffOutlinedW100Filled;
