...
const IconMaterialThumbUpOffRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ThumbUpOffRoundedW700Filled'
...
export default IconMaterialThumbUpOffRoundedW700Filled;
