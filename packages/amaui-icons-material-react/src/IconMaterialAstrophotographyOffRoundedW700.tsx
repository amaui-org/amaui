...
const IconMaterialAstrophotographyOffRoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AstrophotographyOffRoundedW700'
...
export default IconMaterialAstrophotographyOffRoundedW700;
