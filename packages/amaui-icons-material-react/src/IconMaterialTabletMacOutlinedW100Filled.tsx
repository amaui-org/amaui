...
const IconMaterialTabletMacOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TabletMacOutlinedW100Filled'
...
export default IconMaterialTabletMacOutlinedW100Filled;
