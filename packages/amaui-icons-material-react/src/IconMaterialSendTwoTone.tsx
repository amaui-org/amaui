...
const IconMaterialSendTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialSendTwoTone.displayName = 'AmauiIconMaterialSendTwoTone';

export default IconMaterialSendTwoTone;
