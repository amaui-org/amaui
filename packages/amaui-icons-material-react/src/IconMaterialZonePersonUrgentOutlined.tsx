...
const IconMaterialZonePersonUrgentOutlined = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ZonePersonUrgentOutlined'
...
export default IconMaterialZonePersonUrgentOutlined;
