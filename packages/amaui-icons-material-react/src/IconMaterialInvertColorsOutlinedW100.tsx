...
const IconMaterialInvertColorsOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='InvertColorsOutlinedW100'
...
export default IconMaterialInvertColorsOutlinedW100;
