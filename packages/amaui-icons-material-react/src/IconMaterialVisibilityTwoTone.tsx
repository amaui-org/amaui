...
const IconMaterialVisibilityTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialVisibilityTwoTone.displayName = 'AmauiIconMaterialVisibilityTwoTone';

export default IconMaterialVisibilityTwoTone;
