...
const IconMaterialAstrophotographyAutoOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AstrophotographyAutoOutlinedW100'
...
export default IconMaterialAstrophotographyAutoOutlinedW100;
