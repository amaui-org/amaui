...
const IconMaterialPhoneCallbackOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PhoneCallbackOutlinedW700Filled'
...
export default IconMaterialPhoneCallbackOutlinedW700Filled;
