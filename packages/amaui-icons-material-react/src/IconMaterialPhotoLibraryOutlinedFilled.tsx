...
const IconMaterialPhotoLibraryOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PhotoLibraryOutlinedFilled'
...
export default IconMaterialPhotoLibraryOutlinedFilled;
