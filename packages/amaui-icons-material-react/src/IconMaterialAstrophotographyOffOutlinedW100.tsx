...
const IconMaterialAstrophotographyOffOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AstrophotographyOffOutlinedW100'
...
export default IconMaterialAstrophotographyOffOutlinedW100;
