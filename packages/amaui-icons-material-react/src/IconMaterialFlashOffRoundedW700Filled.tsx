...
const IconMaterialFlashOffRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FlashOffRoundedW700Filled'
      short_name='FlashOff'
...
export default IconMaterialFlashOffRoundedW700Filled;
