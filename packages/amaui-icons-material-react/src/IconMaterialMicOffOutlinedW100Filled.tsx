...
const IconMaterialMicOffOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MicOffOutlinedW100Filled'
      short_name='MicOff'
...
export default IconMaterialMicOffOutlinedW100Filled;
