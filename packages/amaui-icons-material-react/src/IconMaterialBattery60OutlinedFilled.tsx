...
const IconMaterialBattery60OutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Battery60OutlinedFilled'
...
export default IconMaterialBattery60OutlinedFilled;
