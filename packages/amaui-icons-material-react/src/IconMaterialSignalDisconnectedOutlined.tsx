...
const IconMaterialSignalDisconnectedOutlined = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SignalDisconnectedOutlined'
...
export default IconMaterialSignalDisconnectedOutlined;
