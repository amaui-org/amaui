...
const IconMaterialSettingsAlertOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SettingsAlertOutlinedW100'
...
export default IconMaterialSettingsAlertOutlinedW100;
