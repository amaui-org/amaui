...
const IconMaterialStopCircleTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialStopCircleTwoTone.displayName = 'AmauiIconMaterialStopCircleTwoTone';

export default IconMaterialStopCircleTwoTone;
