...
const IconMaterialNoteAddRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NoteAddRoundedW100'
      short_name='NoteAdd'
...
IconMaterialNoteAddRoundedW100.displayName = 'AmauiIconMaterialNoteAddRoundedW100';

export default IconMaterialNoteAddRoundedW100;
