...
const IconMaterialBrowserUpdatedOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BrowserUpdatedOutlinedFilled'
...
export default IconMaterialBrowserUpdatedOutlinedFilled;
