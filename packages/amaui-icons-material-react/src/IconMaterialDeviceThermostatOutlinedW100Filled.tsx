...
const IconMaterialDeviceThermostatOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DeviceThermostatOutlinedW100Filled'
...
export default IconMaterialDeviceThermostatOutlinedW100Filled;
