...
const IconMaterialAppShortcutOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AppShortcutOutlinedW700Filled'
...
export default IconMaterialAppShortcutOutlinedW700Filled;
