...
const IconMaterialLeakRemoveSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialLeakRemoveSharp.displayName = 'AmauiIconMaterialLeakRemoveSharp';

export default IconMaterialLeakRemoveSharp;
