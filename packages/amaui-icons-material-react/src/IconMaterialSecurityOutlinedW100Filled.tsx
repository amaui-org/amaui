...
const IconMaterialSecurityOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SecurityOutlinedW100Filled'
      short_name='Security'
...
export default IconMaterialSecurityOutlinedW100Filled;
