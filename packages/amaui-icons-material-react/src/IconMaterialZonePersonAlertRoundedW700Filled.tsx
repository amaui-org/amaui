...
const IconMaterialZonePersonAlertRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ZonePersonAlertRoundedW700Filled'
...
export default IconMaterialZonePersonAlertRoundedW700Filled;
