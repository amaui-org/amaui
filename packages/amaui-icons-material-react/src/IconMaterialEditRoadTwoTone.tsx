...
const IconMaterialEditRoadTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialEditRoadTwoTone.displayName = 'AmauiIconMaterialEditRoadTwoTone';

export default IconMaterialEditRoadTwoTone;
