...
const IconMaterialVolumeDownSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialVolumeDownSharp.displayName = 'AmauiIconMaterialVolumeDownSharp';

export default IconMaterialVolumeDownSharp;
