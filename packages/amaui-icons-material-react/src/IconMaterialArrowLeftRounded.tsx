...
const IconMaterialArrowLeftRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialArrowLeftRounded.displayName = 'AmauiIconMaterialArrowLeftRounded';

export default IconMaterialArrowLeftRounded;
