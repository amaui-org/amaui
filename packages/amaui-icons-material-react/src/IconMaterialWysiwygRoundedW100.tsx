...
const IconMaterialWysiwygRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WysiwygRoundedW100'
      short_name='Wysiwyg'
...
IconMaterialWysiwygRoundedW100.displayName = 'AmauiIconMaterialWysiwygRoundedW100';

export default IconMaterialWysiwygRoundedW100;
