...
const IconMaterialLocalHospitalTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialLocalHospitalTwoTone.displayName = 'AmauiIconMaterialLocalHospitalTwoTone';

export default IconMaterialLocalHospitalTwoTone;
