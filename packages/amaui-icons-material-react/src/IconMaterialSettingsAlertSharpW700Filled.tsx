...
const IconMaterialSettingsAlertSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SettingsAlertSharpW700Filled'
...
export default IconMaterialSettingsAlertSharpW700Filled;
