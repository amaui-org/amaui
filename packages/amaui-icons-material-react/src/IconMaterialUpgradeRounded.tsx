...
const IconMaterialUpgradeRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialUpgradeRounded.displayName = 'AmauiIconMaterialUpgradeRounded';

export default IconMaterialUpgradeRounded;
