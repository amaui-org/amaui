...
const IconMaterialFormatBoldSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FormatBoldSharpW700Filled'
...
export default IconMaterialFormatBoldSharpW700Filled;
