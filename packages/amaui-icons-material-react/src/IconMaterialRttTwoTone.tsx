...
const IconMaterialRttTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialRttTwoTone.displayName = 'AmauiIconMaterialRttTwoTone';

export default IconMaterialRttTwoTone;
