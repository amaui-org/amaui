...
const IconMaterialConstructionOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ConstructionOutlinedW700'
...
export default IconMaterialConstructionOutlinedW700;
