...
const IconMaterialConstructionOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ConstructionOutlinedW100'
...
export default IconMaterialConstructionOutlinedW100;
