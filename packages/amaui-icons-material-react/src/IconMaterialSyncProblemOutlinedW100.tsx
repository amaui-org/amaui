...
const IconMaterialSyncProblemOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SyncProblemOutlinedW100'
...
export default IconMaterialSyncProblemOutlinedW100;
