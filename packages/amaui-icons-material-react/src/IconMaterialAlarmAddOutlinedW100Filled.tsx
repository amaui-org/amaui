...
const IconMaterialAlarmAddOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AlarmAddOutlinedW100Filled'
      short_name='AlarmAdd'
...
export default IconMaterialAlarmAddOutlinedW100Filled;
