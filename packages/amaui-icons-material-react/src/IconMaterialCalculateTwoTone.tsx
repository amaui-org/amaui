...
const IconMaterialCalculateTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialCalculateTwoTone.displayName = 'AmauiIconMaterialCalculateTwoTone';

export default IconMaterialCalculateTwoTone;
