...
const IconMaterialSwapVerticalCircleSharpW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SwapVerticalCircleSharpW700'
...
export default IconMaterialSwapVerticalCircleSharpW700;
