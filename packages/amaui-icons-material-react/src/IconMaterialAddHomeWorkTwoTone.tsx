...
const IconMaterialAddHomeWorkTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialAddHomeWorkTwoTone.displayName = 'AmauiIconMaterialAddHomeWorkTwoTone';

export default IconMaterialAddHomeWorkTwoTone;
