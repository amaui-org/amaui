...
const IconMaterialRefreshOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RefreshOutlinedW100Filled'
      short_name='Refresh'
...
export default IconMaterialRefreshOutlinedW100Filled;
