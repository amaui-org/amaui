...
const IconMaterialHomeMaxTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialHomeMaxTwoTone.displayName = 'AmauiIconMaterialHomeMaxTwoTone';

export default IconMaterialHomeMaxTwoTone;
