...
const IconMaterialSpatialTrackingOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SpatialTrackingOutlinedFilled'
...
export default IconMaterialSpatialTrackingOutlinedFilled;
