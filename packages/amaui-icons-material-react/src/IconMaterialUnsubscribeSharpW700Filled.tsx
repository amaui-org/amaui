...
const IconMaterialUnsubscribeSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='UnsubscribeSharpW700Filled'
...
export default IconMaterialUnsubscribeSharpW700Filled;
