...
const IconMaterialAstrophotographyOffOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AstrophotographyOffOutlinedFilled'
...
export default IconMaterialAstrophotographyOffOutlinedFilled;
