...
const IconMaterialBorderBottomSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialBorderBottomSharp.displayName = 'AmauiIconMaterialBorderBottomSharp';

export default IconMaterialBorderBottomSharp;
