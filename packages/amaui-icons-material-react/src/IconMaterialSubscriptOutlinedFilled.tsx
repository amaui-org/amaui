...
const IconMaterialSubscriptOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SubscriptOutlinedFilled'
...
export default IconMaterialSubscriptOutlinedFilled;
