...
const IconMaterialMonitorWeightOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MonitorWeightOutlinedFilled'
...
export default IconMaterialMonitorWeightOutlinedFilled;
