...
const IconMaterialTimerOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TimerOutlinedW700Filled'
      short_name='Timer'
...
export default IconMaterialTimerOutlinedW700Filled;
