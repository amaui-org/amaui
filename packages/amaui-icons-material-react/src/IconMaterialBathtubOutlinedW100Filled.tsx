...
const IconMaterialBathtubOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BathtubOutlinedW100Filled'
      short_name='Bathtub'
...
export default IconMaterialBathtubOutlinedW100Filled;
