...
const IconMaterialHighlightTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialHighlightTwoTone.displayName = 'AmauiIconMaterialHighlightTwoTone';

export default IconMaterialHighlightTwoTone;
