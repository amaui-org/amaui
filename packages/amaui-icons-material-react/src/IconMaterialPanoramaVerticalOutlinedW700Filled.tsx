...
const IconMaterialPanoramaVerticalOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PanoramaVerticalOutlinedW700Filled'
...
export default IconMaterialPanoramaVerticalOutlinedW700Filled;
