...
const IconMaterialFace6OutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Face6OutlinedW100Filled'
      short_name='Face6'
...
export default IconMaterialFace6OutlinedW100Filled;
