...
const IconMaterialRamenDiningTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialRamenDiningTwoTone.displayName = 'AmauiIconMaterialRamenDiningTwoTone';

export default IconMaterialRamenDiningTwoTone;
