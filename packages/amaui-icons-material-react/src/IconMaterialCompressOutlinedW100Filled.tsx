...
const IconMaterialCompressOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CompressOutlinedW100Filled'
      short_name='Compress'
...
export default IconMaterialCompressOutlinedW100Filled;
