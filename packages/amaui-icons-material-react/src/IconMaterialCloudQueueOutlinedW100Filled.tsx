...
const IconMaterialCloudQueueOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CloudQueueOutlinedW100Filled'
...
export default IconMaterialCloudQueueOutlinedW100Filled;
