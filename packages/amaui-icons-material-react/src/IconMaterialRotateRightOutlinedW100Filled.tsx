...
const IconMaterialRotateRightOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RotateRightOutlinedW100Filled'
...
export default IconMaterialRotateRightOutlinedW100Filled;
