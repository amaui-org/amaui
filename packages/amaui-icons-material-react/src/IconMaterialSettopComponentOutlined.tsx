...
const IconMaterialSettopComponentOutlined = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SettopComponentOutlined'
...
export default IconMaterialSettopComponentOutlined;
