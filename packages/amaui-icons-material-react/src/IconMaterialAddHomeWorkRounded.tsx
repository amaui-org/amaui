...
const IconMaterialAddHomeWorkRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialAddHomeWorkRounded.displayName = 'AmauiIconMaterialAddHomeWorkRounded';

export default IconMaterialAddHomeWorkRounded;
