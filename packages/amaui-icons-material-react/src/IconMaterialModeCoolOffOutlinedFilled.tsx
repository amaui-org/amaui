...
const IconMaterialModeCoolOffOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ModeCoolOffOutlinedFilled'
...
export default IconMaterialModeCoolOffOutlinedFilled;
