...
const IconMaterialChangeCircleTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialChangeCircleTwoTone.displayName = 'AmauiIconMaterialChangeCircleTwoTone';

export default IconMaterialChangeCircleTwoTone;
