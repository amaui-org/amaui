...
const IconMaterialTrailLengthSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TrailLengthSharpW700Filled'
...
export default IconMaterialTrailLengthSharpW700Filled;
