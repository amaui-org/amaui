...
const IconMaterialHourglassFullOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HourglassFullOutlinedW700Filled'
...
export default IconMaterialHourglassFullOutlinedW700Filled;
