...
const IconMaterialHomePinRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HomePinRoundedW100'
      short_name='HomePin'
...
IconMaterialHomePinRoundedW100.displayName = 'AmauiIconMaterialHomePinRoundedW100';

export default IconMaterialHomePinRoundedW100;
