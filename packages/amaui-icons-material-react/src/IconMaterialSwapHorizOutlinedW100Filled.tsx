...
const IconMaterialSwapHorizOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SwapHorizOutlinedW100Filled'
...
export default IconMaterialSwapHorizOutlinedW100Filled;
