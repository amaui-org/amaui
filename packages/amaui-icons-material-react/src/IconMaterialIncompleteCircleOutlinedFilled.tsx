...
const IconMaterialIncompleteCircleOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='IncompleteCircleOutlinedFilled'
...
export default IconMaterialIncompleteCircleOutlinedFilled;
