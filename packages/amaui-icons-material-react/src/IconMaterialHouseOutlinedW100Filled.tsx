...
const IconMaterialHouseOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HouseOutlinedW100Filled'
      short_name='House'
...
export default IconMaterialHouseOutlinedW100Filled;
