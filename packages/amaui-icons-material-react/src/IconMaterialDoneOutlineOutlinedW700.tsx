...
const IconMaterialDoneOutlineOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DoneOutlineOutlinedW700'
...
export default IconMaterialDoneOutlineOutlinedW700;
