...
const IconMaterialAgenderRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialAgenderRounded.displayName = 'AmauiIconMaterialAgenderRounded';

export default IconMaterialAgenderRounded;
