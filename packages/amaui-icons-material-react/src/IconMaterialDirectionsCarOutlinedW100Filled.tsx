...
const IconMaterialDirectionsCarOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DirectionsCarOutlinedW100Filled'
...
export default IconMaterialDirectionsCarOutlinedW100Filled;
