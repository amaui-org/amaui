...
const IconMaterialScatterPlotOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ScatterPlotOutlinedFilled'
...
export default IconMaterialScatterPlotOutlinedFilled;
