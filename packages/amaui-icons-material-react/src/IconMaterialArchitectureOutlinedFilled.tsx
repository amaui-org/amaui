...
const IconMaterialArchitectureOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ArchitectureOutlinedFilled'
...
export default IconMaterialArchitectureOutlinedFilled;
