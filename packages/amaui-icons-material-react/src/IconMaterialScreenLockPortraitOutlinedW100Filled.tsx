...
const IconMaterialScreenLockPortraitOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ScreenLockPortraitOutlinedW100Filled'
...
export default IconMaterialScreenLockPortraitOutlinedW100Filled;
