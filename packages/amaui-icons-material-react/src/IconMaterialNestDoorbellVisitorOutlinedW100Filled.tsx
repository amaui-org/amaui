...
const IconMaterialNestDoorbellVisitorOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestDoorbellVisitorOutlinedW100Filled'
...
export default IconMaterialNestDoorbellVisitorOutlinedW100Filled;
