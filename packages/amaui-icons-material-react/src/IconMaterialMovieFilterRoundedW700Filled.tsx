...
const IconMaterialMovieFilterRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MovieFilterRoundedW700Filled'
...
export default IconMaterialMovieFilterRoundedW700Filled;
