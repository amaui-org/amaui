...
const IconMaterialDetectorAlarmSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DetectorAlarmSharpW700Filled'
...
export default IconMaterialDetectorAlarmSharpW700Filled;
