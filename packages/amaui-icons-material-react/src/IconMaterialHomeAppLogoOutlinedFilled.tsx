...
const IconMaterialHomeAppLogoOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HomeAppLogoOutlinedFilled'
...
export default IconMaterialHomeAppLogoOutlinedFilled;
