...
const IconMaterialVolumeOffOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='VolumeOffOutlinedW100Filled'
...
export default IconMaterialVolumeOffOutlinedW100Filled;
