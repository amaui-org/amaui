...
const IconMaterialAutoScheduleRoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AutoScheduleRoundedW700'
...
export default IconMaterialAutoScheduleRoundedW700;
