...
const IconMaterialCheckroomOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CheckroomOutlinedW100Filled'
...
export default IconMaterialCheckroomOutlinedW100Filled;
