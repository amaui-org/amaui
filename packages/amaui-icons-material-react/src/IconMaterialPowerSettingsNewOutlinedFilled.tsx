...
const IconMaterialPowerSettingsNewOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PowerSettingsNewOutlinedFilled'
...
export default IconMaterialPowerSettingsNewOutlinedFilled;
