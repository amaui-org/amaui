...
const IconMaterialDonutLargeOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DonutLargeOutlinedW100Filled'
...
export default IconMaterialDonutLargeOutlinedW100Filled;
