...
const IconMaterialLocationSearchingOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LocationSearchingOutlinedFilled'
...
export default IconMaterialLocationSearchingOutlinedFilled;
