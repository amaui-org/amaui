...
const IconMaterialCelebrationOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CelebrationOutlinedFilled'
...
export default IconMaterialCelebrationOutlinedFilled;
