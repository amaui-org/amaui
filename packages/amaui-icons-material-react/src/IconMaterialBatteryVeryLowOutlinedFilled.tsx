...
const IconMaterialBatteryVeryLowOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryVeryLowOutlinedFilled'
...
export default IconMaterialBatteryVeryLowOutlinedFilled;
