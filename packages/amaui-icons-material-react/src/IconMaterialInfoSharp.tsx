...
const IconMaterialInfoSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialInfoSharp.displayName = 'AmauiIconMaterialInfoSharp';

export default IconMaterialInfoSharp;
