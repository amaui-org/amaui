...
const IconMaterialBackupOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BackupOutlinedW100Filled'
      short_name='Backup'
...
export default IconMaterialBackupOutlinedW100Filled;
