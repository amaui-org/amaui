...
const IconMaterialEuroSymbolTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialEuroSymbolTwoTone.displayName = 'AmauiIconMaterialEuroSymbolTwoTone';

export default IconMaterialEuroSymbolTwoTone;
