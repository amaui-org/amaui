...
const IconMaterialSceneRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SceneRoundedW100'
      short_name='Scene'
...
IconMaterialSceneRoundedW100.displayName = 'AmauiIconMaterialSceneRoundedW100';

export default IconMaterialSceneRoundedW100;
