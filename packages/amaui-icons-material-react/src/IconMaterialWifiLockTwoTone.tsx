...
const IconMaterialWifiLockTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialWifiLockTwoTone.displayName = 'AmauiIconMaterialWifiLockTwoTone';

export default IconMaterialWifiLockTwoTone;
