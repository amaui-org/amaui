...
const IconMaterialParaglidingOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ParaglidingOutlinedFilled'
...
export default IconMaterialParaglidingOutlinedFilled;
