...
const IconMaterialBrightness3OutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Brightness3OutlinedFilled'
...
export default IconMaterialBrightness3OutlinedFilled;
