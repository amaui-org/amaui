...
const IconMaterialModeHeatOffOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ModeHeatOffOutlinedW100'
...
export default IconMaterialModeHeatOffOutlinedW100;
