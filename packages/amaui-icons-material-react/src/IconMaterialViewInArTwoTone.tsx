...
const IconMaterialViewInArTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialViewInArTwoTone.displayName = 'AmauiIconMaterialViewInArTwoTone';

export default IconMaterialViewInArTwoTone;
