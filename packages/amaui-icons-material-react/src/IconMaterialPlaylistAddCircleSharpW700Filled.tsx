...
const IconMaterialPlaylistAddCircleSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PlaylistAddCircleSharpW700Filled'
...
export default IconMaterialPlaylistAddCircleSharpW700Filled;
