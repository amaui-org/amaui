...
const IconMaterialSpeakerNotesOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SpeakerNotesOutlinedW700'
...
export default IconMaterialSpeakerNotesOutlinedW700;
