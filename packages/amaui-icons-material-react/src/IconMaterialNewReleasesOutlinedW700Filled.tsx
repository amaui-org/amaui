...
const IconMaterialNewReleasesOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NewReleasesOutlinedW700Filled'
...
export default IconMaterialNewReleasesOutlinedW700Filled;
