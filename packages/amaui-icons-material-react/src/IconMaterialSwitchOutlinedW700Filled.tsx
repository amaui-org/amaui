...
const IconMaterialSwitchOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SwitchOutlinedW700Filled'
      short_name='Switch'
...
export default IconMaterialSwitchOutlinedW700Filled;
