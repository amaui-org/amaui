...
const IconMaterialNaturePeopleTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialNaturePeopleTwoTone.displayName = 'AmauiIconMaterialNaturePeopleTwoTone';

export default IconMaterialNaturePeopleTwoTone;
