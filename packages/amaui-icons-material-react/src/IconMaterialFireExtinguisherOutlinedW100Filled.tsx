...
const IconMaterialFireExtinguisherOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FireExtinguisherOutlinedW100Filled'
...
export default IconMaterialFireExtinguisherOutlinedW100Filled;
