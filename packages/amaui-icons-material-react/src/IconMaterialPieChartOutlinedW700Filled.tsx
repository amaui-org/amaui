...
const IconMaterialPieChartOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PieChartOutlinedW700Filled'
      short_name='PieChart'
...
export default IconMaterialPieChartOutlinedW700Filled;
