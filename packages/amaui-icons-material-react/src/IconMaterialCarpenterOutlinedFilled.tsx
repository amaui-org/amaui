...
const IconMaterialCarpenterOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CarpenterOutlinedFilled'
...
export default IconMaterialCarpenterOutlinedFilled;
