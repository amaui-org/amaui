...
const IconMaterialUpgradeRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='UpgradeRoundedW100'
      short_name='Upgrade'
...
IconMaterialUpgradeRoundedW100.displayName = 'AmauiIconMaterialUpgradeRoundedW100';

export default IconMaterialUpgradeRoundedW100;
