...
const IconMaterialThumbUpRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialThumbUpRounded.displayName = 'AmauiIconMaterialThumbUpRounded';

export default IconMaterialThumbUpRounded;
