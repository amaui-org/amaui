...
const IconMaterialRecommendOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RecommendOutlinedW100Filled'
...
export default IconMaterialRecommendOutlinedW100Filled;
