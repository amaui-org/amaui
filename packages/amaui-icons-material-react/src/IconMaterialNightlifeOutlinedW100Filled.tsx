...
const IconMaterialNightlifeOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NightlifeOutlinedW100Filled'
...
export default IconMaterialNightlifeOutlinedW100Filled;
