...
const IconMaterialModeCoolSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ModeCoolSharpFilled'
      short_name='ModeCool'
...
IconMaterialModeCoolSharpFilled.displayName = 'AmauiIconMaterialModeCoolSharpFilled';

export default IconMaterialModeCoolSharpFilled;
