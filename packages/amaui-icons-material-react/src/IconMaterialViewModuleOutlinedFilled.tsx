...
const IconMaterialViewModuleOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ViewModuleOutlinedFilled'
...
export default IconMaterialViewModuleOutlinedFilled;
