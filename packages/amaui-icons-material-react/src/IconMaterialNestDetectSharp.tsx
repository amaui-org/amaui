...
const IconMaterialNestDetectSharp = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestDetectSharp'
...
IconMaterialNestDetectSharp.displayName = 'AmauiIconMaterialNestDetectSharp';

export default IconMaterialNestDetectSharp;
