...
const IconMaterialNewReleasesOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NewReleasesOutlinedW700'
...
export default IconMaterialNewReleasesOutlinedW700;
