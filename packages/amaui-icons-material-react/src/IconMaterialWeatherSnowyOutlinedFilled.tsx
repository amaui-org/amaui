...
const IconMaterialWeatherSnowyOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WeatherSnowyOutlinedFilled'
...
export default IconMaterialWeatherSnowyOutlinedFilled;
