...
const IconMaterialSpeakerPhoneTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialSpeakerPhoneTwoTone.displayName = 'AmauiIconMaterialSpeakerPhoneTwoTone';

export default IconMaterialSpeakerPhoneTwoTone;
