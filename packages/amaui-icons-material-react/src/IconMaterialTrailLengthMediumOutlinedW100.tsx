...
const IconMaterialTrailLengthMediumOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TrailLengthMediumOutlinedW100'
...
export default IconMaterialTrailLengthMediumOutlinedW100;
