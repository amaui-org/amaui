...
const IconMaterialGppMaybeSharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='GppMaybeSharpW100'
      short_name='GppMaybe'
...
IconMaterialGppMaybeSharpW100.displayName = 'AmauiIconMaterialGppMaybeSharpW100';

export default IconMaterialGppMaybeSharpW100;
