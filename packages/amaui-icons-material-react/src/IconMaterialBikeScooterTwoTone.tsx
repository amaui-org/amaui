...
const IconMaterialBikeScooterTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialBikeScooterTwoTone.displayName = 'AmauiIconMaterialBikeScooterTwoTone';

export default IconMaterialBikeScooterTwoTone;
