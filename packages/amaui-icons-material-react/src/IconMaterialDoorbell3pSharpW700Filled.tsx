...
const IconMaterialDoorbell3pSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Doorbell3pSharpW700Filled'
...
export default IconMaterialDoorbell3pSharpW700Filled;
