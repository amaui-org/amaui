...
const IconMaterialFormatBoldOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FormatBoldOutlinedFilled'
...
export default IconMaterialFormatBoldOutlinedFilled;
