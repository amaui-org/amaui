...
const IconMaterialDetectorOfflineOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DetectorOfflineOutlinedW100Filled'
...
export default IconMaterialDetectorOfflineOutlinedW100Filled;
