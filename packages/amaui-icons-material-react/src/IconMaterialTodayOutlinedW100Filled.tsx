...
const IconMaterialTodayOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TodayOutlinedW100Filled'
      short_name='Today'
...
export default IconMaterialTodayOutlinedW100Filled;
