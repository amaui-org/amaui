...
const IconMaterialRepartitionOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RepartitionOutlinedW100Filled'
...
export default IconMaterialRepartitionOutlinedW100Filled;
