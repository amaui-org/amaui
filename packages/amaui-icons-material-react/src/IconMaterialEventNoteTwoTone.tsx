...
const IconMaterialEventNoteTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialEventNoteTwoTone.displayName = 'AmauiIconMaterialEventNoteTwoTone';

export default IconMaterialEventNoteTwoTone;
