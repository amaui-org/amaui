...
const IconMaterialDatabaseTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialDatabaseTwoTone.displayName = 'AmauiIconMaterialDatabaseTwoTone';

export default IconMaterialDatabaseTwoTone;
