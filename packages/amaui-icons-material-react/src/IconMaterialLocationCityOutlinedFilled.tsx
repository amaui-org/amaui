...
const IconMaterialLocationCityOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LocationCityOutlinedFilled'
...
export default IconMaterialLocationCityOutlinedFilled;
