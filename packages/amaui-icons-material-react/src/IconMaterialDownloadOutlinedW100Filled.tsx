...
const IconMaterialDownloadOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DownloadOutlinedW100Filled'
      short_name='Download'
...
export default IconMaterialDownloadOutlinedW100Filled;
