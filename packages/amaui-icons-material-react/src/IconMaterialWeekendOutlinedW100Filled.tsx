...
const IconMaterialWeekendOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WeekendOutlinedW100Filled'
      short_name='Weekend'
...
export default IconMaterialWeekendOutlinedW100Filled;
