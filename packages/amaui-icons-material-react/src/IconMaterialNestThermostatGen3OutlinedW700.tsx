...
const IconMaterialNestThermostatGen3OutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestThermostatGen3OutlinedW700'
...
export default IconMaterialNestThermostatGen3OutlinedW700;
