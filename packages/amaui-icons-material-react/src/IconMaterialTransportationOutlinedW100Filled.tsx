...
const IconMaterialTransportationOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TransportationOutlinedW100Filled'
...
export default IconMaterialTransportationOutlinedW100Filled;
