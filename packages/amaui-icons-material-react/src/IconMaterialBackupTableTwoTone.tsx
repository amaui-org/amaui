...
const IconMaterialBackupTableTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialBackupTableTwoTone.displayName = 'AmauiIconMaterialBackupTableTwoTone';

export default IconMaterialBackupTableTwoTone;
