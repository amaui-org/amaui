...
const IconMaterialLightSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LightSharpFilled'
      short_name='Light'
...
IconMaterialLightSharpFilled.displayName = 'AmauiIconMaterialLightSharpFilled';

export default IconMaterialLightSharpFilled;
