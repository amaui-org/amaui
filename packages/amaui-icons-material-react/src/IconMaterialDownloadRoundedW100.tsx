...
const IconMaterialDownloadRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DownloadRoundedW100'
      short_name='Download'
...
IconMaterialDownloadRoundedW100.displayName = 'AmauiIconMaterialDownloadRoundedW100';

export default IconMaterialDownloadRoundedW100;
