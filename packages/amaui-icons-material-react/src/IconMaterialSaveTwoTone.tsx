...
const IconMaterialSaveTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialSaveTwoTone.displayName = 'AmauiIconMaterialSaveTwoTone';

export default IconMaterialSaveTwoTone;
