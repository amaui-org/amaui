...
const IconMaterialTamperDetectionOffOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TamperDetectionOffOutlinedFilled'
...
export default IconMaterialTamperDetectionOffOutlinedFilled;
