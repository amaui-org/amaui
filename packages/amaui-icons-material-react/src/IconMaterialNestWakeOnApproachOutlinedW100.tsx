...
const IconMaterialNestWakeOnApproachOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestWakeOnApproachOutlinedW100'
...
export default IconMaterialNestWakeOnApproachOutlinedW100;
