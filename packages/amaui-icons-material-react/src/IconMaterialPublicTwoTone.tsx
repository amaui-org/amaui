...
const IconMaterialPublicTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialPublicTwoTone.displayName = 'AmauiIconMaterialPublicTwoTone';

export default IconMaterialPublicTwoTone;
