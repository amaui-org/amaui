...
const IconMaterialWeightRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialWeightRounded.displayName = 'AmauiIconMaterialWeightRounded';

export default IconMaterialWeightRounded;
