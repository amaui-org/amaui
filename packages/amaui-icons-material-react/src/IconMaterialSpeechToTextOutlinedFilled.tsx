...
const IconMaterialSpeechToTextOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SpeechToTextOutlinedFilled'
...
export default IconMaterialSpeechToTextOutlinedFilled;
