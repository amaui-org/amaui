...
const IconMaterialTrailLengthShortSharpW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TrailLengthShortSharpW700'
...
export default IconMaterialTrailLengthShortSharpW700;
