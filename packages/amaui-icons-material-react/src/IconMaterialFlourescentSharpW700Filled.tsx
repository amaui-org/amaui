...
const IconMaterialFlourescentSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FlourescentSharpW700Filled'
...
export default IconMaterialFlourescentSharpW700Filled;
