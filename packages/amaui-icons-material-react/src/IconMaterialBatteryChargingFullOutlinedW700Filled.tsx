...
const IconMaterialBatteryChargingFullOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryChargingFullOutlinedW700Filled'
...
export default IconMaterialBatteryChargingFullOutlinedW700Filled;
