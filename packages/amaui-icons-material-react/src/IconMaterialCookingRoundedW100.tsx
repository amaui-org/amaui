...
const IconMaterialCookingRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CookingRoundedW100'
      short_name='Cooking'
...
IconMaterialCookingRoundedW100.displayName = 'AmauiIconMaterialCookingRoundedW100';

export default IconMaterialCookingRoundedW100;
