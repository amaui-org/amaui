...
const IconMaterialScatterPlotOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ScatterPlotOutlinedW100Filled'
...
export default IconMaterialScatterPlotOutlinedW100Filled;
