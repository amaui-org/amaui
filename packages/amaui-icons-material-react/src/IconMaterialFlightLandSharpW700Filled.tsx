...
const IconMaterialFlightLandSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FlightLandSharpW700Filled'
...
export default IconMaterialFlightLandSharpW700Filled;
