...
const IconMaterialTvGenOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TvGenOutlinedW700Filled'
      short_name='TvGen'
...
export default IconMaterialTvGenOutlinedW700Filled;
