...
const IconMaterialNearMeDisabledOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NearMeDisabledOutlinedW100'
...
export default IconMaterialNearMeDisabledOutlinedW100;
