...
const IconMaterialSportsEsportsTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialSportsEsportsTwoTone.displayName = 'AmauiIconMaterialSportsEsportsTwoTone';

export default IconMaterialSportsEsportsTwoTone;
