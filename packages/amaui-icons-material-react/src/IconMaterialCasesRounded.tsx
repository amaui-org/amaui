...
const IconMaterialCasesRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialCasesRounded.displayName = 'AmauiIconMaterialCasesRounded';

export default IconMaterialCasesRounded;
