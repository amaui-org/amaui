...
const IconMaterialAutoReadPlayRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AutoReadPlayRoundedW700Filled'
...
export default IconMaterialAutoReadPlayRoundedW700Filled;
