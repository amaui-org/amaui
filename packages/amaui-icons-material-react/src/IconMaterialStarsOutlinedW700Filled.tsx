...
const IconMaterialStarsOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='StarsOutlinedW700Filled'
      short_name='Stars'
...
export default IconMaterialStarsOutlinedW700Filled;
