...
const IconMaterialDriveFileMoveOutlineOutlined = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DriveFileMoveOutlineOutlined'
...
export default IconMaterialDriveFileMoveOutlineOutlined;
