...
const IconMaterialDiversity2TwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialDiversity2TwoTone.displayName = 'AmauiIconMaterialDiversity2TwoTone';

export default IconMaterialDiversity2TwoTone;
