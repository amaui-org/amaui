...
const IconMaterialVolumeDownSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='VolumeDownSharpW700Filled'
...
export default IconMaterialVolumeDownSharpW700Filled;
