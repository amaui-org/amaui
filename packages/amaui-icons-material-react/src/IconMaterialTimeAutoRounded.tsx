...
const IconMaterialTimeAutoRounded = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TimeAutoRounded'
      short_name='TimeAuto'
...
IconMaterialTimeAutoRounded.displayName = 'AmauiIconMaterialTimeAutoRounded';

export default IconMaterialTimeAutoRounded;
