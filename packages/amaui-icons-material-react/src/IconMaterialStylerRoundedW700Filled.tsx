...
const IconMaterialStylerRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='StylerRoundedW700Filled'
      short_name='Styler'
...
export default IconMaterialStylerRoundedW700Filled;
