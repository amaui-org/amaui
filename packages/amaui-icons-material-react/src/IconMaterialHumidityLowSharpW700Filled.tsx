...
const IconMaterialHumidityLowSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HumidityLowSharpW700Filled'
...
export default IconMaterialHumidityLowSharpW700Filled;
