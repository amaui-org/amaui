...
const IconMaterialAutoAwesomeMotionOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AutoAwesomeMotionOutlinedFilled'
...
export default IconMaterialAutoAwesomeMotionOutlinedFilled;
