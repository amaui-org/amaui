...
const IconMaterialLibraryAddCheckOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LibraryAddCheckOutlinedW100Filled'
...
export default IconMaterialLibraryAddCheckOutlinedW100Filled;
