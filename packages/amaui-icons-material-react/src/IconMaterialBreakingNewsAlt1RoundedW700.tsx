...
const IconMaterialBreakingNewsAlt1RoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BreakingNewsAlt1RoundedW700'
...
export default IconMaterialBreakingNewsAlt1RoundedW700;
