...
const IconMaterialGooglePlusReshareOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='GooglePlusReshareOutlinedW700Filled'
...
export default IconMaterialGooglePlusReshareOutlinedW700Filled;
