...
const IconMaterialFaucetSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FaucetSharpFilled'
      short_name='Faucet'
...
IconMaterialFaucetSharpFilled.displayName = 'AmauiIconMaterialFaucetSharpFilled';

export default IconMaterialFaucetSharpFilled;
