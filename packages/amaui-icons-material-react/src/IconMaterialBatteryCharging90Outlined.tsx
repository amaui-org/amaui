...
const IconMaterialBatteryCharging90Outlined = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryCharging90Outlined'
...
export default IconMaterialBatteryCharging90Outlined;
