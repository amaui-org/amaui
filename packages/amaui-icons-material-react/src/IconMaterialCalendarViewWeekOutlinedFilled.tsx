...
const IconMaterialCalendarViewWeekOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CalendarViewWeekOutlinedFilled'
...
export default IconMaterialCalendarViewWeekOutlinedFilled;
