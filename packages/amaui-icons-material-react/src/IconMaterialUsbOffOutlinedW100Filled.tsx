...
const IconMaterialUsbOffOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='UsbOffOutlinedW100Filled'
      short_name='UsbOff'
...
export default IconMaterialUsbOffOutlinedW100Filled;
