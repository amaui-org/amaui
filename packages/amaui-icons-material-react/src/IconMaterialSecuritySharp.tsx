...
const IconMaterialSecuritySharp = React.forwardRef((props: any, ref) => {
...
IconMaterialSecuritySharp.displayName = 'AmauiIconMaterialSecuritySharp';

export default IconMaterialSecuritySharp;
