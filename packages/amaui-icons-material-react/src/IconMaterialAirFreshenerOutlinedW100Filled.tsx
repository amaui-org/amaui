...
const IconMaterialAirFreshenerOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AirFreshenerOutlinedW100Filled'
...
export default IconMaterialAirFreshenerOutlinedW100Filled;
