...
const IconMaterialAddToPhotosOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AddToPhotosOutlinedFilled'
...
export default IconMaterialAddToPhotosOutlinedFilled;
