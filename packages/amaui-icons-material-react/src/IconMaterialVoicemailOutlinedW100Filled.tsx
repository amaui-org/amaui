...
const IconMaterialVoicemailOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='VoicemailOutlinedW100Filled'
...
export default IconMaterialVoicemailOutlinedW100Filled;
