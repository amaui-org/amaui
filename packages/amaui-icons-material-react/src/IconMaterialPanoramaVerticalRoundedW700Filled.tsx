...
const IconMaterialPanoramaVerticalRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PanoramaVerticalRoundedW700Filled'
...
export default IconMaterialPanoramaVerticalRoundedW700Filled;
