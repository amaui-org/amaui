...
const IconMaterialBatteryFullRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryFullRoundedW700Filled'
...
export default IconMaterialBatteryFullRoundedW700Filled;
