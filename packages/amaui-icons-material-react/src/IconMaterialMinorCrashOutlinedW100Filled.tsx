...
const IconMaterialMinorCrashOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MinorCrashOutlinedW100Filled'
...
export default IconMaterialMinorCrashOutlinedW100Filled;
