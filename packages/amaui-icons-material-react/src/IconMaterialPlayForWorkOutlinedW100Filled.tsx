...
const IconMaterialPlayForWorkOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PlayForWorkOutlinedW100Filled'
...
export default IconMaterialPlayForWorkOutlinedW100Filled;
