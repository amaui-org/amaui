...
const IconMaterialBlockSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BlockSharpFilled'
      short_name='Block'
...
IconMaterialBlockSharpFilled.displayName = 'AmauiIconMaterialBlockSharpFilled';

export default IconMaterialBlockSharpFilled;
