...
const IconMaterialPhotoOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PhotoOutlinedW700Filled'
      short_name='Photo'
...
export default IconMaterialPhotoOutlinedW700Filled;
