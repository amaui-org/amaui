...
const IconMaterialPianoRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PianoRoundedW100'
      short_name='Piano'
...
IconMaterialPianoRoundedW100.displayName = 'AmauiIconMaterialPianoRoundedW100';

export default IconMaterialPianoRoundedW100;
