...
const IconMaterialBrightnessLowSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialBrightnessLowSharp.displayName = 'AmauiIconMaterialBrightnessLowSharp';

export default IconMaterialBrightnessLowSharp;
