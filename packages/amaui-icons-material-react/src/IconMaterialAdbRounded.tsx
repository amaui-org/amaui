...
const IconMaterialAdbRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialAdbRounded.displayName = 'AmauiIconMaterialAdbRounded';

export default IconMaterialAdbRounded;
