...
const IconMaterialStayPrimaryPortraitRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='StayPrimaryPortraitRoundedW700Filled'
...
export default IconMaterialStayPrimaryPortraitRoundedW700Filled;
