...
const IconMaterialDresserRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DresserRoundedW100'
      short_name='Dresser'
...
IconMaterialDresserRoundedW100.displayName = 'AmauiIconMaterialDresserRoundedW100';

export default IconMaterialDresserRoundedW100;
