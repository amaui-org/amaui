...
const IconMaterialScheduleRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ScheduleRoundedW100'
      short_name='Schedule'
...
IconMaterialScheduleRoundedW100.displayName = 'AmauiIconMaterialScheduleRoundedW100';

export default IconMaterialScheduleRoundedW100;
