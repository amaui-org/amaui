...
const IconMaterialTrailLengthOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TrailLengthOutlinedW100Filled'
...
export default IconMaterialTrailLengthOutlinedW100Filled;
