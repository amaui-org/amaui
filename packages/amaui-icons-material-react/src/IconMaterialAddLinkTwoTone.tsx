...
const IconMaterialAddLinkTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialAddLinkTwoTone.displayName = 'AmauiIconMaterialAddLinkTwoTone';

export default IconMaterialAddLinkTwoTone;
