...
const IconMaterialCancelScheduleSendOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CancelScheduleSendOutlinedFilled'
...
export default IconMaterialCancelScheduleSendOutlinedFilled;
