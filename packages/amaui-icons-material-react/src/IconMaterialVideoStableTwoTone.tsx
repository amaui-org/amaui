...
const IconMaterialVideoStableTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialVideoStableTwoTone.displayName = 'AmauiIconMaterialVideoStableTwoTone';

export default IconMaterialVideoStableTwoTone;
