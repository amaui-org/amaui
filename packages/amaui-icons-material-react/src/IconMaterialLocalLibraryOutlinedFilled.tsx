...
const IconMaterialLocalLibraryOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LocalLibraryOutlinedFilled'
...
export default IconMaterialLocalLibraryOutlinedFilled;
