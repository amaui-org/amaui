...
const IconMaterialViewCarouselOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ViewCarouselOutlinedW700'
...
export default IconMaterialViewCarouselOutlinedW700;
