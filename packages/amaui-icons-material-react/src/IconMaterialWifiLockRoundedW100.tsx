...
const IconMaterialWifiLockRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WifiLockRoundedW100'
      short_name='WifiLock'
...
IconMaterialWifiLockRoundedW100.displayName = 'AmauiIconMaterialWifiLockRoundedW100';

export default IconMaterialWifiLockRoundedW100;
