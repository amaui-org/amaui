...
const IconMaterialRecommendOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RecommendOutlinedFilled'
...
export default IconMaterialRecommendOutlinedFilled;
