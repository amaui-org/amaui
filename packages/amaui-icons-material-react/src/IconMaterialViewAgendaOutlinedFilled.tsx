...
const IconMaterialViewAgendaOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ViewAgendaOutlinedFilled'
...
export default IconMaterialViewAgendaOutlinedFilled;
