...
const IconMaterialSportsSoccerOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SportsSoccerOutlinedFilled'
...
export default IconMaterialSportsSoccerOutlinedFilled;
