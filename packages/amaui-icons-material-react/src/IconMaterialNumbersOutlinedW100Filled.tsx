...
const IconMaterialNumbersOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NumbersOutlinedW100Filled'
      short_name='Numbers'
...
export default IconMaterialNumbersOutlinedW100Filled;
