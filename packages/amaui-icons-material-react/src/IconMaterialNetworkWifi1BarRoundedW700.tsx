...
const IconMaterialNetworkWifi1BarRoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NetworkWifi1BarRoundedW700'
...
export default IconMaterialNetworkWifi1BarRoundedW700;
