...
const IconMaterialThunderstormOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ThunderstormOutlinedFilled'
...
export default IconMaterialThunderstormOutlinedFilled;
