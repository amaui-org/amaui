...
const IconMaterialDoNotDisturbOnTotalSilenceOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DoNotDisturbOnTotalSilenceOutlinedW700Filled'
...
export default IconMaterialDoNotDisturbOnTotalSilenceOutlinedW700Filled;
