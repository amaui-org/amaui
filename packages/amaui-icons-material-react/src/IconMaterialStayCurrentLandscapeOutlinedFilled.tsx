...
const IconMaterialStayCurrentLandscapeOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='StayCurrentLandscapeOutlinedFilled'
...
export default IconMaterialStayCurrentLandscapeOutlinedFilled;
