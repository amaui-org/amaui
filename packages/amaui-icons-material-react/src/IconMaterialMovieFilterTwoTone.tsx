...
const IconMaterialMovieFilterTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialMovieFilterTwoTone.displayName = 'AmauiIconMaterialMovieFilterTwoTone';

export default IconMaterialMovieFilterTwoTone;
