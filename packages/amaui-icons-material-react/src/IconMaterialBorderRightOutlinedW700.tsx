...
const IconMaterialBorderRightOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BorderRightOutlinedW700'
...
export default IconMaterialBorderRightOutlinedW700;
