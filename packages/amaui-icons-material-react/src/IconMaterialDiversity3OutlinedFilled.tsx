...
const IconMaterialDiversity3OutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Diversity3OutlinedFilled'
...
export default IconMaterialDiversity3OutlinedFilled;
