...
const IconMaterialPerson2TwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialPerson2TwoTone.displayName = 'AmauiIconMaterialPerson2TwoTone';

export default IconMaterialPerson2TwoTone;
