...
const IconMaterialBatteryVeryLowSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryVeryLowSharpW700Filled'
...
export default IconMaterialBatteryVeryLowSharpW700Filled;
