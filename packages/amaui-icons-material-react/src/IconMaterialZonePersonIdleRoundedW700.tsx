...
const IconMaterialZonePersonIdleRoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ZonePersonIdleRoundedW700'
...
export default IconMaterialZonePersonIdleRoundedW700;
