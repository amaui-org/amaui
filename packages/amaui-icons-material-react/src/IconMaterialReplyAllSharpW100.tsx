...
const IconMaterialReplyAllSharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ReplyAllSharpW100'
      short_name='ReplyAll'
...
IconMaterialReplyAllSharpW100.displayName = 'AmauiIconMaterialReplyAllSharpW100';

export default IconMaterialReplyAllSharpW100;
