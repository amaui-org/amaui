...
const IconMaterialPergolaOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PergolaOutlinedW100Filled'
      short_name='Pergola'
...
export default IconMaterialPergolaOutlinedW100Filled;
