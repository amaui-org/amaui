...
const IconMaterialBookmarkAddedTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialBookmarkAddedTwoTone.displayName = 'AmauiIconMaterialBookmarkAddedTwoTone';

export default IconMaterialBookmarkAddedTwoTone;
