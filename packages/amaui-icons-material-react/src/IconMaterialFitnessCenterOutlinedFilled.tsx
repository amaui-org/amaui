...
const IconMaterialFitnessCenterOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FitnessCenterOutlinedFilled'
...
export default IconMaterialFitnessCenterOutlinedFilled;
