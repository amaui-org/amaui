...
const IconMaterialHumidityHighOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HumidityHighOutlinedW100'
...
export default IconMaterialHumidityHighOutlinedW100;
