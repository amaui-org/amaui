...
const IconMaterialThumbUpOffOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ThumbUpOffOutlinedFilled'
...
export default IconMaterialThumbUpOffOutlinedFilled;
