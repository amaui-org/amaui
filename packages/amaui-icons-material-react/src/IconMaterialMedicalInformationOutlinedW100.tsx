...
const IconMaterialMedicalInformationOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MedicalInformationOutlinedW100'
...
export default IconMaterialMedicalInformationOutlinedW100;
