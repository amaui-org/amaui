...
const IconMaterialPanoramaFishEyeRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PanoramaFishEyeRoundedW700Filled'
...
export default IconMaterialPanoramaFishEyeRoundedW700Filled;
