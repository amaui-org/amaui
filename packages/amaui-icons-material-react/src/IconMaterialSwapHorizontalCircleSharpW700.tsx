...
const IconMaterialSwapHorizontalCircleSharpW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SwapHorizontalCircleSharpW700'
...
export default IconMaterialSwapHorizontalCircleSharpW700;
