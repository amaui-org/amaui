...
const IconMaterialHomeSpeakerOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HomeSpeakerOutlinedW100Filled'
...
export default IconMaterialHomeSpeakerOutlinedW100Filled;
