...
const IconMaterialStarTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialStarTwoTone.displayName = 'AmauiIconMaterialStarTwoTone';

export default IconMaterialStarTwoTone;
