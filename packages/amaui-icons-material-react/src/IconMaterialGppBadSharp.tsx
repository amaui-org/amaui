...
const IconMaterialGppBadSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialGppBadSharp.displayName = 'AmauiIconMaterialGppBadSharp';

export default IconMaterialGppBadSharp;
