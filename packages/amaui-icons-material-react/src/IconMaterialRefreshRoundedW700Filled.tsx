...
const IconMaterialRefreshRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RefreshRoundedW700Filled'
      short_name='Refresh'
...
export default IconMaterialRefreshRoundedW700Filled;
