...
const IconMaterialArchitectureOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ArchitectureOutlinedW700'
...
export default IconMaterialArchitectureOutlinedW700;
