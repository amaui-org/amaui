...
const IconMaterialCloudSyncOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CloudSyncOutlinedFilled'
...
export default IconMaterialCloudSyncOutlinedFilled;
