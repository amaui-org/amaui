...
const IconMaterialDataUsageRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialDataUsageRounded.displayName = 'AmauiIconMaterialDataUsageRounded';

export default IconMaterialDataUsageRounded;
