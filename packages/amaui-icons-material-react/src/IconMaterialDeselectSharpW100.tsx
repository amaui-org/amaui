...
const IconMaterialDeselectSharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DeselectSharpW100'
      short_name='Deselect'
...
IconMaterialDeselectSharpW100.displayName = 'AmauiIconMaterialDeselectSharpW100';

export default IconMaterialDeselectSharpW100;
