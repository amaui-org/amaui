...
const IconMaterialControlCameraSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ControlCameraSharpW700Filled'
...
export default IconMaterialControlCameraSharpW700Filled;
