...
const IconMaterialGrid4x4OutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Grid4x4OutlinedW100Filled'
      short_name='Grid4x4'
...
export default IconMaterialGrid4x4OutlinedW100Filled;
