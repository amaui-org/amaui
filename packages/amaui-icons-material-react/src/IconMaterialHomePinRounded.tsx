...
const IconMaterialHomePinRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialHomePinRounded.displayName = 'AmauiIconMaterialHomePinRounded';

export default IconMaterialHomePinRounded;
