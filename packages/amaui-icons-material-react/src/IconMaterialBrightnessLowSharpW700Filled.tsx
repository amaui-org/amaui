...
const IconMaterialBrightnessLowSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BrightnessLowSharpW700Filled'
...
export default IconMaterialBrightnessLowSharpW700Filled;
