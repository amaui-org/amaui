...
const IconMaterialShoppingBagOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ShoppingBagOutlinedFilled'
...
export default IconMaterialShoppingBagOutlinedFilled;
