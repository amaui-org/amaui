...
const IconMaterialAssignmentReturnOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AssignmentReturnOutlinedW100Filled'
...
export default IconMaterialAssignmentReturnOutlinedW100Filled;
