...
const IconMaterialBentoOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BentoOutlinedW100Filled'
      short_name='Bento'
...
export default IconMaterialBentoOutlinedW100Filled;
