...
const IconMaterialPlaylistAddSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PlaylistAddSharpW700Filled'
...
export default IconMaterialPlaylistAddSharpW700Filled;
