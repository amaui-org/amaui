...
const IconMaterialLineStyleOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LineStyleOutlinedW100Filled'
...
export default IconMaterialLineStyleOutlinedW100Filled;
