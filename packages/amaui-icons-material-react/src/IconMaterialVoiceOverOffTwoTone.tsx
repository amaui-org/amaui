...
const IconMaterialVoiceOverOffTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialVoiceOverOffTwoTone.displayName = 'AmauiIconMaterialVoiceOverOffTwoTone';

export default IconMaterialVoiceOverOffTwoTone;
