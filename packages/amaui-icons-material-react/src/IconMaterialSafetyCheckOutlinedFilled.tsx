...
const IconMaterialSafetyCheckOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SafetyCheckOutlinedFilled'
...
export default IconMaterialSafetyCheckOutlinedFilled;
