...
const IconMaterialBatteryCharging50Outlined = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryCharging50Outlined'
...
export default IconMaterialBatteryCharging50Outlined;
