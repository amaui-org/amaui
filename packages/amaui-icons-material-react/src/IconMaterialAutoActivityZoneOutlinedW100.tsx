...
const IconMaterialAutoActivityZoneOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AutoActivityZoneOutlinedW100'
...
export default IconMaterialAutoActivityZoneOutlinedW100;
