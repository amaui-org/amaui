...
const IconMaterialVoicemailOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='VoicemailOutlinedW700Filled'
...
export default IconMaterialVoicemailOutlinedW700Filled;
