...
const IconMaterialHdrWeakOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HdrWeakOutlinedW100Filled'
      short_name='HdrWeak'
...
export default IconMaterialHdrWeakOutlinedW100Filled;
