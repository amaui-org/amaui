...
const IconMaterialTeamDashboardOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TeamDashboardOutlinedW100'
...
export default IconMaterialTeamDashboardOutlinedW100;
