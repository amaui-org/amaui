...
const IconMaterialNavigateBeforeRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NavigateBeforeRoundedW700Filled'
...
export default IconMaterialNavigateBeforeRoundedW700Filled;
