...
const IconMaterialAssignmentReturnedOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AssignmentReturnedOutlinedW100Filled'
...
export default IconMaterialAssignmentReturnedOutlinedW100Filled;
