...
const IconMaterialAttachmentTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialAttachmentTwoTone.displayName = 'AmauiIconMaterialAttachmentTwoTone';

export default IconMaterialAttachmentTwoTone;
