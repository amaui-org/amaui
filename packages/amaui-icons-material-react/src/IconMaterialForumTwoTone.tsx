...
const IconMaterialForumTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialForumTwoTone.displayName = 'AmauiIconMaterialForumTwoTone';

export default IconMaterialForumTwoTone;
