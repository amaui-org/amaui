...
const IconMaterialGTranslateTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialGTranslateTwoTone.displayName = 'AmauiIconMaterialGTranslateTwoTone';

export default IconMaterialGTranslateTwoTone;
