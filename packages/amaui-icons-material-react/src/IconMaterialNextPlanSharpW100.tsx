...
const IconMaterialNextPlanSharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NextPlanSharpW100'
      short_name='NextPlan'
...
IconMaterialNextPlanSharpW100.displayName = 'AmauiIconMaterialNextPlanSharpW100';

export default IconMaterialNextPlanSharpW100;
