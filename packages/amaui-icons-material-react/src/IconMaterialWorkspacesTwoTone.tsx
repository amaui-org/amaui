...
const IconMaterialWorkspacesTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialWorkspacesTwoTone.displayName = 'AmauiIconMaterialWorkspacesTwoTone';

export default IconMaterialWorkspacesTwoTone;
