...
const IconMaterialBorderOuterOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BorderOuterOutlinedW100Filled'
...
export default IconMaterialBorderOuterOutlinedW100Filled;
