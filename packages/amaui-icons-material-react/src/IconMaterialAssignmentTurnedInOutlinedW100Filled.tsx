...
const IconMaterialAssignmentTurnedInOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AssignmentTurnedInOutlinedW100Filled'
...
export default IconMaterialAssignmentTurnedInOutlinedW100Filled;
