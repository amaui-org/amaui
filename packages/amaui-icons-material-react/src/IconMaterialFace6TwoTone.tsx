...
const IconMaterialFace6TwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialFace6TwoTone.displayName = 'AmauiIconMaterialFace6TwoTone';

export default IconMaterialFace6TwoTone;
