...
const IconMaterialPhoneEnabledSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PhoneEnabledSharpW700Filled'
...
export default IconMaterialPhoneEnabledSharpW700Filled;
