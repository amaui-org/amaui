...
const IconMaterialPersonSearchOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PersonSearchOutlinedFilled'
...
export default IconMaterialPersonSearchOutlinedFilled;
