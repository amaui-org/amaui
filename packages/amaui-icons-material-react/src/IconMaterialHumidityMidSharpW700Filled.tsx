...
const IconMaterialHumidityMidSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HumidityMidSharpW700Filled'
...
export default IconMaterialHumidityMidSharpW700Filled;
