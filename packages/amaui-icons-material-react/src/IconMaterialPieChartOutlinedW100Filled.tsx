...
const IconMaterialPieChartOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PieChartOutlinedW100Filled'
      short_name='PieChart'
...
export default IconMaterialPieChartOutlinedW100Filled;
