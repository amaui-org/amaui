...
const IconMaterialRsvpSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialRsvpSharp.displayName = 'AmauiIconMaterialRsvpSharp';

export default IconMaterialRsvpSharp;
