...
const IconMaterialDashboardTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialDashboardTwoTone.displayName = 'AmauiIconMaterialDashboardTwoTone';

export default IconMaterialDashboardTwoTone;
