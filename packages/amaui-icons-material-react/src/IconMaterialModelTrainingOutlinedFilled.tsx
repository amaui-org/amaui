...
const IconMaterialModelTrainingOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ModelTrainingOutlinedFilled'
...
export default IconMaterialModelTrainingOutlinedFilled;
