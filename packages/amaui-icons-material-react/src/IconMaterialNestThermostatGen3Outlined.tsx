...
const IconMaterialNestThermostatGen3Outlined = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestThermostatGen3Outlined'
...
export default IconMaterialNestThermostatGen3Outlined;
