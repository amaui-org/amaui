...
const IconMaterialSportsBarTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialSportsBarTwoTone.displayName = 'AmauiIconMaterialSportsBarTwoTone';

export default IconMaterialSportsBarTwoTone;
