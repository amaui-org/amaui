...
const IconMaterialLogoutOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LogoutOutlinedW700Filled'
      short_name='Logout'
...
export default IconMaterialLogoutOutlinedW700Filled;
