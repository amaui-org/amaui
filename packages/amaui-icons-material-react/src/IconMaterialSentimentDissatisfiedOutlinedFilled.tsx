...
const IconMaterialSentimentDissatisfiedOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SentimentDissatisfiedOutlinedFilled'
...
export default IconMaterialSentimentDissatisfiedOutlinedFilled;
