...
const IconMaterialArrowForwardRoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ArrowForwardRoundedW700'
...
export default IconMaterialArrowForwardRoundedW700;
