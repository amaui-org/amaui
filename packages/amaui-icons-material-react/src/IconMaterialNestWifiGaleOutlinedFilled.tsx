...
const IconMaterialNestWifiGaleOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestWifiGaleOutlinedFilled'
...
export default IconMaterialNestWifiGaleOutlinedFilled;
