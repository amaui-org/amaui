...
const IconMaterialErrorOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ErrorOutlinedW100Filled'
      short_name='Error'
...
export default IconMaterialErrorOutlinedW100Filled;
