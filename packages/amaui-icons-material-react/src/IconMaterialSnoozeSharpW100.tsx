...
const IconMaterialSnoozeSharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SnoozeSharpW100'
      short_name='Snooze'
...
IconMaterialSnoozeSharpW100.displayName = 'AmauiIconMaterialSnoozeSharpW100';

export default IconMaterialSnoozeSharpW100;
