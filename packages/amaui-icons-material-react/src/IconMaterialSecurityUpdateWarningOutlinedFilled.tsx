...
const IconMaterialSecurityUpdateWarningOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SecurityUpdateWarningOutlinedFilled'
...
export default IconMaterialSecurityUpdateWarningOutlinedFilled;
