...
const IconMaterialLinkRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialLinkRounded.displayName = 'AmauiIconMaterialLinkRounded';

export default IconMaterialLinkRounded;
