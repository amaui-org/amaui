...
const IconMaterialNestTagRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestTagRoundedW100'
      short_name='NestTag'
...
IconMaterialNestTagRoundedW100.displayName = 'AmauiIconMaterialNestTagRoundedW100';

export default IconMaterialNestTagRoundedW100;
