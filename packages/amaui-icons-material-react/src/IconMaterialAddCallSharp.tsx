...
const IconMaterialAddCallSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialAddCallSharp.displayName = 'AmauiIconMaterialAddCallSharp';

export default IconMaterialAddCallSharp;
