...
const IconMaterialEmojiPeopleOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='EmojiPeopleOutlinedW700Filled'
...
export default IconMaterialEmojiPeopleOutlinedW700Filled;
