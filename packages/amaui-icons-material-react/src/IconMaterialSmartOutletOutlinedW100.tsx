...
const IconMaterialSmartOutletOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SmartOutletOutlinedW100'
...
export default IconMaterialSmartOutletOutlinedW100;
