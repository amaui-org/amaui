...
const IconMaterialTransformTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialTransformTwoTone.displayName = 'AmauiIconMaterialTransformTwoTone';

export default IconMaterialTransformTwoTone;
