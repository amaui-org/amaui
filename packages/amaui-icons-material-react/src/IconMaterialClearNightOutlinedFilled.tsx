...
const IconMaterialClearNightOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ClearNightOutlinedFilled'
...
export default IconMaterialClearNightOutlinedFilled;
