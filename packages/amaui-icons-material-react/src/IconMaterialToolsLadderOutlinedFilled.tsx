...
const IconMaterialToolsLadderOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ToolsLadderOutlinedFilled'
...
export default IconMaterialToolsLadderOutlinedFilled;
