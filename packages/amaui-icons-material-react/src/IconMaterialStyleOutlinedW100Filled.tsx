...
const IconMaterialStyleOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='StyleOutlinedW100Filled'
      short_name='Style'
...
export default IconMaterialStyleOutlinedW100Filled;
