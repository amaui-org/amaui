...
const IconMaterialTvGenRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialTvGenRounded.displayName = 'AmauiIconMaterialTvGenRounded';

export default IconMaterialTvGenRounded;
