...
const IconMaterialRoundedCornerSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RoundedCornerSharpW700Filled'
...
export default IconMaterialRoundedCornerSharpW700Filled;
