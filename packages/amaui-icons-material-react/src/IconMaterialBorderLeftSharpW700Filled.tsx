...
const IconMaterialBorderLeftSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BorderLeftSharpW700Filled'
...
export default IconMaterialBorderLeftSharpW700Filled;
