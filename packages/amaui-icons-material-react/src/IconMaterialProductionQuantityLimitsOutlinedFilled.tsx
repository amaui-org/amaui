...
const IconMaterialProductionQuantityLimitsOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ProductionQuantityLimitsOutlinedFilled'
...
export default IconMaterialProductionQuantityLimitsOutlinedFilled;
