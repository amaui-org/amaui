...
const IconMaterialNestCamIqOutdoorRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestCamIqOutdoorRoundedW700Filled'
...
export default IconMaterialNestCamIqOutdoorRoundedW700Filled;
