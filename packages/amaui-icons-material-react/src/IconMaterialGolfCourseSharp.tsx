...
const IconMaterialGolfCourseSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialGolfCourseSharp.displayName = 'AmauiIconMaterialGolfCourseSharp';

export default IconMaterialGolfCourseSharp;
