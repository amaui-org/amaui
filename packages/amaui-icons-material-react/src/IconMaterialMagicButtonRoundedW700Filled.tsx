...
const IconMaterialMagicButtonRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MagicButtonRoundedW700Filled'
...
export default IconMaterialMagicButtonRoundedW700Filled;
