...
const IconMaterialBrightnessLowOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BrightnessLowOutlinedW100Filled'
...
export default IconMaterialBrightnessLowOutlinedW100Filled;
