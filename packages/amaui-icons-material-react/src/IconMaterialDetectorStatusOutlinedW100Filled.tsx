...
const IconMaterialDetectorStatusOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DetectorStatusOutlinedW100Filled'
...
export default IconMaterialDetectorStatusOutlinedW100Filled;
