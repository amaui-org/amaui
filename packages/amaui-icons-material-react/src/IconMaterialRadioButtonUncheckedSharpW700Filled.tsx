...
const IconMaterialRadioButtonUncheckedSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RadioButtonUncheckedSharpW700Filled'
...
export default IconMaterialRadioButtonUncheckedSharpW700Filled;
