...
const IconMaterialMoreTimeOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MoreTimeOutlinedW100Filled'
      short_name='MoreTime'
...
export default IconMaterialMoreTimeOutlinedW100Filled;
