...
const IconMaterialContentCutSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialContentCutSharp.displayName = 'AmauiIconMaterialContentCutSharp';

export default IconMaterialContentCutSharp;
