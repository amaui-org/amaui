...
const IconMaterialPolicyTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialPolicyTwoTone.displayName = 'AmauiIconMaterialPolicyTwoTone';

export default IconMaterialPolicyTwoTone;
