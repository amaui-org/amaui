...
const IconMaterialZonePersonAlertOutlined = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ZonePersonAlertOutlined'
...
export default IconMaterialZonePersonAlertOutlined;
