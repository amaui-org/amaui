...
const IconMaterialBubbleChartOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BubbleChartOutlinedFilled'
...
export default IconMaterialBubbleChartOutlinedFilled;
