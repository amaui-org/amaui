...
const IconMaterialStayCurrentPortraitOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='StayCurrentPortraitOutlinedW100Filled'
...
export default IconMaterialStayCurrentPortraitOutlinedW100Filled;
