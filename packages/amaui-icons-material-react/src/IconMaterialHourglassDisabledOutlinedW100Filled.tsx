...
const IconMaterialHourglassDisabledOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HourglassDisabledOutlinedW100Filled'
...
export default IconMaterialHourglassDisabledOutlinedW100Filled;
