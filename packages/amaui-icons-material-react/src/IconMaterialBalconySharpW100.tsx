...
const IconMaterialBalconySharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BalconySharpW100'
      short_name='Balcony'
...
IconMaterialBalconySharpW100.displayName = 'AmauiIconMaterialBalconySharpW100';

export default IconMaterialBalconySharpW100;
