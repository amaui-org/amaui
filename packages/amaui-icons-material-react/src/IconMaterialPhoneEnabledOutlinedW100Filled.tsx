...
const IconMaterialPhoneEnabledOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PhoneEnabledOutlinedW100Filled'
...
export default IconMaterialPhoneEnabledOutlinedW100Filled;
