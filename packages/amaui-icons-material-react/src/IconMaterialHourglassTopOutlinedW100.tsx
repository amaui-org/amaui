...
const IconMaterialHourglassTopOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HourglassTopOutlinedW100'
...
export default IconMaterialHourglassTopOutlinedW100;
