...
const IconMaterialSentimentSatisfiedOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SentimentSatisfiedOutlinedFilled'
...
export default IconMaterialSentimentSatisfiedOutlinedFilled;
