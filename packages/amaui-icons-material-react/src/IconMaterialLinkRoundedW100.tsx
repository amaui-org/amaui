...
const IconMaterialLinkRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LinkRoundedW100'
      short_name='Link'
...
IconMaterialLinkRoundedW100.displayName = 'AmauiIconMaterialLinkRoundedW100';

export default IconMaterialLinkRoundedW100;
