...
const IconMaterialDirectionsRunSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DirectionsRunSharpW700Filled'
...
export default IconMaterialDirectionsRunSharpW700Filled;
