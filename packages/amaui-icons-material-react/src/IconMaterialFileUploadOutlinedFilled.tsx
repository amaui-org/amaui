...
const IconMaterialFileUploadOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FileUploadOutlinedFilled'
...
export default IconMaterialFileUploadOutlinedFilled;
