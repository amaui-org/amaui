...
const IconMaterialEnableRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='EnableRoundedW100'
      short_name='Enable'
...
IconMaterialEnableRoundedW100.displayName = 'AmauiIconMaterialEnableRoundedW100';

export default IconMaterialEnableRoundedW100;
