...
const IconMaterialSwordsSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SwordsSharpFilled'
      short_name='Swords'
...
IconMaterialSwordsSharpFilled.displayName = 'AmauiIconMaterialSwordsSharpFilled';

export default IconMaterialSwordsSharpFilled;
