...
const IconMaterialGroupRemoveSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialGroupRemoveSharp.displayName = 'AmauiIconMaterialGroupRemoveSharp';

export default IconMaterialGroupRemoveSharp;
