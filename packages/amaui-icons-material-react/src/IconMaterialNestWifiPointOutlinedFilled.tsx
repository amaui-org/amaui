...
const IconMaterialNestWifiPointOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestWifiPointOutlinedFilled'
...
export default IconMaterialNestWifiPointOutlinedFilled;
