...
const IconMaterialBreakingNewsAlt1SharpW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BreakingNewsAlt1SharpW700'
...
export default IconMaterialBreakingNewsAlt1SharpW700;
