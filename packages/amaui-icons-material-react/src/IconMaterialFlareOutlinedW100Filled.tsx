...
const IconMaterialFlareOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FlareOutlinedW100Filled'
      short_name='Flare'
...
export default IconMaterialFlareOutlinedW100Filled;
