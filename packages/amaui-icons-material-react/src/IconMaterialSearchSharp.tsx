...
const IconMaterialSearchSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialSearchSharp.displayName = 'AmauiIconMaterialSearchSharp';

export default IconMaterialSearchSharp;
