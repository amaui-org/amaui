...
const IconMaterialExpandCircleDownOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ExpandCircleDownOutlinedW700'
...
export default IconMaterialExpandCircleDownOutlinedW700;
