...
const IconMaterialOpenWithSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='OpenWithSharpW700Filled'
      short_name='OpenWith'
...
export default IconMaterialOpenWithSharpW700Filled;
