...
const IconMaterialDownloadingOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DownloadingOutlinedW100'
...
export default IconMaterialDownloadingOutlinedW100;
