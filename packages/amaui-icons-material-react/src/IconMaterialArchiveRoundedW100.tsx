...
const IconMaterialArchiveRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ArchiveRoundedW100'
      short_name='Archive'
...
IconMaterialArchiveRoundedW100.displayName = 'AmauiIconMaterialArchiveRoundedW100';

export default IconMaterialArchiveRoundedW100;
