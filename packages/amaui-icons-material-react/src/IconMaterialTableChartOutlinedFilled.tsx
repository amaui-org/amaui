...
const IconMaterialTableChartOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TableChartOutlinedFilled'
...
export default IconMaterialTableChartOutlinedFilled;
