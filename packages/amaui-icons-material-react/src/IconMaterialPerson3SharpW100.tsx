...
const IconMaterialPerson3SharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Person3SharpW100'
      short_name='Person3'
...
IconMaterialPerson3SharpW100.displayName = 'AmauiIconMaterialPerson3SharpW100';

export default IconMaterialPerson3SharpW100;
