...
const IconMaterialBalconySharp = React.forwardRef((props: any, ref) => {
...
IconMaterialBalconySharp.displayName = 'AmauiIconMaterialBalconySharp';

export default IconMaterialBalconySharp;
