...
const IconMaterialFilterBAndWOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FilterBAndWOutlinedW100Filled'
...
export default IconMaterialFilterBAndWOutlinedW100Filled;
