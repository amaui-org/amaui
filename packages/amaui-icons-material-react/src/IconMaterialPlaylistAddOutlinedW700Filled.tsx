...
const IconMaterialPlaylistAddOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PlaylistAddOutlinedW700Filled'
...
export default IconMaterialPlaylistAddOutlinedW700Filled;
