...
const IconMaterialAstrophotographyAutoOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AstrophotographyAutoOutlinedW100Filled'
...
export default IconMaterialAstrophotographyAutoOutlinedW100Filled;
