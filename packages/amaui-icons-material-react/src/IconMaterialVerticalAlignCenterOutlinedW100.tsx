...
const IconMaterialVerticalAlignCenterOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='VerticalAlignCenterOutlinedW100'
...
export default IconMaterialVerticalAlignCenterOutlinedW100;
