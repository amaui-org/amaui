...
const IconMaterialSmartButtonTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialSmartButtonTwoTone.displayName = 'AmauiIconMaterialSmartButtonTwoTone';

export default IconMaterialSmartButtonTwoTone;
