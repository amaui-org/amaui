...
const IconMaterialRepeatOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RepeatOutlinedW100Filled'
      short_name='Repeat'
...
export default IconMaterialRepeatOutlinedW100Filled;
