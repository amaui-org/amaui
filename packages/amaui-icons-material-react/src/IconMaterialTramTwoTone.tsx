...
const IconMaterialTramTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialTramTwoTone.displayName = 'AmauiIconMaterialTramTwoTone';

export default IconMaterialTramTwoTone;
