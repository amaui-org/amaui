...
const IconMaterialUpcomingTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialUpcomingTwoTone.displayName = 'AmauiIconMaterialUpcomingTwoTone';

export default IconMaterialUpcomingTwoTone;
