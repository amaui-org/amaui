...
const IconMaterialVolumeDownAltSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='VolumeDownAltSharpW700Filled'
...
export default IconMaterialVolumeDownAltSharpW700Filled;
