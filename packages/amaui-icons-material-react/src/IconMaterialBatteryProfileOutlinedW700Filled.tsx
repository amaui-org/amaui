...
const IconMaterialBatteryProfileOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryProfileOutlinedW700Filled'
...
export default IconMaterialBatteryProfileOutlinedW700Filled;
