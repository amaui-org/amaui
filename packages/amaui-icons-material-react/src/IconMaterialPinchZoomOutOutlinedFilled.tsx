...
const IconMaterialPinchZoomOutOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PinchZoomOutOutlinedFilled'
...
export default IconMaterialPinchZoomOutOutlinedFilled;
