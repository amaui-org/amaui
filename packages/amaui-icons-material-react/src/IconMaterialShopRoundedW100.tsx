...
const IconMaterialShopRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ShopRoundedW100'
      short_name='Shop'
...
IconMaterialShopRoundedW100.displayName = 'AmauiIconMaterialShopRoundedW100';

export default IconMaterialShopRoundedW100;
