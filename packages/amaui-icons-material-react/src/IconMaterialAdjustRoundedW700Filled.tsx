...
const IconMaterialAdjustRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AdjustRoundedW700Filled'
      short_name='Adjust'
...
export default IconMaterialAdjustRoundedW700Filled;
