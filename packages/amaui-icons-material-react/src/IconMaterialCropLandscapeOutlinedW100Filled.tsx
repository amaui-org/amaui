...
const IconMaterialCropLandscapeOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CropLandscapeOutlinedW100Filled'
...
export default IconMaterialCropLandscapeOutlinedW100Filled;
