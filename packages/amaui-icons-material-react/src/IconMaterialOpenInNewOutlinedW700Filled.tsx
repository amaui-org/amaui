...
const IconMaterialOpenInNewOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='OpenInNewOutlinedW700Filled'
...
export default IconMaterialOpenInNewOutlinedW700Filled;
