...
const IconMaterialUmbrellaOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='UmbrellaOutlinedW100Filled'
      short_name='Umbrella'
...
export default IconMaterialUmbrellaOutlinedW100Filled;
