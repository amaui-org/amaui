...
const IconMaterialFireExtinguisherOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FireExtinguisherOutlinedFilled'
...
export default IconMaterialFireExtinguisherOutlinedFilled;
