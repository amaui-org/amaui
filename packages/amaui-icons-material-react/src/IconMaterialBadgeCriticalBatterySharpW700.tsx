...
const IconMaterialBadgeCriticalBatterySharpW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BadgeCriticalBatterySharpW700'
...
export default IconMaterialBadgeCriticalBatterySharpW700;
