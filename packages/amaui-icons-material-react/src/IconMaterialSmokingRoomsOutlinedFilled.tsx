...
const IconMaterialSmokingRoomsOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SmokingRoomsOutlinedFilled'
...
export default IconMaterialSmokingRoomsOutlinedFilled;
