...
const IconMaterialArrowCircleDownOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ArrowCircleDownOutlinedW100'
...
export default IconMaterialArrowCircleDownOutlinedW100;
