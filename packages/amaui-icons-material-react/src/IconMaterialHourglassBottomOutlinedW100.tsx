...
const IconMaterialHourglassBottomOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HourglassBottomOutlinedW100'
...
export default IconMaterialHourglassBottomOutlinedW100;
