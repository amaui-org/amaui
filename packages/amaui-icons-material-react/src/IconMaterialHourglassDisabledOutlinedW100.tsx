...
const IconMaterialHourglassDisabledOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HourglassDisabledOutlinedW100'
...
export default IconMaterialHourglassDisabledOutlinedW100;
