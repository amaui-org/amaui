...
const IconMaterialZonePersonUrgentOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ZonePersonUrgentOutlinedFilled'
...
export default IconMaterialZonePersonUrgentOutlinedFilled;
