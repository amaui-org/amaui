...
const IconMaterialUnfoldLessDoubleOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='UnfoldLessDoubleOutlinedW100'
...
export default IconMaterialUnfoldLessDoubleOutlinedW100;
