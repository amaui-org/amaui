...
const IconMaterialMapTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialMapTwoTone.displayName = 'AmauiIconMaterialMapTwoTone';

export default IconMaterialMapTwoTone;
