...
const IconMaterialTransformOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TransformOutlinedW700Filled'
...
export default IconMaterialTransformOutlinedW700Filled;
