...
const IconMaterialUmbrellaSharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='UmbrellaSharpW100'
      short_name='Umbrella'
...
IconMaterialUmbrellaSharpW100.displayName = 'AmauiIconMaterialUmbrellaSharpW100';

export default IconMaterialUmbrellaSharpW100;
