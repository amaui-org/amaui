...
const IconMaterialAvTimerTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialAvTimerTwoTone.displayName = 'AmauiIconMaterialAvTimerTwoTone';

export default IconMaterialAvTimerTwoTone;
