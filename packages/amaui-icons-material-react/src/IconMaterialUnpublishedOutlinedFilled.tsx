...
const IconMaterialUnpublishedOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='UnpublishedOutlinedFilled'
...
export default IconMaterialUnpublishedOutlinedFilled;
