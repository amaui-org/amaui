...
const IconMaterialFileDownloadSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FileDownloadSharpW700Filled'
...
export default IconMaterialFileDownloadSharpW700Filled;
