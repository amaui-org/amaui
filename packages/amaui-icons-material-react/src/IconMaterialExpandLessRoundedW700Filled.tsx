...
const IconMaterialExpandLessRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ExpandLessRoundedW700Filled'
...
export default IconMaterialExpandLessRoundedW700Filled;
