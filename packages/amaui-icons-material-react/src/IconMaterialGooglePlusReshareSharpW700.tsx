...
const IconMaterialGooglePlusReshareSharpW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='GooglePlusReshareSharpW700'
...
export default IconMaterialGooglePlusReshareSharpW700;
