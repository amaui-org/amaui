...
const IconMaterialBatteryAlertOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryAlertOutlinedW700'
...
export default IconMaterialBatteryAlertOutlinedW700;
