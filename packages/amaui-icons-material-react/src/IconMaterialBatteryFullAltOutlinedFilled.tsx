...
const IconMaterialBatteryFullAltOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryFullAltOutlinedFilled'
...
export default IconMaterialBatteryFullAltOutlinedFilled;
