...
const IconMaterialBlurOffTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialBlurOffTwoTone.displayName = 'AmauiIconMaterialBlurOffTwoTone';

export default IconMaterialBlurOffTwoTone;
