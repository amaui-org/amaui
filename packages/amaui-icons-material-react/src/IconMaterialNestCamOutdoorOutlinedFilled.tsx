...
const IconMaterialNestCamOutdoorOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestCamOutdoorOutlinedFilled'
...
export default IconMaterialNestCamOutdoorOutlinedFilled;
