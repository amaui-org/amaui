...
const IconMaterialRepeatOneOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RepeatOneOutlinedFilled'
...
export default IconMaterialRepeatOneOutlinedFilled;
