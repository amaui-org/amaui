...
const IconMaterialNestDetectOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestDetectOutlinedFilled'
...
export default IconMaterialNestDetectOutlinedFilled;
