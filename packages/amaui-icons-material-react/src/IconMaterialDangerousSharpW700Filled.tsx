...
const IconMaterialDangerousSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DangerousSharpW700Filled'
...
export default IconMaterialDangerousSharpW700Filled;
