...
const IconMaterialCheckCircleOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CheckCircleOutlinedW100'
...
export default IconMaterialCheckCircleOutlinedW100;
