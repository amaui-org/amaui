...
const IconMaterialPhotoCameraFrontOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PhotoCameraFrontOutlinedFilled'
...
export default IconMaterialPhotoCameraFrontOutlinedFilled;
