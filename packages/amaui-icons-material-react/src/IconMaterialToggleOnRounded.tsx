...
const IconMaterialToggleOnRounded = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ToggleOnRounded'
      short_name='ToggleOn'
...
IconMaterialToggleOnRounded.displayName = 'AmauiIconMaterialToggleOnRounded';

export default IconMaterialToggleOnRounded;
