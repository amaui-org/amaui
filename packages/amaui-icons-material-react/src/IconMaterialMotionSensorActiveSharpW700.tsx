...
const IconMaterialMotionSensorActiveSharpW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MotionSensorActiveSharpW700'
...
export default IconMaterialMotionSensorActiveSharpW700;
