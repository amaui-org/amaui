...
const IconMaterialEnableOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='EnableOutlinedW700Filled'
      short_name='Enable'
...
export default IconMaterialEnableOutlinedW700Filled;
