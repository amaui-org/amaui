...
const IconMaterialSettopComponentOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SettopComponentOutlinedFilled'
...
export default IconMaterialSettopComponentOutlinedFilled;
