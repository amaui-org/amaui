...
const IconMaterialHeartMinusSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HeartMinusSharpW700Filled'
...
export default IconMaterialHeartMinusSharpW700Filled;
