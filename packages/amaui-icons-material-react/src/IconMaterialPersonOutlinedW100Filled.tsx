...
const IconMaterialPersonOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PersonOutlinedW100Filled'
      short_name='Person'
...
export default IconMaterialPersonOutlinedW100Filled;
