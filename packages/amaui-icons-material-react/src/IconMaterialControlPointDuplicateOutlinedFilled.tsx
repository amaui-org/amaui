...
const IconMaterialControlPointDuplicateOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ControlPointDuplicateOutlinedFilled'
...
export default IconMaterialControlPointDuplicateOutlinedFilled;
