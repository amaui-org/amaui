...
const IconMaterialRoundedCornerOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RoundedCornerOutlinedW100Filled'
...
export default IconMaterialRoundedCornerOutlinedW100Filled;
