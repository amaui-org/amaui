...
const IconMaterialZoomOutMapOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ZoomOutMapOutlinedW100Filled'
...
export default IconMaterialZoomOutMapOutlinedW100Filled;
