...
const IconMaterialTrailLengthShortOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TrailLengthShortOutlinedW100'
...
export default IconMaterialTrailLengthShortOutlinedW100;
