...
const IconMaterialStayPrimaryLandscapeOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='StayPrimaryLandscapeOutlinedW100Filled'
...
export default IconMaterialStayPrimaryLandscapeOutlinedW100Filled;
