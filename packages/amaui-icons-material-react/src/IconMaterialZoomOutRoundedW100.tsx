...
const IconMaterialZoomOutRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ZoomOutRoundedW100'
      short_name='ZoomOut'
...
IconMaterialZoomOutRoundedW100.displayName = 'AmauiIconMaterialZoomOutRoundedW100';

export default IconMaterialZoomOutRoundedW100;
