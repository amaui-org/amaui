...
const IconMaterialMovingOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MovingOutlinedW100Filled'
      short_name='Moving'
...
export default IconMaterialMovingOutlinedW100Filled;
