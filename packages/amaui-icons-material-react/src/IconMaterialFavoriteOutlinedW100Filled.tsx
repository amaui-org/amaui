...
const IconMaterialFavoriteOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FavoriteOutlinedW100Filled'
      short_name='Favorite'
...
export default IconMaterialFavoriteOutlinedW100Filled;
