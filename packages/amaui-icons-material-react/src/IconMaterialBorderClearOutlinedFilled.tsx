...
const IconMaterialBorderClearOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BorderClearOutlinedFilled'
...
export default IconMaterialBorderClearOutlinedFilled;
