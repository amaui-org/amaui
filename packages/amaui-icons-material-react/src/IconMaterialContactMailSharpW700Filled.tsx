...
const IconMaterialContactMailSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ContactMailSharpW700Filled'
...
export default IconMaterialContactMailSharpW700Filled;
