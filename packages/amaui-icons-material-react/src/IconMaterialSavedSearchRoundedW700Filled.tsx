...
const IconMaterialSavedSearchRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SavedSearchRoundedW700Filled'
...
export default IconMaterialSavedSearchRoundedW700Filled;
