...
const IconMaterialInputTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialInputTwoTone.displayName = 'AmauiIconMaterialInputTwoTone';

export default IconMaterialInputTwoTone;
