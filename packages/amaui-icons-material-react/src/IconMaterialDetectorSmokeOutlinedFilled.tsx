...
const IconMaterialDetectorSmokeOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DetectorSmokeOutlinedFilled'
...
export default IconMaterialDetectorSmokeOutlinedFilled;
