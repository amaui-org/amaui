...
const IconMaterialMobiledataOffOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MobiledataOffOutlinedFilled'
...
export default IconMaterialMobiledataOffOutlinedFilled;
