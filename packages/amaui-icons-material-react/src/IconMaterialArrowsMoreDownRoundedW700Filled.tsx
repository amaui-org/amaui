...
const IconMaterialArrowsMoreDownRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ArrowsMoreDownRoundedW700Filled'
...
export default IconMaterialArrowsMoreDownRoundedW700Filled;
