...
const IconMaterialCheckBoxOutlineBlankOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CheckBoxOutlineBlankOutlinedFilled'
...
export default IconMaterialCheckBoxOutlineBlankOutlinedFilled;
