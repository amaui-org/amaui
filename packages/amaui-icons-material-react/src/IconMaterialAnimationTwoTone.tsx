...
const IconMaterialAnimationTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialAnimationTwoTone.displayName = 'AmauiIconMaterialAnimationTwoTone';

export default IconMaterialAnimationTwoTone;
