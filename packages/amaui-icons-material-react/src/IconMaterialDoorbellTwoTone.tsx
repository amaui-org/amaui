...
const IconMaterialDoorbellTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialDoorbellTwoTone.displayName = 'AmauiIconMaterialDoorbellTwoTone';

export default IconMaterialDoorbellTwoTone;
