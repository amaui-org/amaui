...
const IconMaterialCloudCircleOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CloudCircleOutlinedFilled'
...
export default IconMaterialCloudCircleOutlinedFilled;
