...
const IconMaterialSmartToyOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SmartToyOutlinedW100Filled'
      short_name='SmartToy'
...
export default IconMaterialSmartToyOutlinedW100Filled;
