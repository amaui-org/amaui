...
const IconMaterialDriveFileMoveOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DriveFileMoveOutlinedW100'
...
export default IconMaterialDriveFileMoveOutlinedW100;
