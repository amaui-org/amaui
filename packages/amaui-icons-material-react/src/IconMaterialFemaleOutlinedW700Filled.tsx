...
const IconMaterialFemaleOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FemaleOutlinedW700Filled'
      short_name='Female'
...
export default IconMaterialFemaleOutlinedW700Filled;
