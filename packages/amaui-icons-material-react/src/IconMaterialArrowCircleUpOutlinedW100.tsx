...
const IconMaterialArrowCircleUpOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ArrowCircleUpOutlinedW100'
...
export default IconMaterialArrowCircleUpOutlinedW100;
