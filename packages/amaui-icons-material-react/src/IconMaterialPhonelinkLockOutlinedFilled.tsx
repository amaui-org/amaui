...
const IconMaterialPhonelinkLockOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PhonelinkLockOutlinedFilled'
...
export default IconMaterialPhonelinkLockOutlinedFilled;
