...
const IconMaterialEventUpcomingOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='EventUpcomingOutlinedFilled'
...
export default IconMaterialEventUpcomingOutlinedFilled;
