...
const IconMaterialMotionSensorUrgentOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MotionSensorUrgentOutlinedW700'
...
export default IconMaterialMotionSensorUrgentOutlinedW700;
