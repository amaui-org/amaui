...
const IconMaterialEmergencyRecordingOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='EmergencyRecordingOutlinedW100Filled'
...
export default IconMaterialEmergencyRecordingOutlinedW100Filled;
