...
const IconMaterialHomeMiniOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HomeMiniOutlinedW700Filled'
      short_name='HomeMini'
...
export default IconMaterialHomeMiniOutlinedW700Filled;
