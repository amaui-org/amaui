...
const IconMaterialWorkspacePremiumOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WorkspacePremiumOutlinedFilled'
...
export default IconMaterialWorkspacePremiumOutlinedFilled;
