...
const IconMaterialCallMadeRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CallMadeRoundedW700Filled'
      short_name='CallMade'
...
export default IconMaterialCallMadeRoundedW700Filled;
