...
const IconMaterialBrightness7OutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Brightness7OutlinedFilled'
...
export default IconMaterialBrightness7OutlinedFilled;
