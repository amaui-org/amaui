...
const IconMaterialPasswordSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PasswordSharpFilled'
      short_name='Password'
...
IconMaterialPasswordSharpFilled.displayName = 'AmauiIconMaterialPasswordSharpFilled';

export default IconMaterialPasswordSharpFilled;
