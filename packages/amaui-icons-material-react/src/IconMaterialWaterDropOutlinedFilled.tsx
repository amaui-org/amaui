...
const IconMaterialWaterDropOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WaterDropOutlinedFilled'
...
export default IconMaterialWaterDropOutlinedFilled;
