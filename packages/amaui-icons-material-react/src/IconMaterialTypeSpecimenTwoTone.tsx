...
const IconMaterialTypeSpecimenTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialTypeSpecimenTwoTone.displayName = 'AmauiIconMaterialTypeSpecimenTwoTone';

export default IconMaterialTypeSpecimenTwoTone;
