...
const IconMaterialScheduleSendOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ScheduleSendOutlinedFilled'
...
export default IconMaterialScheduleSendOutlinedFilled;
