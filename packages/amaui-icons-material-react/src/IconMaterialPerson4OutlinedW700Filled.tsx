...
const IconMaterialPerson4OutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Person4OutlinedW700Filled'
      short_name='Person4'
...
export default IconMaterialPerson4OutlinedW700Filled;
