...
const IconMaterialMarkEmailUnreadOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MarkEmailUnreadOutlinedW700Filled'
...
export default IconMaterialMarkEmailUnreadOutlinedW700Filled;
