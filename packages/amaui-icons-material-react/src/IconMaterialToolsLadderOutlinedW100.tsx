...
const IconMaterialToolsLadderOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ToolsLadderOutlinedW100'
...
export default IconMaterialToolsLadderOutlinedW100;
