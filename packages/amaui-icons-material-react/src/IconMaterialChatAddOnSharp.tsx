...
const IconMaterialChatAddOnSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialChatAddOnSharp.displayName = 'AmauiIconMaterialChatAddOnSharp';

export default IconMaterialChatAddOnSharp;
