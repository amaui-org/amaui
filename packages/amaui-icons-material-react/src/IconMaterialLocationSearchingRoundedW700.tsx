...
const IconMaterialLocationSearchingRoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LocationSearchingRoundedW700'
...
export default IconMaterialLocationSearchingRoundedW700;
