...
const IconMaterialPaidTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialPaidTwoTone.displayName = 'AmauiIconMaterialPaidTwoTone';

export default IconMaterialPaidTwoTone;
