...
const IconMaterialTripOriginSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TripOriginSharpW700Filled'
...
export default IconMaterialTripOriginSharpW700Filled;
