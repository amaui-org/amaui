...
const IconMaterialSubjectRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialSubjectRounded.displayName = 'AmauiIconMaterialSubjectRounded';

export default IconMaterialSubjectRounded;
