...
const IconMaterialEmojiPeopleOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='EmojiPeopleOutlinedW100'
...
export default IconMaterialEmojiPeopleOutlinedW100;
