...
const IconMaterialBreakingNewsAlt1OutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BreakingNewsAlt1OutlinedW700Filled'
...
export default IconMaterialBreakingNewsAlt1OutlinedW700Filled;
