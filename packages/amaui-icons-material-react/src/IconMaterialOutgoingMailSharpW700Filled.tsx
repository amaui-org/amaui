...
const IconMaterialOutgoingMailSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='OutgoingMailSharpW700Filled'
...
export default IconMaterialOutgoingMailSharpW700Filled;
