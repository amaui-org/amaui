...
const IconMaterialCleaningServicesOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CleaningServicesOutlinedFilled'
...
export default IconMaterialCleaningServicesOutlinedFilled;
