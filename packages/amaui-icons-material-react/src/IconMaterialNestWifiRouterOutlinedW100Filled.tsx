...
const IconMaterialNestWifiRouterOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestWifiRouterOutlinedW100Filled'
...
export default IconMaterialNestWifiRouterOutlinedW100Filled;
