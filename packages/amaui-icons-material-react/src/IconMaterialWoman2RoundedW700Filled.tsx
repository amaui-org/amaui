...
const IconMaterialWoman2RoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Woman2RoundedW700Filled'
      short_name='Woman2'
...
export default IconMaterialWoman2RoundedW700Filled;
