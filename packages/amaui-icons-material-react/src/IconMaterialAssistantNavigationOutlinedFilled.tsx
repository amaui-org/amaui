...
const IconMaterialAssistantNavigationOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AssistantNavigationOutlinedFilled'
...
export default IconMaterialAssistantNavigationOutlinedFilled;
