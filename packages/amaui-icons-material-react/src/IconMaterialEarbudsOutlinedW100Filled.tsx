...
const IconMaterialEarbudsOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='EarbudsOutlinedW100Filled'
      short_name='Earbuds'
...
export default IconMaterialEarbudsOutlinedW100Filled;
