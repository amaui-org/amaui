...
const IconMaterialAllInclusiveOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AllInclusiveOutlinedW100Filled'
...
export default IconMaterialAllInclusiveOutlinedW100Filled;
