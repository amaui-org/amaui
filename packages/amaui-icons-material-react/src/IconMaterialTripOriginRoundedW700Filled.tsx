...
const IconMaterialTripOriginRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TripOriginRoundedW700Filled'
...
export default IconMaterialTripOriginRoundedW700Filled;
