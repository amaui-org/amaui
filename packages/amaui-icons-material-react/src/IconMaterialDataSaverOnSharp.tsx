...
const IconMaterialDataSaverOnSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialDataSaverOnSharp.displayName = 'AmauiIconMaterialDataSaverOnSharp';

export default IconMaterialDataSaverOnSharp;
