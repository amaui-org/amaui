...
const IconMaterialPersonAddDisabledOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PersonAddDisabledOutlinedFilled'
...
export default IconMaterialPersonAddDisabledOutlinedFilled;
