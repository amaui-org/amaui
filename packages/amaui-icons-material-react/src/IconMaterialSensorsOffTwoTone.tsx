...
const IconMaterialSensorsOffTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialSensorsOffTwoTone.displayName = 'AmauiIconMaterialSensorsOffTwoTone';

export default IconMaterialSensorsOffTwoTone;
