...
const IconMaterialLowPriorityOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LowPriorityOutlinedW700Filled'
...
export default IconMaterialLowPriorityOutlinedW700Filled;
