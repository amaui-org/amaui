...
const IconMaterialHouseSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialHouseSharp.displayName = 'AmauiIconMaterialHouseSharp';

export default IconMaterialHouseSharp;
