...
const IconMaterialClearDaySharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ClearDaySharpW100'
      short_name='ClearDay'
...
IconMaterialClearDaySharpW100.displayName = 'AmauiIconMaterialClearDaySharpW100';

export default IconMaterialClearDaySharpW100;
