...
const IconMaterialAgenderSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AgenderSharpFilled'
      short_name='Agender'
...
IconMaterialAgenderSharpFilled.displayName = 'AmauiIconMaterialAgenderSharpFilled';

export default IconMaterialAgenderSharpFilled;
