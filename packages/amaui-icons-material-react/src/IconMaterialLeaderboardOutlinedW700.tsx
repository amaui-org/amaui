...
const IconMaterialLeaderboardOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LeaderboardOutlinedW700'
...
export default IconMaterialLeaderboardOutlinedW700;
