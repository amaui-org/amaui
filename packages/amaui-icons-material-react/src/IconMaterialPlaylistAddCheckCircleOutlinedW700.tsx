...
const IconMaterialPlaylistAddCheckCircleOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PlaylistAddCheckCircleOutlinedW700'
...
export default IconMaterialPlaylistAddCheckCircleOutlinedW700;
