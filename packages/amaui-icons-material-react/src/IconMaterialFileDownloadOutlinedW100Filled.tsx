...
const IconMaterialFileDownloadOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FileDownloadOutlinedW100Filled'
...
export default IconMaterialFileDownloadOutlinedW100Filled;
