...
const IconMaterialLocalParkingOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LocalParkingOutlinedFilled'
...
export default IconMaterialLocalParkingOutlinedFilled;
