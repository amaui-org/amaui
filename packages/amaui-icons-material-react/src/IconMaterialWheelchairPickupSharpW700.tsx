...
const IconMaterialWheelchairPickupSharpW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WheelchairPickupSharpW700'
...
export default IconMaterialWheelchairPickupSharpW700;
