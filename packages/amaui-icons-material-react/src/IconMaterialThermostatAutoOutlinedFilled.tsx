...
const IconMaterialThermostatAutoOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ThermostatAutoOutlinedFilled'
...
export default IconMaterialThermostatAutoOutlinedFilled;
