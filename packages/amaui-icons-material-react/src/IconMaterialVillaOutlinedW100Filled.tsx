...
const IconMaterialVillaOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='VillaOutlinedW100Filled'
      short_name='Villa'
...
export default IconMaterialVillaOutlinedW100Filled;
