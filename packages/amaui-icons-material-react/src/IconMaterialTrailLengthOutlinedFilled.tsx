...
const IconMaterialTrailLengthOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TrailLengthOutlinedFilled'
...
export default IconMaterialTrailLengthOutlinedFilled;
