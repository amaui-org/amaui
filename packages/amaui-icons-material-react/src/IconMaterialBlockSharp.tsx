...
const IconMaterialBlockSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialBlockSharp.displayName = 'AmauiIconMaterialBlockSharp';

export default IconMaterialBlockSharp;
