...
const IconMaterialShuffleRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ShuffleRoundedW100'
      short_name='Shuffle'
...
IconMaterialShuffleRoundedW100.displayName = 'AmauiIconMaterialShuffleRoundedW100';

export default IconMaterialShuffleRoundedW100;
