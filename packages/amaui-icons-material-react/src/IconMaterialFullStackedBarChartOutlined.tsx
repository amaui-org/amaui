...
const IconMaterialFullStackedBarChartOutlined = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FullStackedBarChartOutlined'
...
export default IconMaterialFullStackedBarChartOutlined;
