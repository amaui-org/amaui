...
const IconMaterialNearbyErrorSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialNearbyErrorSharp.displayName = 'AmauiIconMaterialNearbyErrorSharp';

export default IconMaterialNearbyErrorSharp;
