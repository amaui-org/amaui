...
const IconMaterialConstructionOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ConstructionOutlinedFilled'
...
export default IconMaterialConstructionOutlinedFilled;
