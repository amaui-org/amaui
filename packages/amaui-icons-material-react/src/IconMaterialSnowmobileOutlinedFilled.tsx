...
const IconMaterialSnowmobileOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SnowmobileOutlinedFilled'
...
export default IconMaterialSnowmobileOutlinedFilled;
