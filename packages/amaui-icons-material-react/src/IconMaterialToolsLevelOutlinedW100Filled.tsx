...
const IconMaterialToolsLevelOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ToolsLevelOutlinedW100Filled'
...
export default IconMaterialToolsLevelOutlinedW100Filled;
