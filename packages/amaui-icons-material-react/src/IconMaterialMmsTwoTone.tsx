...
const IconMaterialMmsTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialMmsTwoTone.displayName = 'AmauiIconMaterialMmsTwoTone';

export default IconMaterialMmsTwoTone;
