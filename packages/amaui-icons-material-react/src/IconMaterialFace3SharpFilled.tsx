...
const IconMaterialFace3SharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Face3SharpFilled'
      short_name='Face3'
...
IconMaterialFace3SharpFilled.displayName = 'AmauiIconMaterialFace3SharpFilled';

export default IconMaterialFace3SharpFilled;
