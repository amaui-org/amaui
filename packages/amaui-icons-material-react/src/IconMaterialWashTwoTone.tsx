...
const IconMaterialWashTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialWashTwoTone.displayName = 'AmauiIconMaterialWashTwoTone';

export default IconMaterialWashTwoTone;
