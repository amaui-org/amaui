...
const IconMaterialOtherHousesTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialOtherHousesTwoTone.displayName = 'AmauiIconMaterialOtherHousesTwoTone';

export default IconMaterialOtherHousesTwoTone;
