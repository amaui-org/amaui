...
const IconMaterialBungalowTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialBungalowTwoTone.displayName = 'AmauiIconMaterialBungalowTwoTone';

export default IconMaterialBungalowTwoTone;
