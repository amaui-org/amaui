...
const IconMaterialCookingOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CookingOutlinedW100Filled'
      short_name='Cooking'
...
export default IconMaterialCookingOutlinedW100Filled;
