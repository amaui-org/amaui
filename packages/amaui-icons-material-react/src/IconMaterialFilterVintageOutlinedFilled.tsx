...
const IconMaterialFilterVintageOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FilterVintageOutlinedFilled'
...
export default IconMaterialFilterVintageOutlinedFilled;
