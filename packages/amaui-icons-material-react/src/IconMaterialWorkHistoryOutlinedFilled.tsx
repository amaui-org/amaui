...
const IconMaterialWorkHistoryOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WorkHistoryOutlinedFilled'
...
export default IconMaterialWorkHistoryOutlinedFilled;
