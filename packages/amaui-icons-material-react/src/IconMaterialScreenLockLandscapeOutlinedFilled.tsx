...
const IconMaterialScreenLockLandscapeOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ScreenLockLandscapeOutlinedFilled'
...
export default IconMaterialScreenLockLandscapeOutlinedFilled;
