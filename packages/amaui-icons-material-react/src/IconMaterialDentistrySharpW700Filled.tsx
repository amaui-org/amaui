...
const IconMaterialDentistrySharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DentistrySharpW700Filled'
...
export default IconMaterialDentistrySharpW700Filled;
