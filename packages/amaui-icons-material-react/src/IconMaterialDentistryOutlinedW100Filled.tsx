...
const IconMaterialDentistryOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DentistryOutlinedW100Filled'
...
export default IconMaterialDentistryOutlinedW100Filled;
