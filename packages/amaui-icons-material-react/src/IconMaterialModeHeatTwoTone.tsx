...
const IconMaterialModeHeatTwoTone = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ModeHeatTwoTone'
      short_name='ModeHeat'
...
IconMaterialModeHeatTwoTone.displayName = 'AmauiIconMaterialModeHeatTwoTone';

export default IconMaterialModeHeatTwoTone;
