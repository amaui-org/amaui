...
const IconMaterialToysFanOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ToysFanOutlinedW700Filled'
      short_name='ToysFan'
...
export default IconMaterialToysFanOutlinedW700Filled;
