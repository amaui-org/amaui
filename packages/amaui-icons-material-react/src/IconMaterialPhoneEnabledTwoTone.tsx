...
const IconMaterialPhoneEnabledTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialPhoneEnabledTwoTone.displayName = 'AmauiIconMaterialPhoneEnabledTwoTone';

export default IconMaterialPhoneEnabledTwoTone;
