...
const IconMaterialGridOnOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='GridOnOutlinedW100Filled'
      short_name='GridOn'
...
export default IconMaterialGridOnOutlinedW100Filled;
