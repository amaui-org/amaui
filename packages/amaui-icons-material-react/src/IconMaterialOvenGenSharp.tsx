...
const IconMaterialOvenGenSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialOvenGenSharp.displayName = 'AmauiIconMaterialOvenGenSharp';

export default IconMaterialOvenGenSharp;
