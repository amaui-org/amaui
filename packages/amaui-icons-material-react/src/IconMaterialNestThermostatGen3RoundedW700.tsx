...
const IconMaterialNestThermostatGen3RoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestThermostatGen3RoundedW700'
...
export default IconMaterialNestThermostatGen3RoundedW700;
