...
const IconMaterialZoomOutMapOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ZoomOutMapOutlinedFilled'
...
export default IconMaterialZoomOutMapOutlinedFilled;
