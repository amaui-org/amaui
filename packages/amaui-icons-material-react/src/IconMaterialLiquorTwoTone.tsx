...
const IconMaterialLiquorTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialLiquorTwoTone.displayName = 'AmauiIconMaterialLiquorTwoTone';

export default IconMaterialLiquorTwoTone;
