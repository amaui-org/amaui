...
const IconMaterialQueueMusicOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='QueueMusicOutlinedW100Filled'
...
export default IconMaterialQueueMusicOutlinedW100Filled;
