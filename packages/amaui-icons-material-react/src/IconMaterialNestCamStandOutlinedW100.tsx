...
const IconMaterialNestCamStandOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestCamStandOutlinedW100'
...
export default IconMaterialNestCamStandOutlinedW100;
