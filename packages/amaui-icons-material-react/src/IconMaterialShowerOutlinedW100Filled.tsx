...
const IconMaterialShowerOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ShowerOutlinedW100Filled'
      short_name='Shower'
...
export default IconMaterialShowerOutlinedW100Filled;
