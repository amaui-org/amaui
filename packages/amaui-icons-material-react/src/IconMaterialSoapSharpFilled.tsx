...
const IconMaterialSoapSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SoapSharpFilled'
      short_name='Soap'
...
IconMaterialSoapSharpFilled.displayName = 'AmauiIconMaterialSoapSharpFilled';

export default IconMaterialSoapSharpFilled;
