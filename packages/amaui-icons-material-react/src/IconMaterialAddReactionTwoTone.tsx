...
const IconMaterialAddReactionTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialAddReactionTwoTone.displayName = 'AmauiIconMaterialAddReactionTwoTone';

export default IconMaterialAddReactionTwoTone;
