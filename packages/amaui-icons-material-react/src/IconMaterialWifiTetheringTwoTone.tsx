...
const IconMaterialWifiTetheringTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialWifiTetheringTwoTone.displayName = 'AmauiIconMaterialWifiTetheringTwoTone';

export default IconMaterialWifiTetheringTwoTone;
