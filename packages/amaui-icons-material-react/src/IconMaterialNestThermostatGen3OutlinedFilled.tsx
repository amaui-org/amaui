...
const IconMaterialNestThermostatGen3OutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestThermostatGen3OutlinedFilled'
...
export default IconMaterialNestThermostatGen3OutlinedFilled;
