...
const IconMaterialDiversity3OutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Diversity3OutlinedW100Filled'
...
export default IconMaterialDiversity3OutlinedW100Filled;
