...
const IconMaterialAirSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialAirSharp.displayName = 'AmauiIconMaterialAirSharp';

export default IconMaterialAirSharp;
