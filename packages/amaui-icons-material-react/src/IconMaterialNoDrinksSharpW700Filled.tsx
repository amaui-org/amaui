...
const IconMaterialNoDrinksSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NoDrinksSharpW700Filled'
      short_name='NoDrinks'
...
export default IconMaterialNoDrinksSharpW700Filled;
