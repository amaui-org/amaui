...
const IconMaterialScoreTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialScoreTwoTone.displayName = 'AmauiIconMaterialScoreTwoTone';

export default IconMaterialScoreTwoTone;
