...
const IconMaterialAcUnitOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AcUnitOutlinedW100Filled'
      short_name='AcUnit'
...
export default IconMaterialAcUnitOutlinedW100Filled;
