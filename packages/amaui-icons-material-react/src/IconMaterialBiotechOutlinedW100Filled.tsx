...
const IconMaterialBiotechOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BiotechOutlinedW100Filled'
      short_name='Biotech'
...
export default IconMaterialBiotechOutlinedW100Filled;
