...
const IconMaterialSoundDetectionLoudSoundOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SoundDetectionLoudSoundOutlinedW100'
...
export default IconMaterialSoundDetectionLoudSoundOutlinedW100;
