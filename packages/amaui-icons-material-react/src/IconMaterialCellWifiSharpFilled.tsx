...
const IconMaterialCellWifiSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CellWifiSharpFilled'
      short_name='CellWifi'
...
IconMaterialCellWifiSharpFilled.displayName = 'AmauiIconMaterialCellWifiSharpFilled';

export default IconMaterialCellWifiSharpFilled;
