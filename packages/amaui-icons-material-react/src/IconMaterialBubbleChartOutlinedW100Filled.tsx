...
const IconMaterialBubbleChartOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BubbleChartOutlinedW100Filled'
...
export default IconMaterialBubbleChartOutlinedW100Filled;
