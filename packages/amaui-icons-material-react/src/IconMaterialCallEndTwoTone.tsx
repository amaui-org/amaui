...
const IconMaterialCallEndTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialCallEndTwoTone.displayName = 'AmauiIconMaterialCallEndTwoTone';

export default IconMaterialCallEndTwoTone;
