...
const IconMaterialContentPasteOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ContentPasteOutlinedW700'
...
export default IconMaterialContentPasteOutlinedW700;
