...
const IconMaterialToolsLevelOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ToolsLevelOutlinedW700Filled'
...
export default IconMaterialToolsLevelOutlinedW700Filled;
