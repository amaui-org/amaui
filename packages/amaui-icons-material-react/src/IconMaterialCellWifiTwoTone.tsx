...
const IconMaterialCellWifiTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialCellWifiTwoTone.displayName = 'AmauiIconMaterialCellWifiTwoTone';

export default IconMaterialCellWifiTwoTone;
