...
const IconMaterialFlareSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FlareSharpFilled'
      short_name='Flare'
...
IconMaterialFlareSharpFilled.displayName = 'AmauiIconMaterialFlareSharpFilled';

export default IconMaterialFlareSharpFilled;
