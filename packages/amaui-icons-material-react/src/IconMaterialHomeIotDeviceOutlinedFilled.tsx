...
const IconMaterialHomeIotDeviceOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HomeIotDeviceOutlinedFilled'
...
export default IconMaterialHomeIotDeviceOutlinedFilled;
