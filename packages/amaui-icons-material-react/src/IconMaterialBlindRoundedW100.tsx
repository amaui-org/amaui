...
const IconMaterialBlindRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BlindRoundedW100'
      short_name='Blind'
...
IconMaterialBlindRoundedW100.displayName = 'AmauiIconMaterialBlindRoundedW100';

export default IconMaterialBlindRoundedW100;
