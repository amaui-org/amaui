...
const IconMaterialFireHydrantOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FireHydrantOutlinedFilled'
...
export default IconMaterialFireHydrantOutlinedFilled;
