...
const IconMaterialGooglePlusReshareOutlined = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='GooglePlusReshareOutlined'
...
export default IconMaterialGooglePlusReshareOutlined;
