...
const IconMaterialWebRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialWebRounded.displayName = 'AmauiIconMaterialWebRounded';

export default IconMaterialWebRounded;
