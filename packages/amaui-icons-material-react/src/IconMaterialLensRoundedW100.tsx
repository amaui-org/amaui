...
const IconMaterialLensRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LensRoundedW100'
      short_name='Lens'
...
IconMaterialLensRoundedW100.displayName = 'AmauiIconMaterialLensRoundedW100';

export default IconMaterialLensRoundedW100;
