...
const IconMaterialDatasetOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DatasetOutlinedW100Filled'
      short_name='Dataset'
...
export default IconMaterialDatasetOutlinedW100Filled;
