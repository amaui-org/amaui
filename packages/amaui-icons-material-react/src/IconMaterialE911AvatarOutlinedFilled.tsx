...
const IconMaterialE911AvatarOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='E911AvatarOutlinedFilled'
...
export default IconMaterialE911AvatarOutlinedFilled;
