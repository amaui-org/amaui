...
const IconMaterialControlPointDuplicateSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ControlPointDuplicateSharpW700Filled'
...
export default IconMaterialControlPointDuplicateSharpW700Filled;
