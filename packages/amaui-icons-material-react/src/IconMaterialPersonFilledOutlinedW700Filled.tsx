...
const IconMaterialPersonFilledOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PersonFilledOutlinedW700Filled'
...
export default IconMaterialPersonFilledOutlinedW700Filled;
