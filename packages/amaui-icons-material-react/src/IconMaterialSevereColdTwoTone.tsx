...
const IconMaterialSevereColdTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialSevereColdTwoTone.displayName = 'AmauiIconMaterialSevereColdTwoTone';

export default IconMaterialSevereColdTwoTone;
