...
const IconMaterialHomeSpeakerOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HomeSpeakerOutlinedFilled'
...
export default IconMaterialHomeSpeakerOutlinedFilled;
