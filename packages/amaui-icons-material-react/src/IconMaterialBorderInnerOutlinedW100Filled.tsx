...
const IconMaterialBorderInnerOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BorderInnerOutlinedW100Filled'
...
export default IconMaterialBorderInnerOutlinedW100Filled;
