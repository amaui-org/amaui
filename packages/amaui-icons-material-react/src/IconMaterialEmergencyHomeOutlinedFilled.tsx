...
const IconMaterialEmergencyHomeOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='EmergencyHomeOutlinedFilled'
...
export default IconMaterialEmergencyHomeOutlinedFilled;
