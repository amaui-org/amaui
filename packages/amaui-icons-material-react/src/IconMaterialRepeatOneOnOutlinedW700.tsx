...
const IconMaterialRepeatOneOnOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RepeatOneOnOutlinedW700'
...
export default IconMaterialRepeatOneOnOutlinedW700;
