...
const IconMaterialNestTagSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialNestTagSharp.displayName = 'AmauiIconMaterialNestTagSharp';

export default IconMaterialNestTagSharp;
