...
const IconMaterialCalendarTodayOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CalendarTodayOutlinedW100'
...
export default IconMaterialCalendarTodayOutlinedW100;
