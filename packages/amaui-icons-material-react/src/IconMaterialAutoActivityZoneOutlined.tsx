...
const IconMaterialAutoActivityZoneOutlined = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AutoActivityZoneOutlined'
...
export default IconMaterialAutoActivityZoneOutlined;
