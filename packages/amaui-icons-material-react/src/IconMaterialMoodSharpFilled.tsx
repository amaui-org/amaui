...
const IconMaterialMoodSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MoodSharpFilled'
      short_name='Mood'
...
IconMaterialMoodSharpFilled.displayName = 'AmauiIconMaterialMoodSharpFilled';

export default IconMaterialMoodSharpFilled;
