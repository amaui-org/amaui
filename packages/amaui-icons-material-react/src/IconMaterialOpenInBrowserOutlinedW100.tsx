...
const IconMaterialOpenInBrowserOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='OpenInBrowserOutlinedW100'
...
export default IconMaterialOpenInBrowserOutlinedW100;
