...
const IconMaterialNoDrinksTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialNoDrinksTwoTone.displayName = 'AmauiIconMaterialNoDrinksTwoTone';

export default IconMaterialNoDrinksTwoTone;
