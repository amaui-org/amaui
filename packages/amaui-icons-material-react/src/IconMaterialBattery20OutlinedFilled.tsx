...
const IconMaterialBattery20OutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Battery20OutlinedFilled'
...
export default IconMaterialBattery20OutlinedFilled;
