...
const IconMaterialRMobiledataOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RMobiledataOutlinedFilled'
...
export default IconMaterialRMobiledataOutlinedFilled;
