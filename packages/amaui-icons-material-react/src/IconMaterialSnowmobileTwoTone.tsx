...
const IconMaterialSnowmobileTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialSnowmobileTwoTone.displayName = 'AmauiIconMaterialSnowmobileTwoTone';

export default IconMaterialSnowmobileTwoTone;
