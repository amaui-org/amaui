...
const IconMaterialDetectorStatusOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DetectorStatusOutlinedW100'
...
export default IconMaterialDetectorStatusOutlinedW100;
