...
const IconMaterialFlipCameraAndroidOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FlipCameraAndroidOutlinedFilled'
...
export default IconMaterialFlipCameraAndroidOutlinedFilled;
