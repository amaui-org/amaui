...
const IconMaterialEscalatorOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='EscalatorOutlinedW100Filled'
...
export default IconMaterialEscalatorOutlinedW100Filled;
