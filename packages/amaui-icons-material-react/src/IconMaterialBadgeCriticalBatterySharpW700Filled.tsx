...
const IconMaterialBadgeCriticalBatterySharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BadgeCriticalBatterySharpW700Filled'
...
export default IconMaterialBadgeCriticalBatterySharpW700Filled;
