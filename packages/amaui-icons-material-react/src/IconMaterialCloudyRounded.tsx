...
const IconMaterialCloudyRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialCloudyRounded.displayName = 'AmauiIconMaterialCloudyRounded';

export default IconMaterialCloudyRounded;
