...
const IconMaterialCircleRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CircleRoundedW700Filled'
      short_name='Circle'
...
export default IconMaterialCircleRoundedW700Filled;
