...
const IconMaterialFilter7Rounded = React.forwardRef((props: any, ref) => {
...
IconMaterialFilter7Rounded.displayName = 'AmauiIconMaterialFilter7Rounded';

export default IconMaterialFilter7Rounded;
