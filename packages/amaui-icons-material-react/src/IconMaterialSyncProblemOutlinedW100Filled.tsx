...
const IconMaterialSyncProblemOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SyncProblemOutlinedW100Filled'
...
export default IconMaterialSyncProblemOutlinedW100Filled;
