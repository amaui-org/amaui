...
const IconMaterialCabinOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CabinOutlinedW100Filled'
      short_name='Cabin'
...
export default IconMaterialCabinOutlinedW100Filled;
