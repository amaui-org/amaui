...
const IconMaterialArrowDropDownCircleSharpW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ArrowDropDownCircleSharpW700'
...
export default IconMaterialArrowDropDownCircleSharpW700;
