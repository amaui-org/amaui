...
const IconMaterialSettingsVoiceTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialSettingsVoiceTwoTone.displayName = 'AmauiIconMaterialSettingsVoiceTwoTone';

export default IconMaterialSettingsVoiceTwoTone;
