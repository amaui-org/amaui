...
const IconMaterialNotificationsPausedOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NotificationsPausedOutlinedW700Filled'
...
export default IconMaterialNotificationsPausedOutlinedW700Filled;
