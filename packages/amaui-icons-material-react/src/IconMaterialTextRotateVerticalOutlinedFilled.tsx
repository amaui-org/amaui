...
const IconMaterialTextRotateVerticalOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TextRotateVerticalOutlinedFilled'
...
export default IconMaterialTextRotateVerticalOutlinedFilled;
