...
const IconMaterialFlightTakeoffOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FlightTakeoffOutlinedW100'
...
export default IconMaterialFlightTakeoffOutlinedW100;
