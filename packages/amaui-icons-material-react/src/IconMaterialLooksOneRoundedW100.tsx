...
const IconMaterialLooksOneRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LooksOneRoundedW100'
      short_name='LooksOne'
...
IconMaterialLooksOneRoundedW100.displayName = 'AmauiIconMaterialLooksOneRoundedW100';

export default IconMaterialLooksOneRoundedW100;
