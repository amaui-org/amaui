...
const IconMaterialFormatClearOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FormatClearOutlinedW100'
...
export default IconMaterialFormatClearOutlinedW100;
