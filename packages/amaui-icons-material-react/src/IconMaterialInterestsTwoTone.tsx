...
const IconMaterialInterestsTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialInterestsTwoTone.displayName = 'AmauiIconMaterialInterestsTwoTone';

export default IconMaterialInterestsTwoTone;
