...
const IconMaterialEmojiFlagsTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialEmojiFlagsTwoTone.displayName = 'AmauiIconMaterialEmojiFlagsTwoTone';

export default IconMaterialEmojiFlagsTwoTone;
