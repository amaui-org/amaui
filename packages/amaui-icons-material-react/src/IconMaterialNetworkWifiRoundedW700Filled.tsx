...
const IconMaterialNetworkWifiRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NetworkWifiRoundedW700Filled'
...
export default IconMaterialNetworkWifiRoundedW700Filled;
