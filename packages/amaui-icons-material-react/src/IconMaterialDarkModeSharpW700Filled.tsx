...
const IconMaterialDarkModeSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DarkModeSharpW700Filled'
      short_name='DarkMode'
...
export default IconMaterialDarkModeSharpW700Filled;
