...
const IconMaterial21mpTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterial21mpTwoTone.displayName = 'AmauiIconMaterial21mpTwoTone';

export default IconMaterial21mpTwoTone;
