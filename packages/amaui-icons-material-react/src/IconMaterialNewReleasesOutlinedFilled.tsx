...
const IconMaterialNewReleasesOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NewReleasesOutlinedFilled'
...
export default IconMaterialNewReleasesOutlinedFilled;
