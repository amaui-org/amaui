...
const IconMaterialBattery50RoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Battery50RoundedW700Filled'
...
export default IconMaterialBattery50RoundedW700Filled;
