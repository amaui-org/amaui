...
const IconMaterialPasswordSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PasswordSharpW700Filled'
      short_name='Password'
...
export default IconMaterialPasswordSharpW700Filled;
