...
const IconMaterialHeartMinusOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HeartMinusOutlinedW700Filled'
...
export default IconMaterialHeartMinusOutlinedW700Filled;
