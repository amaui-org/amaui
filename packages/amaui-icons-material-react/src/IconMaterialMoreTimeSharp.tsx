...
const IconMaterialMoreTimeSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialMoreTimeSharp.displayName = 'AmauiIconMaterialMoreTimeSharp';

export default IconMaterialMoreTimeSharp;
