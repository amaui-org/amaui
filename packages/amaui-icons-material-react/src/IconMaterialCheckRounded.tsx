...
const IconMaterialCheckRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialCheckRounded.displayName = 'AmauiIconMaterialCheckRounded';

export default IconMaterialCheckRounded;
