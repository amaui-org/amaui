...
const IconMaterialPhotoCameraFrontOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PhotoCameraFrontOutlinedW100Filled'
...
export default IconMaterialPhotoCameraFrontOutlinedW100Filled;
