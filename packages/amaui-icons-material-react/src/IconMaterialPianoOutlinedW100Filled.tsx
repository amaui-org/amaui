...
const IconMaterialPianoOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PianoOutlinedW100Filled'
      short_name='Piano'
...
export default IconMaterialPianoOutlinedW100Filled;
