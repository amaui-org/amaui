...
const IconMaterialReceiptTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialReceiptTwoTone.displayName = 'AmauiIconMaterialReceiptTwoTone';

export default IconMaterialReceiptTwoTone;
