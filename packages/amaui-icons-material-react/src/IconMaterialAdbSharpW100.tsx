...
const IconMaterialAdbSharpW100 = React.forwardRef((props: any, ref) => {
...
IconMaterialAdbSharpW100.displayName = 'AmauiIconMaterialAdbSharpW100';

export default IconMaterialAdbSharpW100;
