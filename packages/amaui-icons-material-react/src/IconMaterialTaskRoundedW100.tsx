...
const IconMaterialTaskRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TaskRoundedW100'
      short_name='Task'
...
IconMaterialTaskRoundedW100.displayName = 'AmauiIconMaterialTaskRoundedW100';

export default IconMaterialTaskRoundedW100;
