...
const IconMaterialReviewsTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialReviewsTwoTone.displayName = 'AmauiIconMaterialReviewsTwoTone';

export default IconMaterialReviewsTwoTone;
