...
const IconMaterialRangeHoodSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RangeHoodSharpW700Filled'
...
export default IconMaterialRangeHoodSharpW700Filled;
