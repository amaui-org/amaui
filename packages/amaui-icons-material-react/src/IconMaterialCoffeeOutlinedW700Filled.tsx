...
const IconMaterialCoffeeOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CoffeeOutlinedW700Filled'
      short_name='Coffee'
...
export default IconMaterialCoffeeOutlinedW700Filled;
