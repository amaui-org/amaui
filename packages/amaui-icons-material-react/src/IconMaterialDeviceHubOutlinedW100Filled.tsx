...
const IconMaterialDeviceHubOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DeviceHubOutlinedW100Filled'
...
export default IconMaterialDeviceHubOutlinedW100Filled;
