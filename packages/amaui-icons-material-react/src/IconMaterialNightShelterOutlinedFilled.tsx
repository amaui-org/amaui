...
const IconMaterialNightShelterOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NightShelterOutlinedFilled'
...
export default IconMaterialNightShelterOutlinedFilled;
