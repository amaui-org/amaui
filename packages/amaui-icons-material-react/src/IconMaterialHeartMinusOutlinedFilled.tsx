...
const IconMaterialHeartMinusOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HeartMinusOutlinedFilled'
...
export default IconMaterialHeartMinusOutlinedFilled;
