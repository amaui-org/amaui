...
const IconMaterialLocalShippingOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LocalShippingOutlinedFilled'
...
export default IconMaterialLocalShippingOutlinedFilled;
