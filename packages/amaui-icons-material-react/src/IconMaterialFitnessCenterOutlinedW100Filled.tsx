...
const IconMaterialFitnessCenterOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FitnessCenterOutlinedW100Filled'
...
export default IconMaterialFitnessCenterOutlinedW100Filled;
