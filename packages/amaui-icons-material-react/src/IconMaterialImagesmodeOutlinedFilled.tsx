...
const IconMaterialImagesmodeOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ImagesmodeOutlinedFilled'
...
export default IconMaterialImagesmodeOutlinedFilled;
