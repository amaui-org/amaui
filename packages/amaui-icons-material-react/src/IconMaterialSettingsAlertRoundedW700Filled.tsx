...
const IconMaterialSettingsAlertRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SettingsAlertRoundedW700Filled'
...
export default IconMaterialSettingsAlertRoundedW700Filled;
