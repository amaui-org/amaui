...
const IconMaterialBatteryUnknownOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryUnknownOutlinedFilled'
...
export default IconMaterialBatteryUnknownOutlinedFilled;
