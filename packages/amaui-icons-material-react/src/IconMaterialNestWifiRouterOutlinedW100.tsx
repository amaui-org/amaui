...
const IconMaterialNestWifiRouterOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestWifiRouterOutlinedW100'
...
export default IconMaterialNestWifiRouterOutlinedW100;
