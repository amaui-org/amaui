...
const IconMaterialWbIridescentSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WbIridescentSharpW700Filled'
...
export default IconMaterialWbIridescentSharpW700Filled;
