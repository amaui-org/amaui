...
const IconMaterialVerticalSplitSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='VerticalSplitSharpW700Filled'
...
export default IconMaterialVerticalSplitSharpW700Filled;
