...
const IconMaterialHikingSharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HikingSharpW100'
      short_name='Hiking'
...
IconMaterialHikingSharpW100.displayName = 'AmauiIconMaterialHikingSharpW100';

export default IconMaterialHikingSharpW100;
