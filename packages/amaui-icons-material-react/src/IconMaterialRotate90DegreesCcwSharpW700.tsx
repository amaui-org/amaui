...
const IconMaterialRotate90DegreesCcwSharpW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Rotate90DegreesCcwSharpW700'
...
export default IconMaterialRotate90DegreesCcwSharpW700;
