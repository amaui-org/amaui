...
const IconMaterialVapingRoomsTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialVapingRoomsTwoTone.displayName = 'AmauiIconMaterialVapingRoomsTwoTone';

export default IconMaterialVapingRoomsTwoTone;
