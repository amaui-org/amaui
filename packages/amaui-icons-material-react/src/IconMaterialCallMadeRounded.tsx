...
const IconMaterialCallMadeRounded = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CallMadeRounded'
      short_name='CallMade'
...
IconMaterialCallMadeRounded.displayName = 'AmauiIconMaterialCallMadeRounded';

export default IconMaterialCallMadeRounded;
