...
const IconMaterialAirlineStopsOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AirlineStopsOutlinedW100Filled'
...
export default IconMaterialAirlineStopsOutlinedW100Filled;
