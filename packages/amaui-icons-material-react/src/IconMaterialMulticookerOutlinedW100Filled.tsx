...
const IconMaterialMulticookerOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MulticookerOutlinedW100Filled'
...
export default IconMaterialMulticookerOutlinedW100Filled;
