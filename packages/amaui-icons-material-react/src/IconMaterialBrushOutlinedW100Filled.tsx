...
const IconMaterialBrushOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BrushOutlinedW100Filled'
      short_name='Brush'
...
export default IconMaterialBrushOutlinedW100Filled;
