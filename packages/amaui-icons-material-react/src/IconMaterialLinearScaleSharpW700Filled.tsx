...
const IconMaterialLinearScaleSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LinearScaleSharpW700Filled'
...
export default IconMaterialLinearScaleSharpW700Filled;
