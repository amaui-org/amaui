...
const IconMaterialDeviceThermostatOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DeviceThermostatOutlinedW100'
...
export default IconMaterialDeviceThermostatOutlinedW100;
