...
const IconMaterialSportsBaseballOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SportsBaseballOutlinedFilled'
...
export default IconMaterialSportsBaseballOutlinedFilled;
