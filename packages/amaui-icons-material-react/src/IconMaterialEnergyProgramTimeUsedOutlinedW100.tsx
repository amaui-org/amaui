...
const IconMaterialEnergyProgramTimeUsedOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='EnergyProgramTimeUsedOutlinedW100'
...
export default IconMaterialEnergyProgramTimeUsedOutlinedW100;
