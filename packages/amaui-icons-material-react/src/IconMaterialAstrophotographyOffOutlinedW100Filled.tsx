...
const IconMaterialAstrophotographyOffOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AstrophotographyOffOutlinedW100Filled'
...
export default IconMaterialAstrophotographyOffOutlinedW100Filled;
