...
const IconMaterialUlnaRadiusAltRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='UlnaRadiusAltRoundedW700Filled'
...
export default IconMaterialUlnaRadiusAltRoundedW700Filled;
