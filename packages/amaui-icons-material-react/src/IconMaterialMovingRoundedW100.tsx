...
const IconMaterialMovingRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MovingRoundedW100'
      short_name='Moving'
...
IconMaterialMovingRoundedW100.displayName = 'AmauiIconMaterialMovingRoundedW100';

export default IconMaterialMovingRoundedW100;
