...
const IconMaterialVapingRoomsOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='VapingRoomsOutlinedFilled'
...
export default IconMaterialVapingRoomsOutlinedFilled;
