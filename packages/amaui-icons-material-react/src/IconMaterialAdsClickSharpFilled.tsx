...
const IconMaterialAdsClickSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AdsClickSharpFilled'
      short_name='AdsClick'
...
IconMaterialAdsClickSharpFilled.displayName = 'AmauiIconMaterialAdsClickSharpFilled';

export default IconMaterialAdsClickSharpFilled;
