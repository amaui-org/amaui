...
const IconMaterialBatteryCharging30Outlined = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryCharging30Outlined'
...
export default IconMaterialBatteryCharging30Outlined;
