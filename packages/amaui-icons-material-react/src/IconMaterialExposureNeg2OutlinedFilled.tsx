...
const IconMaterialExposureNeg2OutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ExposureNeg2OutlinedFilled'
...
export default IconMaterialExposureNeg2OutlinedFilled;
