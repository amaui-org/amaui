...
const IconMaterialContentPasteOffOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ContentPasteOffOutlinedW700'
...
export default IconMaterialContentPasteOffOutlinedW700;
