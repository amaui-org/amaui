...
const IconMaterialPublicOffTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialPublicOffTwoTone.displayName = 'AmauiIconMaterialPublicOffTwoTone';

export default IconMaterialPublicOffTwoTone;
