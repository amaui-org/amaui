...
const IconMaterialCachedSharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CachedSharpW100'
      short_name='Cached'
...
IconMaterialCachedSharpW100.displayName = 'AmauiIconMaterialCachedSharpW100';

export default IconMaterialCachedSharpW100;
