...
const IconMaterialOpenInNewOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='OpenInNewOutlinedFilled'
...
export default IconMaterialOpenInNewOutlinedFilled;
