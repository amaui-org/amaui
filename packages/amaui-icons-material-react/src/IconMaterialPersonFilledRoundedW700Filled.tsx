...
const IconMaterialPersonFilledRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PersonFilledRoundedW700Filled'
...
export default IconMaterialPersonFilledRoundedW700Filled;
