...
const IconMaterialCalendarAddOnOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CalendarAddOnOutlinedW100'
...
export default IconMaterialCalendarAddOnOutlinedW100;
