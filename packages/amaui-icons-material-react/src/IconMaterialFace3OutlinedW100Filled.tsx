...
const IconMaterialFace3OutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Face3OutlinedW100Filled'
      short_name='Face3'
...
export default IconMaterialFace3OutlinedW100Filled;
