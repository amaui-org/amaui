...
const IconMaterialRepeatOnOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RepeatOnOutlinedW700Filled'
      short_name='RepeatOn'
...
export default IconMaterialRepeatOnOutlinedW700Filled;
