...
const IconMaterialZonePersonUrgentOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ZonePersonUrgentOutlinedW100'
...
export default IconMaterialZonePersonUrgentOutlinedW100;
