...
const IconMaterialNoiseControlOffOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NoiseControlOffOutlinedFilled'
...
export default IconMaterialNoiseControlOffOutlinedFilled;
