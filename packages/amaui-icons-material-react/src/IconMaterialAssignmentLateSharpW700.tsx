...
const IconMaterialAssignmentLateSharpW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AssignmentLateSharpW700'
...
export default IconMaterialAssignmentLateSharpW700;
