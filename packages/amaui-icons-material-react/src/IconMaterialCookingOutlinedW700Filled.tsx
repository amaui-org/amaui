...
const IconMaterialCookingOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CookingOutlinedW700Filled'
      short_name='Cooking'
...
export default IconMaterialCookingOutlinedW700Filled;
