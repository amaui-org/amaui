...
const IconMaterialSubwayOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SubwayOutlinedW100Filled'
      short_name='Subway'
...
export default IconMaterialSubwayOutlinedW100Filled;
