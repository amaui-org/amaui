...
const IconMaterialDataUsageOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DataUsageOutlinedW100Filled'
...
export default IconMaterialDataUsageOutlinedW100Filled;
