...
const IconMaterialEditAttributesOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='EditAttributesOutlinedFilled'
...
export default IconMaterialEditAttributesOutlinedFilled;
