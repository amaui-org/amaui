...
const IconMaterialMonitorWeightOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MonitorWeightOutlinedW700'
...
export default IconMaterialMonitorWeightOutlinedW700;
