...
const IconMaterialRestartAltTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialRestartAltTwoTone.displayName = 'AmauiIconMaterialRestartAltTwoTone';

export default IconMaterialRestartAltTwoTone;
