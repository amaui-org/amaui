...
const IconMaterialFlightRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialFlightRounded.displayName = 'AmauiIconMaterialFlightRounded';

export default IconMaterialFlightRounded;
