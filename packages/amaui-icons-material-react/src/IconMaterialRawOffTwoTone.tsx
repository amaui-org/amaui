...
const IconMaterialRawOffTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialRawOffTwoTone.displayName = 'AmauiIconMaterialRawOffTwoTone';

export default IconMaterialRawOffTwoTone;
