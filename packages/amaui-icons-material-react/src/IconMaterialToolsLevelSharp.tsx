...
const IconMaterialToolsLevelSharp = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ToolsLevelSharp'
...
IconMaterialToolsLevelSharp.displayName = 'AmauiIconMaterialToolsLevelSharp';

export default IconMaterialToolsLevelSharp;
