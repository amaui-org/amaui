...
const IconMaterialWineBarOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WineBarOutlinedW100Filled'
      short_name='WineBar'
...
export default IconMaterialWineBarOutlinedW100Filled;
