...
const IconMaterialDetectorBatterySharpW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DetectorBatterySharpW700'
...
export default IconMaterialDetectorBatterySharpW700;
