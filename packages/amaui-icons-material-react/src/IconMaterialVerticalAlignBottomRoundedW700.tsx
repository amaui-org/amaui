...
const IconMaterialVerticalAlignBottomRoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='VerticalAlignBottomRoundedW700'
...
export default IconMaterialVerticalAlignBottomRoundedW700;
