...
const IconMaterialLaundryOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LaundryOutlinedW100Filled'
      short_name='Laundry'
...
export default IconMaterialLaundryOutlinedW100Filled;
