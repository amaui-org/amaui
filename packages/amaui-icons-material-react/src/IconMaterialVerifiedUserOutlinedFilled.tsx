...
const IconMaterialVerifiedUserOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='VerifiedUserOutlinedFilled'
...
export default IconMaterialVerifiedUserOutlinedFilled;
