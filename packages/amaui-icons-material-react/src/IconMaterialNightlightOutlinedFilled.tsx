...
const IconMaterialNightlightOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NightlightOutlinedFilled'
...
export default IconMaterialNightlightOutlinedFilled;
