...
const IconMaterialLocalMallTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialLocalMallTwoTone.displayName = 'AmauiIconMaterialLocalMallTwoTone';

export default IconMaterialLocalMallTwoTone;
