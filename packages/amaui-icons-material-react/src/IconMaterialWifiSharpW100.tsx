...
const IconMaterialWifiSharpW100 = React.forwardRef((props: any, ref) => {
...
IconMaterialWifiSharpW100.displayName = 'AmauiIconMaterialWifiSharpW100';

export default IconMaterialWifiSharpW100;
