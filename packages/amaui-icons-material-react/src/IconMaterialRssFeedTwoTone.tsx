...
const IconMaterialRssFeedTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialRssFeedTwoTone.displayName = 'AmauiIconMaterialRssFeedTwoTone';

export default IconMaterialRssFeedTwoTone;
