...
const IconMaterialHdrOnSelectOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HdrOnSelectOutlinedFilled'
...
export default IconMaterialHdrOnSelectOutlinedFilled;
