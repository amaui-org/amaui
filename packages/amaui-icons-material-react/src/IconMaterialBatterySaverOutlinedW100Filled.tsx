...
const IconMaterialBatterySaverOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatterySaverOutlinedW100Filled'
...
export default IconMaterialBatterySaverOutlinedW100Filled;
