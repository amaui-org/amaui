...
const IconMaterialToolsPhillipsOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ToolsPhillipsOutlinedW700'
...
export default IconMaterialToolsPhillipsOutlinedW700;
