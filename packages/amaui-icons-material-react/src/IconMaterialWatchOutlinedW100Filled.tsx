...
const IconMaterialWatchOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WatchOutlinedW100Filled'
      short_name='Watch'
...
export default IconMaterialWatchOutlinedW100Filled;
