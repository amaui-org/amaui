...
const IconMaterialAssistWalkerTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialAssistWalkerTwoTone.displayName = 'AmauiIconMaterialAssistWalkerTwoTone';

export default IconMaterialAssistWalkerTwoTone;
