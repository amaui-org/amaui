...
const IconMaterialArmingCountdownOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ArmingCountdownOutlinedW100'
...
export default IconMaterialArmingCountdownOutlinedW100;
