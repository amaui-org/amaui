...
const IconMaterialVolumeUpOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='VolumeUpOutlinedW700Filled'
      short_name='VolumeUp'
...
export default IconMaterialVolumeUpOutlinedW700Filled;
