...
const IconMaterialGoogleWifiOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='GoogleWifiOutlinedW100Filled'
...
export default IconMaterialGoogleWifiOutlinedW100Filled;
