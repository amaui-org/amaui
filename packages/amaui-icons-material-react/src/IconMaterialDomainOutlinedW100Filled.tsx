...
const IconMaterialDomainOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DomainOutlinedW100Filled'
      short_name='Domain'
...
export default IconMaterialDomainOutlinedW100Filled;
