...
const IconMaterialShieldWithHeartOutlined = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ShieldWithHeartOutlined'
...
export default IconMaterialShieldWithHeartOutlined;
