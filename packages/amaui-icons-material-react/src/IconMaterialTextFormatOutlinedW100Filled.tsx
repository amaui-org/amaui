...
const IconMaterialTextFormatOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TextFormatOutlinedW100Filled'
...
export default IconMaterialTextFormatOutlinedW100Filled;
