...
const IconMaterialArrowUpwardRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialArrowUpwardRounded.displayName = 'AmauiIconMaterialArrowUpwardRounded';

export default IconMaterialArrowUpwardRounded;
