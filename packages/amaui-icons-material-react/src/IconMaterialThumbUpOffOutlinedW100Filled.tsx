...
const IconMaterialThumbUpOffOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ThumbUpOffOutlinedW100Filled'
...
export default IconMaterialThumbUpOffOutlinedW100Filled;
