...
const IconMaterialPerson2SharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Person2SharpW100'
      short_name='Person2'
...
IconMaterialPerson2SharpW100.displayName = 'AmauiIconMaterialPerson2SharpW100';

export default IconMaterialPerson2SharpW100;
