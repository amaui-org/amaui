...
const IconMaterialBrightnessAutoOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BrightnessAutoOutlinedW100Filled'
...
export default IconMaterialBrightnessAutoOutlinedW100Filled;
