...
const IconMaterialToolsLevelSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ToolsLevelSharpW700Filled'
...
export default IconMaterialToolsLevelSharpW700Filled;
