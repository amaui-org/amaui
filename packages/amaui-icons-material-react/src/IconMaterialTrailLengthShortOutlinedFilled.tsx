...
const IconMaterialTrailLengthShortOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TrailLengthShortOutlinedFilled'
...
export default IconMaterialTrailLengthShortOutlinedFilled;
