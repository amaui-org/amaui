...
const IconMaterialTibiaAltSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TibiaAltSharpFilled'
      short_name='TibiaAlt'
...
IconMaterialTibiaAltSharpFilled.displayName = 'AmauiIconMaterialTibiaAltSharpFilled';

export default IconMaterialTibiaAltSharpFilled;
