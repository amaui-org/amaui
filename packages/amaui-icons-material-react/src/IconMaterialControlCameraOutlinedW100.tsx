...
const IconMaterialControlCameraOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ControlCameraOutlinedW100'
...
export default IconMaterialControlCameraOutlinedW100;
