...
const IconMaterialNestCamWallMountOutlined = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestCamWallMountOutlined'
...
export default IconMaterialNestCamWallMountOutlined;
