...
const IconMaterialWindowSensorOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WindowSensorOutlinedW100Filled'
...
export default IconMaterialWindowSensorOutlinedW100Filled;
