...
const IconMaterialNightSightAutoOffOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NightSightAutoOffOutlinedFilled'
...
export default IconMaterialNightSightAutoOffOutlinedFilled;
