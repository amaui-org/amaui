...
const IconMaterialGoogleWifiOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='GoogleWifiOutlinedFilled'
...
export default IconMaterialGoogleWifiOutlinedFilled;
