...
const IconMaterialPottedPlantOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PottedPlantOutlinedW100'
...
export default IconMaterialPottedPlantOutlinedW100;
