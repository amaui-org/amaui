...
const IconMaterialOutboundSharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='OutboundSharpW100'
      short_name='Outbound'
...
IconMaterialOutboundSharpW100.displayName = 'AmauiIconMaterialOutboundSharpW100';

export default IconMaterialOutboundSharpW100;
