...
const IconMaterialIncompleteCircleOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='IncompleteCircleOutlinedW700'
...
export default IconMaterialIncompleteCircleOutlinedW700;
