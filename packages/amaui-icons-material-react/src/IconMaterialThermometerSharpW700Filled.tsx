...
const IconMaterialThermometerSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ThermometerSharpW700Filled'
...
export default IconMaterialThermometerSharpW700Filled;
