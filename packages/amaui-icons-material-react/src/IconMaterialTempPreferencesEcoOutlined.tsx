...
const IconMaterialTempPreferencesEcoOutlined = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TempPreferencesEcoOutlined'
...
export default IconMaterialTempPreferencesEcoOutlined;
