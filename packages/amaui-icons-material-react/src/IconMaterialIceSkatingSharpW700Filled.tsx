...
const IconMaterialIceSkatingSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='IceSkatingSharpW700Filled'
...
export default IconMaterialIceSkatingSharpW700Filled;
