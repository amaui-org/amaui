...
const IconMaterialStayPrimaryPortraitOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='StayPrimaryPortraitOutlinedW100Filled'
...
export default IconMaterialStayPrimaryPortraitOutlinedW100Filled;
