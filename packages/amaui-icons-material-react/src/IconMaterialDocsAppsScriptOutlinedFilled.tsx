...
const IconMaterialDocsAppsScriptOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DocsAppsScriptOutlinedFilled'
...
export default IconMaterialDocsAppsScriptOutlinedFilled;
