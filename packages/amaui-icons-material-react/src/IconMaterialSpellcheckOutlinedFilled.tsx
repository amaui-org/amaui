...
const IconMaterialSpellcheckOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SpellcheckOutlinedFilled'
...
export default IconMaterialSpellcheckOutlinedFilled;
