...
const IconMaterialHourglassEmptyOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HourglassEmptyOutlinedW100Filled'
...
export default IconMaterialHourglassEmptyOutlinedW100Filled;
