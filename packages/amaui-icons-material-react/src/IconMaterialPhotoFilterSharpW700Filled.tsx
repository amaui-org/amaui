...
const IconMaterialPhotoFilterSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PhotoFilterSharpW700Filled'
...
export default IconMaterialPhotoFilterSharpW700Filled;
