...
const IconMaterialBlindRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialBlindRounded.displayName = 'AmauiIconMaterialBlindRounded';

export default IconMaterialBlindRounded;
