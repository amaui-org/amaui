...
const IconMaterialHomeMaxDotsOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HomeMaxDotsOutlinedFilled'
...
export default IconMaterialHomeMaxDotsOutlinedFilled;
