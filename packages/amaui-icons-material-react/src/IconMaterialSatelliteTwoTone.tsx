...
const IconMaterialSatelliteTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialSatelliteTwoTone.displayName = 'AmauiIconMaterialSatelliteTwoTone';

export default IconMaterialSatelliteTwoTone;
