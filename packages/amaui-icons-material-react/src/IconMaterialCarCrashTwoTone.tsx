...
const IconMaterialCarCrashTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialCarCrashTwoTone.displayName = 'AmauiIconMaterialCarCrashTwoTone';

export default IconMaterialCarCrashTwoTone;
