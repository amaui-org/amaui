...
const IconMaterialDetectorStatusSharpW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DetectorStatusSharpW700'
...
export default IconMaterialDetectorStatusSharpW700;
