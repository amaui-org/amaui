...
const IconMaterialMovieFilterOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MovieFilterOutlinedW700Filled'
...
export default IconMaterialMovieFilterOutlinedW700Filled;
