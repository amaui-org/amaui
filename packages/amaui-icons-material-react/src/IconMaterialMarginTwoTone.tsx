...
const IconMaterialMarginTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialMarginTwoTone.displayName = 'AmauiIconMaterialMarginTwoTone';

export default IconMaterialMarginTwoTone;
