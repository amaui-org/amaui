...
const IconMaterialHumerusAltOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HumerusAltOutlinedW100Filled'
...
export default IconMaterialHumerusAltOutlinedW100Filled;
