...
const IconMaterialSavedSearchOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SavedSearchOutlinedFilled'
...
export default IconMaterialSavedSearchOutlinedFilled;
