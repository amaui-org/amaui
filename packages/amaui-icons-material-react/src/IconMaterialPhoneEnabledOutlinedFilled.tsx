...
const IconMaterialPhoneEnabledOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PhoneEnabledOutlinedFilled'
...
export default IconMaterialPhoneEnabledOutlinedFilled;
