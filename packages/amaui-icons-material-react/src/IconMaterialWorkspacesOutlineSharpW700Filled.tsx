...
const IconMaterialWorkspacesOutlineSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WorkspacesOutlineSharpW700Filled'
...
export default IconMaterialWorkspacesOutlineSharpW700Filled;
