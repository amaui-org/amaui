...
const IconMaterialHdrPlusTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialHdrPlusTwoTone.displayName = 'AmauiIconMaterialHdrPlusTwoTone';

export default IconMaterialHdrPlusTwoTone;
