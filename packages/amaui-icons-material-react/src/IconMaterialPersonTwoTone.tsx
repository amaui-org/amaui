...
const IconMaterialPersonTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialPersonTwoTone.displayName = 'AmauiIconMaterialPersonTwoTone';

export default IconMaterialPersonTwoTone;
