...
const IconMaterialVibrationTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialVibrationTwoTone.displayName = 'AmauiIconMaterialVibrationTwoTone';

export default IconMaterialVibrationTwoTone;
