...
const IconMaterialEnableRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialEnableRounded.displayName = 'AmauiIconMaterialEnableRounded';

export default IconMaterialEnableRounded;
