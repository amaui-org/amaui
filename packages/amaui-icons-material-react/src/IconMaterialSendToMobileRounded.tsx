...
const IconMaterialSendToMobileRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialSendToMobileRounded.displayName = 'AmauiIconMaterialSendToMobileRounded';

export default IconMaterialSendToMobileRounded;
