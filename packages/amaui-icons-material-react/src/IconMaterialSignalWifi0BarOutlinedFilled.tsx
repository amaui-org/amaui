...
const IconMaterialSignalWifi0BarOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SignalWifi0BarOutlinedFilled'
...
export default IconMaterialSignalWifi0BarOutlinedFilled;
