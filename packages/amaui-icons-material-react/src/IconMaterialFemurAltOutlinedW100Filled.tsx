...
const IconMaterialFemurAltOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FemurAltOutlinedW100Filled'
      short_name='FemurAlt'
...
export default IconMaterialFemurAltOutlinedW100Filled;
