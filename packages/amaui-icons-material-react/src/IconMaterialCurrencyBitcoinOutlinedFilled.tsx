...
const IconMaterialCurrencyBitcoinOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CurrencyBitcoinOutlinedFilled'
...
export default IconMaterialCurrencyBitcoinOutlinedFilled;
