...
const IconMaterialShieldWithHeartSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ShieldWithHeartSharpW700Filled'
...
export default IconMaterialShieldWithHeartSharpW700Filled;
