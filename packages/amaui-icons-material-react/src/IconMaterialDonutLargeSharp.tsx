...
const IconMaterialDonutLargeSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialDonutLargeSharp.displayName = 'AmauiIconMaterialDonutLargeSharp';

export default IconMaterialDonutLargeSharp;
