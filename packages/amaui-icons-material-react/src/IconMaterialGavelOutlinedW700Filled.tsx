...
const IconMaterialGavelOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='GavelOutlinedW700Filled'
      short_name='Gavel'
...
export default IconMaterialGavelOutlinedW700Filled;
