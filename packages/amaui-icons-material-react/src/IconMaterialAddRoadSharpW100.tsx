...
const IconMaterialAddRoadSharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AddRoadSharpW100'
      short_name='AddRoad'
...
IconMaterialAddRoadSharpW100.displayName = 'AmauiIconMaterialAddRoadSharpW100';

export default IconMaterialAddRoadSharpW100;
