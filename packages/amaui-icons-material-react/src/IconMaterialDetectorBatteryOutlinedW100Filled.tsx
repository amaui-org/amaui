...
const IconMaterialDetectorBatteryOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DetectorBatteryOutlinedW100Filled'
...
export default IconMaterialDetectorBatteryOutlinedW100Filled;
