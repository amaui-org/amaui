...
const IconMaterialVoicemailOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='VoicemailOutlinedFilled'
...
export default IconMaterialVoicemailOutlinedFilled;
