...
const IconMaterialConversionPathOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ConversionPathOutlinedFilled'
...
export default IconMaterialConversionPathOutlinedFilled;
