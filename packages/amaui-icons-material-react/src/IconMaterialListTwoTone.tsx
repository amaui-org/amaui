...
const IconMaterialListTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialListTwoTone.displayName = 'AmauiIconMaterialListTwoTone';

export default IconMaterialListTwoTone;
