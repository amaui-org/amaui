...
const IconMaterialPrivacyTipOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PrivacyTipOutlinedW100Filled'
...
export default IconMaterialPrivacyTipOutlinedW100Filled;
