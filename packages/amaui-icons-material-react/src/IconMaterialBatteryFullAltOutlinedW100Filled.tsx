...
const IconMaterialBatteryFullAltOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryFullAltOutlinedW100Filled'
...
export default IconMaterialBatteryFullAltOutlinedW100Filled;
