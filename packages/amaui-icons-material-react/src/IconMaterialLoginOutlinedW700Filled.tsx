...
const IconMaterialLoginOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LoginOutlinedW700Filled'
      short_name='Login'
...
export default IconMaterialLoginOutlinedW700Filled;
