...
const IconMaterialBedroomParentTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialBedroomParentTwoTone.displayName = 'AmauiIconMaterialBedroomParentTwoTone';

export default IconMaterialBedroomParentTwoTone;
