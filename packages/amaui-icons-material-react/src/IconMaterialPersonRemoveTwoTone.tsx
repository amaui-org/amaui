...
const IconMaterialPersonRemoveTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialPersonRemoveTwoTone.displayName = 'AmauiIconMaterialPersonRemoveTwoTone';

export default IconMaterialPersonRemoveTwoTone;
