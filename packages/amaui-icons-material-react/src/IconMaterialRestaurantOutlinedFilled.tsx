...
const IconMaterialRestaurantOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RestaurantOutlinedFilled'
...
export default IconMaterialRestaurantOutlinedFilled;
