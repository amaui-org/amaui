...
const IconMaterialFestivalTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialFestivalTwoTone.displayName = 'AmauiIconMaterialFestivalTwoTone';

export default IconMaterialFestivalTwoTone;
