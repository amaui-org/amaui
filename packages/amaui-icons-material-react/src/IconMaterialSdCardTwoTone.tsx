...
const IconMaterialSdCardTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialSdCardTwoTone.displayName = 'AmauiIconMaterialSdCardTwoTone';

export default IconMaterialSdCardTwoTone;
