...
const IconMaterialHumidityMidOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HumidityMidOutlinedW700Filled'
...
export default IconMaterialHumidityMidOutlinedW700Filled;
