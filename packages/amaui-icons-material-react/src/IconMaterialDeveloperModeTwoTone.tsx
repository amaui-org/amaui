...
const IconMaterialDeveloperModeTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialDeveloperModeTwoTone.displayName = 'AmauiIconMaterialDeveloperModeTwoTone';

export default IconMaterialDeveloperModeTwoTone;
