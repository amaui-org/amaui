...
const IconMaterialFormatShapesOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FormatShapesOutlinedFilled'
...
export default IconMaterialFormatShapesOutlinedFilled;
