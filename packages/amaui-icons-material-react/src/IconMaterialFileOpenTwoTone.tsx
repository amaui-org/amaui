...
const IconMaterialFileOpenTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialFileOpenTwoTone.displayName = 'AmauiIconMaterialFileOpenTwoTone';

export default IconMaterialFileOpenTwoTone;
