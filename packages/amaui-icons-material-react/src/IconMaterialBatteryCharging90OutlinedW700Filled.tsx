...
const IconMaterialBatteryCharging90OutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryCharging90OutlinedW700Filled'
...
export default IconMaterialBatteryCharging90OutlinedW700Filled;
