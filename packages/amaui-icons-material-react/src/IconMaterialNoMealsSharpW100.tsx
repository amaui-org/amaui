...
const IconMaterialNoMealsSharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NoMealsSharpW100'
      short_name='NoMeals'
...
IconMaterialNoMealsSharpW100.displayName = 'AmauiIconMaterialNoMealsSharpW100';

export default IconMaterialNoMealsSharpW100;
