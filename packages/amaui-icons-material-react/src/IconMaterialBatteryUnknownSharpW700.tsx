...
const IconMaterialBatteryUnknownSharpW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryUnknownSharpW700'
...
export default IconMaterialBatteryUnknownSharpW700;
