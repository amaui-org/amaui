...
const IconMaterialHikingSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HikingSharpFilled'
      short_name='Hiking'
...
IconMaterialHikingSharpFilled.displayName = 'AmauiIconMaterialHikingSharpFilled';

export default IconMaterialHikingSharpFilled;
