...
const IconMaterialImagesearchRollerRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ImagesearchRollerRoundedW700Filled'
...
export default IconMaterialImagesearchRollerRoundedW700Filled;
