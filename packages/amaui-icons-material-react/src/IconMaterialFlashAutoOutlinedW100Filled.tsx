...
const IconMaterialFlashAutoOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FlashAutoOutlinedW100Filled'
...
export default IconMaterialFlashAutoOutlinedW100Filled;
