...
const IconMaterialLocationHomeOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LocationHomeOutlinedW100'
...
export default IconMaterialLocationHomeOutlinedW100;
