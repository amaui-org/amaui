...
const IconMaterialLinearScaleOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LinearScaleOutlinedW100'
...
export default IconMaterialLinearScaleOutlinedW100;
