...
const IconMaterialRowingOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RowingOutlinedW100Filled'
      short_name='Rowing'
...
export default IconMaterialRowingOutlinedW100Filled;
