...
const IconMaterialSystemUpdateAltOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SystemUpdateAltOutlinedFilled'
...
export default IconMaterialSystemUpdateAltOutlinedFilled;
