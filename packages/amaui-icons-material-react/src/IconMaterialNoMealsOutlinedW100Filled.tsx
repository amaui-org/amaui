...
const IconMaterialNoMealsOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NoMealsOutlinedW100Filled'
      short_name='NoMeals'
...
export default IconMaterialNoMealsOutlinedW100Filled;
