...
const IconMaterialAutoAwesomeOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AutoAwesomeOutlinedFilled'
...
export default IconMaterialAutoAwesomeOutlinedFilled;
