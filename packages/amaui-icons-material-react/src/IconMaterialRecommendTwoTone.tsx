...
const IconMaterialRecommendTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialRecommendTwoTone.displayName = 'AmauiIconMaterialRecommendTwoTone';

export default IconMaterialRecommendTwoTone;
