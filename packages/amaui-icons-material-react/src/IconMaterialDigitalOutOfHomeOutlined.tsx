...
const IconMaterialDigitalOutOfHomeOutlined = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DigitalOutOfHomeOutlined'
...
export default IconMaterialDigitalOutOfHomeOutlined;
