...
const IconMaterialSettingsOverscanOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SettingsOverscanOutlinedW700Filled'
...
export default IconMaterialSettingsOverscanOutlinedW700Filled;
