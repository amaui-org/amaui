...
const IconMaterialPersonRemoveOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PersonRemoveOutlinedW100Filled'
...
export default IconMaterialPersonRemoveOutlinedW100Filled;
