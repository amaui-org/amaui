...
const IconMaterialRepeatOnSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RepeatOnSharpW700Filled'
      short_name='RepeatOn'
...
export default IconMaterialRepeatOnSharpW700Filled;
