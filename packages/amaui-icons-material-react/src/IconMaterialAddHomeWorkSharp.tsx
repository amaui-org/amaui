...
const IconMaterialAddHomeWorkSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialAddHomeWorkSharp.displayName = 'AmauiIconMaterialAddHomeWorkSharp';

export default IconMaterialAddHomeWorkSharp;
