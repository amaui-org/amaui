...
const IconMaterialVerifiedSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='VerifiedSharpW700Filled'
      short_name='Verified'
...
export default IconMaterialVerifiedSharpW700Filled;
