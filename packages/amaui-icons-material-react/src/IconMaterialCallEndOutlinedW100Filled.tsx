...
const IconMaterialCallEndOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CallEndOutlinedW100Filled'
      short_name='CallEnd'
...
export default IconMaterialCallEndOutlinedW100Filled;
