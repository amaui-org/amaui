...
const IconMaterialWorkspacesOutlineOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WorkspacesOutlineOutlinedFilled'
...
export default IconMaterialWorkspacesOutlineOutlinedFilled;
