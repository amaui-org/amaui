...
const IconMaterialDresserOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DresserOutlinedW100Filled'
      short_name='Dresser'
...
export default IconMaterialDresserOutlinedW100Filled;
