...
const IconMaterialGavelRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialGavelRounded.displayName = 'AmauiIconMaterialGavelRounded';

export default IconMaterialGavelRounded;
