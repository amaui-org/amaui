...
const IconMaterialMonitorWeightRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MonitorWeightRoundedW700Filled'
...
export default IconMaterialMonitorWeightRoundedW700Filled;
