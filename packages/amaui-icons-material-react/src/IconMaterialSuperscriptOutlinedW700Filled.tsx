...
const IconMaterialSuperscriptOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SuperscriptOutlinedW700Filled'
...
export default IconMaterialSuperscriptOutlinedW700Filled;
