...
const IconMaterialLightbulbCircleOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LightbulbCircleOutlinedW100Filled'
...
export default IconMaterialLightbulbCircleOutlinedW100Filled;
