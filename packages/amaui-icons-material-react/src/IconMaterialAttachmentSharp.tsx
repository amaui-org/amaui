...
const IconMaterialAttachmentSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialAttachmentSharp.displayName = 'AmauiIconMaterialAttachmentSharp';

export default IconMaterialAttachmentSharp;
