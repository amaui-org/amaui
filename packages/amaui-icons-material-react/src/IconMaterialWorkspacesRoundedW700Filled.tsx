...
const IconMaterialWorkspacesRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WorkspacesRoundedW700Filled'
...
export default IconMaterialWorkspacesRoundedW700Filled;
