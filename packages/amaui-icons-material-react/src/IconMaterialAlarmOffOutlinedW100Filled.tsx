...
const IconMaterialAlarmOffOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AlarmOffOutlinedW100Filled'
      short_name='AlarmOff'
...
export default IconMaterialAlarmOffOutlinedW100Filled;
