...
const IconMaterialPagesRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialPagesRounded.displayName = 'AmauiIconMaterialPagesRounded';

export default IconMaterialPagesRounded;
