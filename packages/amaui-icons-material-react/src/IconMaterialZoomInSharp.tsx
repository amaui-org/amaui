...
const IconMaterialZoomInSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialZoomInSharp.displayName = 'AmauiIconMaterialZoomInSharp';

export default IconMaterialZoomInSharp;
