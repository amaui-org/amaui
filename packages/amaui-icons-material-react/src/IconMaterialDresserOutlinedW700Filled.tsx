...
const IconMaterialDresserOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DresserOutlinedW700Filled'
      short_name='Dresser'
...
export default IconMaterialDresserOutlinedW700Filled;
