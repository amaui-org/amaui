...
const IconMaterialWomanRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialWomanRounded.displayName = 'AmauiIconMaterialWomanRounded';

export default IconMaterialWomanRounded;
