...
const IconMaterialApprovalTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialApprovalTwoTone.displayName = 'AmauiIconMaterialApprovalTwoTone';

export default IconMaterialApprovalTwoTone;
