...
const IconMaterialRemoteGenSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialRemoteGenSharp.displayName = 'AmauiIconMaterialRemoteGenSharp';

export default IconMaterialRemoteGenSharp;
