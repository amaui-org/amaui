...
const IconMaterialFilterAltOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FilterAltOutlinedFilled'
...
export default IconMaterialFilterAltOutlinedFilled;
