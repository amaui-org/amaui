...
const IconMaterialCommunicationOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CommunicationOutlinedW100Filled'
...
export default IconMaterialCommunicationOutlinedW100Filled;
