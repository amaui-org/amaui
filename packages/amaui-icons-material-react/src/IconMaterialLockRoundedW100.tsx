...
const IconMaterialLockRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LockRoundedW100'
      short_name='Lock'
...
IconMaterialLockRoundedW100.displayName = 'AmauiIconMaterialLockRoundedW100';

export default IconMaterialLockRoundedW100;
