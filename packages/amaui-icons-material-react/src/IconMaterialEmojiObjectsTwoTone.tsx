...
const IconMaterialEmojiObjectsTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialEmojiObjectsTwoTone.displayName = 'AmauiIconMaterialEmojiObjectsTwoTone';

export default IconMaterialEmojiObjectsTwoTone;
