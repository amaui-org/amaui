...
const IconMaterialNestCamMagnetMountOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestCamMagnetMountOutlinedFilled'
...
export default IconMaterialNestCamMagnetMountOutlinedFilled;
