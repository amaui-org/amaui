...
const IconMaterialVideoSettingsSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialVideoSettingsSharp.displayName = 'AmauiIconMaterialVideoSettingsSharp';

export default IconMaterialVideoSettingsSharp;
