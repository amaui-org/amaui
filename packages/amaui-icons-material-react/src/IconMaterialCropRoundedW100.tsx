...
const IconMaterialCropRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CropRoundedW100'
      short_name='Crop'
...
IconMaterialCropRoundedW100.displayName = 'AmauiIconMaterialCropRoundedW100';

export default IconMaterialCropRoundedW100;
