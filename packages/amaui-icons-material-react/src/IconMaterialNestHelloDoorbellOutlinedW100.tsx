...
const IconMaterialNestHelloDoorbellOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestHelloDoorbellOutlinedW100'
...
export default IconMaterialNestHelloDoorbellOutlinedW100;
