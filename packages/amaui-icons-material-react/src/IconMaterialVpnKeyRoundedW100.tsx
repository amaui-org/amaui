...
const IconMaterialVpnKeyRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='VpnKeyRoundedW100'
      short_name='VpnKey'
...
IconMaterialVpnKeyRoundedW100.displayName = 'AmauiIconMaterialVpnKeyRoundedW100';

export default IconMaterialVpnKeyRoundedW100;
