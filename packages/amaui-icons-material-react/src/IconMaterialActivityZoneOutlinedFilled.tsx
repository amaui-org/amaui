...
const IconMaterialActivityZoneOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ActivityZoneOutlinedFilled'
...
export default IconMaterialActivityZoneOutlinedFilled;
