...
const IconMaterialTaskAltTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialTaskAltTwoTone.displayName = 'AmauiIconMaterialTaskAltTwoTone';

export default IconMaterialTaskAltTwoTone;
