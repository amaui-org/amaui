...
const IconMaterialQuietTimeActiveOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='QuietTimeActiveOutlinedFilled'
...
export default IconMaterialQuietTimeActiveOutlinedFilled;
