...
const IconMaterialCompressSharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CompressSharpW100'
      short_name='Compress'
...
IconMaterialCompressSharpW100.displayName = 'AmauiIconMaterialCompressSharpW100';

export default IconMaterialCompressSharpW100;
