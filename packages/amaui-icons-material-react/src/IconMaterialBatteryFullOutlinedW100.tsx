...
const IconMaterialBatteryFullOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryFullOutlinedW100'
...
export default IconMaterialBatteryFullOutlinedW100;
