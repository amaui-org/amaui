...
const IconMaterialDetectorSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DetectorSharpFilled'
      short_name='Detector'
...
IconMaterialDetectorSharpFilled.displayName = 'AmauiIconMaterialDetectorSharpFilled';

export default IconMaterialDetectorSharpFilled;
