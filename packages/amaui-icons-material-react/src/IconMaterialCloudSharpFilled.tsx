...
const IconMaterialCloudSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CloudSharpFilled'
      short_name='Cloud'
...
IconMaterialCloudSharpFilled.displayName = 'AmauiIconMaterialCloudSharpFilled';

export default IconMaterialCloudSharpFilled;
