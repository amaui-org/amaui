...
const IconMaterial10kTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterial10kTwoTone.displayName = 'AmauiIconMaterial10kTwoTone';

export default IconMaterial10kTwoTone;
