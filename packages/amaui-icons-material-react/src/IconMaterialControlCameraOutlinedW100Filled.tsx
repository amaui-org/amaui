...
const IconMaterialControlCameraOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ControlCameraOutlinedW100Filled'
...
export default IconMaterialControlCameraOutlinedW100Filled;
