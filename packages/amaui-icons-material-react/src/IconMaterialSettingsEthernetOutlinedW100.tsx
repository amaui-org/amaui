...
const IconMaterialSettingsEthernetOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SettingsEthernetOutlinedW100'
...
export default IconMaterialSettingsEthernetOutlinedW100;
