...
const IconMaterialNightlifeOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NightlifeOutlinedW700Filled'
...
export default IconMaterialNightlifeOutlinedW700Filled;
