...
const IconMaterialStorageRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialStorageRounded.displayName = 'AmauiIconMaterialStorageRounded';

export default IconMaterialStorageRounded;
