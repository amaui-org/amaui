...
const IconMaterialAddLinkSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AddLinkSharpFilled'
      short_name='AddLink'
...
IconMaterialAddLinkSharpFilled.displayName = 'AmauiIconMaterialAddLinkSharpFilled';

export default IconMaterialAddLinkSharpFilled;
