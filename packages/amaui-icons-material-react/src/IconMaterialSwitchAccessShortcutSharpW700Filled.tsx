...
const IconMaterialSwitchAccessShortcutSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SwitchAccessShortcutSharpW700Filled'
...
export default IconMaterialSwitchAccessShortcutSharpW700Filled;
