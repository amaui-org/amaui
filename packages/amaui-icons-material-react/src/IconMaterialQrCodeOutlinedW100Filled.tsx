...
const IconMaterialQrCodeOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='QrCodeOutlinedW100Filled'
      short_name='QrCode'
...
export default IconMaterialQrCodeOutlinedW100Filled;
