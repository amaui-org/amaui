...
const IconMaterialAgenderRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AgenderRoundedW100'
      short_name='Agender'
...
IconMaterialAgenderRoundedW100.displayName = 'AmauiIconMaterialAgenderRoundedW100';

export default IconMaterialAgenderRoundedW100;
