...
const IconMaterialFormatUnderlinedSquiggleOutlined = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FormatUnderlinedSquiggleOutlined'
...
export default IconMaterialFormatUnderlinedSquiggleOutlined;
