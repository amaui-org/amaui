...
const IconMaterialTimer3Alt1Sharp = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Timer3Alt1Sharp'
...
IconMaterialTimer3Alt1Sharp.displayName = 'AmauiIconMaterialTimer3Alt1Sharp';

export default IconMaterialTimer3Alt1Sharp;
