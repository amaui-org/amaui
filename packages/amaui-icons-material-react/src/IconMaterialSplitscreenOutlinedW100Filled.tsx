...
const IconMaterialSplitscreenOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SplitscreenOutlinedW100Filled'
...
export default IconMaterialSplitscreenOutlinedW100Filled;
