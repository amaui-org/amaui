...
const IconMaterialNetworkWifiOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NetworkWifiOutlinedFilled'
...
export default IconMaterialNetworkWifiOutlinedFilled;
