...
const IconMaterialFormatUnderlinedRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FormatUnderlinedRoundedW700Filled'
...
export default IconMaterialFormatUnderlinedRoundedW700Filled;
