...
const IconMaterialConfirmationNumberOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ConfirmationNumberOutlinedFilled'
...
export default IconMaterialConfirmationNumberOutlinedFilled;
