...
const IconMaterialIntegrationInstructionsOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='IntegrationInstructionsOutlinedW100Filled'
...
export default IconMaterialIntegrationInstructionsOutlinedW100Filled;
