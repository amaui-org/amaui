...
const IconMaterialAccessibilitySharp = React.forwardRef((props: any, ref) => {
...
IconMaterialAccessibilitySharp.displayName = 'AmauiIconMaterialAccessibilitySharp';

export default IconMaterialAccessibilitySharp;
