...
const IconMaterialClearNightOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ClearNightOutlinedW100Filled'
...
export default IconMaterialClearNightOutlinedW100Filled;
