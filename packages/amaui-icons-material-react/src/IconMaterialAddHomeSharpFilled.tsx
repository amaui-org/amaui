...
const IconMaterialAddHomeSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AddHomeSharpFilled'
      short_name='AddHome'
...
IconMaterialAddHomeSharpFilled.displayName = 'AmauiIconMaterialAddHomeSharpFilled';

export default IconMaterialAddHomeSharpFilled;
