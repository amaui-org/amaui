...
const IconMaterialPhoneIphoneOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PhoneIphoneOutlinedW100Filled'
...
export default IconMaterialPhoneIphoneOutlinedW100Filled;
