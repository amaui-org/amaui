...
const IconMaterialShieldWithHeartOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ShieldWithHeartOutlinedFilled'
...
export default IconMaterialShieldWithHeartOutlinedFilled;
