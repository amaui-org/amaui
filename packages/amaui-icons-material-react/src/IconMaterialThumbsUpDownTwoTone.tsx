...
const IconMaterialThumbsUpDownTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialThumbsUpDownTwoTone.displayName = 'AmauiIconMaterialThumbsUpDownTwoTone';

export default IconMaterialThumbsUpDownTwoTone;
