...
const IconMaterialMarkChatReadTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialMarkChatReadTwoTone.displayName = 'AmauiIconMaterialMarkChatReadTwoTone';

export default IconMaterialMarkChatReadTwoTone;
