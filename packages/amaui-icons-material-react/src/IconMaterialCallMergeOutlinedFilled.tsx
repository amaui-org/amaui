...
const IconMaterialCallMergeOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CallMergeOutlinedFilled'
...
export default IconMaterialCallMergeOutlinedFilled;
