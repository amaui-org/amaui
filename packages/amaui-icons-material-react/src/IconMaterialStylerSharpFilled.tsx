...
const IconMaterialStylerSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='StylerSharpFilled'
      short_name='Styler'
...
IconMaterialStylerSharpFilled.displayName = 'AmauiIconMaterialStylerSharpFilled';

export default IconMaterialStylerSharpFilled;
