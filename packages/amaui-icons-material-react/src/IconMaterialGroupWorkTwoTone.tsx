...
const IconMaterialGroupWorkTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialGroupWorkTwoTone.displayName = 'AmauiIconMaterialGroupWorkTwoTone';

export default IconMaterialGroupWorkTwoTone;
