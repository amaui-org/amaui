...
const IconMaterialMovieRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MovieRoundedW100'
      short_name='Movie'
...
IconMaterialMovieRoundedW100.displayName = 'AmauiIconMaterialMovieRoundedW100';

export default IconMaterialMovieRoundedW100;
