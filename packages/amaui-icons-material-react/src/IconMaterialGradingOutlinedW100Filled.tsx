...
const IconMaterialGradingOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='GradingOutlinedW100Filled'
      short_name='Grading'
...
export default IconMaterialGradingOutlinedW100Filled;
