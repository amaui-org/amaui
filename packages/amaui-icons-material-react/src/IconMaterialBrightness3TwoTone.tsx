...
const IconMaterialBrightness3TwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialBrightness3TwoTone.displayName = 'AmauiIconMaterialBrightness3TwoTone';

export default IconMaterialBrightness3TwoTone;
