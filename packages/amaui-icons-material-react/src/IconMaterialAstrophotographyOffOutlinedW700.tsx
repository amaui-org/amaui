...
const IconMaterialAstrophotographyOffOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AstrophotographyOffOutlinedW700'
...
export default IconMaterialAstrophotographyOffOutlinedW700;
