...
const IconMaterialBlurMediumSharp = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BlurMediumSharp'
...
IconMaterialBlurMediumSharp.displayName = 'AmauiIconMaterialBlurMediumSharp';

export default IconMaterialBlurMediumSharp;
