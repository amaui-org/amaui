...
const IconMaterialGroups3SharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Groups3SharpFilled'
      short_name='Groups3'
...
IconMaterialGroups3SharpFilled.displayName = 'AmauiIconMaterialGroups3SharpFilled';

export default IconMaterialGroups3SharpFilled;
