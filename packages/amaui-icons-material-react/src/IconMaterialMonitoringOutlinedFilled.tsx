...
const IconMaterialMonitoringOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MonitoringOutlinedFilled'
...
export default IconMaterialMonitoringOutlinedFilled;
