...
const IconMaterialReportOffSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ReportOffSharpW700Filled'
...
export default IconMaterialReportOffSharpW700Filled;
