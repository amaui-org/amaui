...
const IconMaterialAllOutOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AllOutOutlinedW100Filled'
      short_name='AllOut'
...
export default IconMaterialAllOutOutlinedW100Filled;
