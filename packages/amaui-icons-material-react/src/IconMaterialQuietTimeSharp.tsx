...
const IconMaterialQuietTimeSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialQuietTimeSharp.displayName = 'AmauiIconMaterialQuietTimeSharp';

export default IconMaterialQuietTimeSharp;
