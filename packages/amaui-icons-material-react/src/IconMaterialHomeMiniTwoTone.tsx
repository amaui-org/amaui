...
const IconMaterialHomeMiniTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialHomeMiniTwoTone.displayName = 'AmauiIconMaterialHomeMiniTwoTone';

export default IconMaterialHomeMiniTwoTone;
