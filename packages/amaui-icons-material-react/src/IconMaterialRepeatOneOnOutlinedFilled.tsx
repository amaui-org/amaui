...
const IconMaterialRepeatOneOnOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RepeatOneOnOutlinedFilled'
...
export default IconMaterialRepeatOneOnOutlinedFilled;
