...
const IconMaterialRememberMeOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RememberMeOutlinedFilled'
...
export default IconMaterialRememberMeOutlinedFilled;
