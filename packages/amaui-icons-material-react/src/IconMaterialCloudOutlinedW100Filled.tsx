...
const IconMaterialCloudOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CloudOutlinedW100Filled'
      short_name='Cloud'
...
export default IconMaterialCloudOutlinedW100Filled;
