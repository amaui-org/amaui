...
const IconMaterialMovieFilterOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MovieFilterOutlinedW100Filled'
...
export default IconMaterialMovieFilterOutlinedW100Filled;
