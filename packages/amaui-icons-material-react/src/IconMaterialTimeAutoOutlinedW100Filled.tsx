...
const IconMaterialTimeAutoOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TimeAutoOutlinedW100Filled'
      short_name='TimeAuto'
...
export default IconMaterialTimeAutoOutlinedW100Filled;
