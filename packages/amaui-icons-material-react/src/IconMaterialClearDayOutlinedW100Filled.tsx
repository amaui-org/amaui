...
const IconMaterialClearDayOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ClearDayOutlinedW100Filled'
      short_name='ClearDay'
...
export default IconMaterialClearDayOutlinedW100Filled;
