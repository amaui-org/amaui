...
const IconMaterialTimelapseOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TimelapseOutlinedW100Filled'
...
export default IconMaterialTimelapseOutlinedW100Filled;
