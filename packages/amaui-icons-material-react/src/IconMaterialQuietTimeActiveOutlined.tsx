...
const IconMaterialQuietTimeActiveOutlined = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='QuietTimeActiveOutlined'
...
export default IconMaterialQuietTimeActiveOutlined;
