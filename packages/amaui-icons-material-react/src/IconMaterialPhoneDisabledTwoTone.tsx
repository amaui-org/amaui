...
const IconMaterialPhoneDisabledTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialPhoneDisabledTwoTone.displayName = 'AmauiIconMaterialPhoneDisabledTwoTone';

export default IconMaterialPhoneDisabledTwoTone;
