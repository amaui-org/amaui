...
const IconMaterialPianoOffSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PianoOffSharpFilled'
      short_name='PianoOff'
...
IconMaterialPianoOffSharpFilled.displayName = 'AmauiIconMaterialPianoOffSharpFilled';

export default IconMaterialPianoOffSharpFilled;
