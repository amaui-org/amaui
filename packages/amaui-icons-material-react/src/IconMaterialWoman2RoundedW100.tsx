...
const IconMaterialWoman2RoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Woman2RoundedW100'
      short_name='Woman2'
...
IconMaterialWoman2RoundedW100.displayName = 'AmauiIconMaterialWoman2RoundedW100';

export default IconMaterialWoman2RoundedW100;
