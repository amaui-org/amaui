...
const IconMaterialExposureZeroSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialExposureZeroSharp.displayName = 'AmauiIconMaterialExposureZeroSharp';

export default IconMaterialExposureZeroSharp;
