...
const IconMaterialPhotoCameraOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PhotoCameraOutlinedW700Filled'
...
export default IconMaterialPhotoCameraOutlinedW700Filled;
