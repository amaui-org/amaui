...
const IconMaterialWbIncandescentOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WbIncandescentOutlinedFilled'
...
export default IconMaterialWbIncandescentOutlinedFilled;
