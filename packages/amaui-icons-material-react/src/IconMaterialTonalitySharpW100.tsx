...
const IconMaterialTonalitySharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TonalitySharpW100'
      short_name='Tonality'
...
IconMaterialTonalitySharpW100.displayName = 'AmauiIconMaterialTonalitySharpW100';

export default IconMaterialTonalitySharpW100;
