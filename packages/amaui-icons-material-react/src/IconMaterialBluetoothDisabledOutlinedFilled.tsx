...
const IconMaterialBluetoothDisabledOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BluetoothDisabledOutlinedFilled'
...
export default IconMaterialBluetoothDisabledOutlinedFilled;
