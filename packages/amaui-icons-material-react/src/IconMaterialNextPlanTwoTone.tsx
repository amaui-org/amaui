...
const IconMaterialNextPlanTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialNextPlanTwoTone.displayName = 'AmauiIconMaterialNextPlanTwoTone';

export default IconMaterialNextPlanTwoTone;
