...
const IconMaterialOpacityOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='OpacityOutlinedW100Filled'
      short_name='Opacity'
...
export default IconMaterialOpacityOutlinedW100Filled;
