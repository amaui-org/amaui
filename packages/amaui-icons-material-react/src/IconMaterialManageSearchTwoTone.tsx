...
const IconMaterialManageSearchTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialManageSearchTwoTone.displayName = 'AmauiIconMaterialManageSearchTwoTone';

export default IconMaterialManageSearchTwoTone;
