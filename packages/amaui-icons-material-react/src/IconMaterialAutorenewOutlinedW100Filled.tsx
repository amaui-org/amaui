...
const IconMaterialAutorenewOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AutorenewOutlinedW100Filled'
...
export default IconMaterialAutorenewOutlinedW100Filled;
