...
const IconMaterialCreditCardRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CreditCardRoundedW700Filled'
...
export default IconMaterialCreditCardRoundedW700Filled;
