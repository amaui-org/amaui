...
const IconMaterialModeHeatCoolOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ModeHeatCoolOutlinedFilled'
...
export default IconMaterialModeHeatCoolOutlinedFilled;
