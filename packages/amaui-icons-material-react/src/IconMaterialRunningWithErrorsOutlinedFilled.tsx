...
const IconMaterialRunningWithErrorsOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RunningWithErrorsOutlinedFilled'
...
export default IconMaterialRunningWithErrorsOutlinedFilled;
