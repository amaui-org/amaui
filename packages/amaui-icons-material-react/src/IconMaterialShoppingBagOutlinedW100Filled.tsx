...
const IconMaterialShoppingBagOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ShoppingBagOutlinedW100Filled'
...
export default IconMaterialShoppingBagOutlinedW100Filled;
