...
const IconMaterialCropPortraitOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CropPortraitOutlinedW100Filled'
...
export default IconMaterialCropPortraitOutlinedW100Filled;
