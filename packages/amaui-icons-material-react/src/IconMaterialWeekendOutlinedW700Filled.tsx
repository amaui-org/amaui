...
const IconMaterialWeekendOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WeekendOutlinedW700Filled'
      short_name='Weekend'
...
export default IconMaterialWeekendOutlinedW700Filled;
