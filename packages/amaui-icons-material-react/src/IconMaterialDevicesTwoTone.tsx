...
const IconMaterialDevicesTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialDevicesTwoTone.displayName = 'AmauiIconMaterialDevicesTwoTone';

export default IconMaterialDevicesTwoTone;
