...
const IconMaterialEnergyProgramTimeUsedOutlined = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='EnergyProgramTimeUsedOutlined'
...
export default IconMaterialEnergyProgramTimeUsedOutlined;
