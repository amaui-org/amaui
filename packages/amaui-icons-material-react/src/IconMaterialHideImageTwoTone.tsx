...
const IconMaterialHideImageTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialHideImageTwoTone.displayName = 'AmauiIconMaterialHideImageTwoTone';

export default IconMaterialHideImageTwoTone;
