...
const IconMaterialBrightness5SharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Brightness5SharpW700Filled'
...
export default IconMaterialBrightness5SharpW700Filled;
