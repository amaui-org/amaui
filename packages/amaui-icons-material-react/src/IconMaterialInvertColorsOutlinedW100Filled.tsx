...
const IconMaterialInvertColorsOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='InvertColorsOutlinedW100Filled'
...
export default IconMaterialInvertColorsOutlinedW100Filled;
