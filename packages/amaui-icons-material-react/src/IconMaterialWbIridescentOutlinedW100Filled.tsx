...
const IconMaterialWbIridescentOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WbIridescentOutlinedW100Filled'
...
export default IconMaterialWbIridescentOutlinedW100Filled;
