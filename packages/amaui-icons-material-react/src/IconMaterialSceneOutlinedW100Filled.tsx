...
const IconMaterialSceneOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SceneOutlinedW100Filled'
      short_name='Scene'
...
export default IconMaterialSceneOutlinedW100Filled;
