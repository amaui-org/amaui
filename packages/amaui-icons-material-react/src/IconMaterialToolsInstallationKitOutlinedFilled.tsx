...
const IconMaterialToolsInstallationKitOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ToolsInstallationKitOutlinedFilled'
...
export default IconMaterialToolsInstallationKitOutlinedFilled;
