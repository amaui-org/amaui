...
const IconMaterialHumerusOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HumerusOutlinedW100Filled'
      short_name='Humerus'
...
export default IconMaterialHumerusOutlinedW100Filled;
