...
const IconMaterialPinchZoomOutOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PinchZoomOutOutlinedW100Filled'
...
export default IconMaterialPinchZoomOutOutlinedW100Filled;
