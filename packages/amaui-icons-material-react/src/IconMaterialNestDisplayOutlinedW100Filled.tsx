...
const IconMaterialNestDisplayOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestDisplayOutlinedW100Filled'
...
export default IconMaterialNestDisplayOutlinedW100Filled;
