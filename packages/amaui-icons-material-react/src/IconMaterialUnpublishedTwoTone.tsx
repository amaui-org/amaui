...
const IconMaterialUnpublishedTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialUnpublishedTwoTone.displayName = 'AmauiIconMaterialUnpublishedTwoTone';

export default IconMaterialUnpublishedTwoTone;
