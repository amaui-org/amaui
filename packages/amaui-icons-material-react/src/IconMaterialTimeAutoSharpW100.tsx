...
const IconMaterialTimeAutoSharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TimeAutoSharpW100'
      short_name='TimeAuto'
...
IconMaterialTimeAutoSharpW100.displayName = 'AmauiIconMaterialTimeAutoSharpW100';

export default IconMaterialTimeAutoSharpW100;
