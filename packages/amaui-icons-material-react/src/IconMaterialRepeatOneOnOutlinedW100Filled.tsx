...
const IconMaterialRepeatOneOnOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RepeatOneOnOutlinedW100Filled'
...
export default IconMaterialRepeatOneOnOutlinedW100Filled;
