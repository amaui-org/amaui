...
const IconMaterialFilterDramaTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialFilterDramaTwoTone.displayName = 'AmauiIconMaterialFilterDramaTwoTone';

export default IconMaterialFilterDramaTwoTone;
