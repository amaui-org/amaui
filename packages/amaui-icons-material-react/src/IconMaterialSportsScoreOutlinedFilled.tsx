...
const IconMaterialSportsScoreOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SportsScoreOutlinedFilled'
...
export default IconMaterialSportsScoreOutlinedFilled;
