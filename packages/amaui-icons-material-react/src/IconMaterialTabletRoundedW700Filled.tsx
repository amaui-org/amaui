...
const IconMaterialTabletRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TabletRoundedW700Filled'
      short_name='Tablet'
...
export default IconMaterialTabletRoundedW700Filled;
