...
const IconMaterialThermometerRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ThermometerRoundedW700Filled'
...
export default IconMaterialThermometerRoundedW700Filled;
