...
const IconMaterialBrushOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BrushOutlinedW700Filled'
      short_name='Brush'
...
export default IconMaterialBrushOutlinedW700Filled;
