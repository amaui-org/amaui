...
const IconMaterialRepartitionOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RepartitionOutlinedW100'
...
export default IconMaterialRepartitionOutlinedW100;
