...
const IconMaterialPhotoTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialPhotoTwoTone.displayName = 'AmauiIconMaterialPhotoTwoTone';

export default IconMaterialPhotoTwoTone;
