...
const IconMaterialLightbulbOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LightbulbOutlinedW100Filled'
...
export default IconMaterialLightbulbOutlinedW100Filled;
