...
const IconMaterialLibraryBooksTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialLibraryBooksTwoTone.displayName = 'AmauiIconMaterialLibraryBooksTwoTone';

export default IconMaterialLibraryBooksTwoTone;
