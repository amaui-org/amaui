...
const IconMaterialRefreshSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialRefreshSharp.displayName = 'AmauiIconMaterialRefreshSharp';

export default IconMaterialRefreshSharp;
