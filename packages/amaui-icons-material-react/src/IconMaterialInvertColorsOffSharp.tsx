...
const IconMaterialInvertColorsOffSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialInvertColorsOffSharp.displayName = 'AmauiIconMaterialInvertColorsOffSharp';

export default IconMaterialInvertColorsOffSharp;
