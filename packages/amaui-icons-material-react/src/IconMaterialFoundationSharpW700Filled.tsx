...
const IconMaterialFoundationSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FoundationSharpW700Filled'
...
export default IconMaterialFoundationSharpW700Filled;
