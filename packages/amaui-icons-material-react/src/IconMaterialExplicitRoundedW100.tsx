...
const IconMaterialExplicitRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ExplicitRoundedW100'
      short_name='Explicit'
...
IconMaterialExplicitRoundedW100.displayName = 'AmauiIconMaterialExplicitRoundedW100';

export default IconMaterialExplicitRoundedW100;
