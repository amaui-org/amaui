...
const IconMaterialFitnessCenterOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FitnessCenterOutlinedW100'
...
export default IconMaterialFitnessCenterOutlinedW100;
