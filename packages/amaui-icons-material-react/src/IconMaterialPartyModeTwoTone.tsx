...
const IconMaterialPartyModeTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialPartyModeTwoTone.displayName = 'AmauiIconMaterialPartyModeTwoTone';

export default IconMaterialPartyModeTwoTone;
