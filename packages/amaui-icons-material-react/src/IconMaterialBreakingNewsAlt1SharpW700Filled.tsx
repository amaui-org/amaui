...
const IconMaterialBreakingNewsAlt1SharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BreakingNewsAlt1SharpW700Filled'
...
export default IconMaterialBreakingNewsAlt1SharpW700Filled;
