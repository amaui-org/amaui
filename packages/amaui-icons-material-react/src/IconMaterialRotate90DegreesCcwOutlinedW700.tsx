...
const IconMaterialRotate90DegreesCcwOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Rotate90DegreesCcwOutlinedW700'
...
export default IconMaterialRotate90DegreesCcwOutlinedW700;
