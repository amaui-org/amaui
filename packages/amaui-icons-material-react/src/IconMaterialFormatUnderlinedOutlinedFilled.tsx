...
const IconMaterialFormatUnderlinedOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FormatUnderlinedOutlinedFilled'
...
export default IconMaterialFormatUnderlinedOutlinedFilled;
