...
const IconMaterialDonutSmallOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DonutSmallOutlinedFilled'
...
export default IconMaterialDonutSmallOutlinedFilled;
