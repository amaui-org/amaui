...
const IconMaterialAirPurifierGenOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AirPurifierGenOutlinedFilled'
...
export default IconMaterialAirPurifierGenOutlinedFilled;
