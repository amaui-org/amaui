...
const IconMaterialAddModeratorOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AddModeratorOutlinedW100Filled'
...
export default IconMaterialAddModeratorOutlinedW100Filled;
