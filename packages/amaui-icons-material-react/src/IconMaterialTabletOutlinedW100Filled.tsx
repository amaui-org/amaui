...
const IconMaterialTabletOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TabletOutlinedW100Filled'
      short_name='Tablet'
...
export default IconMaterialTabletOutlinedW100Filled;
