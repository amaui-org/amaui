...
const IconMaterialKeyboardOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='KeyboardOutlinedW100Filled'
      short_name='Keyboard'
...
export default IconMaterialKeyboardOutlinedW100Filled;
