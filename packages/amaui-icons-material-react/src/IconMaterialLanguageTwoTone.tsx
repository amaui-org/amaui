...
const IconMaterialLanguageTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialLanguageTwoTone.displayName = 'AmauiIconMaterialLanguageTwoTone';

export default IconMaterialLanguageTwoTone;
