...
const IconMaterialTrailLengthMediumOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TrailLengthMediumOutlinedW700'
...
export default IconMaterialTrailLengthMediumOutlinedW700;
