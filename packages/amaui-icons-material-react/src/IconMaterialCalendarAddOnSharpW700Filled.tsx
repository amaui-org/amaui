...
const IconMaterialCalendarAddOnSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CalendarAddOnSharpW700Filled'
...
export default IconMaterialCalendarAddOnSharpW700Filled;
