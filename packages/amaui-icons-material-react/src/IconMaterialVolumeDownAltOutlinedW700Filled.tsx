...
const IconMaterialVolumeDownAltOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='VolumeDownAltOutlinedW700Filled'
...
export default IconMaterialVolumeDownAltOutlinedW700Filled;
