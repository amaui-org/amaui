...
const IconMaterialHumidityLowOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HumidityLowOutlinedW700'
...
export default IconMaterialHumidityLowOutlinedW700;
