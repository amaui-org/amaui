...
const IconMaterialScatterPlotSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ScatterPlotSharpW700Filled'
...
export default IconMaterialScatterPlotSharpW700Filled;
