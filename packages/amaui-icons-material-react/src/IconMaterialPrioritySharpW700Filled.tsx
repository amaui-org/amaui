...
const IconMaterialPrioritySharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PrioritySharpW700Filled'
      short_name='Priority'
...
export default IconMaterialPrioritySharpW700Filled;
