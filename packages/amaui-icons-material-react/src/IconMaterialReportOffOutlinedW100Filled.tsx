...
const IconMaterialReportOffOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ReportOffOutlinedW100Filled'
...
export default IconMaterialReportOffOutlinedW100Filled;
