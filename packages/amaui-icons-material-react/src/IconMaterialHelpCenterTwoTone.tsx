...
const IconMaterialHelpCenterTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialHelpCenterTwoTone.displayName = 'AmauiIconMaterialHelpCenterTwoTone';

export default IconMaterialHelpCenterTwoTone;
