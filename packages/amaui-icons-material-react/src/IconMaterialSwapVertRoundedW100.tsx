...
const IconMaterialSwapVertRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SwapVertRoundedW100'
      short_name='SwapVert'
...
IconMaterialSwapVertRoundedW100.displayName = 'AmauiIconMaterialSwapVertRoundedW100';

export default IconMaterialSwapVertRoundedW100;
