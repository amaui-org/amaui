...
const IconMaterialAstrophotographyOffSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AstrophotographyOffSharpW700Filled'
...
export default IconMaterialAstrophotographyOffSharpW700Filled;
