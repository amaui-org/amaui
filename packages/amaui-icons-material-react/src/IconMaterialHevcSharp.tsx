...
const IconMaterialHevcSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialHevcSharp.displayName = 'AmauiIconMaterialHevcSharp';

export default IconMaterialHevcSharp;
