...
const IconMaterialShapeLineOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ShapeLineOutlinedFilled'
...
export default IconMaterialShapeLineOutlinedFilled;
