...
const IconMaterialPhoneCallbackOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PhoneCallbackOutlinedFilled'
...
export default IconMaterialPhoneCallbackOutlinedFilled;
