...
const IconMaterialBoltRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BoltRoundedW100'
      short_name='Bolt'
...
IconMaterialBoltRoundedW100.displayName = 'AmauiIconMaterialBoltRoundedW100';

export default IconMaterialBoltRoundedW100;
