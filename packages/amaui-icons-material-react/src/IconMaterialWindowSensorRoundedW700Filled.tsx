...
const IconMaterialWindowSensorRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WindowSensorRoundedW700Filled'
...
export default IconMaterialWindowSensorRoundedW700Filled;
