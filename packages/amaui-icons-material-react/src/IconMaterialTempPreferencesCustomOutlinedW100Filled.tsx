...
const IconMaterialTempPreferencesCustomOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TempPreferencesCustomOutlinedW100Filled'
...
export default IconMaterialTempPreferencesCustomOutlinedW100Filled;
