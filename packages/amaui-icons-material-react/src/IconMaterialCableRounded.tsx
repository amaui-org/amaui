...
const IconMaterialCableRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialCableRounded.displayName = 'AmauiIconMaterialCableRounded';

export default IconMaterialCableRounded;
