...
const IconMaterialCrop32OutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Crop32OutlinedW100Filled'
      short_name='Crop32'
...
export default IconMaterialCrop32OutlinedW100Filled;
