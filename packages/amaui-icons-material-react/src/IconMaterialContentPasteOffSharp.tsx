...
const IconMaterialContentPasteOffSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialContentPasteOffSharp.displayName = 'AmauiIconMaterialContentPasteOffSharp';

export default IconMaterialContentPasteOffSharp;
