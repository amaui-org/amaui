...
const IconMaterialMoreTimeSharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MoreTimeSharpW100'
      short_name='MoreTime'
...
IconMaterialMoreTimeSharpW100.displayName = 'AmauiIconMaterialMoreTimeSharpW100';

export default IconMaterialMoreTimeSharpW100;
