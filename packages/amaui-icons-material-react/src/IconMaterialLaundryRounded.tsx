...
const IconMaterialLaundryRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialLaundryRounded.displayName = 'AmauiIconMaterialLaundryRounded';

export default IconMaterialLaundryRounded;
