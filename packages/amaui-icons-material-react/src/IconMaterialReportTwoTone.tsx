...
const IconMaterialReportTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialReportTwoTone.displayName = 'AmauiIconMaterialReportTwoTone';

export default IconMaterialReportTwoTone;
