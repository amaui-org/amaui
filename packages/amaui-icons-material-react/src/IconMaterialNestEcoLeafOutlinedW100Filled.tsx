...
const IconMaterialNestEcoLeafOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestEcoLeafOutlinedW100Filled'
...
export default IconMaterialNestEcoLeafOutlinedW100Filled;
