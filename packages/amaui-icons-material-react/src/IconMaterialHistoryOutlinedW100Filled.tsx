...
const IconMaterialHistoryOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HistoryOutlinedW100Filled'
      short_name='History'
...
export default IconMaterialHistoryOutlinedW100Filled;
