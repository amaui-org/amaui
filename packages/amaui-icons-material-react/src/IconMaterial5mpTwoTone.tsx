...
const IconMaterial5mpTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterial5mpTwoTone.displayName = 'AmauiIconMaterial5mpTwoTone';

export default IconMaterial5mpTwoTone;
