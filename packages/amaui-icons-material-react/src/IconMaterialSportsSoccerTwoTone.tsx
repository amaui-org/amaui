...
const IconMaterialSportsSoccerTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialSportsSoccerTwoTone.displayName = 'AmauiIconMaterialSportsSoccerTwoTone';

export default IconMaterialSportsSoccerTwoTone;
