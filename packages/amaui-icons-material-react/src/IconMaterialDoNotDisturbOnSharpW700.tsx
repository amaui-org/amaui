...
const IconMaterialDoNotDisturbOnSharpW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DoNotDisturbOnSharpW700'
...
export default IconMaterialDoNotDisturbOnSharpW700;
