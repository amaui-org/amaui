...
const IconMaterialWifi2BarSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Wifi2BarSharpFilled'
      short_name='Wifi2Bar'
...
IconMaterialWifi2BarSharpFilled.displayName = 'AmauiIconMaterialWifi2BarSharpFilled';

export default IconMaterialWifi2BarSharpFilled;
