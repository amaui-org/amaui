...
const IconMaterialTocSharpFilled = React.forwardRef((props: any, ref) => {
...
IconMaterialTocSharpFilled.displayName = 'AmauiIconMaterialTocSharpFilled';

export default IconMaterialTocSharpFilled;
