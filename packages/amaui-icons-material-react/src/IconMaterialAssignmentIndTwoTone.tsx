...
const IconMaterialAssignmentIndTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialAssignmentIndTwoTone.displayName = 'AmauiIconMaterialAssignmentIndTwoTone';

export default IconMaterialAssignmentIndTwoTone;
