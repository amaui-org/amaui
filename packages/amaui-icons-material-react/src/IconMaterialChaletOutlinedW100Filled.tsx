...
const IconMaterialChaletOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ChaletOutlinedW100Filled'
      short_name='Chalet'
...
export default IconMaterialChaletOutlinedW100Filled;
