...
const IconMaterialBorderRightSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BorderRightSharpW700Filled'
...
export default IconMaterialBorderRightSharpW700Filled;
