...
const IconMaterialDuoTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialDuoTwoTone.displayName = 'AmauiIconMaterialDuoTwoTone';

export default IconMaterialDuoTwoTone;
