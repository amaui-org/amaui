...
const IconMaterialMusicOffRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MusicOffRoundedW700Filled'
      short_name='MusicOff'
...
export default IconMaterialMusicOffRoundedW700Filled;
