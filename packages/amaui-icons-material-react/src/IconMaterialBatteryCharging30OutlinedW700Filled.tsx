...
const IconMaterialBatteryCharging30OutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryCharging30OutlinedW700Filled'
...
export default IconMaterialBatteryCharging30OutlinedW700Filled;
