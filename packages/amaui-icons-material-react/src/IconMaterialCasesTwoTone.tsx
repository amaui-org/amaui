...
const IconMaterialCasesTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialCasesTwoTone.displayName = 'AmauiIconMaterialCasesTwoTone';

export default IconMaterialCasesTwoTone;
