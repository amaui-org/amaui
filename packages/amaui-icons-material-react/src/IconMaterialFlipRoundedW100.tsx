...
const IconMaterialFlipRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FlipRoundedW100'
      short_name='Flip'
...
IconMaterialFlipRoundedW100.displayName = 'AmauiIconMaterialFlipRoundedW100';

export default IconMaterialFlipRoundedW100;
