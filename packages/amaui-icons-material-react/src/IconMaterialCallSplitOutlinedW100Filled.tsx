...
const IconMaterialCallSplitOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CallSplitOutlinedW100Filled'
...
export default IconMaterialCallSplitOutlinedW100Filled;
