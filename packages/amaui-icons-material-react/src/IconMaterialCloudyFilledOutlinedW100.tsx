...
const IconMaterialCloudyFilledOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CloudyFilledOutlinedW100'
...
export default IconMaterialCloudyFilledOutlinedW100;
