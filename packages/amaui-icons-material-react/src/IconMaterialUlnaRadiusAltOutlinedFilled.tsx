...
const IconMaterialUlnaRadiusAltOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='UlnaRadiusAltOutlinedFilled'
...
export default IconMaterialUlnaRadiusAltOutlinedFilled;
