...
const IconMaterialNestDisplayMaxSharpW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestDisplayMaxSharpW700'
...
export default IconMaterialNestDisplayMaxSharpW700;
