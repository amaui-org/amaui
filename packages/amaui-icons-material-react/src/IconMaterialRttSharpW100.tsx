...
const IconMaterialRttSharpW100 = React.forwardRef((props: any, ref) => {
...
IconMaterialRttSharpW100.displayName = 'AmauiIconMaterialRttSharpW100';

export default IconMaterialRttSharpW100;
