...
const IconMaterialPrintDisabledTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialPrintDisabledTwoTone.displayName = 'AmauiIconMaterialPrintDisabledTwoTone';

export default IconMaterialPrintDisabledTwoTone;
