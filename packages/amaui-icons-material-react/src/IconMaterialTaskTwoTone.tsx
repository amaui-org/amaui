...
const IconMaterialTaskTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialTaskTwoTone.displayName = 'AmauiIconMaterialTaskTwoTone';

export default IconMaterialTaskTwoTone;
