...
const IconMaterialWifi2BarRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Wifi2BarRoundedW100'
      short_name='Wifi2Bar'
...
IconMaterialWifi2BarRoundedW100.displayName = 'AmauiIconMaterialWifi2BarRoundedW100';

export default IconMaterialWifi2BarRoundedW100;
