...
const IconMaterialLandscapeTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialLandscapeTwoTone.displayName = 'AmauiIconMaterialLandscapeTwoTone';

export default IconMaterialLandscapeTwoTone;
