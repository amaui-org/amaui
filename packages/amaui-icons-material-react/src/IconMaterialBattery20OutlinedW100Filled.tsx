...
const IconMaterialBattery20OutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Battery20OutlinedW100Filled'
...
export default IconMaterialBattery20OutlinedW100Filled;
