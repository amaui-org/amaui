...
const IconMaterialWindowSensorOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WindowSensorOutlinedW100'
...
export default IconMaterialWindowSensorOutlinedW100;
