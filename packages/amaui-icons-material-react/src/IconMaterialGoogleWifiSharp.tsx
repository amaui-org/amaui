...
const IconMaterialGoogleWifiSharp = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='GoogleWifiSharp'
...
IconMaterialGoogleWifiSharp.displayName = 'AmauiIconMaterialGoogleWifiSharp';

export default IconMaterialGoogleWifiSharp;
