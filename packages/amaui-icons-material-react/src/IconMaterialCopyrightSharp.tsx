...
const IconMaterialCopyrightSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialCopyrightSharp.displayName = 'AmauiIconMaterialCopyrightSharp';

export default IconMaterialCopyrightSharp;
