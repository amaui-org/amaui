...
const IconMaterialPhotoFilterOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PhotoFilterOutlinedW700Filled'
...
export default IconMaterialPhotoFilterOutlinedW700Filled;
