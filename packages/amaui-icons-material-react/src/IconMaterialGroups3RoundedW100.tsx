...
const IconMaterialGroups3RoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Groups3RoundedW100'
      short_name='Groups3'
...
IconMaterialGroups3RoundedW100.displayName = 'AmauiIconMaterialGroups3RoundedW100';

export default IconMaterialGroups3RoundedW100;
