...
const IconMaterialBlockRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BlockRoundedW100'
      short_name='Block'
...
IconMaterialBlockRoundedW100.displayName = 'AmauiIconMaterialBlockRoundedW100';

export default IconMaterialBlockRoundedW100;
