...
const IconMaterialCalendarAddOnOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CalendarAddOnOutlinedFilled'
...
export default IconMaterialCalendarAddOnOutlinedFilled;
