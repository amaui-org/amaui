...
const IconMaterialNestSunblockOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestSunblockOutlinedW100'
...
export default IconMaterialNestSunblockOutlinedW100;
