...
const IconMaterialRecyclingOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RecyclingOutlinedW100Filled'
...
export default IconMaterialRecyclingOutlinedW100Filled;
