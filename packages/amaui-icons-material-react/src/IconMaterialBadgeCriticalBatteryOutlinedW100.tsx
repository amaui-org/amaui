...
const IconMaterialBadgeCriticalBatteryOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BadgeCriticalBatteryOutlinedW100'
...
export default IconMaterialBadgeCriticalBatteryOutlinedW100;
