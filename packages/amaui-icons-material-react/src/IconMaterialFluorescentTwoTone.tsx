...
const IconMaterialFluorescentTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialFluorescentTwoTone.displayName = 'AmauiIconMaterialFluorescentTwoTone';

export default IconMaterialFluorescentTwoTone;
