...
const IconMaterialSellTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialSellTwoTone.displayName = 'AmauiIconMaterialSellTwoTone';

export default IconMaterialSellTwoTone;
