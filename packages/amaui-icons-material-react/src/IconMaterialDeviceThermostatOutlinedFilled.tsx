...
const IconMaterialDeviceThermostatOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DeviceThermostatOutlinedFilled'
...
export default IconMaterialDeviceThermostatOutlinedFilled;
