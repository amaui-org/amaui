...
const IconMaterialSportsGolfTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialSportsGolfTwoTone.displayName = 'AmauiIconMaterialSportsGolfTwoTone';

export default IconMaterialSportsGolfTwoTone;
