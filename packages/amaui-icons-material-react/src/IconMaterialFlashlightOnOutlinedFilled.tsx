...
const IconMaterialFlashlightOnOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FlashlightOnOutlinedFilled'
...
export default IconMaterialFlashlightOnOutlinedFilled;
