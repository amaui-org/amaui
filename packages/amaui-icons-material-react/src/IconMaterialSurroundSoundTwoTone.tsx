...
const IconMaterialSurroundSoundTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialSurroundSoundTwoTone.displayName = 'AmauiIconMaterialSurroundSoundTwoTone';

export default IconMaterialSurroundSoundTwoTone;
