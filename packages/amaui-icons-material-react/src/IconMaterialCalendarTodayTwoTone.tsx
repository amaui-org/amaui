...
const IconMaterialCalendarTodayTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialCalendarTodayTwoTone.displayName = 'AmauiIconMaterialCalendarTodayTwoTone';

export default IconMaterialCalendarTodayTwoTone;
