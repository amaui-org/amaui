...
const IconMaterialPriorityHighOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PriorityHighOutlinedFilled'
...
export default IconMaterialPriorityHighOutlinedFilled;
