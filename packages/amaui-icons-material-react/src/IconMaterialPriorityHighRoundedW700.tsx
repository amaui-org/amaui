...
const IconMaterialPriorityHighRoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PriorityHighRoundedW700'
...
export default IconMaterialPriorityHighRoundedW700;
