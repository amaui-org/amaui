...
const IconMaterialLocationHomeOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LocationHomeOutlinedW100Filled'
...
export default IconMaterialLocationHomeOutlinedW100Filled;
