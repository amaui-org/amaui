...
const IconMaterialHdrStrongOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HdrStrongOutlinedFilled'
...
export default IconMaterialHdrStrongOutlinedFilled;
