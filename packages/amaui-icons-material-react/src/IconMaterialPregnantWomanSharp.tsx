...
const IconMaterialPregnantWomanSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialPregnantWomanSharp.displayName = 'AmauiIconMaterialPregnantWomanSharp';

export default IconMaterialPregnantWomanSharp;
