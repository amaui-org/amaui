...
const IconMaterialSettingsAlertOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SettingsAlertOutlinedW100Filled'
...
export default IconMaterialSettingsAlertOutlinedW100Filled;
