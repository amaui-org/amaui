...
const IconMaterialRepeatOneOnSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialRepeatOneOnSharp.displayName = 'AmauiIconMaterialRepeatOneOnSharp';

export default IconMaterialRepeatOneOnSharp;
