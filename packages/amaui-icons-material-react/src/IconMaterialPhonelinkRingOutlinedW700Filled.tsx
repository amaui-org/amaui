...
const IconMaterialPhonelinkRingOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PhonelinkRingOutlinedW700Filled'
...
export default IconMaterialPhonelinkRingOutlinedW700Filled;
