...
const IconMaterialBarcodeScannerOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BarcodeScannerOutlinedW100Filled'
...
export default IconMaterialBarcodeScannerOutlinedW100Filled;
