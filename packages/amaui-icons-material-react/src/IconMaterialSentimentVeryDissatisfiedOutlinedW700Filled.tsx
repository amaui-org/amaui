...
const IconMaterialSentimentVeryDissatisfiedOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SentimentVeryDissatisfiedOutlinedW700Filled'
...
export default IconMaterialSentimentVeryDissatisfiedOutlinedW700Filled;
