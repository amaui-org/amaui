...
const IconMaterialSwitchOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SwitchOutlinedW100Filled'
      short_name='Switch'
...
export default IconMaterialSwitchOutlinedW100Filled;
