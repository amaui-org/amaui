...
const IconMaterialHdrWeakRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialHdrWeakRounded.displayName = 'AmauiIconMaterialHdrWeakRounded';

export default IconMaterialHdrWeakRounded;
