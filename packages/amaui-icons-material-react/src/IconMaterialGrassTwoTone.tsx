...
const IconMaterialGrassTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialGrassTwoTone.displayName = 'AmauiIconMaterialGrassTwoTone';

export default IconMaterialGrassTwoTone;
