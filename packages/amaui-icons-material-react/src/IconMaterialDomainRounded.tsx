...
const IconMaterialDomainRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialDomainRounded.displayName = 'AmauiIconMaterialDomainRounded';

export default IconMaterialDomainRounded;
