...
const IconMaterialLoyaltyRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialLoyaltyRounded.displayName = 'AmauiIconMaterialLoyaltyRounded';

export default IconMaterialLoyaltyRounded;
