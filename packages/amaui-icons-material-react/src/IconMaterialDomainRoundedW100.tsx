...
const IconMaterialDomainRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DomainRoundedW100'
      short_name='Domain'
...
IconMaterialDomainRoundedW100.displayName = 'AmauiIconMaterialDomainRoundedW100';

export default IconMaterialDomainRoundedW100;
