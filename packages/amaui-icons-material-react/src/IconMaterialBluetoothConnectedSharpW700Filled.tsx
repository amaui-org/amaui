...
const IconMaterialBluetoothConnectedSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BluetoothConnectedSharpW700Filled'
...
export default IconMaterialBluetoothConnectedSharpW700Filled;
