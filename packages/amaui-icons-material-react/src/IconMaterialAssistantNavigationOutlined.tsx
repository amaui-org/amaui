...
const IconMaterialAssistantNavigationOutlined = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AssistantNavigationOutlined'
...
export default IconMaterialAssistantNavigationOutlined;
