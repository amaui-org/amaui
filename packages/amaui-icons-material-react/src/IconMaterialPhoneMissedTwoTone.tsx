...
const IconMaterialPhoneMissedTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialPhoneMissedTwoTone.displayName = 'AmauiIconMaterialPhoneMissedTwoTone';

export default IconMaterialPhoneMissedTwoTone;
