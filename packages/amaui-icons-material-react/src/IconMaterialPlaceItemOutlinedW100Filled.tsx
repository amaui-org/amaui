...
const IconMaterialPlaceItemOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PlaceItemOutlinedW100Filled'
...
export default IconMaterialPlaceItemOutlinedW100Filled;
