...
const IconMaterialAirwareSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AirwareSharpFilled'
      short_name='Airware'
...
IconMaterialAirwareSharpFilled.displayName = 'AmauiIconMaterialAirwareSharpFilled';

export default IconMaterialAirwareSharpFilled;
