...
const IconMaterialMonitorWeightOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MonitorWeightOutlinedW100Filled'
...
export default IconMaterialMonitorWeightOutlinedW100Filled;
