...
const IconMaterialDirectionsCarOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DirectionsCarOutlinedW100'
...
export default IconMaterialDirectionsCarOutlinedW100;
