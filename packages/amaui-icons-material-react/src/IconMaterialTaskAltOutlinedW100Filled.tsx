...
const IconMaterialTaskAltOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TaskAltOutlinedW100Filled'
      short_name='TaskAlt'
...
export default IconMaterialTaskAltOutlinedW100Filled;
