...
const IconMaterialFemaleOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FemaleOutlinedW100Filled'
      short_name='Female'
...
export default IconMaterialFemaleOutlinedW100Filled;
