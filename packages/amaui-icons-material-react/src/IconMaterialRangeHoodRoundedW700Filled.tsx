...
const IconMaterialRangeHoodRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RangeHoodRoundedW700Filled'
...
export default IconMaterialRangeHoodRoundedW700Filled;
