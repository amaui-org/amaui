...
const IconMaterialBatteryVeryLowRoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryVeryLowRoundedW700'
...
export default IconMaterialBatteryVeryLowRoundedW700;
