...
const IconMaterialBookmarksTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialBookmarksTwoTone.displayName = 'AmauiIconMaterialBookmarksTwoTone';

export default IconMaterialBookmarksTwoTone;
