...
const IconMaterialBatteryCharging80OutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryCharging80OutlinedFilled'
...
export default IconMaterialBatteryCharging80OutlinedFilled;
