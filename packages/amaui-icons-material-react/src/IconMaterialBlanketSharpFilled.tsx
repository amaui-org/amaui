...
const IconMaterialBlanketSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BlanketSharpFilled'
      short_name='Blanket'
...
IconMaterialBlanketSharpFilled.displayName = 'AmauiIconMaterialBlanketSharpFilled';

export default IconMaterialBlanketSharpFilled;
