...
const IconMaterialNetworkWifi1BarOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NetworkWifi1BarOutlinedFilled'
...
export default IconMaterialNetworkWifi1BarOutlinedFilled;
