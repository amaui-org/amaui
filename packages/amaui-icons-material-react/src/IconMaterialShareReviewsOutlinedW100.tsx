...
const IconMaterialShareReviewsOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ShareReviewsOutlinedW100'
...
export default IconMaterialShareReviewsOutlinedW100;
