...
const IconMaterialZonePersonAlertOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ZonePersonAlertOutlinedFilled'
...
export default IconMaterialZonePersonAlertOutlinedFilled;
