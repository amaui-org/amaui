...
const IconMaterialSportsVolleyballRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SportsVolleyballRoundedW700Filled'
...
export default IconMaterialSportsVolleyballRoundedW700Filled;
