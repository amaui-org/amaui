...
const IconMaterialPublicSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PublicSharpFilled'
      short_name='Public'
...
IconMaterialPublicSharpFilled.displayName = 'AmauiIconMaterialPublicSharpFilled';

export default IconMaterialPublicSharpFilled;
