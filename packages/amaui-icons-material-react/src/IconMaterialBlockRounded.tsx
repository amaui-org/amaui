...
const IconMaterialBlockRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialBlockRounded.displayName = 'AmauiIconMaterialBlockRounded';

export default IconMaterialBlockRounded;
