...
const IconMaterialNetworkPingRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NetworkPingRoundedW700Filled'
...
export default IconMaterialNetworkPingRoundedW700Filled;
