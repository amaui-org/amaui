...
const IconMaterialWaterDamageOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WaterDamageOutlinedW100Filled'
...
export default IconMaterialWaterDamageOutlinedW100Filled;
