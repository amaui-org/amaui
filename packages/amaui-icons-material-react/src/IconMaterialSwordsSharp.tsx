...
const IconMaterialSwordsSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialSwordsSharp.displayName = 'AmauiIconMaterialSwordsSharp';

export default IconMaterialSwordsSharp;
