...
const IconMaterialShieldWithHouseOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ShieldWithHouseOutlinedW100'
...
export default IconMaterialShieldWithHouseOutlinedW100;
