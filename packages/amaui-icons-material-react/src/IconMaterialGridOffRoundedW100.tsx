...
const IconMaterialGridOffRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='GridOffRoundedW100'
      short_name='GridOff'
...
IconMaterialGridOffRoundedW100.displayName = 'AmauiIconMaterialGridOffRoundedW100';

export default IconMaterialGridOffRoundedW100;
