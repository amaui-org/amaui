...
const IconMaterialFullscreenOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FullscreenOutlinedW700Filled'
...
export default IconMaterialFullscreenOutlinedW700Filled;
