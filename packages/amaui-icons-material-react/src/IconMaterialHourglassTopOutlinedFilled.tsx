...
const IconMaterialHourglassTopOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HourglassTopOutlinedFilled'
...
export default IconMaterialHourglassTopOutlinedFilled;
