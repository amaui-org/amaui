...
const IconMaterialEmergencyOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='EmergencyOutlinedW100Filled'
...
export default IconMaterialEmergencyOutlinedW100Filled;
