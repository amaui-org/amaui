...
const IconMaterialPsychologyOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PsychologyOutlinedFilled'
...
export default IconMaterialPsychologyOutlinedFilled;
