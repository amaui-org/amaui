...
const IconMaterialInHomeModeSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='InHomeModeSharpW700Filled'
...
export default IconMaterialInHomeModeSharpW700Filled;
