...
const IconMaterialPowerRoundedOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PowerRoundedOutlinedW100Filled'
...
export default IconMaterialPowerRoundedOutlinedW100Filled;
