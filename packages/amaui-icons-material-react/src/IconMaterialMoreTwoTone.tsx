...
const IconMaterialMoreTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialMoreTwoTone.displayName = 'AmauiIconMaterialMoreTwoTone';

export default IconMaterialMoreTwoTone;
