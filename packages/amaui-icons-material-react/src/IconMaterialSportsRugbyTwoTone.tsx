...
const IconMaterialSportsRugbyTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialSportsRugbyTwoTone.displayName = 'AmauiIconMaterialSportsRugbyTwoTone';

export default IconMaterialSportsRugbyTwoTone;
