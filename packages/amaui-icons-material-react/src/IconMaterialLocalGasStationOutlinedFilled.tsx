...
const IconMaterialLocalGasStationOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LocalGasStationOutlinedFilled'
...
export default IconMaterialLocalGasStationOutlinedFilled;
