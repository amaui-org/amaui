...
const IconMaterialDoneOutlineOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DoneOutlineOutlinedFilled'
...
export default IconMaterialDoneOutlineOutlinedFilled;
