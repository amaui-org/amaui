...
const IconMaterialTimelineRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialTimelineRounded.displayName = 'AmauiIconMaterialTimelineRounded';

export default IconMaterialTimelineRounded;
