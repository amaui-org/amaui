...
const IconMaterialMemoryTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialMemoryTwoTone.displayName = 'AmauiIconMaterialMemoryTwoTone';

export default IconMaterialMemoryTwoTone;
