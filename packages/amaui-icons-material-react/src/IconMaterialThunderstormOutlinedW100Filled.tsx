...
const IconMaterialThunderstormOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ThunderstormOutlinedW100Filled'
...
export default IconMaterialThunderstormOutlinedW100Filled;
