...
const IconMaterialAddToDriveSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialAddToDriveSharp.displayName = 'AmauiIconMaterialAddToDriveSharp';

export default IconMaterialAddToDriveSharp;
