...
const IconMaterialBadgeCriticalBatteryRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BadgeCriticalBatteryRoundedW700Filled'
...
export default IconMaterialBadgeCriticalBatteryRoundedW700Filled;
