...
const IconMaterialZoomOutOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ZoomOutOutlinedW100Filled'
      short_name='ZoomOut'
...
export default IconMaterialZoomOutOutlinedW100Filled;
