...
const IconMaterialFindReplaceOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FindReplaceOutlinedFilled'
...
export default IconMaterialFindReplaceOutlinedFilled;
