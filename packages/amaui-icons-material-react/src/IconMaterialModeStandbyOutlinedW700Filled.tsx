...
const IconMaterialModeStandbyOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ModeStandbyOutlinedW700Filled'
...
export default IconMaterialModeStandbyOutlinedW700Filled;
