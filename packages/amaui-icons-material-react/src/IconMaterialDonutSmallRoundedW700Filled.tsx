...
const IconMaterialDonutSmallRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DonutSmallRoundedW700Filled'
...
export default IconMaterialDonutSmallRoundedW700Filled;
