...
const IconMaterialDirectionsWalkSharpW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DirectionsWalkSharpW700'
...
export default IconMaterialDirectionsWalkSharpW700;
