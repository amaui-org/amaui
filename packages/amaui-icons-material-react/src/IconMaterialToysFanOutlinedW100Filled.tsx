...
const IconMaterialToysFanOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ToysFanOutlinedW100Filled'
      short_name='ToysFan'
...
export default IconMaterialToysFanOutlinedW100Filled;
