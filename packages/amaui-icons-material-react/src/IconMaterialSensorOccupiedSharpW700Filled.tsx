...
const IconMaterialSensorOccupiedSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SensorOccupiedSharpW700Filled'
...
export default IconMaterialSensorOccupiedSharpW700Filled;
