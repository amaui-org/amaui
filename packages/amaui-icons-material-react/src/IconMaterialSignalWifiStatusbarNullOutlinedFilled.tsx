...
const IconMaterialSignalWifiStatusbarNullOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SignalWifiStatusbarNullOutlinedFilled'
...
export default IconMaterialSignalWifiStatusbarNullOutlinedFilled;
