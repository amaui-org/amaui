...
const IconMaterialForwardOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ForwardOutlinedW700Filled'
      short_name='Forward'
...
export default IconMaterialForwardOutlinedW700Filled;
