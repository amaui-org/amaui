...
const IconMaterialRssFeedRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialRssFeedRounded.displayName = 'AmauiIconMaterialRssFeedRounded';

export default IconMaterialRssFeedRounded;
