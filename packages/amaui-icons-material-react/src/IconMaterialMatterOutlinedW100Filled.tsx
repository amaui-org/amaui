...
const IconMaterialMatterOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MatterOutlinedW100Filled'
      short_name='Matter'
...
export default IconMaterialMatterOutlinedW100Filled;
