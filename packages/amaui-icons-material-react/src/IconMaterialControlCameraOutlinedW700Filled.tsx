...
const IconMaterialControlCameraOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ControlCameraOutlinedW700Filled'
...
export default IconMaterialControlCameraOutlinedW700Filled;
