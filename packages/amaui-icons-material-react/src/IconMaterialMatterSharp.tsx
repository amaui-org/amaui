...
const IconMaterialMatterSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialMatterSharp.displayName = 'AmauiIconMaterialMatterSharp';

export default IconMaterialMatterSharp;
