...
const IconMaterialNetworkPingOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NetworkPingOutlinedW100'
...
export default IconMaterialNetworkPingOutlinedW100;
