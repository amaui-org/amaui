...
const IconMaterialRollerSkatingTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialRollerSkatingTwoTone.displayName = 'AmauiIconMaterialRollerSkatingTwoTone';

export default IconMaterialRollerSkatingTwoTone;
