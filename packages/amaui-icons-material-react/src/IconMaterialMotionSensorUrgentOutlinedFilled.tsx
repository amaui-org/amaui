...
const IconMaterialMotionSensorUrgentOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MotionSensorUrgentOutlinedFilled'
...
export default IconMaterialMotionSensorUrgentOutlinedFilled;
