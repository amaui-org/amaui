...
const IconMaterialEmergencyTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialEmergencyTwoTone.displayName = 'AmauiIconMaterialEmergencyTwoTone';

export default IconMaterialEmergencyTwoTone;
