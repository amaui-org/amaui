...
const IconMaterialRotateRightOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RotateRightOutlinedW100'
...
export default IconMaterialRotateRightOutlinedW100;
