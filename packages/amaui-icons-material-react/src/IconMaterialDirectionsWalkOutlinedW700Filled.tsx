...
const IconMaterialDirectionsWalkOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DirectionsWalkOutlinedW700Filled'
...
export default IconMaterialDirectionsWalkOutlinedW700Filled;
