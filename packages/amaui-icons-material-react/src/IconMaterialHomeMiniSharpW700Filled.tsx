...
const IconMaterialHomeMiniSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HomeMiniSharpW700Filled'
      short_name='HomeMini'
...
export default IconMaterialHomeMiniSharpW700Filled;
