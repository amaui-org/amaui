...
const IconMaterialSnowshoeingTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialSnowshoeingTwoTone.displayName = 'AmauiIconMaterialSnowshoeingTwoTone';

export default IconMaterialSnowshoeingTwoTone;
