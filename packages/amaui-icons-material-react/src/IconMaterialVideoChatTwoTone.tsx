...
const IconMaterialVideoChatTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialVideoChatTwoTone.displayName = 'AmauiIconMaterialVideoChatTwoTone';

export default IconMaterialVideoChatTwoTone;
