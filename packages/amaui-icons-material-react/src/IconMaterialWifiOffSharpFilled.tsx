...
const IconMaterialWifiOffSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WifiOffSharpFilled'
      short_name='WifiOff'
...
IconMaterialWifiOffSharpFilled.displayName = 'AmauiIconMaterialWifiOffSharpFilled';

export default IconMaterialWifiOffSharpFilled;
