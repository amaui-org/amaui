...
const IconMaterialHeartPlusSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialHeartPlusSharp.displayName = 'AmauiIconMaterialHeartPlusSharp';

export default IconMaterialHeartPlusSharp;
