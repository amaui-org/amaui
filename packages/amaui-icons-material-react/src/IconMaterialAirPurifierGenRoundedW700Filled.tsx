...
const IconMaterialAirPurifierGenRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AirPurifierGenRoundedW700Filled'
...
export default IconMaterialAirPurifierGenRoundedW700Filled;
