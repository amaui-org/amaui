...
const IconMaterialFmdBadTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialFmdBadTwoTone.displayName = 'AmauiIconMaterialFmdBadTwoTone';

export default IconMaterialFmdBadTwoTone;
