...
const IconMaterialLandslideOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LandslideOutlinedFilled'
...
export default IconMaterialLandslideOutlinedFilled;
