...
const IconMaterialBatteryCharging60RoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryCharging60RoundedW700Filled'
...
export default IconMaterialBatteryCharging60RoundedW700Filled;
