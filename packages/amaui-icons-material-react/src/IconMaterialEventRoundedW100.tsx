...
const IconMaterialEventRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='EventRoundedW100'
      short_name='Event'
...
IconMaterialEventRoundedW100.displayName = 'AmauiIconMaterialEventRoundedW100';

export default IconMaterialEventRoundedW100;
