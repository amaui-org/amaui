...
const IconMaterialSouthAmericaTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialSouthAmericaTwoTone.displayName = 'AmauiIconMaterialSouthAmericaTwoTone';

export default IconMaterialSouthAmericaTwoTone;
