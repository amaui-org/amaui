...
const IconMaterialTrainTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialTrainTwoTone.displayName = 'AmauiIconMaterialTrainTwoTone';

export default IconMaterialTrainTwoTone;
