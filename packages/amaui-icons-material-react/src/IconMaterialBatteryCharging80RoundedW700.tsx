...
const IconMaterialBatteryCharging80RoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryCharging80RoundedW700'
...
export default IconMaterialBatteryCharging80RoundedW700;
