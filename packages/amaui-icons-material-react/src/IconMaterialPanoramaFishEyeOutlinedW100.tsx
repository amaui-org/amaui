...
const IconMaterialPanoramaFishEyeOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PanoramaFishEyeOutlinedW100'
...
export default IconMaterialPanoramaFishEyeOutlinedW100;
