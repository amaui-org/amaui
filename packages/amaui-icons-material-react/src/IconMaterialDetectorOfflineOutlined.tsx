...
const IconMaterialDetectorOfflineOutlined = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DetectorOfflineOutlined'
...
export default IconMaterialDetectorOfflineOutlined;
