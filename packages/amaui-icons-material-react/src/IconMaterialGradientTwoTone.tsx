...
const IconMaterialGradientTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialGradientTwoTone.displayName = 'AmauiIconMaterialGradientTwoTone';

export default IconMaterialGradientTwoTone;
