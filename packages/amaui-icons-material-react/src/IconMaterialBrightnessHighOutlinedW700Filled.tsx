...
const IconMaterialBrightnessHighOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BrightnessHighOutlinedW700Filled'
...
export default IconMaterialBrightnessHighOutlinedW700Filled;
