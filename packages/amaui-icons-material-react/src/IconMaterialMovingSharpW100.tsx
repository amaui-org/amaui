...
const IconMaterialMovingSharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MovingSharpW100'
      short_name='Moving'
...
IconMaterialMovingSharpW100.displayName = 'AmauiIconMaterialMovingSharpW100';

export default IconMaterialMovingSharpW100;
