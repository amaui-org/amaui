...
const IconMaterialShareReviewsOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ShareReviewsOutlinedW100Filled'
...
export default IconMaterialShareReviewsOutlinedW100Filled;
