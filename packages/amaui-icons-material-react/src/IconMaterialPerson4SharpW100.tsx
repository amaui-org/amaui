...
const IconMaterialPerson4SharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Person4SharpW100'
      short_name='Person4'
...
IconMaterialPerson4SharpW100.displayName = 'AmauiIconMaterialPerson4SharpW100';

export default IconMaterialPerson4SharpW100;
