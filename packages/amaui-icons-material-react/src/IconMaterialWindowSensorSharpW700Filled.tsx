...
const IconMaterialWindowSensorSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WindowSensorSharpW700Filled'
...
export default IconMaterialWindowSensorSharpW700Filled;
