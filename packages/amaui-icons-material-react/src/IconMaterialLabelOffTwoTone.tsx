...
const IconMaterialLabelOffTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialLabelOffTwoTone.displayName = 'AmauiIconMaterialLabelOffTwoTone';

export default IconMaterialLabelOffTwoTone;
