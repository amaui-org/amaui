...
const IconMaterialInventorySharp = React.forwardRef((props: any, ref) => {
...
IconMaterialInventorySharp.displayName = 'AmauiIconMaterialInventorySharp';

export default IconMaterialInventorySharp;
