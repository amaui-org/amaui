...
const IconMaterialRowingOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RowingOutlinedW700Filled'
      short_name='Rowing'
...
export default IconMaterialRowingOutlinedW700Filled;
