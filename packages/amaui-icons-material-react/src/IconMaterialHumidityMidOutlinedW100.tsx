...
const IconMaterialHumidityMidOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HumidityMidOutlinedW100'
...
export default IconMaterialHumidityMidOutlinedW100;
