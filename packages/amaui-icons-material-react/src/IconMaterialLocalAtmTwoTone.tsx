...
const IconMaterialLocalAtmTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialLocalAtmTwoTone.displayName = 'AmauiIconMaterialLocalAtmTwoTone';

export default IconMaterialLocalAtmTwoTone;
