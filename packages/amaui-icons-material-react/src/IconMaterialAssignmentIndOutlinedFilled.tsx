...
const IconMaterialAssignmentIndOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AssignmentIndOutlinedFilled'
...
export default IconMaterialAssignmentIndOutlinedFilled;
