...
const IconMaterialSyncDisabledTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialSyncDisabledTwoTone.displayName = 'AmauiIconMaterialSyncDisabledTwoTone';

export default IconMaterialSyncDisabledTwoTone;
