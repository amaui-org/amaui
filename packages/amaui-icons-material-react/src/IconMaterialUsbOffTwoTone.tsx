...
const IconMaterialUsbOffTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialUsbOffTwoTone.displayName = 'AmauiIconMaterialUsbOffTwoTone';

export default IconMaterialUsbOffTwoTone;
