...
const IconMaterialWbTwilightOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WbTwilightOutlinedFilled'
...
export default IconMaterialWbTwilightOutlinedFilled;
