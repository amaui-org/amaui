...
const IconMaterialPianoOffSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PianoOffSharpW700Filled'
      short_name='PianoOff'
...
export default IconMaterialPianoOffSharpW700Filled;
