...
const IconMaterialFlakyOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FlakyOutlinedW100Filled'
      short_name='Flaky'
...
export default IconMaterialFlakyOutlinedW100Filled;
