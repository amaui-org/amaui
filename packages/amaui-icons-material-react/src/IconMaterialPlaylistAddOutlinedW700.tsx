...
const IconMaterialPlaylistAddOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PlaylistAddOutlinedW700'
...
export default IconMaterialPlaylistAddOutlinedW700;
