...
const IconMaterialReceiptLongOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ReceiptLongOutlinedFilled'
...
export default IconMaterialReceiptLongOutlinedFilled;
