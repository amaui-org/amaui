...
const IconMaterialLaundrySharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LaundrySharpFilled'
      short_name='Laundry'
...
IconMaterialLaundrySharpFilled.displayName = 'AmauiIconMaterialLaundrySharpFilled';

export default IconMaterialLaundrySharpFilled;
