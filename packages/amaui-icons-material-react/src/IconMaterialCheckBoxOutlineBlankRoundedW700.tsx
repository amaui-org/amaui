...
const IconMaterialCheckBoxOutlineBlankRoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CheckBoxOutlineBlankRoundedW700'
...
export default IconMaterialCheckBoxOutlineBlankRoundedW700;
