...
const IconMaterialApprovalRounded = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ApprovalRounded'
      short_name='Approval'
...
IconMaterialApprovalRounded.displayName = 'AmauiIconMaterialApprovalRounded';

export default IconMaterialApprovalRounded;
