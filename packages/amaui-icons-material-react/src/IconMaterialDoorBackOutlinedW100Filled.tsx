...
const IconMaterialDoorBackOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DoorBackOutlinedW100Filled'
      short_name='DoorBack'
...
export default IconMaterialDoorBackOutlinedW100Filled;
