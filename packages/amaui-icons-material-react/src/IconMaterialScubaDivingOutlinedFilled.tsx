...
const IconMaterialScubaDivingOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ScubaDivingOutlinedFilled'
...
export default IconMaterialScubaDivingOutlinedFilled;
