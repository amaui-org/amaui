...
const IconMaterialFace2SharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Face2SharpFilled'
      short_name='Face2'
...
IconMaterialFace2SharpFilled.displayName = 'AmauiIconMaterialFace2SharpFilled';

export default IconMaterialFace2SharpFilled;
