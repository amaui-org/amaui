...
const IconMaterialPhoneIphoneOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PhoneIphoneOutlinedW700Filled'
...
export default IconMaterialPhoneIphoneOutlinedW700Filled;
