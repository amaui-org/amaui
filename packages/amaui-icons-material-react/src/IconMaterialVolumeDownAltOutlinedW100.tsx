...
const IconMaterialVolumeDownAltOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='VolumeDownAltOutlinedW100'
...
export default IconMaterialVolumeDownAltOutlinedW100;
