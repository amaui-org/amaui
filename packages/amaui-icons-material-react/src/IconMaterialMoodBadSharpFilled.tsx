...
const IconMaterialMoodBadSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MoodBadSharpFilled'
      short_name='MoodBad'
...
IconMaterialMoodBadSharpFilled.displayName = 'AmauiIconMaterialMoodBadSharpFilled';

export default IconMaterialMoodBadSharpFilled;
