...
const IconMaterialAddHomeSharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AddHomeSharpW100'
      short_name='AddHome'
...
IconMaterialAddHomeSharpW100.displayName = 'AmauiIconMaterialAddHomeSharpW100';

export default IconMaterialAddHomeSharpW100;
