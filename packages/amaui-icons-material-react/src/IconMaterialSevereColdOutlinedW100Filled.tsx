...
const IconMaterialSevereColdOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SevereColdOutlinedW100Filled'
...
export default IconMaterialSevereColdOutlinedW100Filled;
