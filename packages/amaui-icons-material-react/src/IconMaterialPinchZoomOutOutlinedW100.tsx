...
const IconMaterialPinchZoomOutOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PinchZoomOutOutlinedW100'
...
export default IconMaterialPinchZoomOutOutlinedW100;
