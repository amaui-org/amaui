...
const IconMaterialNextWeekTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialNextWeekTwoTone.displayName = 'AmauiIconMaterialNextWeekTwoTone';

export default IconMaterialNextWeekTwoTone;
