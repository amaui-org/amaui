...
const IconMaterialBrightness1OutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Brightness1OutlinedW700Filled'
...
export default IconMaterialBrightness1OutlinedW700Filled;
