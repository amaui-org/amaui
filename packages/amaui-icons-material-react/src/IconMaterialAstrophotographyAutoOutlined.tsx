...
const IconMaterialAstrophotographyAutoOutlined = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AstrophotographyAutoOutlined'
...
export default IconMaterialAstrophotographyAutoOutlined;
