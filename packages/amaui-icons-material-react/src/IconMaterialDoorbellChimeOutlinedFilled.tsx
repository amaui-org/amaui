...
const IconMaterialDoorbellChimeOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DoorbellChimeOutlinedFilled'
...
export default IconMaterialDoorbellChimeOutlinedFilled;
