...
const IconMaterialSportsRugbyOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SportsRugbyOutlinedFilled'
...
export default IconMaterialSportsRugbyOutlinedFilled;
