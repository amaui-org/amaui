...
const IconMaterialAutoAwesomeOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AutoAwesomeOutlinedW100'
...
export default IconMaterialAutoAwesomeOutlinedW100;
