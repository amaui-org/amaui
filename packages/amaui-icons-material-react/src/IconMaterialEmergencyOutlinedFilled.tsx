...
const IconMaterialEmergencyOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='EmergencyOutlinedFilled'
...
export default IconMaterialEmergencyOutlinedFilled;
