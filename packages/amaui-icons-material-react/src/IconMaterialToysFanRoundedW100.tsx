...
const IconMaterialToysFanRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ToysFanRoundedW100'
      short_name='ToysFan'
...
IconMaterialToysFanRoundedW100.displayName = 'AmauiIconMaterialToysFanRoundedW100';

export default IconMaterialToysFanRoundedW100;
