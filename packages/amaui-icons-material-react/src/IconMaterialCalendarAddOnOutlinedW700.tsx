...
const IconMaterialCalendarAddOnOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CalendarAddOnOutlinedW700'
...
export default IconMaterialCalendarAddOnOutlinedW700;
