...
const IconMaterialChromecastDeviceOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ChromecastDeviceOutlinedW100'
...
export default IconMaterialChromecastDeviceOutlinedW100;
