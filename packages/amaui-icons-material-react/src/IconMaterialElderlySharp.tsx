...
const IconMaterialElderlySharp = React.forwardRef((props: any, ref) => {
...
IconMaterialElderlySharp.displayName = 'AmauiIconMaterialElderlySharp';

export default IconMaterialElderlySharp;
