...
const IconMaterialAppShortcutOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AppShortcutOutlinedW100'
...
export default IconMaterialAppShortcutOutlinedW100;
