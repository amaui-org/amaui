...
const IconMaterialTamperDetectionOffOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TamperDetectionOffOutlinedW100Filled'
...
export default IconMaterialTamperDetectionOffOutlinedW100Filled;
