...
const IconMaterialAccessibleSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialAccessibleSharp.displayName = 'AmauiIconMaterialAccessibleSharp';

export default IconMaterialAccessibleSharp;
