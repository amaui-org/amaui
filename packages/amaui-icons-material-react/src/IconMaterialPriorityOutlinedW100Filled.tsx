...
const IconMaterialPriorityOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PriorityOutlinedW100Filled'
      short_name='Priority'
...
export default IconMaterialPriorityOutlinedW100Filled;
