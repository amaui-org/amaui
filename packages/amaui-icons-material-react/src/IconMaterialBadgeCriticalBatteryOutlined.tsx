...
const IconMaterialBadgeCriticalBatteryOutlined = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BadgeCriticalBatteryOutlined'
...
export default IconMaterialBadgeCriticalBatteryOutlined;
