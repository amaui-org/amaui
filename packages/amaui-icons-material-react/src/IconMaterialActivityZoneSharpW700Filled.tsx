...
const IconMaterialActivityZoneSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ActivityZoneSharpW700Filled'
...
export default IconMaterialActivityZoneSharpW700Filled;
