...
const IconMaterialPublicSharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PublicSharpW100'
      short_name='Public'
...
IconMaterialPublicSharpW100.displayName = 'AmauiIconMaterialPublicSharpW100';

export default IconMaterialPublicSharpW100;
