...
const IconMaterialTrailLengthOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TrailLengthOutlinedW700Filled'
...
export default IconMaterialTrailLengthOutlinedW700Filled;
