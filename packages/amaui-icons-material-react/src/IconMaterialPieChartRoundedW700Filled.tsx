...
const IconMaterialPieChartRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PieChartRoundedW700Filled'
      short_name='PieChart'
...
export default IconMaterialPieChartRoundedW700Filled;
