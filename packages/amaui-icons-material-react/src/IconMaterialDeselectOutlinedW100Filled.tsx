...
const IconMaterialDeselectOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DeselectOutlinedW100Filled'
      short_name='Deselect'
...
export default IconMaterialDeselectOutlinedW100Filled;
