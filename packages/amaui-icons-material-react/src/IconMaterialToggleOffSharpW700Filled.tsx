...
const IconMaterialToggleOffSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ToggleOffSharpW700Filled'
...
export default IconMaterialToggleOffSharpW700Filled;
