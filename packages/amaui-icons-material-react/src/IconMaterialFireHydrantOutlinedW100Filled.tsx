...
const IconMaterialFireHydrantOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FireHydrantOutlinedW100Filled'
...
export default IconMaterialFireHydrantOutlinedW100Filled;
