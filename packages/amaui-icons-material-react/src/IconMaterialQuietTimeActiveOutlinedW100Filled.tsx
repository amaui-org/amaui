...
const IconMaterialQuietTimeActiveOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='QuietTimeActiveOutlinedW100Filled'
...
export default IconMaterialQuietTimeActiveOutlinedW100Filled;
