...
const IconMaterialMan4RoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Man4RoundedW100'
      short_name='Man4'
...
IconMaterialMan4RoundedW100.displayName = 'AmauiIconMaterialMan4RoundedW100';

export default IconMaterialMan4RoundedW100;
