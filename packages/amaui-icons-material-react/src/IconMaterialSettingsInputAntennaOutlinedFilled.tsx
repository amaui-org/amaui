...
const IconMaterialSettingsInputAntennaOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SettingsInputAntennaOutlinedFilled'
...
export default IconMaterialSettingsInputAntennaOutlinedFilled;
