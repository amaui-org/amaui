...
const IconMaterialRotate90DegreesCcwOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Rotate90DegreesCcwOutlinedFilled'
...
export default IconMaterialRotate90DegreesCcwOutlinedFilled;
