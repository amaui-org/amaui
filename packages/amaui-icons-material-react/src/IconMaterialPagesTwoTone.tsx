...
const IconMaterialPagesTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialPagesTwoTone.displayName = 'AmauiIconMaterialPagesTwoTone';

export default IconMaterialPagesTwoTone;
