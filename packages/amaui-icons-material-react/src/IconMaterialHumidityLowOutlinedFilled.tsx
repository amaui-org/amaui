...
const IconMaterialHumidityLowOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HumidityLowOutlinedFilled'
...
export default IconMaterialHumidityLowOutlinedFilled;
