...
const IconMaterialPersonOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PersonOutlinedW700Filled'
      short_name='Person'
...
export default IconMaterialPersonOutlinedW700Filled;
