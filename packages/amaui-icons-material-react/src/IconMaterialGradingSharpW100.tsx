...
const IconMaterialGradingSharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='GradingSharpW100'
      short_name='Grading'
...
IconMaterialGradingSharpW100.displayName = 'AmauiIconMaterialGradingSharpW100';

export default IconMaterialGradingSharpW100;
