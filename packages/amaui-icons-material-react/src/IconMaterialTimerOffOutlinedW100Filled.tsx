...
const IconMaterialTimerOffOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TimerOffOutlinedW100Filled'
      short_name='TimerOff'
...
export default IconMaterialTimerOffOutlinedW100Filled;
