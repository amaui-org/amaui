...
const IconMaterialNestCamFloodlightOutlined = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestCamFloodlightOutlined'
...
export default IconMaterialNestCamFloodlightOutlined;
