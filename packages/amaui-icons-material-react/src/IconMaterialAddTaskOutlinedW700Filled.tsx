...
const IconMaterialAddTaskOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AddTaskOutlinedW700Filled'
      short_name='AddTask'
...
export default IconMaterialAddTaskOutlinedW700Filled;
