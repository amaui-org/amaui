...
const IconMaterialPaletteTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialPaletteTwoTone.displayName = 'AmauiIconMaterialPaletteTwoTone';

export default IconMaterialPaletteTwoTone;
