...
const IconMaterialBorderOuterOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BorderOuterOutlinedW100'
...
export default IconMaterialBorderOuterOutlinedW100;
