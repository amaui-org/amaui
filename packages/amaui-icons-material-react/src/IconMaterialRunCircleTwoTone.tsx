...
const IconMaterialRunCircleTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialRunCircleTwoTone.displayName = 'AmauiIconMaterialRunCircleTwoTone';

export default IconMaterialRunCircleTwoTone;
