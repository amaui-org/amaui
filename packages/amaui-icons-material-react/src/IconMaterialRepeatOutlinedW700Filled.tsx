...
const IconMaterialRepeatOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RepeatOutlinedW700Filled'
      short_name='Repeat'
...
export default IconMaterialRepeatOutlinedW700Filled;
