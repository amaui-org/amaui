...
const IconMaterialInterestsOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='InterestsOutlinedFilled'
...
export default IconMaterialInterestsOutlinedFilled;
