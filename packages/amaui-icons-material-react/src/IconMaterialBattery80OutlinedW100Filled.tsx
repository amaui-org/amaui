...
const IconMaterialBattery80OutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Battery80OutlinedW100Filled'
...
export default IconMaterialBattery80OutlinedW100Filled;
