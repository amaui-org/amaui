...
const IconMaterialNoiseControlOffOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NoiseControlOffOutlinedW100'
...
export default IconMaterialNoiseControlOffOutlinedW100;
