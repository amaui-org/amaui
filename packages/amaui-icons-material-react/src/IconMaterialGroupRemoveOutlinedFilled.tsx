...
const IconMaterialGroupRemoveOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='GroupRemoveOutlinedFilled'
...
export default IconMaterialGroupRemoveOutlinedFilled;
