...
const IconMaterialWallpaperOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WallpaperOutlinedW100Filled'
...
export default IconMaterialWallpaperOutlinedW100Filled;
