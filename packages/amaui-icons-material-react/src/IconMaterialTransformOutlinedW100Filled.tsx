...
const IconMaterialTransformOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TransformOutlinedW100Filled'
...
export default IconMaterialTransformOutlinedW100Filled;
