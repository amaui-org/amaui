...
const IconMaterialBorderBottomSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BorderBottomSharpW700Filled'
...
export default IconMaterialBorderBottomSharpW700Filled;
