...
const IconMaterialFolderSharedRoundedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FolderSharedRoundedW700'
...
export default IconMaterialFolderSharedRoundedW700;
