...
const IconMaterialAdjustTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialAdjustTwoTone.displayName = 'AmauiIconMaterialAdjustTwoTone';

export default IconMaterialAdjustTwoTone;
