...
const IconMaterialForward5Sharp = React.forwardRef((props: any, ref) => {
...
IconMaterialForward5Sharp.displayName = 'AmauiIconMaterialForward5Sharp';

export default IconMaterialForward5Sharp;
