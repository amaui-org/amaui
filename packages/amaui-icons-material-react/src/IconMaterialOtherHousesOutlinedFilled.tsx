...
const IconMaterialOtherHousesOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='OtherHousesOutlinedFilled'
...
export default IconMaterialOtherHousesOutlinedFilled;
