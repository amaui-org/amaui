...
const IconMaterialBadgeCriticalBatteryOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BadgeCriticalBatteryOutlinedW700'
...
export default IconMaterialBadgeCriticalBatteryOutlinedW700;
