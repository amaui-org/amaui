...
const IconMaterialToolsPowerDrillOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ToolsPowerDrillOutlinedFilled'
...
export default IconMaterialToolsPowerDrillOutlinedFilled;
