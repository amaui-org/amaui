...
const IconMaterialHomeAppLogoOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HomeAppLogoOutlinedW700Filled'
...
export default IconMaterialHomeAppLogoOutlinedW700Filled;
