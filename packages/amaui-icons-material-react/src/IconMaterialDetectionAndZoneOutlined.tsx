...
const IconMaterialDetectionAndZoneOutlined = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DetectionAndZoneOutlined'
...
export default IconMaterialDetectionAndZoneOutlined;
