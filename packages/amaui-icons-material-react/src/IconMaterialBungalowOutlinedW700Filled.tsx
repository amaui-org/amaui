...
const IconMaterialBungalowOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BungalowOutlinedW700Filled'
      short_name='Bungalow'
...
export default IconMaterialBungalowOutlinedW700Filled;
