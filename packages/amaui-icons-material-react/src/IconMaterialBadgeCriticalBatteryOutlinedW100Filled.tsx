...
const IconMaterialBadgeCriticalBatteryOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BadgeCriticalBatteryOutlinedW100Filled'
...
export default IconMaterialBadgeCriticalBatteryOutlinedW100Filled;
