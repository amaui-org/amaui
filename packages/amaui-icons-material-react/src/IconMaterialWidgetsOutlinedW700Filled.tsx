...
const IconMaterialWidgetsOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WidgetsOutlinedW700Filled'
      short_name='Widgets'
...
export default IconMaterialWidgetsOutlinedW700Filled;
