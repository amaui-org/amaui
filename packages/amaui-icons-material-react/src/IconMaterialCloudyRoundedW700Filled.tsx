...
const IconMaterialCloudyRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CloudyRoundedW700Filled'
      short_name='Cloudy'
...
export default IconMaterialCloudyRoundedW700Filled;
