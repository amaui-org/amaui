...
const IconMaterialBrightness2OutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Brightness2OutlinedFilled'
...
export default IconMaterialBrightness2OutlinedFilled;
