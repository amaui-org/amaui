...
const IconMaterialNightlightOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NightlightOutlinedW100Filled'
...
export default IconMaterialNightlightOutlinedW100Filled;
