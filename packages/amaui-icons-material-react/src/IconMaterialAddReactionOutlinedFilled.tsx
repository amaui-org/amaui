...
const IconMaterialAddReactionOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AddReactionOutlinedFilled'
...
export default IconMaterialAddReactionOutlinedFilled;
