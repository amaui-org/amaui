...
const IconMaterialBrightnessAutoSharpW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BrightnessAutoSharpW700'
...
export default IconMaterialBrightnessAutoSharpW700;
