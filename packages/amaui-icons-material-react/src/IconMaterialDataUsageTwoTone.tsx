...
const IconMaterialDataUsageTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialDataUsageTwoTone.displayName = 'AmauiIconMaterialDataUsageTwoTone';

export default IconMaterialDataUsageTwoTone;
