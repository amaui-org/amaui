...
const IconMaterialTaskAltSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TaskAltSharpFilled'
      short_name='TaskAlt'
...
IconMaterialTaskAltSharpFilled.displayName = 'AmauiIconMaterialTaskAltSharpFilled';

export default IconMaterialTaskAltSharpFilled;
