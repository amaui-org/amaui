...
const IconMaterialPlayForWorkOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PlayForWorkOutlinedFilled'
...
export default IconMaterialPlayForWorkOutlinedFilled;
