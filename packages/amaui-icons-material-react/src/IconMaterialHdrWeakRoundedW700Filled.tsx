...
const IconMaterialHdrWeakRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HdrWeakRoundedW700Filled'
      short_name='HdrWeak'
...
export default IconMaterialHdrWeakRoundedW700Filled;
