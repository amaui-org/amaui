...
const IconMaterialRotateLeftOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='RotateLeftOutlinedW100Filled'
...
export default IconMaterialRotateLeftOutlinedW100Filled;
