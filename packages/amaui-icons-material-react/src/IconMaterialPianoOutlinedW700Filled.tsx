...
const IconMaterialPianoOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PianoOutlinedW700Filled'
      short_name='Piano'
...
export default IconMaterialPianoOutlinedW700Filled;
