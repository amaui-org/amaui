...
const IconMaterialTonalityRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TonalityRoundedW100'
      short_name='Tonality'
...
IconMaterialTonalityRoundedW100.displayName = 'AmauiIconMaterialTonalityRoundedW100';

export default IconMaterialTonalityRoundedW100;
