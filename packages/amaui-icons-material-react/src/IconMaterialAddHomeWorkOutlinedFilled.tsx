...
const IconMaterialAddHomeWorkOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AddHomeWorkOutlinedFilled'
...
export default IconMaterialAddHomeWorkOutlinedFilled;
