...
const IconMaterialDetectorRounded = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DetectorRounded'
      short_name='Detector'
...
IconMaterialDetectorRounded.displayName = 'AmauiIconMaterialDetectorRounded';

export default IconMaterialDetectorRounded;
