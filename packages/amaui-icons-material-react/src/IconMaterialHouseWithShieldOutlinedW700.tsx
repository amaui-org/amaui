...
const IconMaterialHouseWithShieldOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HouseWithShieldOutlinedW700'
...
export default IconMaterialHouseWithShieldOutlinedW700;
