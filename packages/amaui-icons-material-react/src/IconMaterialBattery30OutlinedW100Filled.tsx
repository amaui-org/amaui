...
const IconMaterialBattery30OutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Battery30OutlinedW100Filled'
...
export default IconMaterialBattery30OutlinedW100Filled;
