...
const IconMaterialWifi2BarOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Wifi2BarOutlinedW100Filled'
      short_name='Wifi2Bar'
...
export default IconMaterialWifi2BarOutlinedW100Filled;
