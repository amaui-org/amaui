...
const IconMaterialMicrowaveGenOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MicrowaveGenOutlinedFilled'
...
export default IconMaterialMicrowaveGenOutlinedFilled;
