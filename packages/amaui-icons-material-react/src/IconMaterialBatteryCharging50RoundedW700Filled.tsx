...
const IconMaterialBatteryCharging50RoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryCharging50RoundedW700Filled'
...
export default IconMaterialBatteryCharging50RoundedW700Filled;
