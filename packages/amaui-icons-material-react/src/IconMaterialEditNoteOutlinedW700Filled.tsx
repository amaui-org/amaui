...
const IconMaterialEditNoteOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='EditNoteOutlinedW700Filled'
      short_name='EditNote'
...
export default IconMaterialEditNoteOutlinedW700Filled;
