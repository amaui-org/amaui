...
const IconMaterialCropPortraitOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CropPortraitOutlinedW100'
...
export default IconMaterialCropPortraitOutlinedW100;
