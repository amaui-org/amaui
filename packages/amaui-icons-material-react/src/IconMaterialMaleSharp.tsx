...
const IconMaterialMaleSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialMaleSharp.displayName = 'AmauiIconMaterialMaleSharp';

export default IconMaterialMaleSharp;
