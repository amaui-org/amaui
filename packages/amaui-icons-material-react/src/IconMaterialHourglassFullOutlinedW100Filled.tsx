...
const IconMaterialHourglassFullOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HourglassFullOutlinedW100Filled'
...
export default IconMaterialHourglassFullOutlinedW100Filled;
