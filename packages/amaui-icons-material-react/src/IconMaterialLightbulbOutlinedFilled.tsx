...
const IconMaterialLightbulbOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='LightbulbOutlinedFilled'
...
export default IconMaterialLightbulbOutlinedFilled;
