...
const IconMaterialWifiProtectedSetupOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WifiProtectedSetupOutlinedFilled'
...
export default IconMaterialWifiProtectedSetupOutlinedFilled;
