...
const IconMaterialCodeRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CodeRoundedW100'
      short_name='Code'
...
IconMaterialCodeRoundedW100.displayName = 'AmauiIconMaterialCodeRoundedW100';

export default IconMaterialCodeRoundedW100;
