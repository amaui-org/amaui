...
const IconMaterialAccessibilityNewOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AccessibilityNewOutlinedFilled'
...
export default IconMaterialAccessibilityNewOutlinedFilled;
