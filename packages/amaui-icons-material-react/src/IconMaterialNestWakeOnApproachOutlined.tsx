...
const IconMaterialNestWakeOnApproachOutlined = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestWakeOnApproachOutlined'
...
export default IconMaterialNestWakeOnApproachOutlined;
