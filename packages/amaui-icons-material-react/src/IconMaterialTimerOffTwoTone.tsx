...
const IconMaterialTimerOffTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialTimerOffTwoTone.displayName = 'AmauiIconMaterialTimerOffTwoTone';

export default IconMaterialTimerOffTwoTone;
