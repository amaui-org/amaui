...
const IconMaterialDoorbellRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DoorbellRoundedW700Filled'
      short_name='Doorbell'
...
export default IconMaterialDoorbellRoundedW700Filled;
