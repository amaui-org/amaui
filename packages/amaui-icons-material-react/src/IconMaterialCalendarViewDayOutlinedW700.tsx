...
const IconMaterialCalendarViewDayOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CalendarViewDayOutlinedW700'
...
export default IconMaterialCalendarViewDayOutlinedW700;
