...
const IconMaterialHardwareTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialHardwareTwoTone.displayName = 'AmauiIconMaterialHardwareTwoTone';

export default IconMaterialHardwareTwoTone;
