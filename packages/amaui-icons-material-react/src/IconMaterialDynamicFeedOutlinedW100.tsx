...
const IconMaterialDynamicFeedOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DynamicFeedOutlinedW100'
...
export default IconMaterialDynamicFeedOutlinedW100;
