...
const IconMaterialIntegrationInstructionsSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='IntegrationInstructionsSharpW700Filled'
...
export default IconMaterialIntegrationInstructionsSharpW700Filled;
