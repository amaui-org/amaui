...
const IconMaterialBattery2BarOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Battery2BarOutlinedFilled'
...
export default IconMaterialBattery2BarOutlinedFilled;
