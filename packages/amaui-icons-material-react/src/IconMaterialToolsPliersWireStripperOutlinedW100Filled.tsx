...
const IconMaterialToolsPliersWireStripperOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ToolsPliersWireStripperOutlinedW100Filled'
...
export default IconMaterialToolsPliersWireStripperOutlinedW100Filled;
