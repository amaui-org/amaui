...
const IconMaterialBreakingNewsAlt1RoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BreakingNewsAlt1RoundedW700Filled'
...
export default IconMaterialBreakingNewsAlt1RoundedW700Filled;
