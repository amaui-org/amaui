...
const IconMaterialNestMiniSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestMiniSharpFilled'
      short_name='NestMini'
...
IconMaterialNestMiniSharpFilled.displayName = 'AmauiIconMaterialNestMiniSharpFilled';

export default IconMaterialNestMiniSharpFilled;
