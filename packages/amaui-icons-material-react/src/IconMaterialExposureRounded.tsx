...
const IconMaterialExposureRounded = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ExposureRounded'
      short_name='Exposure'
...
IconMaterialExposureRounded.displayName = 'AmauiIconMaterialExposureRounded';

export default IconMaterialExposureRounded;
