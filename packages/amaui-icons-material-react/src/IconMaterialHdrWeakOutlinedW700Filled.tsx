...
const IconMaterialHdrWeakOutlinedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HdrWeakOutlinedW700Filled'
      short_name='HdrWeak'
...
export default IconMaterialHdrWeakOutlinedW700Filled;
