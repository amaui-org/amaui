...
const IconMaterialHomePinOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HomePinOutlinedW100Filled'
      short_name='HomePin'
...
export default IconMaterialHomePinOutlinedW100Filled;
