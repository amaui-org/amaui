...
const IconMaterialPlumbingRounded = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PlumbingRounded'
      short_name='Plumbing'
...
IconMaterialPlumbingRounded.displayName = 'AmauiIconMaterialPlumbingRounded';

export default IconMaterialPlumbingRounded;
