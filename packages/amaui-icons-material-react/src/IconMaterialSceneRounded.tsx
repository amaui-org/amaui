...
const IconMaterialSceneRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialSceneRounded.displayName = 'AmauiIconMaterialSceneRounded';

export default IconMaterialSceneRounded;
