...
const IconMaterialOtherHousesSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='OtherHousesSharpW700Filled'
...
export default IconMaterialOtherHousesSharpW700Filled;
