...
const IconMaterialHomeSpeakerOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HomeSpeakerOutlinedW100'
...
export default IconMaterialHomeSpeakerOutlinedW100;
