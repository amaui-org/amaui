...
const IconMaterialSportsFootballOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SportsFootballOutlinedFilled'
...
export default IconMaterialSportsFootballOutlinedFilled;
