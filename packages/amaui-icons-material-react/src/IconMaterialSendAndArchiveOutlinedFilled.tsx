...
const IconMaterialSendAndArchiveOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SendAndArchiveOutlinedFilled'
...
export default IconMaterialSendAndArchiveOutlinedFilled;
