...
const IconMaterialSensorsOffSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialSensorsOffSharp.displayName = 'AmauiIconMaterialSensorsOffSharp';

export default IconMaterialSensorsOffSharp;
