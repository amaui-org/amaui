...
const IconMaterialPhotoCameraFrontOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PhotoCameraFrontOutlinedW700'
...
export default IconMaterialPhotoCameraFrontOutlinedW700;
