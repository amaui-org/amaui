...
const IconMaterialLunchDiningTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialLunchDiningTwoTone.displayName = 'AmauiIconMaterialLunchDiningTwoTone';

export default IconMaterialLunchDiningTwoTone;
