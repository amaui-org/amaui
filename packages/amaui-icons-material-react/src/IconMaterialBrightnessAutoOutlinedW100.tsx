...
const IconMaterialBrightnessAutoOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BrightnessAutoOutlinedW100'
...
export default IconMaterialBrightnessAutoOutlinedW100;
