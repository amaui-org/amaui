...
const IconMaterialHourglassBottomOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='HourglassBottomOutlinedFilled'
...
export default IconMaterialHourglassBottomOutlinedFilled;
