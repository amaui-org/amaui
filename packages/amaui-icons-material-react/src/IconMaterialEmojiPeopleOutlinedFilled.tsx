...
const IconMaterialEmojiPeopleOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='EmojiPeopleOutlinedFilled'
...
export default IconMaterialEmojiPeopleOutlinedFilled;
