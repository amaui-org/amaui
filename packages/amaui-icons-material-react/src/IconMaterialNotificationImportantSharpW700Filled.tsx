...
const IconMaterialNotificationImportantSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NotificationImportantSharpW700Filled'
...
export default IconMaterialNotificationImportantSharpW700Filled;
