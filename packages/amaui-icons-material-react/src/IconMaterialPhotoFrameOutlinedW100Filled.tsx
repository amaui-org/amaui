...
const IconMaterialPhotoFrameOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PhotoFrameOutlinedW100Filled'
...
export default IconMaterialPhotoFrameOutlinedW100Filled;
