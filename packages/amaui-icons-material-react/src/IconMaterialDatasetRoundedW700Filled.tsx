...
const IconMaterialDatasetRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DatasetRoundedW700Filled'
      short_name='Dataset'
...
export default IconMaterialDatasetRoundedW700Filled;
