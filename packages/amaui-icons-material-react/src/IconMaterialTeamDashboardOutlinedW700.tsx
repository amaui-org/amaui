...
const IconMaterialTeamDashboardOutlinedW700 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TeamDashboardOutlinedW700'
...
export default IconMaterialTeamDashboardOutlinedW700;
