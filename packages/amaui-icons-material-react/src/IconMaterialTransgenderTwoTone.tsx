...
const IconMaterialTransgenderTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialTransgenderTwoTone.displayName = 'AmauiIconMaterialTransgenderTwoTone';

export default IconMaterialTransgenderTwoTone;
