...
const IconMaterialFlashAutoOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='FlashAutoOutlinedFilled'
...
export default IconMaterialFlashAutoOutlinedFilled;
