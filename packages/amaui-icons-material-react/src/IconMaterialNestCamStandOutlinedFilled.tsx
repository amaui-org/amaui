...
const IconMaterialNestCamStandOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestCamStandOutlinedFilled'
...
export default IconMaterialNestCamStandOutlinedFilled;
