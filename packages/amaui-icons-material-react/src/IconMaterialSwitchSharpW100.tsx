...
const IconMaterialSwitchSharpW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SwitchSharpW100'
      short_name='Switch'
...
IconMaterialSwitchSharpW100.displayName = 'AmauiIconMaterialSwitchSharpW100';

export default IconMaterialSwitchSharpW100;
