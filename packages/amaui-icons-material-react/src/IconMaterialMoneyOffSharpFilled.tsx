...
const IconMaterialMoneyOffSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='MoneyOffSharpFilled'
      short_name='MoneyOff'
...
IconMaterialMoneyOffSharpFilled.displayName = 'AmauiIconMaterialMoneyOffSharpFilled';

export default IconMaterialMoneyOffSharpFilled;
