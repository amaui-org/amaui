...
const IconMaterialSplitscreenRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SplitscreenRoundedW700Filled'
...
export default IconMaterialSplitscreenRoundedW700Filled;
