...
const IconMaterialExpandMoreRoundedW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ExpandMoreRoundedW700Filled'
...
export default IconMaterialExpandMoreRoundedW700Filled;
