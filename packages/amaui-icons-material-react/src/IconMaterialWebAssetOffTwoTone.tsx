...
const IconMaterialWebAssetOffTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialWebAssetOffTwoTone.displayName = 'AmauiIconMaterialWebAssetOffTwoTone';

export default IconMaterialWebAssetOffTwoTone;
