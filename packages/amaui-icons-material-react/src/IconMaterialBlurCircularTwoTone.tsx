...
const IconMaterialBlurCircularTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialBlurCircularTwoTone.displayName = 'AmauiIconMaterialBlurCircularTwoTone';

export default IconMaterialBlurCircularTwoTone;
