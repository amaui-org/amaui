...
const IconMaterialEmojiSymbolsTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialEmojiSymbolsTwoTone.displayName = 'AmauiIconMaterialEmojiSymbolsTwoTone';

export default IconMaterialEmojiSymbolsTwoTone;
