...
const IconMaterialCloudCircleOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CloudCircleOutlinedW100Filled'
...
export default IconMaterialCloudCircleOutlinedW100Filled;
