...
const IconMaterialWebStoriesOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='WebStoriesOutlinedW100Filled'
...
export default IconMaterialWebStoriesOutlinedW100Filled;
