...
const IconMaterialTibiaSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TibiaSharpFilled'
      short_name='Tibia'
...
IconMaterialTibiaSharpFilled.displayName = 'AmauiIconMaterialTibiaSharpFilled';

export default IconMaterialTibiaSharpFilled;
