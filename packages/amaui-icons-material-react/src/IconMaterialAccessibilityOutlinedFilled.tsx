...
const IconMaterialAccessibilityOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AccessibilityOutlinedFilled'
...
export default IconMaterialAccessibilityOutlinedFilled;
