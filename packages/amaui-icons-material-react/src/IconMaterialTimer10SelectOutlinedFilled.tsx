...
const IconMaterialTimer10SelectOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='Timer10SelectOutlinedFilled'
...
export default IconMaterialTimer10SelectOutlinedFilled;
