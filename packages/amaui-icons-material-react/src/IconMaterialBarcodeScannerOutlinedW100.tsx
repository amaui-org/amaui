...
const IconMaterialBarcodeScannerOutlinedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BarcodeScannerOutlinedW100'
...
export default IconMaterialBarcodeScannerOutlinedW100;
