...
const IconMaterialApartmentOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ApartmentOutlinedFilled'
...
export default IconMaterialApartmentOutlinedFilled;
