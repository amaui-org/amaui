...
const IconMaterialPhotoFrameSharp = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PhotoFrameSharp'
...
IconMaterialPhotoFrameSharp.displayName = 'AmauiIconMaterialPhotoFrameSharp';

export default IconMaterialPhotoFrameSharp;
