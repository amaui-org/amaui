...
const IconMaterialPaddingRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PaddingRoundedW100'
      short_name='Padding'
...
IconMaterialPaddingRoundedW100.displayName = 'AmauiIconMaterialPaddingRoundedW100';

export default IconMaterialPaddingRoundedW100;
