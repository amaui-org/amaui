...
const IconMaterialTransgenderSharp = React.forwardRef((props: any, ref) => {
...
IconMaterialTransgenderSharp.displayName = 'AmauiIconMaterialTransgenderSharp';

export default IconMaterialTransgenderSharp;
