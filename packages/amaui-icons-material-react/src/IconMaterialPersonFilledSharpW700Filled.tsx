...
const IconMaterialPersonFilledSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PersonFilledSharpW700Filled'
...
export default IconMaterialPersonFilledSharpW700Filled;
