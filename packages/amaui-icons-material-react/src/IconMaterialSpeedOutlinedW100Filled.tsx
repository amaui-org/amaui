...
const IconMaterialSpeedOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='SpeedOutlinedW100Filled'
      short_name='Speed'
...
export default IconMaterialSpeedOutlinedW100Filled;
