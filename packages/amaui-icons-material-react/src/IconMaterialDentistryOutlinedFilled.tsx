...
const IconMaterialDentistryOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='DentistryOutlinedFilled'
...
export default IconMaterialDentistryOutlinedFilled;
