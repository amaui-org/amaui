...
const IconMaterialAccountBoxOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AccountBoxOutlinedFilled'
...
export default IconMaterialAccountBoxOutlinedFilled;
