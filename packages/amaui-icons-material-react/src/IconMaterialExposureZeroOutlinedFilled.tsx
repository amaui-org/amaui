...
const IconMaterialExposureZeroOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ExposureZeroOutlinedFilled'
...
export default IconMaterialExposureZeroOutlinedFilled;
