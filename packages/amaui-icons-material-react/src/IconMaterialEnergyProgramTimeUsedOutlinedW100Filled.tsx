...
const IconMaterialEnergyProgramTimeUsedOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='EnergyProgramTimeUsedOutlinedW100Filled'
...
export default IconMaterialEnergyProgramTimeUsedOutlinedW100Filled;
