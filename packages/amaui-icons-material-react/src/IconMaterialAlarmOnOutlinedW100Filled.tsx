...
const IconMaterialAlarmOnOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AlarmOnOutlinedW100Filled'
      short_name='AlarmOn'
...
export default IconMaterialAlarmOnOutlinedW100Filled;
