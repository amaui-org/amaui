...
const IconMaterialAppBlockingOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AppBlockingOutlinedFilled'
...
export default IconMaterialAppBlockingOutlinedFilled;
