...
const IconMaterialInvertColorsOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='InvertColorsOutlinedFilled'
...
export default IconMaterialInvertColorsOutlinedFilled;
