...
const IconMaterialPublicRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='PublicRoundedW100'
      short_name='Public'
...
IconMaterialPublicRoundedW100.displayName = 'AmauiIconMaterialPublicRoundedW100';

export default IconMaterialPublicRoundedW100;
