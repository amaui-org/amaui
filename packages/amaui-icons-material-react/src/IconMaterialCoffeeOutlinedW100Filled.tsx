...
const IconMaterialCoffeeOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CoffeeOutlinedW100Filled'
      short_name='Coffee'
...
export default IconMaterialCoffeeOutlinedW100Filled;
