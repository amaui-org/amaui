...
const IconMaterialCloudDoneSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='CloudDoneSharpW700Filled'
...
export default IconMaterialCloudDoneSharpW700Filled;
