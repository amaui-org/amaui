...
const IconMaterialEnableOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='EnableOutlinedW100Filled'
      short_name='Enable'
...
export default IconMaterialEnableOutlinedW100Filled;
