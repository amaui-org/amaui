...
const IconMaterialNestDisplayMaxSharpW700Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestDisplayMaxSharpW700Filled'
...
export default IconMaterialNestDisplayMaxSharpW700Filled;
