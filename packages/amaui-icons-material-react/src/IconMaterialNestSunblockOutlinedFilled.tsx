...
const IconMaterialNestSunblockOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestSunblockOutlinedFilled'
...
export default IconMaterialNestSunblockOutlinedFilled;
