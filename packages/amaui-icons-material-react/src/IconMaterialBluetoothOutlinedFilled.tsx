...
const IconMaterialBluetoothOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='BluetoothOutlinedFilled'
...
export default IconMaterialBluetoothOutlinedFilled;
