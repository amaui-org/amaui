...
const IconMaterialAutoActivityZoneOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='AutoActivityZoneOutlinedW100Filled'
...
export default IconMaterialAutoActivityZoneOutlinedW100Filled;
