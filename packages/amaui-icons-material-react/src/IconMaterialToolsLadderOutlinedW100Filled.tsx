...
const IconMaterialToolsLadderOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ToolsLadderOutlinedW100Filled'
...
export default IconMaterialToolsLadderOutlinedW100Filled;
