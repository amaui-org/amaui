...
const IconMaterialCropRotateTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialCropRotateTwoTone.displayName = 'AmauiIconMaterialCropRotateTwoTone';

export default IconMaterialCropRotateTwoTone;
