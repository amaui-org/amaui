...
const IconMaterialReportSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='ReportSharpFilled'
      short_name='Report'
...
IconMaterialReportSharpFilled.displayName = 'AmauiIconMaterialReportSharpFilled';

export default IconMaterialReportSharpFilled;
