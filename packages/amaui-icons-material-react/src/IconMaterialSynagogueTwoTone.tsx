...
const IconMaterialSynagogueTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialSynagogueTwoTone.displayName = 'AmauiIconMaterialSynagogueTwoTone';

export default IconMaterialSynagogueTwoTone;
