...
const IconMaterialNightlightTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialNightlightTwoTone.displayName = 'AmauiIconMaterialNightlightTwoTone';

export default IconMaterialNightlightTwoTone;
