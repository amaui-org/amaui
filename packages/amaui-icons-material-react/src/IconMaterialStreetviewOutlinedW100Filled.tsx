...
const IconMaterialStreetviewOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='StreetviewOutlinedW100Filled'
...
export default IconMaterialStreetviewOutlinedW100Filled;
