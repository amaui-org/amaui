...
const IconMaterialTvGenRoundedW100 = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='TvGenRoundedW100'
      short_name='TvGen'
...
IconMaterialTvGenRoundedW100.displayName = 'AmauiIconMaterialTvGenRoundedW100';

export default IconMaterialTvGenRoundedW100;
