...
const IconMaterialUndoSharpFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='UndoSharpFilled'
      short_name='Undo'
...
IconMaterialUndoSharpFilled.displayName = 'AmauiIconMaterialUndoSharpFilled';

export default IconMaterialUndoSharpFilled;
