...
const IconMaterialPunchClockTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialPunchClockTwoTone.displayName = 'AmauiIconMaterialPunchClockTwoTone';

export default IconMaterialPunchClockTwoTone;
