...
const IconMaterialWallpaperTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialWallpaperTwoTone.displayName = 'AmauiIconMaterialWallpaperTwoTone';

export default IconMaterialWallpaperTwoTone;
