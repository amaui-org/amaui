...
const IconMaterialEscalatorOutlinedFilled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='EscalatorOutlinedFilled'
...
export default IconMaterialEscalatorOutlinedFilled;
