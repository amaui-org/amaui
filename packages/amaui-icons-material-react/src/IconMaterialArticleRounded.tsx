...
const IconMaterialArticleRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialArticleRounded.displayName = 'AmauiIconMaterialArticleRounded';

export default IconMaterialArticleRounded;
