...
const IconMaterialPatternTwoTone = React.forwardRef((props: any, ref) => {
...
IconMaterialPatternTwoTone.displayName = 'AmauiIconMaterialPatternTwoTone';

export default IconMaterialPatternTwoTone;
