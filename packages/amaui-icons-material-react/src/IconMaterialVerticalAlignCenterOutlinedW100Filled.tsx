...
const IconMaterialVerticalAlignCenterOutlinedW100Filled = React.forwardRef((props: any, ref) => {

  return (
    <Icon
      ref={ref}

      name='VerticalAlignCenterOutlinedW100Filled'
...
export default IconMaterialVerticalAlignCenterOutlinedW100Filled;
