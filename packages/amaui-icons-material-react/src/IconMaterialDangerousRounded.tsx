...
const IconMaterialDangerousRounded = React.forwardRef((props: any, ref) => {
...
IconMaterialDangerousRounded.displayName = 'AmauiIconMaterialDangerousRounded';

export default IconMaterialDangerousRounded;
