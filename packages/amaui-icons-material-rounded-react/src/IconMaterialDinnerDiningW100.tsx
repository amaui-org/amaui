...
const IconMaterialDinnerDiningW100 = React.forwardRef((props: IIcon, ref) => {
  ...
  return (
    <Icon
      ...
      {...props}
    >
      <path d="M3.55 20.3q-.125 0-.238-.1-.112-.1-.112-.25 0-.175.112-.262.113-.088.238-.088h16.275q.15 0 .25.1t.1.25q0 .15-.113.25-.112.1-.237.1Zm.25-2.7q.125-.225.325-.5t.475-.55v-8h-.65q-.15 0-.25-.1t-.1-.25q0-.15.1-.25t.25-.1h.65v-1h-.65q-.15 0-.25-.1t-.1-.25q0-.15.1-.25t.25-.1h.65v-1h-.65q-.15 0-.25-.1t-.1-.25q0-.15.1-.25t.25-.1h5.6q.5 0 1 .412.5.413.5 1.288h9.4q.15 0 .25.1t.1.25q0 .15-.1.25t-.25.1h-9.4q0 .875-.5 1.287-.5.413-1 .413H7.8v6.85q.675.05 1.313.3.637.25 1.087.7.15-1.35 1.388-2.425Q12.825 12.9 14.7 12.9q1.925 0 3.262 1.175Q19.3 15.25 19.3 16.9v.7Zm7.05-.7h7.75q0-1.35-1.138-2.325-1.137-.975-2.762-.975-1.575 0-2.712.975-1.138.975-1.138 2.325ZM7.8 6.15h2.55v-.2q0-.3-.25-.55-.25-.25-.55-.25H7.8Zm0 1.7h1.75q.3 0 .55-.25.25-.25.25-.55v-.2H7.8Zm-2.5-1.7h1.8v-1H5.3Zm0 1.7h1.8v-1H5.3Zm0 8.15q.425-.275.85-.413.425-.137.95-.187V8.55H5.3Zm5.55.9h7.75Z"/>
    </Icon>
  );
});
