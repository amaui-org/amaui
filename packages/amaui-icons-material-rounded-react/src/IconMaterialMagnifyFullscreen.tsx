...
const IconMaterialMagnifyFullscreen = React.forwardRef((props: IIcon, ref) => {
  ...
  return (
    <Icon
      ...
      {...props}
    >
      <path d="M160 896q-33 0-56.5-23.5T80 816V336q0-33 23.5-56.5T160 256h640q33 0 56.5 23.5T880 336v480q0 33-23.5 56.5T800 896H160Zm0-80h640V336H160v480Zm0 0V336v480Zm400-240v40q0 17 11.5 28.5T600 656q17 0 28.5-11.5T640 616v-40h40q17 0 28.5-11.5T720 536q0-17-11.5-28.5T680 496h-40v-40q0-17-11.5-28.5T600 416q-17 0-28.5 11.5T560 456v40h-40q-17 0-28.5 11.5T480 536q0 17 11.5 28.5T520 576h40Z"/>
    </Icon>
  );
});
