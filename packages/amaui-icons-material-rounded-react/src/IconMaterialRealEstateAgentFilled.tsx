...
const IconMaterialRealEstateAgentFilled = React.forwardRef((props: IIcon, ref) => {
  ...
  return (
    <Icon
      ...
      {...props}
    >
      <path d="M19 15q0-.8-.475-1.6t-1.375-1.15l-7.8-3.1-.35-.1Q8.825 9 8.6 9H7V7.525q0-.5.225-.925.225-.425.625-.7l5-3.575q.5-.375 1.15-.375.65 0 1.15.375l5 3.575q.4.275.625.7.225.425.225.925V15Zm-4-7q.2 0 .35-.15.15-.15.15-.35 0-.2-.15-.35Q15.2 7 15 7q-.2 0-.35.15-.15.15-.15.35 0 .2.15.35.15.15.35.15Zm-2 0q.2 0 .35-.15.15-.15.15-.35 0-.2-.15-.35Q13.2 7 13 7q-.2 0-.35.15-.15.15-.15.35 0 .2.15.35.15.15.35.15Zm2 2q.2 0 .35-.15.15-.15.15-.35 0-.2-.15-.35Q15.2 9 15 9q-.2 0-.35.15-.15.15-.15.35 0 .2.15.35.15.15.35.15Zm-2 0q.2 0 .35-.15.15-.15.15-.35 0-.2-.15-.35Q13.2 9 13 9q-.2 0-.35.15-.15.15-.15.35 0 .2.15.35.15.15.35.15ZM1 20v-7q0-.825.588-1.413Q2.175 11 3 11t1.412.587Q5 12.175 5 13v7q0 .825-.588 1.413Q3.825 22 3 22t-1.412-.587Q1 20.825 1 20Zm12.375 1.825L7 20.025V11h1.6q.175 0 .35.037.175.038.35.088l6.925 2.575q.35.125.563.45.212.325.212.675 0 .525-.362.85-.363.325-.838.325h-2.625q-.125 0-.187-.012-.063-.013-.163-.063L11.7 15.5q-.2-.075-.4.025t-.25.275q-.05.2.025.375.075.175.275.25l1.475.525q.05.025.15.038.1.012.175.012H20q.8 0 1.4.575.6.575.6 1.425l-7.375 2.775q-.25.1-.613.112-.362.013-.637-.062Z"/>
    </Icon>
  );
});
