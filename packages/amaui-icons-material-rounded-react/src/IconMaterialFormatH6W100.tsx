...
const IconMaterialFormatH6W100 = React.forwardRef((props: IIcon, ref) => {
  ...
  return (
    <Icon
      ...
      {...props}
    >
      <path d="M4.65 16.35q-.15 0-.25-.1T4.3 16V8q0-.15.1-.25t.25-.1q.15 0 .25.1T5 8v3.65h5.3V8q0-.15.1-.25t.25-.1q.15 0 .25.1T11 8v8q0 .15-.1.25t-.25.1q-.15 0-.25-.1t-.1-.25v-3.65H5V16q0 .15-.1.25t-.25.1Zm9.85 0q-.625 0-1.062-.437Q13 15.475 13 14.85v-5.7q0-.625.438-1.063.437-.437 1.062-.437h4.85q.15 0 .25.1t.1.25q0 .15-.1.25t-.25.1H14.5q-.35 0-.575.225-.225.225-.225.575v2.5h4.5q.625 0 1.063.437.437.438.437 1.063v1.7q0 .625-.437 1.063-.438.437-1.063.437Zm-.8-4v2.5q0 .35.225.575.225.225.575.225h3.7q.35 0 .575-.225Q19 15.2 19 14.85v-1.7q0-.35-.225-.575-.225-.225-.575-.225Z"/>
    </Icon>
  );
});
