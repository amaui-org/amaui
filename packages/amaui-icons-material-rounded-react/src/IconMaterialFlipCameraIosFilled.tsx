...
const IconMaterialFlipCameraIosFilled = React.forwardRef((props: IIcon, ref) => {
  ...
  return (
    <Icon
      ...
      {...props}
    >
      <path d="M15.45 13.4q-.15 1.325-1.125 2.213-.975.887-2.325.887-.2 0-.4-.025t-.4-.075q-.2-.05-.425 0-.225.05-.375.2-.275.275-.2.662.075.388.425.513t.687.175q.338.05.688.05 2 0 3.412-1.35 1.413-1.35 1.538-3.3l.225.2q.225.2.525.2.3 0 .5-.2.25-.25.25-.55 0-.3-.225-.525L16.95 11.2q-.275-.275-.7-.275-.425 0-.7.275l-1.275 1.275q-.225.225-.225.525 0 .3.225.525.225.225.525.225.3 0 .525-.225Zm-8.4-.75-.225-.2q-.225-.2-.525-.2-.3 0-.5.2-.25.25-.25.55 0 .3.225.525L7.05 14.8q.275.275.7.275.425 0 .7-.275l1.275-1.275Q9.95 13.3 9.95 13q0-.3-.225-.525-.225-.225-.525-.225-.3 0-.525.225l-.125.125q.15-1.325 1.125-2.213Q10.65 9.5 12 9.5q.2 0 .4.025t.4.075q.2.05.425 0 .225-.05.375-.2.275-.275.2-.662-.075-.388-.425-.513t-.687-.175Q12.35 8 12 8q-2 0-3.412 1.35-1.413 1.35-1.538 3.3ZM4 21q-.825 0-1.412-.587Q2 19.825 2 19V7q0-.825.588-1.412Q3.175 5 4 5h3.15L8.4 3.65q.275-.325.662-.488Q9.45 3 9.875 3h4.25q.425 0 .813.162.387.163.662.488L16.85 5H20q.825 0 1.413.588Q22 6.175 22 7v12q0 .825-.587 1.413Q20.825 21 20 21Z"/>
    </Icon>
  );
});
