...
const IconMaterialDoorbellChimeW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='DoorbellChimeW100'
...
IconMaterialDoorbellChimeW100.displayName = 'AmauiIconMaterialDoorbellChimeW100';

export default IconMaterialDoorbellChimeW100;
