...
const IconMaterialDoNotDisturbOff = React.forwardRef((props: IIcon, ref) => {
  ...
  return (
    <Icon
      ...
      {...props}
    >
      <path d="m15.85 13-2-2h2.175q.425 0 .7.287.275.288.275.713t-.288.712Q16.425 13 16 13Zm3.225 8.9L17.5 20.35q-1.225.8-2.612 1.225Q13.5 22 12 22q-2.075 0-3.9-.788-1.825-.787-3.175-2.137-1.35-1.35-2.137-3.175Q2 14.075 2 12q0-1.5.425-2.888Q2.85 7.725 3.65 6.5L2.075 4.925q-.275-.275-.287-.688-.013-.412.287-.712t.713-.3q.412 0 .712.3l17 16.975q.275.275.288.688.012.412-.288.712t-.712.3q-.413 0-.713-.3Zm1.275-4.4-1.45-1.45q.55-.95.825-1.963Q20 13.075 20 12q0-3.325-2.337-5.663Q15.325 4 12 4q-1.075 0-2.087.275Q8.9 4.55 7.95 5.1L6.5 3.65q1.225-.8 2.613-1.225Q10.5 2 12 2q2.075 0 3.9.787 1.825.788 3.175 2.138 1.35 1.35 2.137 3.175Q22 9.925 22 12q0 1.5-.425 2.887-.425 1.388-1.225 2.613Zm-4.3 1.4-5.9-5.9H7.975q-.425 0-.7-.288Q7 12.425 7 12t.287-.713Q7.575 11 8 11h.15L5.1 7.95q-.55.95-.825 1.962Q4 10.925 4 12q0 3.325 2.338 5.663Q8.675 20 12 20q1.075 0 2.088-.275 1.012-.275 1.962-.825Zm-2.2-7.9Zm-3.275 2.425Z"/>
    </Icon>
  );
});
