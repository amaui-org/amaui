...
const IconMaterialMarkunreadMailbox = React.forwardRef((props: IIcon, ref) => {
  ...
  return (
    <Icon
      ...
      {...props}
    >
      <path d="M4 22q-.825 0-1.412-.587Q2 20.825 2 20V10q0-.825.588-1.413Q3.175 8 4 8h2V3q0-.425.287-.713Q6.575 2 7 2h6q.425 0 .713.287Q14 2.575 14 3v2q0 .425-.287.713Q13.425 6 13 6H8v7q0 .425-.287.712Q7.425 14 7 14t-.713-.288Q6 13.425 6 13v-3H4v10h16V10H10V8h10q.825 0 1.413.587Q22 9.175 22 10v10q0 .825-.587 1.413Q20.825 22 20 22Zm0-12V14v-4 10-10Z"/>
    </Icon>
  );
});
