...
const IconMaterialSupportW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialSupportW100.displayName = 'AmauiIconMaterialSupportW100';

export default IconMaterialSupportW100;
