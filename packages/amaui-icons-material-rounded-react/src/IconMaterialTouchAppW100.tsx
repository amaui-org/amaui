...
const IconMaterialTouchAppW100 = React.forwardRef((props: IIcon, ref) => {
  ...
  return (
    <Icon
      ...
      {...props}
    >
      <path d="M11.5 2.3q1.725 0 2.963 1.237Q15.7 4.775 15.7 6.5q0 1.45-.837 2.537-.838 1.088-2.163 1.488v-.75q1.025-.375 1.663-1.25Q15 7.65 15 6.5q0-1.425-1.037-2.463Q12.925 3 11.5 3T9.038 4.037Q8 5.075 8 6.5q0 1.175.65 2.062.65.888 1.65 1.238v.725Q9 10.15 8.15 9.062 7.3 7.975 7.3 6.5q0-1.725 1.238-2.963Q9.775 2.3 11.5 2.3Zm-.95 18.4q-.15 0-.288-.063-.137-.062-.262-.187l-3.875-3.825Q6 16.5 6 16.275q0-.225.125-.425.15-.2.338-.262.187-.063.387-.013l3.45.675V6.5q0-.5.35-.85t.85-.35q.5 0 .85.35t.35.85v5.3h1.05q.1 0 .188.025.087.025.162.075l3.05 1.5q.725.35 1.038 1.137.312.788.162 1.613l-.7 4q-.05.25-.237.4-.188.15-.463.15Zm0-.7h6.4l.7-4q.1-.525-.063-1.1-.162-.575-.737-.85l-3.1-1.55H12v-6q0-.225-.137-.363Q11.725 6 11.5 6q-.225 0-.363.137Q11 6.275 11 6.5v10.6l-4.25-.85Zm6.4 0h-6.4 6.4Z"/>
    </Icon>
  );
});
