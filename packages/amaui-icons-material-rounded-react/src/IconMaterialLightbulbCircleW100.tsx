...
const IconMaterialLightbulbCircleW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='LightbulbCircleW100'
...
IconMaterialLightbulbCircleW100.displayName = 'AmauiIconMaterialLightbulbCircleW100';

export default IconMaterialLightbulbCircleW100;
