...
const IconMaterialNestRemoteW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestRemoteW100Filled'
...
IconMaterialNestRemoteW100Filled.displayName = 'AmauiIconMaterialNestRemoteW100Filled';

export default IconMaterialNestRemoteW100Filled;
