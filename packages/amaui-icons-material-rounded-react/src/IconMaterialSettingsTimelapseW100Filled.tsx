...
const IconMaterialSettingsTimelapseW100Filled = React.forwardRef((props: IIcon, ref) => {
  ...
  return (
    <Icon
      ...
      {...props}
    >
      <path d="M711-181q-4 2-7.5.5T700-187v-166q0-5 3.5-6.5t7.5.5l138 83q4 2 4 6t-4 6l-138 83Zm-160 0q-4 2-7.5.5T540-187v-166q0-5 3.5-6.5t7.5.5l138 83q4 2 4 6t-4 6l-138 83Zm-111 49q-11 0-18-6.5t-9-17.5l-11-88q-21-6-46.5-20T313-294l-78 34q-11 5-21.5 1T197-273l-38-66q-5-10-3-21t11-18l68-51q-2-12-3.5-25t-1.5-25q0-11 1.5-23.5T235-531l-68-51q-9-7-11.5-18t3.5-21l38-64q6-10 16-14t21 1l78 33q20-17 43.5-30.5T401-716l12-86q2-11 10-18.5t19-7.5h75q11 0 19.5 7.5T547-802l11 87q26 9 45.5 20.5T644-665l82-33q11-5 21-1.5t16 13.5l38 65q6 10 3.5 21T793-582l-72 54q4 14 4.5 25.5t.5 22.5v14H565q1-4 1-7v-7q0-37-25.5-62.5T478-568q-37 0-62.5 25.5T390-480q0 26 13.5 47.5T440-400v268Z"/>
    </Icon>
  );
});
