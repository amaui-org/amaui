...
const IconMaterialLauncherAssistantOff = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='LauncherAssistantOff'
...
IconMaterialLauncherAssistantOff.displayName = 'AmauiIconMaterialLauncherAssistantOff';

export default IconMaterialLauncherAssistantOff;
