...
const IconMaterialInventory2W100Filled = React.forwardRef((props: IIcon, ref) => {
  ...
  return (
    <Icon
      ...
      {...props}
    >
      <path d="M5.8 20.7q-.65 0-1.075-.425Q4.3 19.85 4.3 19.2V8.9q-.35-.075-.675-.475-.325-.4-.325-.925V6.1q0-.65.425-1.075Q4.15 4.6 4.8 4.6h14.4q.65 0 1.075.425.425.425.425 1.075v1.4q0 .525-.325.925T19.7 8.9v10.3q0 .65-.425 1.075-.425.425-1.075.425ZM19.2 8.3q.35 0 .575-.225Q20 7.85 20 7.5V6.1q0-.35-.225-.575Q19.55 5.3 19.2 5.3H4.8q-.35 0-.575.225Q4 5.75 4 6.1v1.4q0 .35.225.575.225.225.575.225Zm-9.35 4.9h4.3q.15 0 .25-.1t.1-.25q0-.15-.1-.25t-.25-.1h-4.3q-.15 0-.25.1t-.1.25q0 .15.1.25t.25.1Z"/>
    </Icon>
  );
});
