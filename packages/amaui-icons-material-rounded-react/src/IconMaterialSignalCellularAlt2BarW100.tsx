...
const IconMaterialSignalCellularAlt2BarW100 = React.forwardRef((props: IIcon, ref) => {
  ...
  return (
    <Icon
      ...
      {...props}
    >
      <path d="M7.5 18.35q-.25 0-.425-.175T6.9 17.75v-3.5q0-.25.175-.425t.425-.175q.25 0 .425.175t.175.425v3.5q0 .25-.175.425t-.425.175Zm5 0q-.25 0-.425-.175t-.175-.425v-8.5q0-.25.175-.425t.425-.175q.25 0 .425.175t.175.425v8.5q0 .25-.175.425t-.425.175Z"/>
    </Icon>
  );
});
