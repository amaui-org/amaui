...
import { AmauiStyle, AmauiTheme, IMethodResponse, IResponse, names, reset as amauiResetMethod, TValue, TValueMethod } from '@amaui/style';
...
export default function reset(value: TValue, options_: IOptions = {}) {
  ...
  function useReset(props_?: Vue.Ref<any>) {
    ...
    if (response === undefined) {
      ...
      if (response === undefined) response = amauiResetMethod(value, merge(options_, options, { copy: true }));
